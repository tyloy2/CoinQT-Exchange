...
var _a, _b;
import { getCurrentInstance, isInSSRComponentSetup, injectHook, defineComponent, computed, inject, openBlock, createElementBlock, normalizeClass, unref, createElementVNode, normalizeStyle, toDisplayString, ref, provide, onBeforeMount, watch, renderSlot, withModifiers, createCommentVNode } from "vue";
  ...
  setup(__props, { emit: emits }) {
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("view", {
        renderWhole: true,
        class: normalizeClass(["flex text-view nv", [unref(_parentClass)]]),
        style: { "line-height": "0" }
      }, [
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("view", {
        ...
        createElementVNode("view", {
          ...
          _showMenu.value ? (openBlock(), createElementBlock("view", {
            key: 0,
            ...
            createElementVNode("scroll-view", {
              ...
              renderSlot(_ctx.$slots, "menu", {
                sys: { width: unref(appConfig).width * 0.7, height: unref(appConfig).height }
              })
            ], 4)
...
export { computedStyle as a, computedClass as b, custom_props as c, computedDark as d, computedTheme as e, resolveEasycom as f, tmApp as g, theme as h, formatAppLog as i, cssDirection as j, onLoad as o, requireNativePlugin as r, tmText as t, useTmpiniaStore as u };
