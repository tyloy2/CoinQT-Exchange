...
(() => {
  ...
  // F:/CoinQT/CoinQT_app/unpackage/dist/dev/.nvue/pages/chart/index.js
  ...
  // F:/CoinQT/CoinQT_app/unpackage/dist/dev/.nvue/tm-col.js
  ...
  var _sfc_main$12 = /* @__PURE__ */ (0, import_vue2.defineComponent)({
    ...
    setup(__props, { emit: emits }) {
      ...
      const tmcomputed = (0, import_vue2.computed)(() => computedTheme(props, isDark.value, tmcfg.value));
      const width_px_rect = (0, import_vue2.computed)(() => props.width);
      const width_px_rect_rp = (0, import_vue2.computed)(() => width_px_rect.value);
      const justifyAlign2 = {
        start: "flex-start",
        end: "flex-end",
        center: "center",
      ...
      const justify_rp = (0, import_vue2.computed)(() => justifyAlign2[props.justify] || "start");
      const AlignAlign = {
        start: "flex-start",
        end: "flex-end",
        center: "center",
      ...
      const align_rp = (0, import_vue2.computed)(() => AlignAlign[props.align] || "start");
      (0, import_vue2.provide)("TmRowWidth", width_px_rect_rp);
      (0, import_vue2.provide)("TmRowColumn", (0, import_vue2.computed)(() => props.column));
      (0, import_vue2.provide)("TmRowGutter", (0, import_vue2.computed)(() => props.gutter));
      let textColor = (0, import_vue2.computed)(() => tmcomputed.value.textColor);
      (0, import_vue2.provide)("appTextColor", textColor);
      return (_ctx, _cache) => {
        return (0, import_vue2.openBlock)(), (0, import_vue2.createElementBlock)("view", {
          ref: "tmRow",
          onClick: _cache[0] || (_cache[0] = (0, import_vue2.withModifiers)(($event) => emits("click", $event), ["stop"])),
          class: (0, import_vue2.normalizeClass)(["flex tm-row", ["overflow ", `round-${props.round}`, (0, import_vue2.unref)(customClass), `mx-${props.margin[0]} my-${__props.margin[1]}`]]),
          style: (0, import_vue2.normalizeStyle)([
            { flexDirection: "row", flexWrap: "wrap" },
            props.height ? { height: props.height + "rpx" } : "",
            (0, import_vue2.unref)(width_px_rect) ? { width: (0, import_vue2.unref)(width_px_rect) + "rpx" } : "",
            { justifyContent: (0, import_vue2.unref)(justify_rp), alignItems: (0, import_vue2.unref)(align_rp) },
            !props.transprent ? (0, import_vue2.unref)(tmcomputed).backgroundColorCss : "",
            !props.transprent ? (0, import_vue2.unref)(tmcomputed).shadowColor : "",
  ...
  var tmRow = /* @__PURE__ */ _export_sfc(_sfc_main$12, [["__file", "F:/CoinQT/CoinQT_app/tmui/components/tm-row/tm-row.vue"]]);
  ...
  var _sfc_main2 = /* @__PURE__ */ (0, import_vue2.defineComponent)({
    ...
    setup(__props, { emit: emits }) {
      ...
      const isDark = (0, import_vue2.computed)(() => computedDark(props, tmcfg.value));
      const tmcomputed = (0, import_vue2.computed)(() => computedTheme(props, isDark.value, tmcfg.value));
      const TmRowWidth = (0, import_vue2.inject)("TmRowWidth", (0, import_vue2.computed)(() => 0));
      const TmRowColumn = (0, import_vue2.inject)("TmRowColumn", (0, import_vue2.computed)(() => 0));
      const TmRowGutter = (0, import_vue2.inject)("TmRowGutter", (0, import_vue2.computed)(() => 0));
      const colWidth = (0, import_vue2.computed)(() => {
        if (TmRowWidth.value == 0)
          return 0;
        return TmRowWidth.value / TmRowColumn.value;
      });
      const alignComputed = (0, import_vue2.computed)(() => justifyAlign[props.align]);
      let textColor = (0, import_vue2.computed)(() => tmcomputed.value.textColor);
      (0, import_vue2.provide)("appTextColor", textColor);
      return (_ctx, _cache) => {
        return (0, import_vue2.openBlock)(), (0, import_vue2.createElementBlock)("view", {
          onClick: _cache[0] || (_cache[0] = ($event) => emits("click", $event)),
          class: (0, import_vue2.normalizeClass)(["flex flex-col", [(0, import_vue2.unref)(colWidth) ? "" : "flex-1"]]),
          style: (0, import_vue2.normalizeStyle)([(0, import_vue2.unref)(colWidth) ? { width: (0, import_vue2.unref)(colWidth) + "rpx" } : ""]),
          renderWhole: true
        }, [
          (0, import_vue2.createElementVNode)("view", {
            eventPenetrationEnabled: true,
            style: (0, import_vue2.normalizeStyle)([
              (0, import_vue2.unref)(TmRowGutter) ? { marginLeft: `${(0, import_vue2.unref)(TmRowGutter)}rpx`, marginRight: `${(0, import_vue2.unref)(TmRowGutter)}rpx` } : "",
              props.height ? { height: props.height + "rpx" } : "",
              !__props.transprent ? (0, import_vue2.unref)(tmcomputed).backgroundColorCss : "",
              { alignItems: (0, import_vue2.unref)(alignComputed), justifyContent: "center" },
              (0, import_vue2.unref)(customCSSStyle)
            ]),
            class: (0, import_vue2.normalizeClass)(["flex flex-col", (0, import_vue2.unref)(customClass)])
          }, [
            (0, import_vue2.renderSlot)(_ctx.$slots, "default")
          ], 6)
        ], 6);
  ...
  var tmCol = /* @__PURE__ */ _export_sfc(_sfc_main2, [["__file", "F:/CoinQT/CoinQT_app/tmui/components/tm-col/tm-col.vue"]]);
  ...
  var _sfc_main4 = /* @__PURE__ */ (0, import_vue4.defineComponent)({
    ...
    setup(__props, { emit: emits }) {
      ...
      const parenClass_p = (0, import_vue4.computed)(() => props.parenClass);
      const contStyle_p = (0, import_vue4.computed)(() => props.contStyle);
      const _transprent = (0, import_vue4.computed)(() => props.transprent);
      const tmcfg = (0, import_vue4.computed)(() => store.tmStore);
      const _blur = (0, import_vue4.computed)(() => {
      ...
      const tmcomputed = (0, import_vue4.computed)(() => {
        ...
        return computedTheme(__spreadProps4(__spreadValues4({}, props), { blur: _blur.value, text }), isDark.value, tmcfg.value);
      });
      const _isNvue = (0, import_vue4.ref)(false);
      _isNvue.value = true;
      const _margin = (0, import_vue4.computed)(() => props.margin);
      const _padding = (0, import_vue4.computed)(() => props.padding);
      const _width = (0, import_vue4.computed)(() => props.width);
      const _height = (0, import_vue4.computed)(() => props.height);
      const _noLevel = (0, import_vue4.computed)(() => props.noLevel);
      const _blue_sheet = (0, import_vue4.ref)(true);
      const _blurEffect = (0, import_vue4.computed)(() => {
        if (props.blur === true && isDark.value)
          return "dark";
        if (props.blur === true && !isDark.value)
          return "extralight";
      ...
      (0, import_vue4.watch)(() => isDark.value, () => {
        if (store.tmStore.os == "ios" && _blur.value === true) {
          _blue_sheet.value = false;
          (0, import_vue4.nextTick)(() => _blue_sheet.value = true);
        }
      });
      const _bgcolor = (0, import_vue4.computed)(() => {
        var _a22;
      ...
      const isLongPress = (0, import_vue4.ref)(false);
      ...
      let textColor = (0, import_vue4.computed)(() => {
        return tmcomputed.value.textColor;
      });
      (0, import_vue4.provide)("appTextColor", textColor);
      return (_ctx, _cache) => {
        return _blue_sheet.value ? ((0, import_vue4.openBlock)(), (0, import_vue4.createElementBlock)("view", {
          key: 0,
          renderWhole: true,
          blurEffect: (0, import_vue4.unref)(_blurEffect),
          onClick: _cache[0] || (_cache[0] = ($event) => emits("click", $event)),
          ...
          class: (0, import_vue4.normalizeClass)([
            ...
            (0, import_vue4.unref)(parenClass_p),
            `mx-${(0, import_vue4.unref)(_margin)[0]}`,
            `my-${(0, import_vue4.unref)(_margin)[1]}`,
            `px-${(0, import_vue4.unref)(_padding)[0]}`,
            `py-${(0, import_vue4.unref)(_padding)[1]}`,
          ...
          style: (0, import_vue4.normalizeStyle)([
            (0, import_vue4.unref)(_height) ? { height: (0, import_vue4.unref)(_height) + (0, import_vue4.unref)(_padding)[1] * 2 + props.unit } : "",
            (0, import_vue4.unref)(_width) ? { width: (0, import_vue4.unref)(_width) + (0, import_vue4.unref)(_padding)[0] * 2 + props.unit } : "",
            (0, import_vue4.unref)(tmcomputed).borderCss,
            (0, import_vue4.unref)(_blur) && (0, import_vue4.unref)(store).tmStore.os == "ios" && _isNvue.value === true ? "" : (0, import_vue4.unref)(_bgcolor),
            !(0, import_vue4.unref)(_transprent) && props.shadow > 0 ? (0, import_vue4.unref)(tmcomputed).shadowColor : "",
            !(0, import_vue4.unref)(_transprent) && (0, import_vue4.unref)(_blur) ? { backdropFilter: "blur(6px)" } : "",
            (0, import_vue4.unref)(customCSSStyle)
          ])
        }, [
          (0, import_vue4.createElementVNode)("view", {
            renderWhole: true,
            class: (0, import_vue4.normalizeClass)(["flex noNvueBorder flex-col flex-1", (0, import_vue4.unref)(customClass)]),
            style: (0, import_vue4.normalizeStyle)((0, import_vue4.unref)(contStyle_p))
          }, [
            (0, import_vue4.renderSlot)(_ctx.$slots, "default")
          ], 6)
        ], 46, ["blurEffect"])) : (0, import_vue4.createCommentVNode)("v-if", true);
      };
    }
  });
  var tmSheet = /* @__PURE__ */ _export_sfc(_sfc_main4, [["__file", "F:/CoinQT/CoinQT_app/tmui/components/tm-sheet/tm-sheet.vue"]]);
  ...
  var _sfc_main6 = /* @__PURE__ */ (0, import_vue6.defineComponent)({
    ...
    setup(__props, { emit: emits }) {
      var _a2, _b2, _c;
      const props = __props;
      const aniplay = (0, import_vue6.ref)(null);
      ...
      const img_width = (0, import_vue6.computed)(() => {
        return props.width;
      });
      const img_height = (0, import_vue6.computed)(() => {
        return props.height - props.padding[1];
      });
      const img_src = (0, import_vue6.computed)(() => props.src);
      const loading = (0, import_vue6.ref)(true);
      const error = (0, import_vue6.ref)(false);
      const isRmove = (0, import_vue6.ref)(false);
      ...
      const ImagGrupList = (0, import_vue6.inject)("ImagGrupList", (0, import_vue6.computed)(() => []));
      ...
      return (_ctx, _cache) => {
        return !isRmove.value ? ((0, import_vue6.openBlock)(), (0, import_vue6.createBlock)(tmTranslate, {
          key: 0,
          width: (0, import_vue6.unref)(img_width) + props.padding[0] * 2 + props.unit,
          onEnd: aniEnd,
          ref_key: "aniplay",
          ref: aniplay,
          autoPlay: false,
          ...
          default: (0, import_vue6.withCtx)(() => [
            (0, import_vue6.createVNode)(tmSheet, {
              ...
              width: (0, import_vue6.unref)(img_width) - props.padding[0] * 2,
              unit: props.unit
            }, {
              default: (0, import_vue6.withCtx)(() => [
                (0, import_vue6.createElementVNode)("view", {
                  class: (0, import_vue6.normalizeClass)([`pb-${props.padding[1]}`])
                }, [
                  loading.value ? ((0, import_vue6.openBlock)(), (0, import_vue6.createElementBlock)("u-image", {
                    key: 0,
                    src: (0, import_vue6.unref)(img_src),
                    style: { "width": "10px", "height": "10px", "opacity": "0", "transform": "translateX(1200px)" },
                    onLoad: imageLoad,
                    onError: imageError,
                    mode: "scaleToFill"
                  }, null, 40, ["src"])) : (0, import_vue6.createCommentVNode)("v-if", true),
                  !loading.value && !error.value ? ((0, import_vue6.openBlock)(), (0, import_vue6.createElementBlock)("u-image", {
                    key: 1,
                    showMenuByLongpress: props.showMenuByLongPress,
                    onClick: imageClick,
                    class: (0, import_vue6.normalizeClass)(["round-" + props.round]),
                    src: (0, import_vue6.unref)(img_src),
                    style: (0, import_vue6.normalizeStyle)([{ width: (0, import_vue6.unref)(img_width) + props.unit, height: (0, import_vue6.unref)(img_height) + props.unit }]),
                    mode: props.model
                  }, null, 14, ["showMenuByLongpress", "src", "mode"])) : (0, import_vue6.createCommentVNode)("v-if", true),
                  loading.value && !error.value ? ((0, import_vue6.openBlock)(), (0, import_vue6.createElementBlock)("view", {
                    key: 2,
                    style: (0, import_vue6.normalizeStyle)([{ width: (0, import_vue6.unref)(img_width) + props.unit, height: (0, import_vue6.unref)(img_height) + props.unit }]),
                    class: "flex flex-center opacity-3"
                  }, [
                    props.showLoad ? ((0, import_vue6.openBlock)(), (0, import_vue6.createBlock)(tmIcon, {
                      key: 0,
                      "font-size": 26,
                      spin: "",
                      name: "tmicon-loading"
                  ...
                  !loading.value && error.value ? ((0, import_vue6.openBlock)(), (0, import_vue6.createElementBlock)("view", {
                    ...
                    (0, import_vue6.createVNode)(tmIcon, { name: "tmicon-exclamation-circle" }),
                  ...
                  (0, import_vue6.createCommentVNode)(" extra "),
                  props.extra ? ((0, import_vue6.openBlock)(), (0, import_vue6.createElementBlock)("view", {
                    key: 4,
                    onClick: (0, import_vue6.withModifiers)(imageClick, ["stop"]),
                    ...
                    style: (0, import_vue6.normalizeStyle)([
                      props.extra && props.extraPosition == "in" ? { height: (0, import_vue6.unref)(img_height) + props.unit, width: (0, import_vue6.unref)(img_width) + props.unit } : "",
                      props.extra && props.extraPosition == "out" ? { width: (0, import_vue6.unref)(img_width) + props.unit } : ""
                    ])
                  }, [
                    (0, import_vue6.renderSlot)(_ctx.$slots, "extra")
                  ], 14, ["onClick"])) : (0, import_vue6.createCommentVNode)("v-if", true),
                  (0, import_vue6.createCommentVNode)(" delete \u5C55\u793A\u5220\u9664\u6309\u94AE\u3002 "),
                  props.delete ? ((0, import_vue6.openBlock)(), (0, import_vue6.createElementBlock)("view", {
                    key: 5,
                    class: "absolute r-10 t-10 flex flex-col flex-col-center-end zIndex-10",
                    style: (0, import_vue6.normalizeStyle)([props.delete ? { width: (0, import_vue6.unref)(img_width) + props.unit } : ""])
                  }, [
          ...
          _: 3
        }, 8, ["width"])) : (0, import_vue6.createCommentVNode)("v-if", true);
      };
    }
  });
  var tmImage = /* @__PURE__ */ _export_sfc(_sfc_main6, [["__file", "F:/CoinQT/CoinQT_app/tmui/components/tm-image/tm-image.vue"]]);
    ...
    setup(__props) {
      ...
      return (_ctx, _cache) => {
        return (0, import_vue7.openBlock)(), (0, import_vue7.createElementBlock)("scroll-view", {
          ...
          (0, import_vue7.createVNode)(tmApp, null, {
            default: (0, import_vue7.withCtx)(() => [
              (0, import_vue7.createElementVNode)("view", { class: "ma-32" }, [
                (0, import_vue7.createVNode)(tmRow, {
                  width: 686,
                  column: 2,
                  transprent: "",
                  gutter: 10
                  ...
                  default: (0, import_vue7.withCtx)(() => [
                    ((0, import_vue7.openBlock)(true), (0, import_vue7.createElementBlock)(import_vue7.Fragment, null, (0, import_vue7.renderList)(list.value, (item, index2) => {
                      return (0, import_vue7.openBlock)(), (0, import_vue7.createBlock)(tmCol, {
                    ...
                    (0, import_vue7.createVNode)(tmCol, {
                      _class: "mb-10 round-2",
                      height: 280
                    }, {
                      default: (0, import_vue7.withCtx)(() => [
                        (0, import_vue7.createVNode)(tmIcon, { name: "tmicon-plus" }),
                        (0, import_vue7.createVNode)(tmText, {
                          label: "\u66F4\u591A\u89C1Echarts\u5B98\u7F51",
                          _class: "py-12"
                        })
  ...
  var index = /* @__PURE__ */ _export_sfc(_sfc_main7, [["__file", "F:/CoinQT/CoinQT_app/pages/chart/index.nvue"]]);

  // <stdin>
  var webview = plus.webview.currentWebview();
  if (webview) {
    const __pageId = parseInt(webview.id);
    const __pagePath = "pages/chart/index";
    let __pageQuery = {};
    try {
