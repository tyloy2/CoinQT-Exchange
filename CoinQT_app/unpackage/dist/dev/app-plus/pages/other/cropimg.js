...
(() => {
  ...
  // F:/CoinQT/CoinQT_app/unpackage/dist/dev/.nvue/pages/other/cropimg.js
  ...
  var _style_02 = { "rect": { "": { "borderWidth": 1, "borderStyle": "solid", "borderColor": "#FFFFFF" } }, "ani": { "": { "transitionProperty": "transform", "transitionTimingFunction": "ease" } }, "@TRANSITION": { "ani": { "property": "transform", "timingFunction": "ease" } } };
  var _sfc_main$12 = /* @__PURE__ */ (0, import_vue2.defineComponent)({
    ...
    setup(__props, { emit: emits }) {
      ...
      const url = (0, import_vue2.ref)(props.url);
      const {
        safeArea,
        windowWidth,
        windowHeight,
      ...
      const points = (0, import_vue2.ref)({
        px: 0,
        py: 0,
        px2: 0,
        py2: 0,
      ...
      const rectPos = (0, import_vue2.ref)({
        w: props.width,
        h: props.height,
        x: 0,
        y: 0
      });
      const imgPos = (0, import_vue2.ref)({
        scale: 1,
        oldscale: 1,
        center: [0, 0],
        sourceImgWidth: 0,
      ...
      let moveable = (0, import_vue2.ref)(false);
      let moveType = 0;
      let scaleing = (0, import_vue2.ref)(false);
      (0, import_vue2.onMounted)(() => {
        (0, import_vue2.nextTick)(function() {
          setTimeout(function() {
          }, 50);
        });
      });
      ...
      return (_ctx, _cache) => {
        return (0, import_vue2.openBlock)(), (0, import_vue2.createElementBlock)("view", {
          ...
          onTouchmove: (0, import_vue2.withModifiers)(touchMove, ["stop", "prevent"]),
          onTouchend: touchEnd,
          onTouchcancel: touchEnd,
          onMousedown: touchStart,
          onMousemove: (0, import_vue2.withModifiers)(touchMove, ["stop", "prevent"]),
          onMouseup: touchEnd,
          onMouseleave: touchEnd,
          class: "relative overflow",
          style: (0, import_vue2.normalizeStyle)([{ width: `${(0, import_vue2.unref)(view_width)}px`, height: `${(0, import_vue2.unref)(view_height)}px`, background: "#000000" }]),
          renderWhole: true
        }, [
          !url.value ? ((0, import_vue2.openBlock)(), (0, import_vue2.createElementBlock)("view", {
            key: 0,
            class: "flex flex-center py-24"
          }, [
            (0, import_vue2.createElementVNode)("u-text", { style: { "font-size": "24rpx", "color": "white" } }, "\u8BF7\u9009\u62E9\u9009\u62E9\u56FE\u7247\u624D\u53EF\u64CD\u4F5C")
          ])) : (0, import_vue2.createCommentVNode)("v-if", true),
          (0, import_vue2.createCommentVNode)(" transform: `translate(${imgPos.x}px,${imgPos.y}px) scale(${imgPos.scale},${imgPos.scale})` "),
          (0, import_vue2.createCommentVNode)(' <image v-if="url" :src="url"></image> '),
          url.value ? ((0, import_vue2.openBlock)(), (0, import_vue2.createElementBlock)("u-image", {
            key: 1,
            onError: imgError,
            class: (0, import_vue2.normalizeClass)(["absolute l-0 t-0", [(0, import_vue2.unref)(moveable) ? "opacity-10" : "ani opacity-5"]]),
          ...
          }, null, 46, ["src"])) : (0, import_vue2.createCommentVNode)("v-if", true),
          (0, import_vue2.createCommentVNode)(" 		   "),
          (0, import_vue2.createElementVNode)("view", {
            class: (0, import_vue2.normalizeClass)([[(0, import_vue2.unref)(moveable) ? "" : "ani"], "absolute l-0 t-0 rect"]),
            userInteractionEnabled: false,
            style: (0, import_vue2.normalizeStyle)([
          ...
          (0, import_vue2.createElementVNode)("view", {
            ...
            style: (0, import_vue2.normalizeStyle)({ width: `${(0, import_vue2.unref)(view_width)}px`, height: `${80}px` })
          }, [
            (0, import_vue2.createCommentVNode)(` 	<view class="flex-center mb-24">\r
				<tm-slider @change="scaleChange" :width="600" :max='3' :min='1'></tm-slider>\r
			</view> `),
            (0, import_vue2.createElementVNode)("view", { class: "flex-row flex-between" }, [
              (0, import_vue2.createCommentVNode)(" \u7FFB\u8F6C "),
              (0, import_vue2.createCommentVNode)(' <view class="flex-1 flex flex-center">\r\n					<tm-text :userInteractionEnabled="false" color="white" label="\u65CB\u8F6C"></tm-text>\r\n				</view> '),
              (0, import_vue2.createCommentVNode)(" \u53D6\u6D88 "),
              (0, import_vue2.createElementVNode)("view", {
              ...
              (0, import_vue2.createCommentVNode)(" \u9009\u62E9\u56FE\u7247 "),
              (0, import_vue2.createElementVNode)("view", {
                onClick: chooseImg,
                class: "flex-1 flex flex-center"
              }, [
              ...
              (0, import_vue2.createCommentVNode)(" \u786E\u8BA4 "),
              (0, import_vue2.createElementVNode)("view", {
  ...
  var tmCropimg = /* @__PURE__ */ _export_sfc(_sfc_main$12, [["styles", [_style_02]], ["__file", "F:/CoinQT/CoinQT_app/tmui/components/tm-cropimg/tm-cropimg.vue"]]);
    ...
    setup(__props) {
      return (_ctx, _cache) => {
        return (0, import_vue2.openBlock)(), (0, import_vue2.createElementBlock)("scroll-view", {
          ...
          (0, import_vue2.createVNode)(tmApp, null, {
            default: (0, import_vue2.withCtx)(() => [
              (0, import_vue2.createVNode)(tmCropimg)
            ]),
            _: 1
          })
        ]);
  ...
  var cropimg = /* @__PURE__ */ _export_sfc(_sfc_main2, [["__file", "F:/CoinQT/CoinQT_app/pages/other/cropimg.nvue"]]);

  // <stdin>
  var webview = plus.webview.currentWebview();
  if (webview) {
    const __pageId = parseInt(webview.id);
    const __pagePath = "pages/other/cropimg";
    let __pageQuery = {};
    try {
    ...
    cropimg.mpType = "page";
    const app = Vue.createPageApp(cropimg, { $store: getApp({ allowDefault: true }).$store, __pageId, __pagePath, __pageQuery });
    app.provide("__globalStyles", Vue.useCssStyles([...__uniConfig.styles, ...cropimg.styles || []]));
    app.mount("#root");
  }
})();
