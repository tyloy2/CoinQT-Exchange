...
(() => {
  ...
  // F:/CoinQT/CoinQT_app/unpackage/dist/dev/.nvue/pages/other/signBoard.js
  ...
  var _sfc_main$4 = /* @__PURE__ */ (0, import_vue8.defineComponent)({
    __name: "slider-bar",
    props: {
      followTheme: {
        type: [Boolean, String],
    ...
    setup(__props) {
      const props = __props;
      const _sizePx = (0, import_vue8.computed)(() => uni.upx2px(props.size));
      return (_ctx, _cache) => {
        return (0, import_vue8.openBlock)(), (0, import_vue8.createElementBlock)("view", {
          ...
          (0, import_vue8.createVNode)(tmSheet, {
            ...
            color: props.color,
            linear: "right",
            width: props.direction == "horizontal" ? props.width : (0, import_vue8.unref)(_sizePx),
            height: props.direction == "horizontal" ? (0, import_vue8.unref)(_sizePx) : props.width,
            margin: [0, 0],
            padding: [0, 0]
  ...
  var _sfc_main$3 = /* @__PURE__ */ (0, import_vue8.defineComponent)({
    ...
    setup(__props, { emit: emits }) {
      const props = __props;
      const _x = (0, import_vue8.computed)(() => props.x);
      let timerId = NaN;
      ...
      return (_ctx, _cache) => {
        return (0, import_vue8.openBlock)(), (0, import_vue8.createElementBlock)("view", {
          onTouchstart: (0, import_vue8.withModifiers)(movestart, ["stop"]),
          onMousedown: (0, import_vue8.withModifiers)(movestart, ["stop"]),
          onTouchmove: (0, import_vue8.withModifiers)(moveing, ["stop"]),
          onMousemove: (0, import_vue8.withModifiers)(moveing, ["stop"]),
          onTouchend: (0, import_vue8.withModifiers)(moveend, ["stop"]),
          onMouseup: (0, import_vue8.withModifiers)(moveend, ["stop"]),
          onMouseleave: (0, import_vue8.withModifiers)(moveend, ["stop"]),
          class: "absolute",
          style: (0, import_vue8.normalizeStyle)([
            props.direction == "horizontal" ? { width: props.size + "rpx", height: props.size + "rpx", transform: `translateX(${(0, import_vue8.unref)(_x)}px)`, top: "0px" } : "",
            props.direction == "vertical" ? { width: props.size + "rpx", height: props.size + "rpx", transform: `translateY(${(0, import_vue8.unref)(_x)}px)`, left: 0 + "rpx", top: "0px" } : ""
          ]),
          renderWhole: true
        }, [
          (0, import_vue8.createVNode)(tmSheet, {
  ...
  var _sfc_main$2 = /* @__PURE__ */ (0, import_vue8.defineComponent)({
    ...
    setup(__props) {
      const props = __props;
      const _stepArray = (0, import_vue8.computed)(() => {
        let label = [];
        if (props.step == 0)
          return [];
        let _step = props.max / props.step;
        for (let i2 = 1; i2 <= props.step; i2++) {
          label.push(i2 * _step);
        }
      ...
      return (_ctx, _cache) => {
        return (0, import_vue8.openBlock)(), (0, import_vue8.createElementBlock)(import_vue8.Fragment, null, [
          (0, import_vue8.createCommentVNode)(" \u5E95\u90E8\u663E\u793A\u7684\u6807\u7B7E "),
          (0, import_vue8.createElementVNode)("view", {
            class: (0, import_vue8.normalizeClass)(["flex flex-between", [props.direction == "vertical" ? "flex-col" : "flex-row"]]),
            style: (0, import_vue8.normalizeStyle)([
              props.direction == "horizontal" ? { width: __props.width + "rpx" } : { height: __props.height + "rpx" }
            ])
          }, [
            props.direction == "horizontal" ? ((0, import_vue8.openBlock)(true), (0, import_vue8.createElementBlock)(import_vue8.Fragment, { key: 0 }, (0, import_vue8.renderList)((0, import_vue8.unref)(_stepArray), (item, index) => {
              return (0, import_vue8.openBlock)(), (0, import_vue8.createElementBlock)("view", {
                class: (0, import_vue8.normalizeClass)(["flex flex-row", [index == 0 ? "flex-row-top-start" : "", index == (0, import_vue8.unref)(_stepArray).length - 1 ? "flex-row-top-end" : "", index < (0, import_vue8.unref)(_stepArray).length - 1 && index > 0 ? "flex-row-top-center" : ""]]),
                style: { "width": "80rpx" },
                key: index
              }, [
            ...
            }), 128)) : (0, import_vue8.createCommentVNode)("v-if", true),
            props.direction != "horizontal" ? ((0, import_vue8.openBlock)(true), (0, import_vue8.createElementBlock)(import_vue8.Fragment, { key: 1 }, (0, import_vue8.renderList)((0, import_vue8.unref)(_stepArray), (item, index) => {
              return (0, import_vue8.openBlock)(), (0, import_vue8.createElementBlock)("view", {
  ...
  var _sfc_main$13 = /* @__PURE__ */ (0, import_vue8.defineComponent)({
    __name: "slider-mask",
    props: {
      followTheme: {
        type: [Boolean, String],
    ...
    setup(__props) {
      ...
      return (_ctx, _cache) => {
        return (0, import_vue8.openBlock)(), (0, import_vue8.createElementBlock)(import_vue8.Fragment, null, [
          (0, import_vue8.createCommentVNode)(" \u5E95\u90E8\u663E\u793A\u7684\u6807\u7B7E "),
          (0, import_vue8.createElementVNode)("view", {
            class: (0, import_vue8.normalizeClass)(["flex flex-between absolute", [props.direction == "vertical" ? "flex-col " : "flex-row"]]),
            style: (0, import_vue8.normalizeStyle)([
  ...
  var _sfc_main8 = /* @__PURE__ */ (0, import_vue8.defineComponent)({
    ...
    setup(__props, { emit: emits }) {
      ...
      const btn0 = (0, import_vue8.ref)(null);
      const btn1 = (0, import_vue8.ref)(null);
      const proxy = (_b2 = (_a2 = (0, import_vue8.getCurrentInstance)()) == null ? void 0 : _a2.proxy) != null ? _b2 : null;
      const width = (0, import_vue8.computed)(() => uni.upx2px(props.width));
      const isDarg = (0, import_vue8.ref)(false);
      const _disabled = (0, import_vue8.computed)(() => props.disabled);
      const btnPos = (0, import_vue8.ref)([
        {
          x: 0,
          y: 0
        },
      ...
      const isNvue = (0, import_vue8.ref)(false);
      const nvueDetailPos = (0, import_vue8.ref)({ left: 0, bottom: 0 });
      isNvue.value = true;
      const _sliderBarCssWidth = (0, import_vue8.computed)(() => {
        if (props.direction == "horizontal")
          return props.width + props.buttonSize;
        return props.buttonSize;
      });
      const _sliderBarCssHeight = (0, import_vue8.computed)(() => {
        if (props.direction == "horizontal")
          return props.buttonSize;
        return props.width + props.buttonSize;
      });
      const BtnIndex = (0, import_vue8.ref)(0);
      const showDetail = (0, import_vue8.ref)(false);
      const _valueMax = (0, import_vue8.computed)(() => {
        return props.max - props.min;
      });
      const _barWidth = (0, import_vue8.computed)(() => {
        return Math.abs(btnPos.value[0].x - btnPos.value[1].x);
      });
      const _barLet = (0, import_vue8.computed)(() => {
        return Math.min(Math.abs(btnPos.value[0].x), Math.abs(btnPos.value[1].x));
      });
      const _value = (0, import_vue8.ref)(0);
      const isDablue = (0, import_vue8.ref)(false);
      ...
      return (_ctx, _cache) => {
        return (0, import_vue8.openBlock)(), (0, import_vue8.createElementBlock)("view", {
          class: (0, import_vue8.normalizeClass)(["flex", [props.direction == "vertical" ? "flex-row" : "", (0, import_vue8.unref)(_disabled) ? "opacity-6" : ""]]),
          renderWhole: true
        }, [
          (0, import_vue8.createElementVNode)("view", {
            class: (0, import_vue8.normalizeClass)(["relative flex flex-col", [props.direction == "horizontal" ? "flex-col-center-start" : "flex-row-center-center"]]),
            style: (0, import_vue8.normalizeStyle)([
              { width: (0, import_vue8.unref)(_sliderBarCssWidth) + "rpx", height: (0, import_vue8.unref)(_sliderBarCssHeight) + "rpx" }
            ])
          }, [
            (0, import_vue8.createVNode)(tmSheet, {
              noLevel: "",
              round: 10,
              color: props.bgColor,
              height: props.direction == "horizontal" ? props.height : (0, import_vue8.unref)(_sliderBarCssHeight),
              width: props.direction == "horizontal" ? (0, import_vue8.unref)(_sliderBarCssWidth) : props.height,
              margin: [0, 0],
              padding: [0, 0]
            }, null, 8, ["color", "height", "width"]),
            (0, import_vue8.createVNode)(sliderBar, {
              followTheme: props.followTheme,
              class: (0, import_vue8.normalizeClass)([props.direction == "horizontal" ? "flex-col-center-start" : "flex-row-center-center"]),
              direction: props.direction,
              color: props.color,
              size: props.height,
              x: (0, import_vue8.unref)(_barLet),
              width: (0, import_vue8.unref)(_barWidth)
            }, null, 8, ["followTheme", "class", "direction", "color", "size", "x", "width"]),
            props.showLabel ? ((0, import_vue8.openBlock)(), (0, import_vue8.createBlock)(sliderMask, {
              key: 0,
              followTheme: props.followTheme,
              color: props.color,
              ...
              min: props.min,
              max: props.max,
              width: (0, import_vue8.unref)(_sliderBarCssWidth),
              height: (0, import_vue8.unref)(_sliderBarCssHeight),
              direction: props.direction
            }, null, 8, ["followTheme", "color", "size", "step", "min", "max", "width", "height", "direction"])) : (0, import_vue8.createCommentVNode)("v-if", true),
            (0, import_vue8.createVNode)(sliderButton, {
              maxLeft: (0, import_vue8.unref)(buttonStaticsMaxLeft),
              followTheme: props.followTheme,
              direction: props.direction,
              ref_key: "btn0",
              ref: btn0,
            ...
            isDablue.value ? ((0, import_vue8.openBlock)(), (0, import_vue8.createBlock)(sliderButton, {
              key: 1,
              maxLeft: (0, import_vue8.unref)(buttonStaticsMaxLeft),
              followTheme: props.followTheme,
              direction: props.direction,
              ...
              size: props.buttonSize
            }, null, 8, ["maxLeft", "followTheme", "direction", "color", "x", "size"])) : (0, import_vue8.createCommentVNode)("v-if", true)
          ], 6),
          props.showLabel ? ((0, import_vue8.openBlock)(), (0, import_vue8.createElementBlock)("view", {
            key: 0,
            class: (0, import_vue8.normalizeClass)([props.direction == "vertical" ? "flex-col" : "flex-row"])
          }, [
            (0, import_vue8.createVNode)(sliderLabel, {
              size: props.buttonSize,
              step: props.step,
              min: props.min,
              max: props.max,
          ...
          showDetail.value ? ((0, import_vue8.openBlock)(), (0, import_vue8.createElementBlock)("view", {
            key: 1,
            class: (0, import_vue8.normalizeClass)(["flex absolute", [props.direction == "horizontal" ? "flex-col flex-col-start-center" : " flex-row "]]),
            style: (0, import_vue8.normalizeStyle)([
            ...
            (0, import_vue8.createElementVNode)("view", {
              ...
              (0, import_vue8.createVNode)(tmSheet, {
                ...
                default: (0, import_vue8.withCtx)(() => [
                  (0, import_vue8.createVNode)(tmText, { label: _value.value }, null, 8, ["label"])
                ]),
                _: 1
              }),
          ...
          ], 6)) : (0, import_vue8.createCommentVNode)("v-if", true)
        ], 2);
      };
    }
  });
  var tmSlider = /* @__PURE__ */ _export_sfc(_sfc_main8, [["__file", "F:/CoinQT/CoinQT_app/tmui/components/tm-slider/tm-slider.vue"]]);

  // F:/CoinQT/CoinQT_app/unpackage/dist/dev/.nvue/pages/other/signBoard.js
  var import_pinia2 = __toESM(require_pinia());
  var _sfc_main$14 = /* @__PURE__ */ (0, import_vue9.defineComponent)({
    ...
    setup(__props, { expose }) {
      ...
      return (_ctx, _cache) => {
        return (0, import_vue9.openBlock)(), (0, import_vue9.createElementBlock)("view", {
          ...
          ref: "tmspin",
          style: (0, import_vue9.normalizeStyle)({ width: `${props.width}rpx`, height: `${props.height}rpx` }),
          renderWhole: true
        }, [
          show.value ? ((0, import_vue9.openBlock)(), (0, import_vue9.createElementBlock)("gcanvas", {
            ...
            class: "canvas",
            style: (0, import_vue9.normalizeStyle)({ width: `${props.width}rpx`, height: `${props.height}rpx` })
          }, null, 44, ["id"])) : (0, import_vue9.createCommentVNode)("v-if", true)
        ], 36);
      };
    }
  });
  var tmSignBoard = /* @__PURE__ */ _export_sfc(_sfc_main$14, [["__file", "F:/CoinQT/CoinQT_app/tmui/components/tm-sign-board/tm-sign-board.vue"]]);
  var _sfc_main9 = /* @__PURE__ */ (0, import_vue9.defineComponent)({
    __name: "signBoard",
    setup(__props) {
      const { proxy } = (0, import_vue9.getCurrentInstance)();
      const board = (0, import_vue9.ref)(null);
      const colors2 = ["red", "blue", "black", "green"];
      const colorNow = (0, import_vue9.ref)("red");
      const lineWidth = (0, import_vue9.ref)(5);
      const saveImg = () => __async(this, null, function* () {
        var _a2;
        let src = yield (_a2 = board.value) == null ? void 0 : _a2.save();
      ...
      return (_ctx, _cache) => {
        return (0, import_vue9.openBlock)(), (0, import_vue9.createBlock)(tmApp, null, {
          default: (0, import_vue9.withCtx)(() => [
            (0, import_vue9.createVNode)(tmSheet, { width: 662 }, {
              default: (0, import_vue9.withCtx)(() => [
                (0, import_vue9.createVNode)(tmText, { label: "\u7B7E\u540D\u677F\u5168\u7AEF\u517C\u5BB9\uFF0C\u7528\u4E8E\u7B7E\u540D\u4F7F\u7528\u3002\u8BF7\u5728\u4E0B\u65B9\u4E66\u5199" }),
                (0, import_vue9.createVNode)(tmDivider),
                (0, import_vue9.createVNode)(tmSignBoard, {
                ...
                (0, import_vue9.createVNode)(tmDivider),
                (0, import_vue9.createElementVNode)("view", { class: "py-24" }, [
                  (0, import_vue9.createVNode)(tmText, { label: "\u9009\u62E9\u4E66\u5199\u989C\u8272" })
                ]),
                (0, import_vue9.createVNode)(tmRadioGroup, {
                  ...
                  default: (0, import_vue9.withCtx)(() => [
                    ((0, import_vue9.openBlock)(), (0, import_vue9.createElementBlock)(import_vue9.Fragment, null, (0, import_vue9.renderList)(colors2, (item, index) => {
                      return (0, import_vue9.createVNode)(tmRadio, {
                        color: item,
                        value: item,
                        label: item,
                        key: "index"
                ...
                (0, import_vue9.createElementVNode)("view", { class: "py-24" }, [
                  (0, import_vue9.createVNode)(tmText, { label: "\u62D6\u52A8\u6539\u53D8\u7C97\u7EC6" })
                ]),
                (0, import_vue9.createVNode)(tmSlider, {
                  max: 20,
                ...
                (0, import_vue9.createVNode)(tmDivider),
                (0, import_vue9.createElementVNode)("view", { class: "flex flex-row flex-center" }, [
                  (0, import_vue9.createVNode)(TmButton, {
                    onClick: _cache[2] || (_cache[2] = ($event) => (0, import_vue9.unref)(proxy).$refs.board.clear()),
                    label: "\u6E05\u7A7A"
                  }),
                  (0, import_vue9.createVNode)(TmButton, {
                    color: "green",
  ...
  var signBoard = /* @__PURE__ */ _export_sfc(_sfc_main9, [["__file", "F:/CoinQT/CoinQT_app/pages/other/signBoard.nvue"]]);

  // <stdin>
  var webview = plus.webview.currentWebview();
  if (webview) {
    const __pageId = parseInt(webview.id);
    const __pagePath = "pages/other/signBoard";
    let __pageQuery = {};
    try {
      __pageQuery = JSON.parse(webview.__query__);
    } catch (e) {
    }
    signBoard.mpType = "page";
    const app = Vue.createPageApp(signBoard, { $store: getApp({ allowDefault: true }).$store, __pageId, __pagePath, __pageQuery });
    app.provide("__globalStyles", Vue.useCssStyles([...__uniConfig.styles, ...signBoard.styles || []]));
    app.mount("#root");
  }
})();
