...
(() => {
  ...
  // F:/CoinQT/CoinQT_app/unpackage/dist/dev/.nvue/pages/other/barCode.js
  ...
  var _sfc_main8 = /* @__PURE__ */ (0, import_vue8.defineComponent)({
    ...
    setup(__props, { emit: emits }) {
      ...
      const isAndroid2 = (0, import_vue8.ref)(false);
      isAndroid2.value = uni.getSystemInfoSync().osName == "android" ? true : false;
            ...
            (0, import_vue8.createVNode)(tmSheet, {
              ...
              default: (0, import_vue8.withCtx)(() => [
                (0, import_vue8.createElementVNode)("view", {
                  ...
                  !isAndroid2.value ? ((0, import_vue8.openBlock)(), (0, import_vue8.createElementBlock)("view", {
                    key: 3,
  ...
  var CODE39 = class extends Barcode {
    constructor(data, options) {
    ...
    encode() {
      ...
      for (let i2 = 0; i2 < this.data.length; i2++) {
        result += getEncoding(this.data[i2]) + "0";
      }
      result += getEncoding("*");
      return {
        data: result,
  ...
  function mod43checksum(data) {
    ...
    for (let i2 = 0; i2 < data.length; i2++) {
      checksum2 += characterValue(data[i2]);
    }
  ...
  var A_CHARS = "[\0-_\xC8-\xCF]";
  var B_CHARS = "[ -\x7F\xC8-\xCF]";
  ...
  var CODE128 = class extends Barcode {
    constructor(data, options) {
  ...
  var CODE128AUTO = class extends CODE128 {
    constructor(data, options) {
  ...
  var CODE128A = class extends CODE128 {
  ...
  var CODE128B = class extends CODE128 {
    constructor(string, options) {
  ...
  var CODE128C = class extends CODE128 {
    constructor(string, options) {
  ...
  var encode$1 = (data, structure, separator) => {
  ...
  var EAN5 = class extends Barcode {
    constructor(data, options) {
      super(data, options);
    }
    valid() {
  ...
  var EAN2 = class extends Barcode {
    constructor(data, options) {
      super(data, options);
    }
    valid() {
  ...
  function checksum$1(number) {
    ...
    var i2;
    for (i2 = 1; i2 < 11; i2 += 2) {
      result += parseInt(number[i2]);
    }
    for (i2 = 0; i2 < 11; i2 += 2) {
      result += parseInt(number[i2]) * 3;
    }
  ...
  var UPCE = class extends Barcode {
    constructor(data, options) {
      super(data, options);
      this.isValid = false;
  ...
  function expandToUPCA(middleDigits, numberSystem) {
    ...
    let result = "";
    let digitIndex = 0;
    for (let i2 = 0; i2 < expansion.length; i2++) {
      let c = expansion[i2];
      if (c === "X") {
  ...
  var MSI = class extends Barcode {
    ...
    encode() {
      ...
      for (var i2 = 0; i2 < this.data.length; i2++) {
        var digit = parseInt(this.data[i2]);
  ...
  function mod10(number) {
    ...
    for (var i2 = 0; i2 < number.length; i2++) {
      var n = parseInt(number[i2]);
      if ((i2 + number.length) % 2 === 0) {
        sum += n;
      } else {
  ...
  function mod11(number) {
    ...
    for (var i2 = 0; i2 < number.length; i2++) {
      var n = parseInt(number[number.length - 1 - i2]);
      sum += weights[i2 % weights.length] * n;
    }
    return (11 - sum % 11) % 11;
  }
  var MSI10 = class extends MSI {
    constructor(data, options) {
      super(data + mod10(data), options);
    }
  };
  var MSI11 = class extends MSI {
    constructor(data, options) {
      super(data + mod11(data), options);
    }
  };
  var MSI1010 = class extends MSI {
    constructor(data, options) {
      data += mod10(data);
      data += mod10(data);
      super(data, options);
  ...
  var pharmacode = class extends Barcode {
    constructor(data, options) {
      super(data, options);
  ...
  var codabar = class extends Barcode {
    constructor(data, options) {
    ...
    encode() {
      ...
      for (var i2 = 0; i2 < this.data.length; i2++) {
        result.push(encodings2[this.data.charAt(i2)]);
  ...
  var GenericBarcode = class extends Barcode {
    constructor(data, options) {
      super(data, options);
    }
    encode() {
  ...
  var merge = (old, replaceObj) => __spreadValues9(__spreadValues9({}, old), replaceObj);
  function linearizeEncodings(encodings2) {
    var linearEncodings = [];
    function nextLevel(encoded) {
      if (Array.isArray(encoded)) {
        for (let i2 = 0; i2 < encoded.length; i2++) {
          nextLevel(encoded[i2]);
        }
      } else {
  ...
  function calculateEncodingAttributes(encodings2, barcodeOptions, context) {
    for (let i2 = 0; i2 < encodings2.length; i2++) {
      var encoding = encodings2[i2];
  ...
  function getTotalWidthOfEncodings(encodings2) {
    var totalWidth = 0;
    for (let i2 = 0; i2 < encodings2.length; i2++) {
      totalWidth += encodings2[i2].width;
    }
    return totalWidth;
  }
  function getMaximumHeightOfEncodings(encodings2) {
    var maxHeight = 0;
    for (let i2 = 0; i2 < encodings2.length; i2++) {
      if (encodings2[i2].height > maxHeight) {
        maxHeight = encodings2[i2].height;
      }
    }
    return maxHeight;
  }
  ...
  var CanvasRenderer = class {
    ...
    render() {
      ...
      this.prepareCanvas();
      for (let i2 = 0; i2 < this.encodings.length; i2++) {
        var encodingOptions = merge(this.options, this.encodings[i2].options);
        this.drawCanvasBarcode(encodingOptions, this.encodings[i2]);
        this.drawCanvasText(encodingOptions, this.encodings[i2]);
        this.moveCanvasDrawing(this.encodings[i2]);
      }
      this.restoreCanvas();
    }
    prepareCanvas() {
  ...
  var SVGRenderer = class {
    ...
    render() {
      ...
      this.prepareSVG();
      for (let i2 = 0; i2 < this.encodings.length; i2++) {
        var encoding = this.encodings[i2];
  ...
  function getRenderProperties(element) {
    if (typeof element === "string") {
      ...
      for (let i2 = 0; i2 < element.length; i2++) {
        returnArray.push(getRenderProperties(element[i2]));
      }
      return returnArray;
  ...
  function querySelectedRenderProperties(string) {
    ...
    if (selector.length === 0) {
      ...
      for (let i2 = 0; i2 < selector.length; i2++) {
        returnArray.push(getRenderProperties(selector[i2]));
      }
      return returnArray;
    }
  }
  ...
  JsBarcode.getModule = function(name2) {
    return barcodes[name2];
  };
  for (name2 in barcodes) {
    if (barcodes.hasOwnProperty(name2)) {
      registerBarcode(barcodes, name2);
    }
  }
  var name2;
  ...
  function encode(text, Encoder, options) {
    ...
    for (let i2 = 0; i2 < encoded.length; i2++) {
      encoded[i2].options = merge(options, encoded[i2].options);
    }
    return encoded;
  }
  ...
  API.prototype.init = function() {
    ...
    var renderProperty;
    for (let i2 in this._renderProperties) {
      renderProperty = this._renderProperties[i2];
  ...
  API.prototype.render = function() {
    ...
    if (Array.isArray(this._renderProperties)) {
      for (var i2 = 0; i2 < this._renderProperties.length; i2++) {
        render(this._renderProperties[i2], this._encodings, this._options);
      }
    } else {
  ...
  function render(renderProperties, encodings2, options) {
    ...
    for (let i2 = 0; i2 < encodings2.length; i2++) {
      encodings2[i2].options = merge(options, encodings2[i2].options);
      fixOptions(encodings2[i2].options);
    }
    fixOptions(options);
  ...
  var _sfc_main$13 = /* @__PURE__ */ (0, import_vue9.defineComponent)({
    ...
    setup(__props, { expose }) {
      ...
      let ctx2;
      let optsCode = (0, import_vue9.computed)(() => {
        let ops = __spreadValues9(__spreadValues9({}, defaults), props.option);
        ops.height = uni.upx2px(props.height) - 40;
        return ops;
      });
      const _width = (0, import_vue9.computed)(() => props.width);
      ...
      (0, import_vue9.watch)(() => props.option, () => {
        if (!ctx2) {
          init().then(() => draw(__spreadValues9({}, optsCode.value)));
        } else {
          draw(__spreadValues9({}, optsCode.value));
        }
      }, { deep: true });
      function init() {
  ...
  var tmBarcode = /* @__PURE__ */ _export_sfc(_sfc_main$13, [["__file", "F:/CoinQT/CoinQT_app/tmui/components/tm-barcode/tm-barcode.vue"]]);
  var _sfc_main9 = /* @__PURE__ */ (0, import_vue9.defineComponent)({
    __name: "barCode",
    setup(__props) {
      let opts = (0, import_vue9.ref)({ lineColor: "#000000", fontSize: 20, width: 2, text: "123 456 89" });
      return (_ctx, _cache) => {
        return (0, import_vue9.openBlock)(), (0, import_vue9.createElementBlock)("scroll-view", {
          ...
          (0, import_vue9.createVNode)(tmApp, null, {
            default: (0, import_vue9.withCtx)(() => [
              (0, import_vue9.createVNode)(tmSheet, { followDark: false }, {
                default: (0, import_vue9.withCtx)(() => [
                  ...
                  (0, import_vue9.createElementVNode)("view", { class: "flex flex-center" }, [
                    (0, import_vue9.createVNode)(tmBarcode, {
                      width: 636,
                      option: (0, import_vue9.unref)(opts)
                    }, null, 8, ["option"])
                  ])
                ]),
                _: 1
              ...
              (0, import_vue9.createVNode)(tmSheet, null, {
                default: (0, import_vue9.withCtx)(() => [
                  (0, import_vue9.createElementVNode)("view", { class: "flex flex-row flex-row-bottom-start" }, [
                    (0, import_vue9.createVNode)(tmText, { label: "\u5C5E\u6027\u8BBE\u7F6E" }),
                    (0, import_vue9.createVNode)(tmText, {
                      "font-size": 22,
                      _class: "ml-10",
                      label: "(\u5B9E\u65F6\u751F\u6548)"
                  ...
                  (0, import_vue9.createVNode)(tmRadioGroup, {
                    modelValue: (0, import_vue9.unref)(opts).lineColor,
                    "onUpdate:modelValue": _cache[0] || (_cache[0] = ($event) => (0, import_vue9.unref)(opts).lineColor = $event),
                    defaultValue: "#000000"
                  }, {
                    default: (0, import_vue9.withCtx)(() => [
                  ...
                  (0, import_vue9.createVNode)(tmInput, {
                    ...
                    align: "right",
                    placeholder: "\u8BF7\u8F93\u5165\u6587\u672C",
                    modelValue: (0, import_vue9.unref)(opts).text,
                    "onUpdate:modelValue": _cache[1] || (_cache[1] = ($event) => (0, import_vue9.unref)(opts).text = $event),
                    type: "text"
                  }, null, 8, ["modelValue"]),
                  (0, import_vue9.createVNode)(tmInput, {
                    margin: [0, 24],
                    ...
                    align: "right",
                    placeholder: "\u8BF7\u8F93\u5165\u5B57\u53F7",
                    modelValue: (0, import_vue9.unref)(opts).fontSize,
                    "onUpdate:modelValue": _cache[2] || (_cache[2] = ($event) => (0, import_vue9.unref)(opts).fontSize = $event),
                    type: "number"
                  }, null, 8, ["modelValue"]),
                  (0, import_vue9.createVNode)(tmInput, {
                    prefixLabel: "\u7EBF\u5BBDPX",
                    align: "right",
                    placeholder: "\u8BF7\u8F93\u5165\u7EBF\u6761\u5BBD\u5EA6",
                    modelValue: (0, import_vue9.unref)(opts).width,
                    "onUpdate:modelValue": _cache[3] || (_cache[3] = ($event) => (0, import_vue9.unref)(opts).width = $event),
                    type: "number"
                  }, null, 8, ["modelValue"])
                ]),
                _: 1
  ...
  var barCode = /* @__PURE__ */ _export_sfc(_sfc_main9, [["__file", "F:/CoinQT/CoinQT_app/pages/other/barCode.nvue"]]);

  // <stdin>
  var webview = plus.webview.currentWebview();
  if (webview) {
    const __pageId = parseInt(webview.id);
    const __pagePath = "pages/other/barCode";
    let __pageQuery = {};
    try {
    ...
    barCode.mpType = "page";
    const app = Vue.createPageApp(barCode, { $store: getApp({ allowDefault: true }).$store, __pageId, __pagePath, __pageQuery });
    app.provide("__globalStyles", Vue.useCssStyles([...__uniConfig.styles, ...barCode.styles || []]));
    app.mount("#root");
  }
})();
