...
(() => {
  ...
  // F:/CoinQT/CoinQT_app/unpackage/dist/dev/.nvue/pages/other/watermark.js
  ...
  var WebGLRenderingContext = class {
    constructor(canvas, type, attrs) {
      ...
      this.stencilFunc = function(func, ref10, mask) {
        WebGLRenderingContext.GBridge.callNative(this._canvas.id, GLmethod.stencilFunc + "," + func + "," + ref10 + "," + mask, true);
      };
      this.stencilFuncSeparate = function(face, func, ref10, mask) {
        WebGLRenderingContext.GBridge.callNative(this._canvas.id, GLmethod.stencilFuncSeparate + "," + face + "," + func + "," + ref10 + "," + mask, true);
      };
  ...
  var tmTranslate = /* @__PURE__ */ _export_sfc(_sfc_main5, [["styles", [_style_02]], ["__file", "F:/CoinQT/CoinQT_app/tmui/components/tm-translate/tm-translate.vue"]]);
  ...
  var _sfc_main$12 = /* @__PURE__ */ (0, import_vue6.defineComponent)({
    ...
    setup(__props, { expose, emit: emits }) {
      ...
      let _cacheBoxList = [];
      const _mValue = (0, import_vue6.ref)(props.defaultValue || props.modelValue);
      ...
      (0, import_vue6.watch)(() => props.modelValue, () => {
      ...
      const rulesObj = (0, import_vue6.inject)("tmFormItemRules", (0, import_vue6.computed)(() => {
        return [
          {
            message: "\u8BF7\u9009\u62E9",
            required: false,
      ...
      const validate = (rules) => {
        rules = rules.map((el) => {
          if (typeof el.validator === "function" && el.required === true) {
            ...
            return __spreadProps6(__spreadValues6({}, el), {
              validator: (val) => {
      ...
      function pushFormItem(isCheckVail = true) {
        return __async(this, null, function* () {
          if (parentFormItem) {
            if (isCheckVail) {
              validate((0, import_vue6.toRaw)(rulesObj.value)).then((ev) => {
      ...
      pushFormItem();
      (0, import_vue6.provide)("tmRadioBoxDisabled", (0, import_vue6.computed)(() => props.disabled));
      (0, import_vue6.provide)("tmRadioBoxVal", (0, import_vue6.computed)(() => _mValue.value));
      (0, import_vue6.provide)("tmRadioBoxModel", (0, import_vue6.computed)(() => props.model == "radio"));
      expose({ pushKey, addKey, checkBoxkeyId });
      return (_ctx, _cache) => {
        return (0, import_vue6.openBlock)(), (0, import_vue6.createElementBlock)("view", {
          class: (0, import_vue6.normalizeClass)(["flex", [props.direction == "row" ? "flex-row  flex-wrap" : "flex-col", (0, import_vue6.unref)(_align)]]),
          renderWhole: true
        }, [
  ...
  var _sfc_main6 = /* @__PURE__ */ (0, import_vue6.defineComponent)({
    ...
    setup(__props, { emit: emits }) {
      ...
      const props = __props;
      const proxy = (_b2 = (_a2 = (0, import_vue6.getCurrentInstance)()) == null ? void 0 : _a2.proxy) != null ? _b2 : null;
      const _checked = (0, import_vue6.ref)((_c = props.defaultChecked) != null ? _c : false);
      const _groupCheckedVal = (0, import_vue6.inject)("tmRadioBoxVal", (0, import_vue6.computed)(() => ""));
      const tmCheckedBoxDisabled = (0, import_vue6.inject)("tmRadioBoxDisabled", (0, import_vue6.computed)(() => false));
      const _is_radio = (0, import_vue6.inject)("tmRadioBoxModel", (0, import_vue6.computed)(() => false));
      const _disabled = (0, import_vue6.computed)(() => props.disabled || tmCheckedBoxDisabled.value);
      ...
      const tmFormFun = (0, import_vue6.inject)("tmFormFun", (0, import_vue6.computed)(() => ""));
      (0, import_vue6.watch)(tmFormFun, () => {
      ...
      (0, import_vue6.watch)([() => props.modelValue, _groupCheckedVal], () => {
        _checked.value = vailChecked();
      });
      return (_ctx, _cache) => {
        return (0, import_vue6.openBlock)(), (0, import_vue6.createElementBlock)("view", {
          class: (0, import_vue6.normalizeClass)(["flex flex-col flex-wrap overflow", [(0, import_vue6.unref)(_disabled) ? "opacity-5" : ""]]),
          ...
          (0, import_vue6.createElementVNode)("view", {
            ...
            props.custom ? ((0, import_vue6.openBlock)(), (0, import_vue6.createBlock)(tmSheet, {
              key: 0,
              linear: props.linear,
              ...
              width: (0, import_vue6.unref)(_is_radio) ? props.size : 0,
              height: (0, import_vue6.unref)(_is_radio) ? props.size : 0,
              text: !_checked.value,
              border: props.border,
              "border-style": props.borderStyle,
              transprent: props.transprent,
              padding: (0, import_vue6.unref)(_is_radio) ? [0, 0] : [16, 10],
              margin: (0, import_vue6.unref)(_is_radio) ? [16, 8] : [8, 8],
              color: (0, import_vue6.unref)(_disabled) ? "grey-2" : props.color,
              round: props.round,
              _class: "flex-row flex-row-center-center"
            }, {
              default: (0, import_vue6.withCtx)(() => [
                _checked.value && (0, import_vue6.unref)(_is_radio) ? ((0, import_vue6.openBlock)(), (0, import_vue6.createBlock)(tmTranslate, {
                  key: 0,
                  duration: 100,
                  name: "zoom",
                  style: { "line-height": "1" }
                ...
                !(0, import_vue6.unref)(_is_radio) ? ((0, import_vue6.openBlock)(), (0, import_vue6.createBlock)(tmText, {
                  key: 1,
                  "font-size": props.fontSize,
                  label: props.label
                }, null, 8, ["font-size", "label"])) : (0, import_vue6.createCommentVNode)("v-if", true)
              ]),
              _: 1
            }, 8, ["linear", "linearDeep", "followTheme", "followDark", "dark", "shadow", "width", "height", "text", "border", "border-style", "transprent", "padding", "margin", "color", "round"])) : (0, import_vue6.createCommentVNode)("v-if", true),
            (0, import_vue6.createElementVNode)("view", { userInteractionEnabled: false }, [
              (0, import_vue6.renderSlot)(_ctx.$slots, "default", {}, () => [
                (0, import_vue6.createElementVNode)("view", {
  ...
  var tmRadio = /* @__PURE__ */ _export_sfc(_sfc_main6, [["__file", "F:/CoinQT/CoinQT_app/tmui/components/tm-radio/tm-radio.vue"]]);
  ...
  var _sfc_main9 = /* @__PURE__ */ (0, import_vue9.defineComponent)({
    ...
    setup(__props, { emit: emits }) {
      var _a2, _b2, _c;
      const props = __props;
      const aniplay = (0, import_vue9.ref)(null);
      ...
      const img_width = (0, import_vue9.computed)(() => {
        return props.width;
      });
      const img_height = (0, import_vue9.computed)(() => {
        return props.height - props.padding[1];
      });
      const img_src = (0, import_vue9.computed)(() => props.src);
      const loading = (0, import_vue9.ref)(true);
      const error = (0, import_vue9.ref)(false);
      const isRmove = (0, import_vue9.ref)(false);
      let parent = proxy == null ? void 0 : proxy.$parent;
      while (parent) {
      ...
      const ImagGrupList = (0, import_vue9.inject)("ImagGrupList", (0, import_vue9.computed)(() => []));
      ...
      return (_ctx, _cache) => {
        return !isRmove.value ? ((0, import_vue9.openBlock)(), (0, import_vue9.createBlock)(tmTranslate, {
          key: 0,
          width: (0, import_vue9.unref)(img_width) + props.padding[0] * 2 + props.unit,
          onEnd: aniEnd,
          ref_key: "aniplay",
          ref: aniplay,
          autoPlay: false,
          ...
          default: (0, import_vue9.withCtx)(() => [
            (0, import_vue9.createVNode)(tmSheet, {
              ...
              class: (0, import_vue9.normalizeClass)(["round-" + props.round]),
              width: (0, import_vue9.unref)(img_width) - props.padding[0] * 2,
              unit: props.unit
            }, {
              default: (0, import_vue9.withCtx)(() => [
                (0, import_vue9.createElementVNode)("view", {
                  class: (0, import_vue9.normalizeClass)([`pb-${props.padding[1]}`])
                }, [
                  loading.value ? ((0, import_vue9.openBlock)(), (0, import_vue9.createElementBlock)("u-image", {
                    key: 0,
                    src: (0, import_vue9.unref)(img_src),
                    style: { "width": "10px", "height": "10px", "opacity": "0", "transform": "translateX(1200px)" },
                    onLoad: imageLoad,
                    onError: imageError,
                    mode: "scaleToFill"
                  }, null, 40, ["src"])) : (0, import_vue9.createCommentVNode)("v-if", true),
                  !loading.value && !error.value ? ((0, import_vue9.openBlock)(), (0, import_vue9.createElementBlock)("u-image", {
                    key: 1,
                    showMenuByLongpress: props.showMenuByLongPress,
                    onClick: imageClick,
                    class: (0, import_vue9.normalizeClass)(["round-" + props.round]),
                    src: (0, import_vue9.unref)(img_src),
                    style: (0, import_vue9.normalizeStyle)([{ width: (0, import_vue9.unref)(img_width) + props.unit, height: (0, import_vue9.unref)(img_height) + props.unit }]),
                    mode: props.model
                  }, null, 14, ["showMenuByLongpress", "src", "mode"])) : (0, import_vue9.createCommentVNode)("v-if", true),
                  loading.value && !error.value ? ((0, import_vue9.openBlock)(), (0, import_vue9.createElementBlock)("view", {
                    key: 2,
                    style: (0, import_vue9.normalizeStyle)([{ width: (0, import_vue9.unref)(img_width) + props.unit, height: (0, import_vue9.unref)(img_height) + props.unit }]),
                    class: "flex flex-center opacity-3"
                  }, [
                    props.showLoad ? ((0, import_vue9.openBlock)(), (0, import_vue9.createBlock)(tmIcon, {
                      key: 0,
                      "font-size": 26,
                      spin: "",
                      name: "tmicon-loading"
                  ...
                  !loading.value && error.value ? ((0, import_vue9.openBlock)(), (0, import_vue9.createElementBlock)("view", {
                    ...
                    (0, import_vue9.createVNode)(tmIcon, { name: "tmicon-exclamation-circle" }),
                  ...
                  (0, import_vue9.createCommentVNode)(" extra "),
                  props.extra ? ((0, import_vue9.openBlock)(), (0, import_vue9.createElementBlock)("view", {
                    key: 4,
                    onClick: (0, import_vue9.withModifiers)(imageClick, ["stop"]),
                    class: (0, import_vue9.normalizeClass)([
                      props.extraPosition == "in" ? "absolute l-0 b-0 zIndex-5" : "",
                      "flex flex-col flex-col-bottom-start"
                    ]),
                    style: (0, import_vue9.normalizeStyle)([
                      props.extra && props.extraPosition == "in" ? { height: (0, import_vue9.unref)(img_height) + props.unit, width: (0, import_vue9.unref)(img_width) + props.unit } : "",
                      props.extra && props.extraPosition == "out" ? { width: (0, import_vue9.unref)(img_width) + props.unit } : ""
                    ])
                  }, [
                    (0, import_vue9.renderSlot)(_ctx.$slots, "extra")
                  ], 14, ["onClick"])) : (0, import_vue9.createCommentVNode)("v-if", true),
                  (0, import_vue9.createCommentVNode)(" delete \u5C55\u793A\u5220\u9664\u6309\u94AE\u3002 "),
                  props.delete ? ((0, import_vue9.openBlock)(), (0, import_vue9.createElementBlock)("view", {
                    key: 5,
                    class: "absolute r-10 t-10 flex flex-col flex-col-center-end zIndex-10",
                    style: (0, import_vue9.normalizeStyle)([props.delete ? { width: (0, import_vue9.unref)(img_width) + props.unit } : ""])
                  }, [
          ...
          _: 3
        }, 8, ["width"])) : (0, import_vue9.createCommentVNode)("v-if", true);
      };
    }
  });
  var tmImage = /* @__PURE__ */ _export_sfc(_sfc_main9, [["__file", "F:/CoinQT/CoinQT_app/tmui/components/tm-image/tm-image.vue"]]);
  ...
  var uploadfile = class {
    constructor(config) {
      ...
      cf = __spreadValues10(__spreadValues10({}, cf), (_a2 = arguments[0]) != null ? _a2 : {});
      this.config = cf;
    ...
    chooseMPH5weixinFile() {
      return __async(this, null, function* () {
        ...
        return new Promise((rs, rj) => {
          ...
          fs(__spreadProps10(__spreadValues10({}, config), {
            fail: (e) => {
    ...
    setConfig(config) {
      this.config = __spreadValues10(__spreadValues10({}, this.config), config != null ? config : {});
    }
    addFile(filelist = []) {
        ...
        function startupload() {
          return __async(this, null, function* () {
            ...
            const upObj = uni.uploadFile({
              ...
              filePath: item.url,
              formData: __spreadValues10({ name: item.name }, t.config.formData),
              success: (res) => {
  ...
  var _sfc_main10 = /* @__PURE__ */ (0, import_vue10.defineComponent)({
    ...
    setup(__props, { expose, emit: emits }) {
      ...
      const itemWidth = (0, import_vue10.computed)(() => {
        return props.width / props.rows;
      });
      const itemHeight = (0, import_vue10.computed)(() => {
        return props.imageHeight;
      });
      const _filelist = (0, import_vue10.ref)([]);
      const _disabledAdd = (0, import_vue10.computed)(() => {
      ...
      (0, import_vue10.watch)([() => props.header, () => props.maxFile, () => props.maxSize, () => props.formData], () => {
      ...
      function addSuccess(fileList = []) {
        fileList = (0, import_vue10.toRaw)(fileList);
        let fl = fileList.map((e) => {
          let _itemfile = { url: "" };
          if (typeof e == "string") {
            _itemfile.url = e;
          } else {
            _itemfile = __spreadValues10({}, e);
          }
          _itemfile = __spreadProps10(__spreadValues10({}, _itemfile), { statusCode: statusCode.success, status: "\u4E0A\u4F20\u6210\u529F", progress: 100 });
          return _itemfile;
        });
        return fl;
      }
      ...
      _uploadObj.complete = function(item) {
        _filelist.value = [..._uploadObj.filelist];
        emits("complete", (0, import_vue10.toRaw)(item), (0, import_vue10.toRaw)(_filelist.value));
        emits("update:modelValue", _filelist.value);
        pushFormItem(true);
      };
      ...
      _uploadObj.success = function(item, fileList) {
        ...
        if (index > -1) {
          ...
          emits("success", (0, import_vue10.toRaw)(item), (0, import_vue10.toRaw)(_filelist.value));
          emits("change", (0, import_vue10.toRaw)(_filelist.value));
        }
      };
      _uploadObj.fail = function(item) {
        ...
        if (index > -1) {
          _filelist.value.splice(index, 1, item);
          emits("fail", (0, import_vue10.toRaw)(item), (0, import_vue10.toRaw)(_filelist.value));
          emits("change", (0, import_vue10.toRaw)(_filelist.value));
        }
      };
      function chooseFile() {
      ...
      function deletedFile(item) {
        return __async(this, null, function* () {
          ...
          emits("remove", (0, import_vue10.toRaw)(item));
          emits("update:modelValue", _filelist.value);
          emits("change", (0, import_vue10.toRaw)(_filelist.value));
          pushFormItem();
        });
      ...
      return (_ctx, _cache) => {
        return (0, import_vue10.openBlock)(), (0, import_vue10.createElementBlock)("view", {
          ...
          (0, import_vue10.createElementVNode)("view", {
            ...
            style: (0, import_vue10.normalizeStyle)([{ "flex-wrap": "wrap" }, { width: __props.width + "rpx" }])
          }, [
            ((0, import_vue10.openBlock)(true), (0, import_vue10.createElementBlock)(import_vue10.Fragment, null, (0, import_vue10.renderList)(_filelist.value, (item, index) => {
              return (0, import_vue10.openBlock)(), (0, import_vue10.createElementBlock)("view", {
                class: "ma-5",
                key: index,
                style: (0, import_vue10.normalizeStyle)({ width: (0, import_vue10.unref)(itemWidth) - 10 + "rpx" })
              }, [
                (0, import_vue10.createVNode)(tmSheet, {
                  ...
                  default: (0, import_vue10.withCtx)(() => [
                    (0, import_vue10.createVNode)(tmImage, {
                      round: 2,
                      allowDelete: false,
                      ...
                      delete: "",
                      src: item.url,
                      width: (0, import_vue10.unref)(itemWidth) - 10,
                      height: (0, import_vue10.unref)(itemHeight) - 10
                    }, {
                      extra: (0, import_vue10.withCtx)(() => [
                        (0, import_vue10.createElementVNode)("view", {
                          style: (0, import_vue10.normalizeStyle)({ background: "rgba(0, 0, 0, 0.7)", width: (0, import_vue10.unref)(itemWidth) - 10 + "rpx" }),
                          class: (0, import_vue10.normalizeClass)([[`round-b-${2}`], "py-4 px-4 flex flex-row flex-row-center-start"])
                        }, [
                          item.statusCode == 0 || item.statusCode == 1 ? ((0, import_vue10.openBlock)(), (0, import_vue10.createBlock)(tmIcon, {
                            key: 0,
                            "font-size": 23,
                            color: "grey-3",
                            name: "tmicon-clock-fill"
                          })) : (0, import_vue10.createCommentVNode)("v-if", true),
                          item.statusCode == 0 || item.statusCode == 1 ? ((0, import_vue10.openBlock)(), (0, import_vue10.createBlock)(tmText, {
                            key: 1,
                            color: "grey-3",
                            _class: "pl-5",
                            "font-size": 23,
                          ...
                          item.statusCode == 2 || item.statusCode == 4 ? ((0, import_vue10.openBlock)(), (0, import_vue10.createBlock)(tmIcon, {
                            key: 2,
                            "font-size": 23,
                            color: "red",
                            name: "tmicon-times-circle-fill"
                          })) : (0, import_vue10.createCommentVNode)("v-if", true),
                          item.statusCode == 2 || item.statusCode == 4 ? ((0, import_vue10.openBlock)(), (0, import_vue10.createBlock)(tmText, {
                            key: 3,
                            color: "red",
                            _class: "pl-5",
                            "font-size": 23,
                          ...
                          item.statusCode == 3 ? ((0, import_vue10.openBlock)(), (0, import_vue10.createBlock)(tmIcon, {
                            key: 4,
                            "font-size": 23,
                            color: "green",
                            name: "tmicon-check-circle-fill"
                          })) : (0, import_vue10.createCommentVNode)("v-if", true),
                          item.statusCode == 3 ? ((0, import_vue10.openBlock)(), (0, import_vue10.createBlock)(tmText, {
                            key: 5,
                            color: "green",
                            _class: "pl-5",
                            "font-size": 23,
            ...
            !(0, import_vue10.unref)(_disabledAdd) ? ((0, import_vue10.openBlock)(), (0, import_vue10.createElementBlock)("view", {
              key: 0,
              onClick: chooseFile,
              class: "ma-5",
              style: (0, import_vue10.normalizeStyle)({ width: (0, import_vue10.unref)(itemWidth) - 10 + "rpx" })
              ...
              (0, import_vue10.createVNode)(tmSheet, {
                ...
                default: (0, import_vue10.withCtx)(() => [
                  (0, import_vue10.renderSlot)(_ctx.$slots, "icon", {}, () => [
  ...
  var tmUpload = /* @__PURE__ */ _export_sfc(_sfc_main10, [["__file", "F:/CoinQT/CoinQT_app/tmui/components/tm-upload/tm-upload.vue"]]);
  ...
  var _sfc_main$13 = /* @__PURE__ */ (0, import_vue11.defineComponent)({
    ...
    setup(__props) {
      const props = __props;
      (0, import_vue11.getCurrentInstance)();
      const waterCanvasRef = (0, import_vue11.ref)();
      const boxInfo = (0, import_vue11.ref)({ width: props.width, height: props.height });
      const base64UrlRef = (0, import_vue11.ref)();
      const imageWaterStyle = (0, import_vue11.computed)(() => {
        return {
          zIndex: props.zIndex,
          width: "100%",
          height: "100%",
      ...
      (0, import_vue11.watch)(() => props, () => __async(this, null, function* () {
        yield init();
      }), { deep: true });
      function init() {
        return __async(this, null, function* () {
          ...
          if (ctx) {
            ...
            if (image2) {
              ...
              yield uni.getImageInfo({
                src: image2,
                success: function(img) {
                  ctx.globalAlpha = props.imageOpacity;
                  ctx.drawImage(image2, canvasOffsetLeft, canvasOffsetTop, (props.imageWidth || (imageHeight ? img.width * imageHeight / img.height : img.width)) * ratio, (props.imageHeight || (imageWidth ? img.height * imageWidth / img.width : img.height)) * ratio);
      ...
      return (_ctx, _cache) => {
        return (0, import_vue11.openBlock)(), (0, import_vue11.createElementBlock)("view", { renderWhole: true }, [
          (0, import_vue11.renderSlot)(_ctx.$slots, "default"),
          (0, import_vue11.createElementVNode)("view", {
            class: "overflow fixed",
            style: { "left": "-999px" }
          }, [
            (0, import_vue11.createElementVNode)("gcanvas", {
              id: "waterCanvas",
              ref_key: "waterCanvasRef",
              ref: waterCanvasRef,
              style: (0, import_vue11.normalizeStyle)({ width: `${boxInfo.value.width}${props.unit}`, height: `${boxInfo.value.height}${props.unit}` })
            }, null, 4)
          ]),
          (0, import_vue11.createElementVNode)("view", {
            class: (0, import_vue11.normalizeClass)(props.fullscreen ? "fixed" : "absolute"),
            style: (0, import_vue11.normalizeStyle)((0, import_vue11.unref)(imageWaterStyle))
          }, null, 6)
        ]);
      };
    }
  });
  var TmWatermark = /* @__PURE__ */ _export_sfc(_sfc_main$13, [["__file", "F:/CoinQT/CoinQT_app/tmui/components/tm-watermark/tm-watermark.vue"]]);
  var _sfc_main11 = /* @__PURE__ */ (0, import_vue11.defineComponent)({
    __name: "watermark",
    setup(__props) {
      const opts = (0, import_vue11.ref)({
        content: "TMUI",
        fontSize: 12,
        lineHeight: 12,
        fullscreen: false,
      ...
      return (_ctx, _cache) => {
        return (0, import_vue11.openBlock)(), (0, import_vue11.createElementBlock)("scroll-view", {
          scrollY: true,
          showScrollbar: true,
          ...
          (0, import_vue11.createVNode)(tmApp, null, {
            default: (0, import_vue11.withCtx)(() => [
              (0, import_vue11.createVNode)(tmSheet, { followDark: false }, {
                default: (0, import_vue11.withCtx)(() => [
              ...
              (0, import_vue11.createVNode)(TmWatermark, {
                selectable: "",
                ...
                default: (0, import_vue11.withCtx)(() => [
                  (0, import_vue11.createVNode)(tmSheet, null, {
                    default: (0, import_vue11.withCtx)(() => [
                      (0, import_vue11.createElementVNode)("view", { class: "flex flex-row flex-row-bottom-start" }, [
                        (0, import_vue11.createVNode)(tmText, { label: "\u5C5E\u6027\u8BBE\u7F6E" }),
                        (0, import_vue11.createVNode)(tmText, {
                          "font-size": 22,
                          _class: "ml-10",
                          label: "(\u5B9E\u65F6\u751F\u6548)"
                      ...
                      (0, import_vue11.createVNode)(tmDivider),
                      (0, import_vue11.createVNode)(tmRadioGroup, {
                        modelValue: opts.value.fullscreen,
                        "onUpdate:modelValue": _cache[0] || (_cache[0] = ($event) => opts.value.fullscreen = $event),
                        defaultValue: false
                      }, {
                        default: (0, import_vue11.withCtx)(() => [
                          (0, import_vue11.createVNode)(tmRadio, {
                            value: true,
                            label: "\u5168\u5C4F\u5E55"
                          }),
                          (0, import_vue11.createVNode)(tmRadio, {
                      ...
                      (0, import_vue11.createVNode)(tmDivider),
                      (0, import_vue11.createVNode)(tmInput, {
                        prefixLabel: "\u6587\u672C\u5185\u5BB9",
                        align: "right",
                        placeholder: "\u8BF7\u8F93\u5165\u6587\u672C",
                      ...
                      (0, import_vue11.createVNode)(tmUpload, {
                        width: 636,
  ...
  var watermark = /* @__PURE__ */ _export_sfc(_sfc_main11, [["__file", "F:/CoinQT/CoinQT_app/pages/other/watermark.nvue"]]);

  // <stdin>
  var webview = plus.webview.currentWebview();
  if (webview) {
    const __pageId = parseInt(webview.id);
    const __pagePath = "pages/other/watermark";
    let __pageQuery = {};
    try {
      __pageQuery = JSON.parse(webview.__query__);
    } catch (e) {
    }
    watermark.mpType = "page";
    const app = Vue.createPageApp(watermark, { $store: getApp({ allowDefault: true }).$store, __pageId, __pagePath, __pageQuery });
    app.provide("__globalStyles", Vue.useCssStyles([...__uniConfig.styles, ...watermark.styles || []]));
    app.mount("#root");
  }
})();
