...
(() => {
  ...
  // F:/CoinQT/CoinQT_app/unpackage/dist/dev/.nvue/pages/other/scrollx.js
  ...
  var tmGrid = /* @__PURE__ */ _export_sfc(_sfc_main5, [["__file", "F:/CoinQT/CoinQT_app/tmui/components/tm-grid/tm-grid.vue"]]);
  ...
  var tmTranslate = /* @__PURE__ */ _export_sfc(_sfc_main6, [["styles", [_style_02]], ["__file", "F:/CoinQT/CoinQT_app/tmui/components/tm-translate/tm-translate.vue"]]);
  ...
  var _style_03 = { "bar": { "": { "transitionProperty": "transform", "transitionDelay": 0, "transitionDuration": 50, "transitionTimingFunction": "linear", "transform": "translateX(0px)" } }, "@TRANSITION": { "bar": { "property": "transform", "delay": 0, "duration": 50, "timingFunction": "linear" } } };
  var _sfc_main$13 = /* @__PURE__ */ (0, import_vue9.defineComponent)({
    ...
    setup(__props) {
      const props = __props;
      const left = (0, import_vue9.ref)(0);
      const totalWidth = uni.upx2px(50);
      const totalContWidth = uni.upx2px(props.width);
      const _showBar = (0, import_vue9.computed)(() => props.showBar);
      const alignKey = {
        "center": "flex-center",
      ...
      return (_ctx, _cache) => {
        return (0, import_vue9.openBlock)(), (0, import_vue9.createElementBlock)("view", {
          class: "relative flex",
          style: (0, import_vue9.normalizeStyle)({ width: props.width + "rpx", height: props.height + 32 + "rpx" }),
          renderWhole: true
        }, [
          ...
          (0, import_vue9.unref)(_showBar) ? ((0, import_vue9.openBlock)(), (0, import_vue9.createElementBlock)("view", {
            key: 0,
            class: (0, import_vue9.normalizeClass)(["absolute l-0 b-10 flex", alignKey[props.align]]),
            style: (0, import_vue9.normalizeStyle)({ width: props.width + "rpx", height: 32 + "rpx" })
          }, [
            (0, import_vue9.createElementVNode)("view", {
              class: "flex-1 pr-40",
              style: { "width": "0px" }
            }, [
              (0, import_vue9.renderSlot)(_ctx.$slots, "barll")
            ]),
            (0, import_vue9.createElementVNode)("view", {
              class: "px-32",
              style: { "width": "164rpx" }
          ...
          ], 6)) : (0, import_vue9.createCommentVNode)("v-if", true)
        ], 4);
      };
    }
  });
  var tmScrollx = /* @__PURE__ */ _export_sfc(_sfc_main$13, [["styles", [_style_03]], ["__file", "F:/CoinQT/CoinQT_app/tmui/components/tm-scrollx/tm-scrollx.vue"]]);
  var _sfc_main9 = /* @__PURE__ */ (0, import_vue9.defineComponent)({
    __name: "scrollx",
    setup(__props) {
      const list = (0, import_vue9.ref)([
            ...
            default: (0, import_vue9.withCtx)(() => [
              (0, import_vue9.createVNode)(tmSheet, null, {
                default: (0, import_vue9.withCtx)(() => [
                  ...
                  (0, import_vue9.createVNode)(tmText, { label: "\u62B9\u5E73\u4E86\u5E73\u53F0\u5DEE\u5F02,\u9002\u7528\u4E8E\u5E0C\u671B\u5185\u5BB9\u6A2A\u5411\u6EDA\u52A8\u7684\u573A\u666F." }),
                  (0, import_vue9.createVNode)(tmText, { label: "\u4F7F\u7528\u65F6\u4E00\u5B9A\u8981\u6CE8\u610Fscrollx\u7684\u5BBD\u5EA6\u548C\u5185\u90E8\u7684\u5BBD\u5EA6\u4E00\u5B9A\u8981\u8BBE\u7F6E,\u5426\u5219\u4F1A\u5931\u6548,\u540C\u65F6\u4E5F\u8981\u6CE8\u610F\u9AD8\u5EA6\u7684\u8BBE\u7F6E,\u7559\u51FA\u5E95\u90E8\u5BFC\u822A\u6761\u7684\u95F4\u8DDD." })
                ]),
                _: 1
              }),
              (0, import_vue9.createVNode)(tmSheet, {
                ...
                default: (0, import_vue9.withCtx)(() => [
                  (0, import_vue9.createVNode)(tmScrollx, {
                    width: 686,
                    height: 300
                  }, {
                    default: (0, import_vue9.withCtx)(() => [
                      (0, import_vue9.createVNode)(tmGrid, {
                        col: 7,
                        width: 1340
                      }, {
                        default: (0, import_vue9.withCtx)(() => [
                          ((0, import_vue9.openBlock)(true), (0, import_vue9.createElementBlock)(import_vue9.Fragment, null, (0, import_vue9.renderList)(list.value, (item, index) => {
                            return (0, import_vue9.openBlock)(), (0, import_vue9.createBlock)(tmGridItem, {
                              key: index,
                              height: 140,
                              count: item.count
                            }, {
  ...
  var scrollx = /* @__PURE__ */ _export_sfc(_sfc_main9, [["__file", "F:/CoinQT/CoinQT_app/pages/other/scrollx.nvue"]]);

  // <stdin>
  var webview = plus.webview.currentWebview();
  if (webview) {
    const __pageId = parseInt(webview.id);
    const __pagePath = "pages/other/scrollx";
    let __pageQuery = {};
    try {
    ...
    scrollx.mpType = "page";
    const app = Vue.createPageApp(scrollx, { $store: getApp({ allowDefault: true }).$store, __pageId, __pagePath, __pageQuery });
    app.provide("__globalStyles", Vue.useCssStyles([...__uniConfig.styles, ...scrollx.styles || []]));
    app.mount("#root");
  }
})();
