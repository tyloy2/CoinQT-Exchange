...
(() => {
  ...
  // F:/CoinQT/CoinQT_app/unpackage/dist/dev/.nvue/pages/other/floatButton.js
  ...
  var _sfc_main5 = /* @__PURE__ */ (0, import_vue5.defineComponent)({
    ...
    setup(__props, { emit: emits }) {
      ...
      const windowWidth = (0, import_vue5.computed)(() => sysinfo.value.width);
      (0, import_vue5.computed)(() => sysinfo.value.top);
      const isH5 = (0, import_vue5.ref)(false);
      const showActions = (0, import_vue5.ref)((_a2 = props.showActions) != null ? _a2 : false);
      const BtnPos = (0, import_vue5.computed)(() => props.position);
      const AcionPos = (0, import_vue5.computed)(() => props.actionsPos);
      const _offset = (0, import_vue5.computed)(() => {
        var _a22;
        let ost = (_a22 = props.offset) != null ? _a22 : [0, 0];
        ost = [uni.upx2px(props.offset[0]), uni.upx2px(props.offset[1])];
        return ost;
      });
      const centerPosLeft = (0, import_vue5.computed)(() => {
        let ps = (windowWidth.value - uni.upx2px(props.width * 1.5)) / 2 + uni.upx2px(_offset.value[0]);
        return ps;
      });
      const _btn = (0, import_vue5.computed)(() => {
        var _a22;
        return __spreadValues5({ icon: "tmicon-plus", fontSize: 20, color: "primary", linear: "", linearDeep: "accent", label: "", iconSize: 42, fontColor: "" }, (_a22 = props.btn) != null ? _a22 : {});
      });
      const _actionsItem = (0, import_vue5.computed)(() => {
        let asbtn = props.actions.map((el) => {
          ...
          return __spreadValues5(__spreadValues5({}, default_btn), el);
        });
        return asbtn;
      });
      const AcionPos_xy = (0, import_vue5.computed)(() => {
      ...
      const parent_style = (0, import_vue5.computed)(() => {
      ...
      return (_ctx, _cache) => {
        return (0, import_vue5.openBlock)(), (0, import_vue5.createElementBlock)("view", {
          ...
          style: (0, import_vue5.normalizeStyle)([
            (0, import_vue5.unref)(BtnPos) == "tl" ? { transform: `translateX(${(0, import_vue5.unref)(_offset)[0]}rpx) translateY(${(0, import_vue5.unref)(_offset)[1]}rpx)` } : "",
            (0, import_vue5.unref)(BtnPos) == "tr" ? { transform: `translateX(-${(0, import_vue5.unref)(_offset)[0]}rpx) translateY(${(0, import_vue5.unref)(_offset)[1]}rpx)`, right: "0px" } : "",
            (0, import_vue5.unref)(BtnPos) == "tc" ? { transform: `translateX(${(0, import_vue5.unref)(centerPosLeft)}px) translateY(${(0, import_vue5.unref)(_offset)[1]}rpx)` } : "",
            (0, import_vue5.unref)(BtnPos) == "bl" ? { transform: `translateX(${(0, import_vue5.unref)(_offset)[0]}rpx) translateY(-${(0, import_vue5.unref)(_offset)[1]}rpx)`, bottom: "0px" } : "",
            (0, import_vue5.unref)(BtnPos) == "br" ? { transform: `translateX(-${(0, import_vue5.unref)(_offset)[0]}rpx) translateY(-${(0, import_vue5.unref)(_offset)[1]}rpx)`, right: "0px", bottom: "0px" } : "",
            (0, import_vue5.unref)(BtnPos) == "bc" ? { transform: `translateX(${(0, import_vue5.unref)(centerPosLeft)}px) translateY(-${(0, import_vue5.unref)(_offset)[1]}rpx)`, bottom: "0px" } : "",
            !isH5.value && ((0, import_vue5.unref)(BtnPos) == "tl" || (0, import_vue5.unref)(BtnPos) == "tc" || (0, import_vue5.unref)(BtnPos) == "tr") ? { top: "0px" } : "",
            (0, import_vue5.unref)(parent_style)
          ]),
          renderWhole: true
        }, [
          (0, import_vue5.createCommentVNode)(" \u4E3B\u6309\u94AE "),
          (0, import_vue5.createElementVNode)("view", {
            style: (0, import_vue5.normalizeStyle)([{ width: props.width + "rpx", height: props.height + "rpx" }]),
            class: "flex-center"
          }, [
            (0, import_vue5.createVNode)(tmSheet, {
              ...
              padding: [0, 0],
              margin: [0, 0],
              color: (0, import_vue5.unref)(_btn).color
            }, {
              default: (0, import_vue5.withCtx)(() => [
                (0, import_vue5.renderSlot)(_ctx.$slots, "default", {}, () => [
                  (0, import_vue5.createVNode)(TmButton, {
                    ...
                    shadow: 3,
                    linear: (0, import_vue5.unref)(_btn).linear,
                    "linear-deep": (0, import_vue5.unref)(_btn).linearDeep,
                    color: (0, import_vue5.unref)(_btn).color,
                    margin: [0, 0],
                    round: 16,
                    padding: [0, 0],
                    ...
                    default: (0, import_vue5.withCtx)(() => [
                      (0, import_vue5.createVNode)(tmIcon, {
                        userInteractionEnabled: false,
                        "follow-dark": false,
                        color: (0, import_vue5.unref)(_btn).fontColor,
                        name: (0, import_vue5.unref)(_btn).icon,
                        "font-size": (0, import_vue5.unref)(_btn).iconSize
                      }, null, 8, ["color", "name", "font-size"]),
                      (0, import_vue5.unref)(_btn).label ? ((0, import_vue5.openBlock)(), (0, import_vue5.createBlock)(tmText, {
                        key: 0,
                        userInteractionEnabled: false,
                        "follow-dark": false,
                        color: (0, import_vue5.unref)(_btn).fontColor,
                        label: (0, import_vue5.unref)(_btn).label,
                        "font-size": (0, import_vue5.unref)(_btn).fontSize
                      }, null, 8, ["color", "label", "font-size"])) : (0, import_vue5.createCommentVNode)("v-if", true)
                    ]),
                    _: 1
          ...
          (0, import_vue5.createCommentVNode)(" \u5B50\u83DC\u5355 "),
          (0, import_vue5.unref)(_actionsItem).length > 0 && showActions.value ? ((0, import_vue5.openBlock)(), (0, import_vue5.createElementBlock)("view", {
            key: 0,
            userInteractionEnabled: showActions.value,
            class: "absolute flex",
            style: (0, import_vue5.normalizeStyle)([(0, import_vue5.unref)(AcionPos_xy)])
          }, [
            (0, import_vue5.createElementVNode)("view", {
              style: (0, import_vue5.normalizeStyle)([{ width: props.width + "rpx", height: props.height + "rpx" }]),
              class: "flex-center"
            }, [
              ((0, import_vue5.openBlock)(true), (0, import_vue5.createElementBlock)(import_vue5.Fragment, null, (0, import_vue5.renderList)((0, import_vue5.unref)(_actionsItem), (item, index) => {
                return (0, import_vue5.openBlock)(), (0, import_vue5.createBlock)(tmSheet, {
                  ...
                  default: (0, import_vue5.withCtx)(() => [
                    ...
                    item.label ? ((0, import_vue5.openBlock)(), (0, import_vue5.createBlock)(tmText, {
                      key: 0,
                      userInteractionEnabled: false,
                      color: item.fontColor,
                      label: item.label,
          ...
          ], 12, ["userInteractionEnabled"])) : (0, import_vue5.createCommentVNode)("v-if", true)
        ], 4);
      };
    }
  });
  var tmFloatButton = /* @__PURE__ */ _export_sfc(_sfc_main5, [["__file", "F:/CoinQT/CoinQT_app/tmui/components/tm-float-button/tm-float-button.vue"]]);
        ...
        return (0, import_vue6.openBlock)(), (0, import_vue6.createElementBlock)("scroll-view", {
          ...
          (0, import_vue6.createVNode)(tmApp, null, {
            default: (0, import_vue6.withCtx)(() => [
              ...
              (0, import_vue6.createVNode)(tmFloatButton, {
                position: "tr",
  ...
  var floatButton = /* @__PURE__ */ _export_sfc(_sfc_main6, [["__file", "F:/CoinQT/CoinQT_app/pages/other/floatButton.nvue"]]);

  // <stdin>
  var webview = plus.webview.currentWebview();
  if (webview) {
    const __pageId = parseInt(webview.id);
    const __pagePath = "pages/other/floatButton";
    let __pageQuery = {};
    try {
      __pageQuery = JSON.parse(webview.__query__);
    } catch (e) {
    }
    floatButton.mpType = "page";
    const app = Vue.createPageApp(floatButton, { $store: getApp({ allowDefault: true }).$store, __pageId, __pagePath, __pageQuery });
    app.provide("__globalStyles", Vue.useCssStyles([...__uniConfig.styles, ...floatButton.styles || []]));
    app.mount("#root");
  }
})();
