...
(() => {
  ...
  // F:/CoinQT/CoinQT_app/unpackage/dist/dev/.nvue/pages/other/sticky.js
  ...
  var _style_02 = { "tm-sticky": { "": { "position": "sticky" } } };
  ...
  var tmSticky = /* @__PURE__ */ _export_sfc(_sfc_main$12, [["styles", [_style_02]], ["__file", "F:/CoinQT/CoinQT_app/tmui/components/tm-sticky/tm-sticky.vue"]]);
  var _sfc_main3 = /* @__PURE__ */ (0, import_vue3.defineComponent)({
    __name: "sticky",
    setup(__props) {
      const offset = (0, import_vue3.ref)(0);
      return (_ctx, _cache) => {
        return (0, import_vue3.openBlock)(), (0, import_vue3.createElementBlock)("scroll-view", {
          ...
          (0, import_vue3.createVNode)(tmApp, null, {
            default: (0, import_vue3.withCtx)(() => [
              (0, import_vue3.createVNode)(tmSticky, { offset: offset.value }, {
                sticky: (0, import_vue3.withCtx)(() => [
                ...
                default: (0, import_vue3.withCtx)(() => [
                  (0, import_vue3.createVNode)(tmSheet, { height: 2e3 })
                ]),
                _: 1
              }, 8, ["offset"])
            ]),
  ...
  var sticky = /* @__PURE__ */ _export_sfc(_sfc_main3, [["__file", "F:/CoinQT/CoinQT_app/pages/other/sticky.nvue"]]);

  // <stdin>
  var webview = plus.webview.currentWebview();
  if (webview) {
    const __pageId = parseInt(webview.id);
    const __pagePath = "pages/other/sticky";
    let __pageQuery = {};
    try {
