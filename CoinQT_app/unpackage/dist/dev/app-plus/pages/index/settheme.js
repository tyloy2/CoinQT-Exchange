...
(() => {
  ...
  // F:/CoinQT/CoinQT_app/unpackage/dist/dev/.nvue/pages/index/settheme.js
  ...
  var _style_02 = { "statusHeightTop": { "": { "zIndex": 400 } } };
  var _sfc_main4 = /* @__PURE__ */ (0, import_vue4.defineComponent)({
    ...
    setup(__props, { emit: emits }) {
      ...
      const _homeColor = (0, import_vue4.computed)(() => props.homeColor);
              ...
              default: (0, import_vue4.withCtx)(() => [
                ...
                (0, import_vue4.createElementVNode)("view", { class: "flex flex-row flex-1 flex-row flex-row-center-between" }, [
                  (0, import_vue4.createElementVNode)("view", {
                    ...
                    _pages.value > 1 && props.hideBack ? ((0, import_vue4.openBlock)(), (0, import_vue4.createBlock)(tmIcon, {
                      key: 0,
                      unit: props.unit,
                      "font-size": props.iconFontSize,
                      _class: "pointer pb-12 pt-12 px-24",
                      color: (0, import_vue4.unref)(_homeColor),
                      onClick: goback,
                      name: "tmicon-angle-left"
                    }, null, 8, ["unit", "font-size", "color"])) : (0, import_vue4.createCommentVNode)("v-if", true),
                    _pages.value == 1 && !__props.hideHome ? ((0, import_vue4.openBlock)(), (0, import_vue4.createBlock)(tmIcon, {
                      key: 1,
                      unit: props.unit,
                      _class: "pointer  pb-12 pt-12 px-24",
                      onClick: backhome,
                      ...
                      "font-size": props.iconFontSize,
                      name: "tmicon-md-home"
                    }, null, 8, ["unit", "color", "font-size"])) : (0, import_vue4.createCommentVNode)("v-if", true),
  ...
  var tmNavbar = /* @__PURE__ */ _export_sfc(_sfc_main4, [["styles", [_style_02]], ["__file", "F:/CoinQT/CoinQT_app/tmui/components/tm-navbar/tm-navbar.vue"]]);
  ...
  var _sfc_main5 = /* @__PURE__ */ (0, import_vue5.defineComponent)({
    __name: "settheme",
    setup(__props) {
      const app = (0, import_vue5.ref)(null);
      const store = useTmpiniaStore();
      (0, import_vue5.getCurrentInstance)();
      const list = (0, import_vue5.ref)([]);
      (0, import_vue5.onMounted)(() => showlist());
      function showlist() {
      ...
      return (_ctx, _cache) => {
        return (0, import_vue5.openBlock)(), (0, import_vue5.createElementBlock)("scroll-view", {
          ...
          (0, import_vue5.createVNode)(tmApp, {
            ref_key: "app",
            ref: app
          }, {
            default: (0, import_vue5.withCtx)(() => [
              (0, import_vue5.createVNode)(tmNavbar, {
                color: "blue",
                linear: "left",
                title: "\u8BBE\u7F6E\u66F4\u591A\u4E3B\u9898"
              }),
              (0, import_vue5.createElementVNode)("view", { class: "mx-32 flex flex-row flex-wrap" }, [
  ...
  var settheme = /* @__PURE__ */ _export_sfc(_sfc_main5, [["__file", "F:/CoinQT/CoinQT_app/pages/index/settheme.nvue"]]);

  // <stdin>
  var webview = plus.webview.currentWebview();
  if (webview) {
    const __pageId = parseInt(webview.id);
    const __pagePath = "pages/index/settheme";
    let __pageQuery = {};
    try {
      __pageQuery = JSON.parse(webview.__query__);
    } catch (e) {
    }
    settheme.mpType = "page";
    const app = Vue.createPageApp(settheme, { $store: getApp({ allowDefault: true }).$store, __pageId, __pagePath, __pageQuery });
    app.provide("__globalStyles", Vue.useCssStyles([...__uniConfig.styles, ...settheme.styles || []]));
    app.mount("#root");
  }
})();
