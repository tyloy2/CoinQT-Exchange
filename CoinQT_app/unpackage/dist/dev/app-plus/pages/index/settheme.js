...
(() => {
  ...
  var _sfc_main3 = /* @__PURE__ */ (0, import_vue3.defineComponent)({
    ...
    setup(__props, { emit: emits }) {
      ...
      (0, import_vue3.computed)(() => props.homeColor);
          ...
          (0, import_vue3.createElementVNode)("view", {
            ...
            (0, import_vue3.createVNode)(tmSheet, {
              ...
              default: (0, import_vue3.withCtx)(() => [
                ...
                (0, import_vue3.createElementVNode)("view", { class: "flex flex-row flex-1 flex-row flex-row-center-between" }, [
                  (0, import_vue3.createElementVNode)("view", {
                    class: "flex-row flex flex-row-center-start",
                    style: (0, import_vue3.normalizeStyle)({ width: (0, import_vue3.unref)(_leftWidth) + "rpx" })
                  }, [
                    (0, import_vue3.createCommentVNode)(' 						<tm-icon :unit="props.unit" :font-size="props.iconFontSize" _class="pointer pb-12 pt-12 px-24" :color="_homeColor" @click="goback" v-if="_pages>1&&props.hideBack" name="tmicon-angle-left"></tm-icon>\r\n						<tm-icon :unit="props.unit" _class="pointer  pb-12 pt-12 px-24" @click="backhome" v-if="_pages==1&&!hideHome" :color="_homeColor" :font-size="props.iconFontSize" name="tmicon-md-home"></tm-icon>\r\n '),
  ...
  var tmNavbar = /* @__PURE__ */ _export_sfc(_sfc_main3, [["styles", [_style_02]], ["__file", "F:/CoinQT/CoinQT_app/tmui/components/tm-navbar/tm-navbar.vue"]]);
  ...
  var _sfc_main4 = /* @__PURE__ */ (0, import_vue4.defineComponent)({
    __name: "settheme",
    setup(__props) {
      const app = (0, import_vue4.ref)(null);
      const store = useTmpiniaStore();
      (0, import_vue4.getCurrentInstance)();
      const list = (0, import_vue4.ref)([]);
      (0, import_vue4.onMounted)(() => showlist());
      function showlist() {
      ...
      return (_ctx, _cache) => {
        return (0, import_vue4.openBlock)(), (0, import_vue4.createElementBlock)("scroll-view", {
          ...
          (0, import_vue4.createVNode)(tmApp, {
            ref_key: "app",
            ref: app
          }, {
            default: (0, import_vue4.withCtx)(() => [
              (0, import_vue4.createVNode)(tmNavbar, {
                color: "blue",
                linear: "left",
                title: "\u8BBE\u7F6E\u66F4\u591A\u4E3B\u9898"
              }),
              (0, import_vue4.createElementVNode)("view", { class: "mx-32 flex flex-row flex-wrap" }, [
                ((0, import_vue4.openBlock)(true), (0, import_vue4.createElementBlock)(import_vue4.Fragment, null, (0, import_vue4.renderList)(list.value, (item, index) => {
  ...
  var settheme = /* @__PURE__ */ _export_sfc(_sfc_main4, [["__file", "F:/CoinQT/CoinQT_app/pages/index/settheme.nvue"]]);
