...
${codeFrame}` : message);
  ...
  var _sfc_main9 = /* @__PURE__ */ (0, import_vue9.defineComponent)({
    ...
    setup(__props) {
      ...
      const isDark = (0, import_vue9.computed)(() => computedDark(__spreadProps8(__spreadValues8({}, props), { borderDirection: borderDir.value }), tmcfg.value));
      const tmcomputed = (0, import_vue9.computed)(() => computedTheme(__spreadProps8(__spreadValues8({}, props), { borderDirection: borderDir.value }), isDark.value, tmcfg.value));
      return (_ctx, _cache) => {
  ...
  var tmCell = /* @__PURE__ */ _export_sfc(_sfc_main11, [["styles", [_style_05]], ["__file", "F:/CoinQT/CoinQT_app/tmui/components/tm-cell/tm-cell.vue"]]);

  // F:/CoinQT/CoinQT_app/unpackage/dist/dev/.nvue/tm-result.js
  ...
  var _sfc_main12 = /* @__PURE__ */ (0, import_vue12.defineComponent)({
    ...
    setup(__props, { emit: emits }) {
      ...
      const icon_rp = (0, import_vue12.computed)(() => {
        if (props.icon)
          return props.icon;
        if (!props.status)
          return "";
      ...
      const icon_title = (0, import_vue12.computed)(() => {
        if (props.title)
          return props.title;
        if (!props.status)
          return "";
      ...
      const icon_subtitle = (0, import_vue12.computed)(() => {
        if (props.subTitle)
      ...
      const icon_color = (0, import_vue12.computed)(() => {
        if (props.color)
          return props.color;
        if (!props.status)
          return "";
      ...
      return (_ctx, _cache) => {
        return (0, import_vue12.openBlock)(), (0, import_vue12.createElementBlock)("view", {
          ...
          (0, import_vue12.createVNode)(tmTranslate, {
            ...
            default: (0, import_vue12.withCtx)(() => [
              (0, import_vue12.createVNode)(tmSheet, {
                ...
                height: 140,
                round: 25,
                color: (0, import_vue12.unref)(icon_color),
                text: ""
              }, {
                default: (0, import_vue12.withCtx)(() => [
                  (0, import_vue12.createVNode)(tmIcon, {
                    ...
                    followDark: props.followDark,
                    fontSize: 80,
                    name: (0, import_vue12.unref)(icon_rp)
          ...
          (0, import_vue12.createElementVNode)("view", {
            ...
            (0, import_vue12.createVNode)(tmText, {
              ...
              fontSize: 34,
              label: (0, import_vue12.unref)(icon_title)
          ...
          (0, import_vue12.createElementVNode)("view", {
            ...
            (0, import_vue12.createVNode)(tmText, {
              ...
              _class: "opacity-6 ",
              fontSize: 24,
              label: (0, import_vue12.unref)(icon_subtitle)
            }, null, 8, ["dark", "followDark", "label"])
          ]),
          props.showBtn ? ((0, import_vue12.openBlock)(), (0, import_vue12.createElementBlock)("view", {
            key: 0,
            eventPenetrationEnabled: true,
  ...
  var tmResult = /* @__PURE__ */ _export_sfc(_sfc_main12, [["__file", "F:/CoinQT/CoinQT_app/tmui/components/tm-result/tm-result.vue"]]);
  ...
  var _sfc_main13 = /* @__PURE__ */ (0, import_vue13.defineComponent)({
    __name: "search",
    setup(__props) {
      const { proxy } = (0, import_vue13.getCurrentInstance)();
      const totalList = [
        ...
        { path: "/pages/fankui/notification", title: "\u901A\u77E5\u63D0\u9192 Notificat, nextTickion", nextTick: import_vue13.nextTick },
          ...
          (0, import_vue13.createVNode)(tmApp, null, {
            default: (0, import_vue13.withCtx)(() => [
              (0, import_vue13.createVNode)(tmSheet, {
                ...
                default: (0, import_vue13.withCtx)(() => [
                  (0, import_vue13.createElementVNode)("view", { class: "flex-row flex-row-center-start pb-10" }, [
                    (0, import_vue13.createVNode)(tmImage, {
                      width: 108,
                      height: 67.5,
                      src: (0, import_vue13.unref)(logoimg)
                    }, null, 8, ["height", "src"]),
                    (0, import_vue13.createElementVNode)("view", { class: "pl-16" }, [
                  ...
                  (0, import_vue13.createVNode)(tmInput, {
              ...
              result.value.length === 0 ? ((0, import_vue13.openBlock)(), (0, import_vue13.createBlock)(tmResult, {
                key: 0,
                showBtn: false,
                subTitle: "\u8BF7\u91CD\u65B0\u8F93\u5165\u5173\u952E\u8BCD"
              })) : (0, import_vue13.createCommentVNode)("v-if", true),
              result.value.length > 0 ? ((0, import_vue13.openBlock)(), (0, import_vue13.createElementBlock)("view", {
                key: 1,
                class: "ma-32 round-3 overflow"
              }, [
                ((0, import_vue13.openBlock)(true), (0, import_vue13.createElementBlock)(import_vue13.Fragment, null, (0, import_vue13.renderList)(result.value, (item, index) => {
                  return (0, import_vue13.openBlock)(), (0, import_vue13.createBlock)(tmCell, {
                    key: index,
                    url: item.path,
                    margin: [0, 0],
                    titleFontSize: 30,
              ...
              (0, import_vue13.createElementVNode)("view", { class: "py-32 mx-32" }, [
                (0, import_vue13.createVNode)(tmDivider, {
                  color: "grey-2",
                  label: "tmui 3.0.0 \u539F\u751F\u6E32\u67D3\uFF0C\u5168\u7AEF\u517C\u5BB9"
                })
              ]),
              (0, import_vue13.createVNode)(tmMessage, { ref: "msg" }, null, 512)
            ]),
            _: 1
          })
        ]);
  ...
  var search = /* @__PURE__ */ _export_sfc(_sfc_main13, [["__file", "F:/CoinQT/CoinQT_app/pages/index/search.nvue"]]);
