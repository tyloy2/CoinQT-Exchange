...
(() => {
  ...
  // F:/CoinQT/CoinQT_app/unpackage/dist/dev/.nvue/pages/form/slider.js
  ...
  var _sfc_main$4 = /* @__PURE__ */ (0, import_vue4.defineComponent)({
    __name: "slider-bar",
    props: {
      followTheme: {
        type: [Boolean, String],
    ...
    setup(__props) {
      const props = __props;
      const _sizePx = (0, import_vue4.computed)(() => uni.upx2px(props.size));
      return (_ctx, _cache) => {
        return (0, import_vue4.openBlock)(), (0, import_vue4.createElementBlock)("view", {
          ...
          (0, import_vue4.createVNode)(tmSheet, {
            ...
            color: props.color,
            linear: "right",
            width: props.direction == "horizontal" ? props.width : (0, import_vue4.unref)(_sizePx),
            height: props.direction == "horizontal" ? (0, import_vue4.unref)(_sizePx) : props.width,
            margin: [0, 0],
            padding: [0, 0]
  ...
  var _sfc_main$3 = /* @__PURE__ */ (0, import_vue4.defineComponent)({
    ...
    setup(__props, { emit: emits }) {
      const props = __props;
      const _x = (0, import_vue4.computed)(() => props.x);
      let timerId = NaN;
      ...
      return (_ctx, _cache) => {
        return (0, import_vue4.openBlock)(), (0, import_vue4.createElementBlock)("view", {
          onTouchstart: (0, import_vue4.withModifiers)(movestart, ["stop"]),
          onMousedown: (0, import_vue4.withModifiers)(movestart, ["stop"]),
          onTouchmove: (0, import_vue4.withModifiers)(moveing, ["stop"]),
          onMousemove: (0, import_vue4.withModifiers)(moveing, ["stop"]),
          onTouchend: (0, import_vue4.withModifiers)(moveend, ["stop"]),
          onMouseup: (0, import_vue4.withModifiers)(moveend, ["stop"]),
          onMouseleave: (0, import_vue4.withModifiers)(moveend, ["stop"]),
          class: "absolute",
          style: (0, import_vue4.normalizeStyle)([
            props.direction == "horizontal" ? { width: props.size + "rpx", height: props.size + "rpx", transform: `translateX(${(0, import_vue4.unref)(_x)}px)`, top: "0px" } : "",
            props.direction == "vertical" ? { width: props.size + "rpx", height: props.size + "rpx", transform: `translateY(${(0, import_vue4.unref)(_x)}px)`, left: 0 + "rpx", top: "0px" } : ""
          ]),
          renderWhole: true
        }, [
          (0, import_vue4.createVNode)(tmSheet, {
  ...
  var _sfc_main$2 = /* @__PURE__ */ (0, import_vue4.defineComponent)({
    __name: "slider-label",
    props: {
      direction: {
        type: String,
    ...
    setup(__props) {
      const props = __props;
      const _stepArray = (0, import_vue4.computed)(() => {
        let label = [];
        if (props.step == 0)
          return [];
      ...
      return (_ctx, _cache) => {
        return (0, import_vue4.openBlock)(), (0, import_vue4.createElementBlock)(import_vue4.Fragment, null, [
          (0, import_vue4.createCommentVNode)(" \u5E95\u90E8\u663E\u793A\u7684\u6807\u7B7E "),
          (0, import_vue4.createElementVNode)("view", {
            class: (0, import_vue4.normalizeClass)(["flex flex-between", [props.direction == "vertical" ? "flex-col" : "flex-row"]]),
            style: (0, import_vue4.normalizeStyle)([
              props.direction == "horizontal" ? { width: __props.width + "rpx" } : { height: __props.height + "rpx" }
            ])
          }, [
            props.direction == "horizontal" ? ((0, import_vue4.openBlock)(true), (0, import_vue4.createElementBlock)(import_vue4.Fragment, { key: 0 }, (0, import_vue4.renderList)((0, import_vue4.unref)(_stepArray), (item, index) => {
              return (0, import_vue4.openBlock)(), (0, import_vue4.createElementBlock)("view", {
                class: (0, import_vue4.normalizeClass)(["flex flex-row", [index == 0 ? "flex-row-top-start" : "", index == (0, import_vue4.unref)(_stepArray).length - 1 ? "flex-row-top-end" : "", index < (0, import_vue4.unref)(_stepArray).length - 1 && index > 0 ? "flex-row-top-center" : ""]]),
                style: { "width": "80rpx" },
                key: index
              }, [
            ...
            }), 128)) : (0, import_vue4.createCommentVNode)("v-if", true),
            props.direction != "horizontal" ? ((0, import_vue4.openBlock)(true), (0, import_vue4.createElementBlock)(import_vue4.Fragment, { key: 1 }, (0, import_vue4.renderList)((0, import_vue4.unref)(_stepArray), (item, index) => {
              return (0, import_vue4.openBlock)(), (0, import_vue4.createElementBlock)("view", {
    ...
    setup(__props) {
      ...
      return (_ctx, _cache) => {
        return (0, import_vue4.openBlock)(), (0, import_vue4.createElementBlock)(import_vue4.Fragment, null, [
          (0, import_vue4.createCommentVNode)(" \u5E95\u90E8\u663E\u793A\u7684\u6807\u7B7E "),
          (0, import_vue4.createElementVNode)("view", {
            class: (0, import_vue4.normalizeClass)(["flex flex-between absolute", [props.direction == "vertical" ? "flex-col " : "flex-row"]]),
            style: (0, import_vue4.normalizeStyle)([
  ...
  var sliderMask = /* @__PURE__ */ _export_sfc(_sfc_main$12, [["__file", "F:/CoinQT/CoinQT_app/tmui/components/tm-slider/slider-mask.vue"]]);
  var _sfc_main4 = /* @__PURE__ */ (0, import_vue4.defineComponent)({
    ...
    setup(__props, { emit: emits }) {
      ...
      const btn0 = (0, import_vue4.ref)(null);
      const btn1 = (0, import_vue4.ref)(null);
      const proxy = (_b2 = (_a2 = (0, import_vue4.getCurrentInstance)()) == null ? void 0 : _a2.proxy) != null ? _b2 : null;
      const width = (0, import_vue4.computed)(() => uni.upx2px(props.width));
      const isDarg = (0, import_vue4.ref)(false);
      const _disabled = (0, import_vue4.computed)(() => props.disabled);
      const btnPos = (0, import_vue4.ref)([
        {
          x: 0,
          y: 0
        },
      ...
      const isNvue = (0, import_vue4.ref)(false);
      const nvueDetailPos = (0, import_vue4.ref)({ left: 0, bottom: 0 });
      isNvue.value = true;
      const _sliderBarCssWidth = (0, import_vue4.computed)(() => {
        if (props.direction == "horizontal")
          return props.width + props.buttonSize;
        return props.buttonSize;
      });
      const _sliderBarCssHeight = (0, import_vue4.computed)(() => {
        if (props.direction == "horizontal")
          return props.buttonSize;
        return props.width + props.buttonSize;
      });
      const BtnIndex = (0, import_vue4.ref)(0);
      const showDetail = (0, import_vue4.ref)(false);
      const _valueMax = (0, import_vue4.computed)(() => {
        return props.max - props.min;
      });
      const _barWidth = (0, import_vue4.computed)(() => {
        return Math.abs(btnPos.value[0].x - btnPos.value[1].x);
      });
      const _barLet = (0, import_vue4.computed)(() => {
        return Math.min(Math.abs(btnPos.value[0].x), Math.abs(btnPos.value[1].x));
      });
      const _value = (0, import_vue4.ref)(0);
      const isDablue = (0, import_vue4.ref)(false);
      ...
      const rulesObj = (0, import_vue4.inject)("tmFormItemRules", (0, import_vue4.computed)(() => {
        return [
          {
            message: "\u8BF7\u9009\u62E9",
            required: false,
      ...
      const validate = (rules) => {
        rules = rules.map((el) => {
          if (typeof el.validator === "function" && el.required === true) {
            ...
            return __spreadProps4(__spreadValues4({}, el), {
              validator: (val) => {
      ...
      function pushFormItem(isCheckVail = true) {
        return __async(this, null, function* () {
          if (parentFormItem) {
            if (isCheckVail) {
              let _valueSlider = getValue();
              validate((0, import_vue4.toRaw)(rulesObj.value)).then((ev) => {
      ...
      pushFormItem();
      const tmFormFun = (0, import_vue4.inject)("tmFormFun", (0, import_vue4.computed)(() => ""));
      (0, import_vue4.watch)(tmFormFun, () => {
      ...
      return (_ctx, _cache) => {
        return (0, import_vue4.openBlock)(), (0, import_vue4.createElementBlock)("view", {
          class: (0, import_vue4.normalizeClass)(["flex", [props.direction == "vertical" ? "flex-row" : "", (0, import_vue4.unref)(_disabled) ? "opacity-6" : ""]]),
          renderWhole: true
        }, [
          (0, import_vue4.createElementVNode)("view", {
            class: (0, import_vue4.normalizeClass)(["relative flex flex-col", [props.direction == "horizontal" ? "flex-col-center-start" : "flex-row-center-center"]]),
            style: (0, import_vue4.normalizeStyle)([
              { width: (0, import_vue4.unref)(_sliderBarCssWidth) + "rpx", height: (0, import_vue4.unref)(_sliderBarCssHeight) + "rpx" }
            ])
          }, [
            (0, import_vue4.createVNode)(tmSheet, {
              noLevel: "",
              round: 10,
              color: props.bgColor,
              height: props.direction == "horizontal" ? props.height : (0, import_vue4.unref)(_sliderBarCssHeight),
              width: props.direction == "horizontal" ? (0, import_vue4.unref)(_sliderBarCssWidth) : props.height,
              margin: [0, 0],
              padding: [0, 0]
            }, null, 8, ["color", "height", "width"]),
            (0, import_vue4.createVNode)(sliderBar, {
              followTheme: props.followTheme,
              class: (0, import_vue4.normalizeClass)([props.direction == "horizontal" ? "flex-col-center-start" : "flex-row-center-center"]),
              direction: props.direction,
              color: props.color,
              size: props.height,
              x: (0, import_vue4.unref)(_barLet),
              width: (0, import_vue4.unref)(_barWidth)
            }, null, 8, ["followTheme", "class", "direction", "color", "size", "x", "width"]),
            props.showLabel ? ((0, import_vue4.openBlock)(), (0, import_vue4.createBlock)(sliderMask, {
              key: 0,
              followTheme: props.followTheme,
              color: props.color,
              ...
              min: props.min,
              max: props.max,
              width: (0, import_vue4.unref)(_sliderBarCssWidth),
              height: (0, import_vue4.unref)(_sliderBarCssHeight),
              direction: props.direction
            }, null, 8, ["followTheme", "color", "size", "step", "min", "max", "width", "height", "direction"])) : (0, import_vue4.createCommentVNode)("v-if", true),
            (0, import_vue4.createVNode)(sliderButton, {
              maxLeft: (0, import_vue4.unref)(buttonStaticsMaxLeft),
              followTheme: props.followTheme,
              direction: props.direction,
              ref_key: "btn0",
              ref: btn0,
            ...
            isDablue.value ? ((0, import_vue4.openBlock)(), (0, import_vue4.createBlock)(sliderButton, {
              key: 1,
              maxLeft: (0, import_vue4.unref)(buttonStaticsMaxLeft),
              followTheme: props.followTheme,
              direction: props.direction,
              ...
              size: props.buttonSize
            }, null, 8, ["maxLeft", "followTheme", "direction", "color", "x", "size"])) : (0, import_vue4.createCommentVNode)("v-if", true)
          ], 6),
          props.showLabel ? ((0, import_vue4.openBlock)(), (0, import_vue4.createElementBlock)("view", {
            key: 0,
            class: (0, import_vue4.normalizeClass)([props.direction == "vertical" ? "flex-col" : "flex-row"])
          }, [
            (0, import_vue4.createVNode)(sliderLabel, {
              size: props.buttonSize,
              step: props.step,
              min: props.min,
              max: props.max,
          ...
          showDetail.value ? ((0, import_vue4.openBlock)(), (0, import_vue4.createElementBlock)("view", {
            key: 1,
            class: (0, import_vue4.normalizeClass)(["flex absolute", [props.direction == "horizontal" ? "flex-col flex-col-start-center" : " flex-row "]]),
            style: (0, import_vue4.normalizeStyle)([
            ...
            (0, import_vue4.createElementVNode)("view", {
              ...
              (0, import_vue4.createVNode)(tmSheet, {
                ...
                default: (0, import_vue4.withCtx)(() => [
                  (0, import_vue4.createVNode)(tmText, { label: _value.value }, null, 8, ["label"])
                ]),
                _: 1
              }),
          ...
          ], 6)) : (0, import_vue4.createCommentVNode)("v-if", true)
        ], 2);
      };
    }
  });
  var tmSlider = /* @__PURE__ */ _export_sfc(_sfc_main4, [["__file", "F:/CoinQT/CoinQT_app/tmui/components/tm-slider/tm-slider.vue"]]);
            ...
            default: (0, import_vue6.withCtx)(() => [
              (0, import_vue6.createVNode)(tmSheet, null, {
                default: (0, import_vue6.withCtx)(() => [
                  ...
                  (0, import_vue6.createVNode)(tmSlider, {
                    width: 600,
                    height: 6,
                    defaultValue: 50
                  }),
  ...
  var slider = /* @__PURE__ */ _export_sfc(_sfc_main6, [["__file", "F:/CoinQT/CoinQT_app/pages/form/slider.nvue"]]);

  // <stdin>
  var webview = plus.webview.currentWebview();
  if (webview) {
    const __pageId = parseInt(webview.id);
    const __pagePath = "pages/form/slider";
    let __pageQuery = {};
    try {
