...
(() => {
  ...
  // F:/CoinQT/CoinQT_app/unpackage/dist/dev/.nvue/pages/form/keyborad.js
  ...
  // F:/CoinQT/CoinQT_app/unpackage/dist/dev/.nvue/tm-keyborad.js
  ...
  var _sfc_main9 = /* @__PURE__ */ (0, import_vue9.defineComponent)({
    ...
    setup(__props, { expose, emit: emits }) {
      ...
      const width = (0, import_vue9.computed)(() => sysinfo.value.width);
      const height = (0, import_vue9.computed)(() => sysinfo.value.height);
      const top = (0, import_vue9.computed)(() => sysinfo.value.top);
      (0, import_vue9.ref)(false);
      let timids = uni.$tm.u.getUid(1);
      let timerId = NaN;
      (0, import_vue9.ref)(null);
      const showMask = (0, import_vue9.ref)(false);
      const ani = (0, import_vue9.ref)(false);
      (0, import_vue9.onUnmounted)(() => clearTimeout(timerId));
      const align_rpx = (0, import_vue9.computed)(() => props.align);
      const bgColor_rp = (0, import_vue9.computed)(() => {
      ...
      (0, import_vue9.watch)(() => props.show, (newval) => {
        open(newval);
      });
      expose({
        close,
      ...
      return (_ctx, _cache) => {
        return showMask.value ? ((0, import_vue9.openBlock)(), (0, import_vue9.createElementBlock)("view", {
          key: 0,
          class: "l-0",
          style: (0, import_vue9.normalizeStyle)([{ width: (0, import_vue9.unref)(width) + "px", height: (0, import_vue9.unref)(height) + "px", top: (0, import_vue9.unref)(top) + "px", position: "fixed" }, __props.zIndex ? { zIndex: __props.zIndex } : ""]),
          renderWhole: true
        }, [
          (0, import_vue9.createElementVNode)("view", {
            ref: "overlay",
            class: (0, import_vue9.normalizeClass)([(0, import_vue9.unref)(bgColor_rp) && !props.transprent && ani.value ? "blurOn" : "blurOff", "overlay"]),
            style: (0, import_vue9.normalizeStyle)([
              (0, import_vue9.unref)(bgColor_rp) && !props.transprent ? { backgroundColor: showMask.value ? (0, import_vue9.unref)(bgColor_rp) : "" } : "",
              { width: (0, import_vue9.unref)(width) + "px", height: (0, import_vue9.unref)(height) + "px", transitionDuration: props.duration + "ms" }
            ])
          }, null, 6),
          (0, import_vue9.createElementVNode)("view", {
            onClick: (0, import_vue9.withModifiers)(closeByclick, ["stop"]),
            class: (0, import_vue9.normalizeClass)([(0, import_vue9.unref)(align_rpx), " absolute flex flex-col  l-0 t-0 ", (0, import_vue9.unref)(customClass)]),
            style: (0, import_vue9.normalizeStyle)([{ width: (0, import_vue9.unref)(width) + "px", height: (0, import_vue9.unref)(height) + "px" }, (0, import_vue9.unref)(customCSSStyle)])
          }, [
            (0, import_vue9.renderSlot)(_ctx.$slots, "default")
          ], 14, ["onClick"])
        ], 4)) : (0, import_vue9.createCommentVNode)("v-if", true);
      };
    }
  });
  var tmOverlay = /* @__PURE__ */ _export_sfc(_sfc_main9, [["styles", [_style_04]], ["__file", "F:/CoinQT/CoinQT_app/tmui/components/tm-overlay/tm-overlay.vue"]]);
  ...
  var _sfc_main10 = /* @__PURE__ */ (0, import_vue10.defineComponent)({
    ...
    setup(__props, { expose, emit: emits }) {
      var _a2, _b2;
      const props = __props;
      const drawerANI = (0, import_vue10.ref)(null);
      const overlayAni = (0, import_vue10.ref)(null);
      const store = useTmpiniaStore();
      ...
      const customCSSStyle = (0, import_vue10.computed)(() => computedStyle(props));
      const customClass = (0, import_vue10.computed)(() => computedClass(props));
      const isDark = (0, import_vue10.computed)(() => computedDark(props, tmcfg.value));
      const tmcomputed = (0, import_vue10.computed)(() => computedTheme(props, isDark.value, tmcfg.value));
      const syswidth = (0, import_vue10.computed)(() => sysinfo.value.width);
      const sysheight = (0, import_vue10.computed)(() => sysinfo.value.height);
      const reverse = (0, import_vue10.ref)(true);
      const timeid = (0, import_vue10.ref)(0);
      let timerId = NaN;
      let timerIdth_flas = false;
      uni.hideKeyboard();
      let _show = (0, import_vue10.ref)(props.show);
      ...
      (0, import_vue10.watch)(() => props.show, (val) => {
      ...
      const ok_loading = (0, import_vue10.computed)(() => props.okLoading);
      const round_rp = (0, import_vue10.computed)(() => {
      ...
      const reverse_rp = (0, import_vue10.computed)(() => {
        if (aniname.value != "zoom")
          return reverse.value;
        return !reverse.value;
      });
      const aniname = (0, import_vue10.computed)(() => {
      ...
      const anwidth = (0, import_vue10.computed)(() => {
        if (aniname.value == "zoom") {
      ...
      const anheight = (0, import_vue10.computed)(() => {
        let wucha = 0;
      ...
      const contentHeight = (0, import_vue10.computed)(() => {
      ...
      const align_rp = (0, import_vue10.computed)(() => {
        if (aniname.value == "down") {
      ...
      return (_ctx, _cache) => {
        return (0, import_vue10.openBlock)(), (0, import_vue10.createBlock)(tmOverlay, {
          ref_key: "overlayAni",
          ref: overlayAni,
          ...
          align: (0, import_vue10.unref)(align_rp),
          overlayClick: false,
          show: (0, import_vue10.unref)(_show),
          "onUpdate:show": _cache[1] || (_cache[1] = ($event) => (0, import_vue10.isRef)(_show) ? _show.value = $event : _show = $event)
        }, {
          default: (0, import_vue10.withCtx)(() => [
            (0, import_vue10.createVNode)(tmTranslate, {
              reverse: (0, import_vue10.unref)(reverse_rp),
              width: (0, import_vue10.unref)(anwidth),
              height: (0, import_vue10.unref)(anheight),
              ref_key: "drawerANI",
              ref: drawerANI,
              "auto-play": false,
              name: (0, import_vue10.unref)(aniname),
              duration: props.duration
            }, {
              default: (0, import_vue10.withCtx)(() => [
                (0, import_vue10.createElementVNode)("view", {
                  onClick: _cache[0] || (_cache[0] = (0, import_vue10.withModifiers)(($event) => $event.stopPropagation(), ["stop"])),
                  style: (0, import_vue10.normalizeStyle)([
                    { width: (0, import_vue10.unref)(anwidth), height: (0, import_vue10.unref)(anheight) },
                    !props.transprent ? (0, import_vue10.unref)(tmcomputed).borderCss : "",
                    !props.transprent ? (0, import_vue10.unref)(tmcomputed).backgroundColorCss : "",
                    !props.transprent ? (0, import_vue10.unref)(tmcomputed).shadowColor : "",
                    (0, import_vue10.unref)(customCSSStyle)
                  ]),
                  class: (0, import_vue10.normalizeClass)([(0, import_vue10.unref)(round_rp), "flex flex-col overflow ", (0, import_vue10.unref)(customClass)])
                }, [
                  !props.closeable && !props.hideHeader ? ((0, import_vue10.openBlock)(), (0, import_vue10.createElementBlock)("view", {
                    key: 0,
                    class: "flex flex-row flex-row-center-center flex-between px-24",
                    style: { "height": "44px" }
                  }, [
                    (0, import_vue10.createElementVNode)("view", { class: "flex-4 flex-shrink" }, [
                      !props.hideCancel ? ((0, import_vue10.openBlock)(), (0, import_vue10.createBlock)(tmText, {
                        key: 0,
                        onClick: cancel,
                        label: props.cancelText
                      }, null, 8, ["label"])) : (0, import_vue10.createCommentVNode)("v-if", true)
                    ]),
                    (0, import_vue10.createElementVNode)("view", { class: "flex-8 px-32 flex-center" }, [
                      (0, import_vue10.renderSlot)(_ctx.$slots, "title", {}, () => [
                    ...
                    (0, import_vue10.createElementVNode)("view", { class: "flex-4 flex-shrink flex-row flex-row-center-end" }, [
                      !(0, import_vue10.unref)(ok_loading) ? ((0, import_vue10.openBlock)(), (0, import_vue10.createBlock)(tmText, {
                        key: 0,
                        color: __props.okColor,
                        onClick: ok,
                        dark: props.dark,
                        label: props.okText
                      }, null, 8, ["color", "dark", "label"])) : (0, import_vue10.createCommentVNode)("v-if", true),
                      (0, import_vue10.unref)(ok_loading) ? ((0, import_vue10.openBlock)(), (0, import_vue10.createBlock)(tmIcon, {
                        key: 1,
                        color: __props.okColor,
                        spin: (0, import_vue10.unref)(ok_loading),
                        dark: (0, import_vue10.unref)(isDark),
                        _class: (0, import_vue10.unref)(isDark) !== true ? "opacity-4" : "",
                        fontSize: 34,
                        name: (0, import_vue10.unref)(ok_loading) ? "tmicon-jiazai_dan" : "tmicon-times-circle-fill"
                      }, null, 8, ["color", "spin", "dark", "_class", "name"])) : (0, import_vue10.createCommentVNode)("v-if", true)
                    ])
                  ...
                  props.closeable && !props.hideHeader ? ((0, import_vue10.openBlock)(), (0, import_vue10.createElementBlock)("view", {
                    ...
                    (0, import_vue10.createElementVNode)("view", { class: "flex-9 pr-32" }, [
                      (0, import_vue10.renderSlot)(_ctx.$slots, "title", {}, () => [
                        (0, import_vue10.createVNode)(tmText, {
                          _class: "text-overflow-1 opacity-7",
                          dark: props.dark,
                    ...
                    (0, import_vue10.createElementVNode)("view", { class: "flex-3 flex-shrink flex-row flex-row-center-end" }, [
                      (0, import_vue10.createVNode)(tmIcon, {
                        onClick: cancel,
                        dark: props.dark,
                        _class: (0, import_vue10.unref)(isDark) !== true ? "opacity-3" : "",
                        fontSize: 36,
                        name: "tmicon-times-circle-fill"
                      }, null, 8, ["dark", "_class"])
                    ])
                  ])) : (0, import_vue10.createCommentVNode)("v-if", true),
                  (0, import_vue10.createElementVNode)("scroll-view", {
                    scrollY: !props.disabbleScroll,
                    style: (0, import_vue10.normalizeStyle)([{ height: (0, import_vue10.unref)(contentHeight) }]),
                    class: "overflow"
                  }, [
  ...
  var tmDrawer = /* @__PURE__ */ _export_sfc(_sfc_main10, [["styles", [_style_05]], ["__file", "F:/CoinQT/CoinQT_app/tmui/components/tm-drawer/tm-drawer.vue"]]);
  ...
  var _sfc_main$4 = /* @__PURE__ */ (0, import_vue11.defineComponent)({
    ...
    setup(__props, { emit: emits }) {
      const props = __props;
      const _dark = (0, import_vue11.computed)(() => props.dark);
      let defaultNum = [1, 2, 3, 4, 5, 6, 7, 8, 9, 0, "."];
      if (!props.decimal) {
        defaultNum.pop();
      }
      const numbersfc = (0, import_vue11.ref)(defaultNum);
      if (props.random) {
        numbersfc.value = shuffle((0, import_vue11.toRaw)(numbersfc.value));
      }
      const numberArray = (0, import_vue11.ref)([]);
      numberArray.value = uni.$tm.u.splitData((0, import_vue11.toRaw)(numbersfc.value), 3);
      const _value = (0, import_vue11.ref)(props.modelValue);
      function keydown(e) {
        let k = String(e);
        _value.value += k;
      ...
      return (_ctx, _cache) => {
        return (0, import_vue11.openBlock)(), (0, import_vue11.createBlock)(tmSheet, {
          "follow-theme": false,
          "follow-dark": false,
          dark: (0, import_vue11.unref)(_dark),
          color: "white",
          transprent: true,
          padding: [4, 4],
          margin: [0, 0],
          ...
          default: (0, import_vue11.withCtx)(() => [
            (0, import_vue11.createElementVNode)("view", {
              ...
              !_value.value && !props.showInputConten ? ((0, import_vue11.openBlock)(), (0, import_vue11.createBlock)(tmText, {
                key: 0,
                "font-size": 28,
                _class: "text-weight-b",
                label: "\u5B89\u5168\u952E\u76D8\u653E\u5FC3\u8F93\u5165"
              })) : (0, import_vue11.createCommentVNode)("v-if", true),
              _value.value && props.showInputContent ? ((0, import_vue11.openBlock)(), (0, import_vue11.createBlock)(tmText, {
                key: 1,
                "font-size": 34,
            ...
            (0, import_vue11.createElementVNode)("view", { class: "flex flex-row" }, [
              (0, import_vue11.createElementVNode)("view", { class: "flex-5 flex flex-col" }, [
                ((0, import_vue11.openBlock)(true), (0, import_vue11.createElementBlock)(import_vue11.Fragment, null, (0, import_vue11.renderList)(numberArray.value, (item2, index2) => {
                  return (0, import_vue11.openBlock)(), (0, import_vue11.createElementBlock)("view", {
                    class: "flex-row flex flex-1",
                    key: index2
                  }, [
                    ((0, import_vue11.openBlock)(true), (0, import_vue11.createElementBlock)(import_vue11.Fragment, null, (0, import_vue11.renderList)(item2, (item, index) => {
                      return (0, import_vue11.openBlock)(), (0, import_vue11.createBlock)(tmSheet, {
                        ...
                        class: (0, import_vue11.normalizeClass)(index2 == 3 && index == 0 ? "flex-5" : "flex-3")
                      }, {
                        default: (0, import_vue11.withCtx)(() => [
                          (0, import_vue11.createElementVNode)("view", {
                            style: { "width": "40rpx" },
              ...
              (0, import_vue11.createElementVNode)("view", { class: "flex-1 flex flex-col" }, [
                (0, import_vue11.createElementVNode)("view", { class: "flex flex-row" }, [
                ...
                (0, import_vue11.createElementVNode)("view", { class: "flex-6 flex flex-row" }, [
                  (0, import_vue11.createVNode)(tmSheet, {
                    "hover-class": "opacity-5 keywordBoradAni",
                    onClick: confirm,
  ...
  var _sfc_main$3 = /* @__PURE__ */ (0, import_vue11.defineComponent)({
    ...
    setup(__props, { emit: emits }) {
      const props = __props;
      const _dark = (0, import_vue11.computed)(() => props.dark);
      const numbersfc = (0, import_vue11.ref)([1, 2, 3, 4, 5, 6, 7, 8, 9, 0, "X"]);
      if (props.random) {
        numbersfc.value = shuffle((0, import_vue11.toRaw)(numbersfc.value));
      }
      const numberArray = (0, import_vue11.ref)([]);
      numberArray.value = uni.$tm.u.splitData((0, import_vue11.toRaw)(numbersfc.value), 3);
      const _value = (0, import_vue11.ref)(props.modelValue);
      const _isOk = (0, import_vue11.computed)(() => validateIdCard(_value.value));
      function keydown(e) {
        let k = String(e);
        _value.value += k;
        emits("update:modelValue", _value.value);
      ...
      (0, import_vue11.watch)(() => props.modelValue, () => {
        (0, import_vue11.nextTick)(() => _value.value = props.modelValue);
      });
      return (_ctx, _cache) => {
        return (0, import_vue11.openBlock)(), (0, import_vue11.createBlock)(tmSheet, {
          "follow-theme": false,
          ...
          default: (0, import_vue11.withCtx)(() => [
            (0, import_vue11.createElementVNode)("view", {
              ...
              _value.value && props.showInputContent ? ((0, import_vue11.openBlock)(), (0, import_vue11.createBlock)(tmText, {
                key: 1,
                color: (0, import_vue11.unref)(_isOk) ? "green" : "red",
                "font-size": 34,
                _class: "text-weight-b pr-24",
                label: _value.value
              }, null, 8, ["color", "label"])) : (0, import_vue11.createCommentVNode)("v-if", true),
              (0, import_vue11.unref)(_isOk) && props.showInputContent ? ((0, import_vue11.openBlock)(), (0, import_vue11.createBlock)(tmIcon, {
                key: 2,
                color: "green",
                "font-size": 34,
  ...
  var _sfc_main$2 = /* @__PURE__ */ (0, import_vue11.defineComponent)({
    ...
    setup(__props, { emit: emits }) {
      ...
      const numberArray = (0, import_vue11.ref)([]);
      const _value = (0, import_vue11.ref)(props.modelValue);
      const shefitUp = (0, import_vue11.ref)(false);
      const changeChart = (0, import_vue11.ref)(false);
      getChart();
      function keydown(e) {
        let k = String(e);
        _value.value += k;
      ...
      function getChart() {
        const numbersfc = (0, import_vue11.ref)([
          1,
          2,
          3,
          4,
        ...
        const chartsfc = (0, import_vue11.ref)([
          '"',
          "'",
          ".",
          "/",
        ...
        if (!changeChart.value) {
          ...
          numberArray.value = uni.$tm.u.splitData((0, import_vue11.toRaw)(numbersfc.value), 9);
        } else {
          if (props.random) {
            chartsfc.value = shuffle((0, import_vue11.toRaw)(chartsfc.value));
          }
          numberArray.value = uni.$tm.u.splitData((0, import_vue11.toRaw)(chartsfc.value), 9);
        }
      }
      function shuffle(arr = []) {
        var i = arr.length, t, j;
      ...
      return (_ctx, _cache) => {
        return (0, import_vue11.openBlock)(), (0, import_vue11.createBlock)(tmSheet, {
          ...
          default: (0, import_vue11.withCtx)(() => [
            ...
            (0, import_vue11.createElementVNode)("view", { class: "flex flex-row" }, [
              (0, import_vue11.createElementVNode)("view", { class: "flex-9 flex flex-col" }, [
                ((0, import_vue11.openBlock)(true), (0, import_vue11.createElementBlock)(import_vue11.Fragment, null, (0, import_vue11.renderList)(numberArray.value, (item2, index2) => {
                  return (0, import_vue11.openBlock)(), (0, import_vue11.createElementBlock)("view", {
                    class: "flex-row flex flex-1",
                    key: index2
              ...
              (0, import_vue11.createElementVNode)("view", { class: "flex-1 flex flex-col" }, [
                ...
                (0, import_vue11.createElementVNode)("view", { class: "flex flex-row" }, [
                  !changeChart.value ? ((0, import_vue11.openBlock)(), (0, import_vue11.createBlock)(tmSheet, {
                    key: 0,
                    "hover-class": "opacity-5 keywordBoradAni",
                    "no-level": "",
                    height: 100,
                    ...
                    _: 1
                  }, 8, ["dark", "color"])) : (0, import_vue11.createCommentVNode)("v-if", true)
                ]),
                (0, import_vue11.createElementVNode)("view", { class: "flex flex-row" }, [
                  (0, import_vue11.createVNode)(tmSheet, {
                    "hover-class": "opacity-5 keywordBoradAni",
  ...
  var _style_06 = { "keywordBoradAni": { "": { "transitionDuration": 100, "transitionTimingFunction": "linear", "transitionDelay": 0, "transitionProperty": "transform", "transform": "scale(0.85)" } }, "@TRANSITION": { "keywordBoradAni": { "duration": 100, "timingFunction": "linear", "delay": 0, "property": "transform" } } };
  ...
  var keyboradCar = /* @__PURE__ */ _export_sfc(_sfc_main$13, [["styles", [_style_06]], ["__file", "F:/CoinQT/CoinQT_app/tmui/components/tm-keyborad/keyborad-car.vue"]]);
  var _sfc_main11 = /* @__PURE__ */ (0, import_vue11.defineComponent)({
    ...
    setup(__props, { emit: emits }) {
      ...
      const props = __props;
      const store = useTmpiniaStore();
      const drawer = (0, import_vue11.ref)(null);
      const tmcfg = (0, import_vue11.computed)(() => store.tmStore);
      const isDark = (0, import_vue11.computed)(() => computedDark(props, tmcfg.value));
      const showPop = (0, import_vue11.ref)((_a2 = props == null ? void 0 : props.show) != null ? _a2 : false);
      const _value = (0, import_vue11.ref)((_b2 = props == null ? void 0 : props.defaultValue) != null ? _b2 : "");
      const sysinfo = (0, import_vue11.inject)("tmuiSysInfo", (0, import_vue11.computed)(() => {
        return { bottom: 0, height: 750, width: uni.upx2px(750), top: 0, isCustomHeader: false, sysinfo: null };
      }));
      const _typemodel = (0, import_vue11.computed)(() => props.type);
      (0, import_vue11.watch)(() => props.show, () => {
      ...
      function change() {
        emits("update:modelValue", (0, import_vue11.toRaw)(_value.value));
        (0, import_vue11.nextTick)(() => {
          _value.value = props.modelValue;
          emits("change", (0, import_vue11.toRaw)(_value.value));
        });
      }
      function confirm() {
        debounce(() => {
          var _a22;
          emits("confirm", (0, import_vue11.toRaw)(_value.value));
          (_a22 = drawer.value) == null ? void 0 : _a22.close();
        }, 250, true);
      }
      const dHeight = (0, import_vue11.computed)(() => {
        return 520 + sysinfo.value.bottom;
      });
      return (_ctx, _cache) => {
        return (0, import_vue11.openBlock)(), (0, import_vue11.createBlock)(tmDrawer, {
          ref_key: "drawer",
          ref: drawer,
          onOpen: drawerOpen,
          onClose: drawerClose,
          ...
          "follow-theme": false,
          height: (0, import_vue11.unref)(dHeight),
          "hide-header": true,
          color: "grey-3",
          mask: false
        }, {
          default: (0, import_vue11.withCtx)(() => [
            (0, import_vue11.unref)(_typemodel) == "number" ? ((0, import_vue11.openBlock)(), (0, import_vue11.createBlock)(keyboradNumber, {
              key: 0,
              ...
              dark: (0, import_vue11.unref)(isDark),
              class: "flex-1"
            }, null, 8, ["showInputContent", "decimal", "followTheme", "random", "color", "model-value", "dark"])) : (0, import_vue11.createCommentVNode)("v-if", true),
            (0, import_vue11.unref)(_typemodel) == "password" ? ((0, import_vue11.openBlock)(), (0, import_vue11.createBlock)(keyboradPass, {
              key: 1,
              showInputContent: props.showInputContent,
              followTheme: props.followTheme,
              random: props.random,
              ...
              dark: (0, import_vue11.unref)(isDark),
              class: "flex-1"
            }, null, 8, ["showInputContent", "followTheme", "random", "color", "model-value", "dark"])) : (0, import_vue11.createCommentVNode)("v-if", true),
            (0, import_vue11.unref)(_typemodel) == "car" ? ((0, import_vue11.openBlock)(), (0, import_vue11.createBlock)(keyboradCar, {
              key: 2,
              showInputContent: props.showInputContent,
              followTheme: props.followTheme,
              random: props.random,
            ...
            (0, import_vue11.unref)(_typemodel) == "card" ? ((0, import_vue11.openBlock)(), (0, import_vue11.createBlock)(keyboradCard, {
              key: 3,
              showInputContent: props.showInputContent,
              followTheme: props.followTheme,
              random: props.random,
  ...
  var tmKeyborad = /* @__PURE__ */ _export_sfc(_sfc_main11, [["__file", "F:/CoinQT/CoinQT_app/tmui/components/tm-keyborad/tm-keyborad.vue"]]);
  ...
  var _sfc_main12 = /* @__PURE__ */ (0, import_vue12.defineComponent)({
    __name: "keyborad",
    setup(__props) {
      const modeltype = (0, import_vue12.ref)("password");
        ...
        return (0, import_vue12.openBlock)(), (0, import_vue12.createElementBlock)("scroll-view", {
          ...
          (0, import_vue12.createVNode)(tmApp, null, {
            default: (0, import_vue12.withCtx)(() => [
              ...
              (0, import_vue12.createVNode)(tmKeyborad, {
  ...
  var keyborad = /* @__PURE__ */ _export_sfc(_sfc_main12, [["__file", "F:/CoinQT/CoinQT_app/pages/form/keyborad.nvue"]]);

  // <stdin>
  var webview = plus.webview.currentWebview();
  if (webview) {
    const __pageId = parseInt(webview.id);
    const __pagePath = "pages/form/keyborad";
    let __pageQuery = {};
    try {
      __pageQuery = JSON.parse(webview.__query__);
    } catch (e) {
    }
    keyborad.mpType = "page";
    const app = Vue.createPageApp(keyborad, { $store: getApp({ allowDefault: true }).$store, __pageId, __pagePath, __pageQuery });
    app.provide("__globalStyles", Vue.useCssStyles([...__uniConfig.styles, ...keyborad.styles || []]));
    app.mount("#root");
  }
})();
