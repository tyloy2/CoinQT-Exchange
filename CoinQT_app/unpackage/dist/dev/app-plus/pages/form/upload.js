...
(() => {
  ...
  // F:/CoinQT/CoinQT_app/unpackage/dist/dev/.nvue/pages/form/upload.js
  ...
  var uploadfile = class {
    constructor(config) {
      ...
      cf = __spreadValues6(__spreadValues6({}, cf), (_a2 = arguments[0]) != null ? _a2 : {});
      this.config = cf;
    ...
    chooseMPH5weixinFile() {
      return __async(this, null, function* () {
        ...
        return new Promise((rs, rj) => {
          ...
          fs(__spreadProps6(__spreadValues6({}, config), {
            fail: (e) => {
    ...
    setConfig(config) {
      this.config = __spreadValues6(__spreadValues6({}, this.config), config != null ? config : {});
    }
    addFile(filelist = []) {
        ...
        function startupload() {
          return __async(this, null, function* () {
            ...
            const upObj = uni.uploadFile({
              ...
              filePath: item.url,
              formData: __spreadValues6({ name: item.name }, t.config.formData),
              success: (res) => {
  ...
  var _sfc_main6 = /* @__PURE__ */ (0, import_vue6.defineComponent)({
    ...
    setup(__props, { expose, emit: emits }) {
      ...
      const itemWidth = (0, import_vue6.computed)(() => {
        return props.width / props.rows;
      });
      const itemHeight = (0, import_vue6.computed)(() => {
        return props.imageHeight;
      });
      const _filelist = (0, import_vue6.ref)([]);
      const _disabledAdd = (0, import_vue6.computed)(() => {
      ...
      (0, import_vue6.watch)([() => props.header, () => props.maxFile, () => props.maxSize, () => props.formData], () => {
      ...
      function addSuccess(fileList = []) {
        fileList = (0, import_vue6.toRaw)(fileList);
        let fl = fileList.map((e) => {
          let _itemfile = { url: "" };
          if (typeof e == "string") {
            _itemfile.url = e;
          } else {
            _itemfile = __spreadValues6({}, e);
          }
          _itemfile = __spreadProps6(__spreadValues6({}, _itemfile), { statusCode: statusCode.success, status: "\u4E0A\u4F20\u6210\u529F", progress: 100 });
          return _itemfile;
        });
        return fl;
      }
      ...
      _uploadObj.complete = function(item) {
        _filelist.value = [..._uploadObj.filelist];
        emits("complete", (0, import_vue6.toRaw)(item), (0, import_vue6.toRaw)(_filelist.value));
        emits("update:modelValue", _filelist.value);
        pushFormItem(true);
      };
      ...
      _uploadObj.success = function(item, fileList) {
        ...
        if (index > -1) {
          ...
          emits("success", (0, import_vue6.toRaw)(item), (0, import_vue6.toRaw)(_filelist.value));
          emits("change", (0, import_vue6.toRaw)(_filelist.value));
        }
      };
      _uploadObj.fail = function(item) {
        ...
        if (index > -1) {
          _filelist.value.splice(index, 1, item);
          emits("fail", (0, import_vue6.toRaw)(item), (0, import_vue6.toRaw)(_filelist.value));
          emits("change", (0, import_vue6.toRaw)(_filelist.value));
        }
      };
      function chooseFile() {
      ...
      function deletedFile(item) {
        return __async(this, null, function* () {
          ...
          emits("remove", (0, import_vue6.toRaw)(item));
          emits("update:modelValue", _filelist.value);
          emits("change", (0, import_vue6.toRaw)(_filelist.value));
          pushFormItem();
        });
      ...
      return (_ctx, _cache) => {
        return (0, import_vue6.openBlock)(), (0, import_vue6.createElementBlock)("view", {
          ...
          (0, import_vue6.createElementVNode)("view", {
            ...
            style: (0, import_vue6.normalizeStyle)([{ "flex-wrap": "wrap" }, { width: __props.width + "rpx" }])
          }, [
            ((0, import_vue6.openBlock)(true), (0, import_vue6.createElementBlock)(import_vue6.Fragment, null, (0, import_vue6.renderList)(_filelist.value, (item, index) => {
              return (0, import_vue6.openBlock)(), (0, import_vue6.createElementBlock)("view", {
                class: "ma-5",
                key: index,
                style: (0, import_vue6.normalizeStyle)({ width: (0, import_vue6.unref)(itemWidth) - 10 + "rpx" })
              }, [
                (0, import_vue6.createVNode)(tmSheet, {
                  ...
                  default: (0, import_vue6.withCtx)(() => [
                    (0, import_vue6.createVNode)(tmImage, {
                      round: 2,
                      allowDelete: false,
                      ...
                      delete: "",
                      src: item.url,
                      width: (0, import_vue6.unref)(itemWidth) - 10,
                      height: (0, import_vue6.unref)(itemHeight) - 10
                    }, {
                      extra: (0, import_vue6.withCtx)(() => [
                        (0, import_vue6.createElementVNode)("view", {
                          style: (0, import_vue6.normalizeStyle)({ background: "rgba(0, 0, 0, 0.7)", width: (0, import_vue6.unref)(itemWidth) - 10 + "rpx" }),
                          class: (0, import_vue6.normalizeClass)([[`round-b-${2}`], "py-4 px-4 flex flex-row flex-row-center-start"])
                        }, [
                          item.statusCode == 0 || item.statusCode == 1 ? ((0, import_vue6.openBlock)(), (0, import_vue6.createBlock)(tmIcon, {
                            key: 0,
                            "font-size": 23,
                            color: "grey-3",
                            name: "tmicon-clock-fill"
                          })) : (0, import_vue6.createCommentVNode)("v-if", true),
                          item.statusCode == 0 || item.statusCode == 1 ? ((0, import_vue6.openBlock)(), (0, import_vue6.createBlock)(tmText, {
                            key: 1,
                            color: "grey-3",
                            _class: "pl-5",
                            "font-size": 23,
                          ...
                          item.statusCode == 2 || item.statusCode == 4 ? ((0, import_vue6.openBlock)(), (0, import_vue6.createBlock)(tmIcon, {
                            key: 2,
                            "font-size": 23,
                            color: "red",
                            name: "tmicon-times-circle-fill"
                          })) : (0, import_vue6.createCommentVNode)("v-if", true),
                          item.statusCode == 2 || item.statusCode == 4 ? ((0, import_vue6.openBlock)(), (0, import_vue6.createBlock)(tmText, {
                            key: 3,
                            color: "red",
                            _class: "pl-5",
                            "font-size": 23,
                          ...
                          item.statusCode == 3 ? ((0, import_vue6.openBlock)(), (0, import_vue6.createBlock)(tmIcon, {
                            key: 4,
                            "font-size": 23,
                            color: "green",
                            name: "tmicon-check-circle-fill"
                          })) : (0, import_vue6.createCommentVNode)("v-if", true),
                          item.statusCode == 3 ? ((0, import_vue6.openBlock)(), (0, import_vue6.createBlock)(tmText, {
                            key: 5,
                            color: "green",
                            _class: "pl-5",
                            "font-size": 23,
            ...
            !(0, import_vue6.unref)(_disabledAdd) ? ((0, import_vue6.openBlock)(), (0, import_vue6.createElementBlock)("view", {
              key: 0,
              onClick: chooseFile,
              class: "ma-5",
              style: (0, import_vue6.normalizeStyle)({ width: (0, import_vue6.unref)(itemWidth) - 10 + "rpx" })
              ...
              (0, import_vue6.createVNode)(tmSheet, {
                ...
                default: (0, import_vue6.withCtx)(() => [
                  (0, import_vue6.renderSlot)(_ctx.$slots, "icon", {}, () => [
  ...
  var tmUpload = /* @__PURE__ */ _export_sfc(_sfc_main6, [["__file", "F:/CoinQT/CoinQT_app/tmui/components/tm-upload/tm-upload.vue"]]);
  ...
  var _sfc_main8 = /* @__PURE__ */ (0, import_vue8.defineComponent)({
    ...
    setup(__props) {
      ...
      const up = (0, import_vue8.ref)(null);
      return (_ctx, _cache) => {
            ...
            default: (0, import_vue8.withCtx)(() => [
              (0, import_vue8.createVNode)(tmSheet, null, {
                default: (0, import_vue8.withCtx)(() => [
                  ...
                  (0, import_vue8.createVNode)(tmUpload, {
                    ref_key: "up",
                    ref: up,
                    width: 636,
                    rows: 4,
                  ...
                  (0, import_vue8.createVNode)(tmUpload, {
                    ...
                    icon: (0, import_vue8.withCtx)(() => [
                      (0, import_vue8.createVNode)(tmText, { label: "\u4E0A\u4F20" })
                    ]),
                    _: 1
                  }, 512)
                ]),
  ...
  var upload = /* @__PURE__ */ _export_sfc(_sfc_main8, [["__file", "F:/CoinQT/CoinQT_app/pages/form/upload.nvue"]]);

  // <stdin>
  var webview = plus.webview.currentWebview();
  if (webview) {
    const __pageId = parseInt(webview.id);
    const __pagePath = "pages/form/upload";
    let __pageQuery = {};
    try {
