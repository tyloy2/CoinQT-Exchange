...
(() => {
  ...
  // F:/CoinQT/CoinQT_app/unpackage/dist/dev/.nvue/pages/form/time.js
  ...
  var _sfc_main6 = /* @__PURE__ */ (0, import_vue6.defineComponent)({
    ...
    setup(__props, { expose, emit: emits }) {
      var _a2, _b2;
      const props = __props;
      const drawerANI = (0, import_vue6.ref)(null);
      const overlayAni = (0, import_vue6.ref)(null);
      const store = useTmpiniaStore();
      (_b2 = (_a2 = (0, import_vue6.getCurrentInstance)()) == null ? void 0 : _a2.proxy) != null ? _b2 : null;
      const sysinfo = (0, import_vue6.inject)("tmuiSysInfo", (0, import_vue6.computed)(() => {
        return { bottom: 0, height: 750, width: uni.upx2px(750), top: 0, isCustomHeader: false, sysinfo: null };
      }));
      ...
      const tmcomputed = (0, import_vue6.computed)(() => computedTheme(props, isDark.value, tmcfg.value));
      const syswidth = (0, import_vue6.computed)(() => sysinfo.value.width);
      const sysheight = (0, import_vue6.computed)(() => sysinfo.value.height);
      const reverse = (0, import_vue6.ref)(true);
      const timeid = (0, import_vue6.ref)(0);
      let timerId = NaN;
      let timerIdth_flas = false;
      uni.hideKeyboard();
      let _show = (0, import_vue6.ref)(props.show);
      ...
      (0, import_vue6.watch)(() => props.show, (val) => {
      ...
      const ok_loading = (0, import_vue6.computed)(() => props.okLoading);
      const round_rp = (0, import_vue6.computed)(() => {
      ...
      const reverse_rp = (0, import_vue6.computed)(() => {
        if (aniname.value != "zoom")
          return reverse.value;
        return !reverse.value;
      });
      const aniname = (0, import_vue6.computed)(() => {
      ...
      const anwidth = (0, import_vue6.computed)(() => {
        if (aniname.value == "zoom") {
      ...
      const anheight = (0, import_vue6.computed)(() => {
        let wucha = 0;
      ...
      const contentHeight = (0, import_vue6.computed)(() => {
      ...
      const align_rp = (0, import_vue6.computed)(() => {
        if (aniname.value == "down") {
      ...
      return (_ctx, _cache) => {
        return (0, import_vue6.openBlock)(), (0, import_vue6.createBlock)(tmOverlay, {
          ...
          align: (0, import_vue6.unref)(align_rp),
          overlayClick: false,
          show: (0, import_vue6.unref)(_show),
          "onUpdate:show": _cache[1] || (_cache[1] = ($event) => (0, import_vue6.isRef)(_show) ? _show.value = $event : _show = $event)
        }, {
          default: (0, import_vue6.withCtx)(() => [
            (0, import_vue6.createVNode)(tmTranslate, {
              reverse: (0, import_vue6.unref)(reverse_rp),
              width: (0, import_vue6.unref)(anwidth),
              height: (0, import_vue6.unref)(anheight),
              ref_key: "drawerANI",
              ref: drawerANI,
              "auto-play": false,
              name: (0, import_vue6.unref)(aniname),
              duration: props.duration
            }, {
              default: (0, import_vue6.withCtx)(() => [
                (0, import_vue6.createElementVNode)("view", {
                  onClick: _cache[0] || (_cache[0] = (0, import_vue6.withModifiers)(($event) => $event.stopPropagation(), ["stop"])),
                  style: (0, import_vue6.normalizeStyle)([
                    { width: (0, import_vue6.unref)(anwidth), height: (0, import_vue6.unref)(anheight) },
                    !props.transprent ? (0, import_vue6.unref)(tmcomputed).borderCss : "",
                    !props.transprent ? (0, import_vue6.unref)(tmcomputed).backgroundColorCss : "",
                    !props.transprent ? (0, import_vue6.unref)(tmcomputed).shadowColor : "",
                    (0, import_vue6.unref)(customCSSStyle)
                  ]),
                  class: (0, import_vue6.normalizeClass)([(0, import_vue6.unref)(round_rp), "flex flex-col overflow ", (0, import_vue6.unref)(customClass)])
                }, [
                  !props.closeable && !props.hideHeader ? ((0, import_vue6.openBlock)(), (0, import_vue6.createElementBlock)("view", {
                    key: 0,
                    class: "flex flex-row flex-row-center-center flex-between px-24",
                    style: { "height": "44px" }
                  }, [
                    (0, import_vue6.createElementVNode)("view", { class: "flex-4 flex-shrink" }, [
                      !props.hideCancel ? ((0, import_vue6.openBlock)(), (0, import_vue6.createBlock)(tmText, {
                        key: 0,
                        onClick: cancel,
                        label: props.cancelText
                      }, null, 8, ["label"])) : (0, import_vue6.createCommentVNode)("v-if", true)
                    ]),
                    (0, import_vue6.createElementVNode)("view", { class: "flex-8 px-32 flex-center" }, [
                    ...
                    (0, import_vue6.createElementVNode)("view", { class: "flex-4 flex-shrink flex-row flex-row-center-end" }, [
                      !(0, import_vue6.unref)(ok_loading) ? ((0, import_vue6.openBlock)(), (0, import_vue6.createBlock)(tmText, {
                        key: 0,
                        color: __props.okColor,
                        onClick: ok,
                        dark: props.dark,
                        label: props.okText
                      }, null, 8, ["color", "dark", "label"])) : (0, import_vue6.createCommentVNode)("v-if", true),
                      (0, import_vue6.unref)(ok_loading) ? ((0, import_vue6.openBlock)(), (0, import_vue6.createBlock)(tmIcon, {
                        key: 1,
                        color: __props.okColor,
                        spin: (0, import_vue6.unref)(ok_loading),
                        dark: (0, import_vue6.unref)(isDark),
                        _class: (0, import_vue6.unref)(isDark) !== true ? "opacity-4" : "",
                        fontSize: 34,
                        name: (0, import_vue6.unref)(ok_loading) ? "tmicon-jiazai_dan" : "tmicon-times-circle-fill"
                      }, null, 8, ["color", "spin", "dark", "_class", "name"])) : (0, import_vue6.createCommentVNode)("v-if", true)
                    ])
                  ...
                  props.closeable && !props.hideHeader ? ((0, import_vue6.openBlock)(), (0, import_vue6.createElementBlock)("view", {
                    ...
                    (0, import_vue6.createElementVNode)("view", { class: "flex-9 pr-32" }, [
                      (0, import_vue6.renderSlot)(_ctx.$slots, "title", {}, () => [
                        (0, import_vue6.createVNode)(tmText, {
                          _class: "text-overflow-1 opacity-7",
                          dark: props.dark,
                    ...
                    (0, import_vue6.createElementVNode)("view", { class: "flex-3 flex-shrink flex-row flex-row-center-end" }, [
                      (0, import_vue6.createVNode)(tmIcon, {
                        onClick: cancel,
                        dark: props.dark,
                        _class: (0, import_vue6.unref)(isDark) !== true ? "opacity-3" : "",
                        fontSize: 36,
                  ...
                  (0, import_vue6.createElementVNode)("scroll-view", {
                    ...
                    style: (0, import_vue6.normalizeStyle)([{ height: (0, import_vue6.unref)(contentHeight) }]),
                    class: "overflow"
                  }, [
  ...
  var tmDrawer = /* @__PURE__ */ _export_sfc(_sfc_main6, [["styles", [_style_04]], ["__file", "F:/CoinQT/CoinQT_app/tmui/components/tm-drawer/tm-drawer.vue"]]);
  ...
  var _style_05 = { "button": { "": { "backgroundColor": "rgba(0,0,0,0)", "borderWidth": 0, "borderStyle": "solid", "borderColor": "rgba(0,0,0,0)", "paddingTop": 0, "paddingRight": 0, "paddingBottom": 0, "paddingLeft": 0, "borderRadius": 0 } }, "buttonHover": { "": { "backgroundColor": "rgba(0,0,0,0)" } }, "bhover": { "": { "opacity": 0.7 } } };
  ...
  var TmButton = /* @__PURE__ */ _export_sfc(_sfc_main7, [["styles", [_style_05]], ["__file", "F:/CoinQT/CoinQT_app/tmui/components/tm-button/tm-button.vue"]]);
  ...
  var _sfc_main$2 = /* @__PURE__ */ (0, import_vue8.defineComponent)({
    __name: "time-panel",
    props: {
      nowtime: {
        type: String,
    ...
    setup(__props) {
      ...
      const DayJs = dayjs;
      const { proxy } = (0, import_vue8.getCurrentInstance)();
      const store = useTmpiniaStore();
      ...
      const tmArray = (0, import_vue8.ref)([]);
      const _nowtimeValue = (0, import_vue8.computed)(() => DayJs(props.nowtime));
      const colIndex = (0, import_vue8.ref)(0);
      const isDark = (0, import_vue8.computed)(() => store.tmStore.dark);
      const maskHeight = (0, import_vue8.computed)(() => {
        return (uni.upx2px(props.height) - 34) / 2;
      });
      const maskWidth = (0, import_vue8.ref)(0);
      (0, import_vue8.computed)(() => {
      ...
      (0, import_vue8.watch)([() => props.start, () => props.end], () => {
        rangeTimeArray();
      });
      (0, import_vue8.watch)([() => props.nowtime], (newval, oldval) => {
      ...
      (0, import_vue8.onUpdated)(() => nvuegetClientRect());
      ...
      function rangeTimeArray() {
        ...
        (0, import_vue8.nextTick)(() => getIndexNow());
      }
      ...
      return (_ctx, _cache) => {
        const _component_picker_view_column = (0, import_vue8.resolveComponent)("picker-view-column");
        const _component_picker_view = (0, import_vue8.resolveComponent)("picker-view");
        return (0, import_vue8.openBlock)(), (0, import_vue8.createElementBlock)(import_vue8.Fragment, null, [
          (0, import_vue8.createCommentVNode)(" background:linear-gradient(180deg,rgba(255,255,255,0.95),rgba(255,255,255,0.6)),linear-gradient(0deg, rgba(255,255,255,0.95), rgba(255,255,255,0.6)) "),
          (0, import_vue8.createCommentVNode)(` :mask-style="isDark?'background:linear-gradient(0deg,rgba(0,0,0,0.4),rgba(0,0,0,0),rgba(0,0,0,0.4))':'background:rgba(255,255,255,0)'" `),
          (0, import_vue8.createElementVNode)("view", {
            class: "flex-1 relative",
            style: (0, import_vue8.normalizeStyle)({ height: props.height + "rpx" })
          }, [
            (0, import_vue8.createVNode)(_component_picker_view, {
              ref: "picker",
              ...
              default: (0, import_vue8.withCtx)(() => [
                (0, import_vue8.createVNode)(_component_picker_view_column, {
                  style: (0, import_vue8.normalizeStyle)([{ height: props.height + "rpx" }])
                }, {
                  default: (0, import_vue8.withCtx)(() => [
                    ((0, import_vue8.openBlock)(true), (0, import_vue8.createElementBlock)(import_vue8.Fragment, null, (0, import_vue8.renderList)(tmArray.value, (item, index) => {
                      return (0, import_vue8.openBlock)(), (0, import_vue8.createElementBlock)("view", {
                        ...
                        props.timeType != "month" ? ((0, import_vue8.openBlock)(), (0, import_vue8.createBlock)(tmText, {
                          key: 0,
                          "font-size": 30,
                          dark: (0, import_vue8.unref)(isDark),
                          label: item + props.suffix
                        }, null, 8, ["dark", "label"])) : (0, import_vue8.createCommentVNode)("v-if", true),
                        props.timeType == "month" ? ((0, import_vue8.openBlock)(), (0, import_vue8.createBlock)(tmText, {
                          key: 1,
                          "font-size": 30,
                          dark: (0, import_vue8.unref)(isDark),
            ...
            (0, import_vue8.unref)(isDark) ? ((0, import_vue8.openBlock)(), (0, import_vue8.createElementBlock)("view", {
              key: 0,
              userInteractionEnabled: false,
              class: "top absolute l-0 t-0",
              style: (0, import_vue8.normalizeStyle)({ height: (0, import_vue8.unref)(maskHeight) + "px", width: maskWidth.value + "px" })
            }, null, 4)) : (0, import_vue8.createCommentVNode)("v-if", true),
            (0, import_vue8.unref)(isDark) ? ((0, import_vue8.openBlock)(), (0, import_vue8.createElementBlock)("view", {
              key: 1,
              userInteractionEnabled: false,
  ...
  var timePanelVue = /* @__PURE__ */ _export_sfc(_sfc_main$2, [["styles", [_style_06]], ["__file", "F:/CoinQT/CoinQT_app/tmui/components/tm-time-view/time-panel.vue"]]);
  var _sfc_main$12 = /* @__PURE__ */ (0, import_vue8.defineComponent)({
    __name: "tm-time-view",
    props: {
      modelValue: {
    ...
    setup(__props, { expose, emit: emits }) {
      ...
      const DayJs = dayjs;
      const _nowtime = (0, import_vue8.ref)(DayJs(props.defaultValue).isValid() ? DayJs(props.defaultValue) : DayJs());
      const _nowtimeValue = (0, import_vue8.computed)(() => _nowtime.value.format());
      const _startTime = (0, import_vue8.computed)(() => {
        return DayJs(props.start).isValid() ? DayJs(props.start).format() : DayJs("2008/01/01 00:00:00").format();
      });
      const _endTime = (0, import_vue8.computed)(() => {
        return DayJs(props.end).isValid() ? DayJs(props.end).format() : DayJs().format();
      });
      const showCol = (0, import_vue8.computed)(() => props.showDetail);
      function setNowtime(data, type) {
        let d = DayJs((0, import_vue8.toRaw)(_nowtime.value));
        const old = _nowtimeValue.value;
        _nowtime.value = DayJs(d[type](data));
        if (isDisabledDate(_nowtime.value.format())) {
          (0, import_vue8.nextTick)(() => _nowtime.value = DayJs(old));
          return;
        }
      ...
      (0, import_vue8.watch)(() => props.modelValue, (newval, oldval) => {
      ...
      return (_ctx, _cache) => {
        return (0, import_vue8.openBlock)(), (0, import_vue8.createElementBlock)("view", {
          ...
          (0, import_vue8.unref)(showCol).year ? ((0, import_vue8.openBlock)(), (0, import_vue8.createBlock)(timePanelVue, {
            key: 0,
            suffix: props.showSuffix.year,
            height: props.height,
            disabledDate: props.disabledDate,
            "time-type": (0, import_vue8.unref)(timeDetailType).year,
            start: (0, import_vue8.unref)(_startTime),
            end: (0, import_vue8.unref)(_endTime),
            nowtime: (0, import_vue8.unref)(_nowtimeValue),
            class: "flex-1"
          }, null, 8, ["suffix", "height", "disabledDate", "time-type", "start", "end", "nowtime"])) : (0, import_vue8.createCommentVNode)("v-if", true),
          (0, import_vue8.unref)(showCol).month ? ((0, import_vue8.openBlock)(), (0, import_vue8.createBlock)(timePanelVue, {
            key: 1,
            suffix: props.showSuffix.month,
            height: props.height,
            disabledDate: props.disabledDate,
            "time-type": (0, import_vue8.unref)(timeDetailType).month,
            start: (0, import_vue8.unref)(_startTime),
            end: (0, import_vue8.unref)(_endTime),
            nowtime: (0, import_vue8.unref)(_nowtimeValue),
            class: "flex-1"
          }, null, 8, ["suffix", "height", "disabledDate", "time-type", "start", "end", "nowtime"])) : (0, import_vue8.createCommentVNode)("v-if", true),
          (0, import_vue8.unref)(showCol).day ? ((0, import_vue8.openBlock)(), (0, import_vue8.createBlock)(timePanelVue, {
            key: 2,
            suffix: props.showSuffix.day,
            height: props.height,
            disabledDate: props.disabledDate,
            "time-type": (0, import_vue8.unref)(timeDetailType).day,
            start: (0, import_vue8.unref)(_startTime),
            end: (0, import_vue8.unref)(_endTime),
            nowtime: (0, import_vue8.unref)(_nowtimeValue),
            class: "flex-1"
          }, null, 8, ["suffix", "height", "disabledDate", "time-type", "start", "end", "nowtime"])) : (0, import_vue8.createCommentVNode)("v-if", true),
          (0, import_vue8.unref)(showCol).hour ? ((0, import_vue8.openBlock)(), (0, import_vue8.createBlock)(timePanelVue, {
            key: 3,
            suffix: props.showSuffix.hour,
            height: props.height,
            disabledDate: props.disabledDate,
            "time-type": (0, import_vue8.unref)(timeDetailType).hour,
            start: (0, import_vue8.unref)(_startTime),
            end: (0, import_vue8.unref)(_endTime),
            nowtime: (0, import_vue8.unref)(_nowtimeValue),
            class: "flex-1"
          }, null, 8, ["suffix", "height", "disabledDate", "time-type", "start", "end", "nowtime"])) : (0, import_vue8.createCommentVNode)("v-if", true),
          (0, import_vue8.unref)(showCol).minute ? ((0, import_vue8.openBlock)(), (0, import_vue8.createBlock)(timePanelVue, {
            key: 4,
            suffix: props.showSuffix.minute,
            height: props.height,
            disabledDate: props.disabledDate,
            "time-type": (0, import_vue8.unref)(timeDetailType).minute,
            start: (0, import_vue8.unref)(_startTime),
            end: (0, import_vue8.unref)(_endTime),
            nowtime: (0, import_vue8.unref)(_nowtimeValue),
            class: "flex-1"
          }, null, 8, ["suffix", "height", "disabledDate", "time-type", "start", "end", "nowtime"])) : (0, import_vue8.createCommentVNode)("v-if", true),
          (0, import_vue8.unref)(showCol).second ? ((0, import_vue8.openBlock)(), (0, import_vue8.createBlock)(timePanelVue, {
            key: 5,
            suffix: props.showSuffix.second,
            height: props.height,
            disabledDate: props.disabledDate,
            "time-type": (0, import_vue8.unref)(timeDetailType).second,
            start: (0, import_vue8.unref)(_startTime),
            end: (0, import_vue8.unref)(_endTime),
            nowtime: (0, import_vue8.unref)(_nowtimeValue),
            class: "flex-1"
  ...
  var tmTimeView = /* @__PURE__ */ _export_sfc(_sfc_main$12, [["__file", "F:/CoinQT/CoinQT_app/tmui/components/tm-time-view/tm-time-view.vue"]]);
  var _sfc_main8 = /* @__PURE__ */ (0, import_vue8.defineComponent)({
    ...
    setup(__props, { emit: emits }) {
      ...
      const drawer = (0, import_vue8.ref)(null);
      const _show = (0, import_vue8.ref)(props.show);
      const isConfirm = (0, import_vue8.ref)(false);
      const _value = (0, import_vue8.ref)(props.defaultValue);
      const _strvalue = (0, import_vue8.ref)("");
      ...
      const dHeight = (0, import_vue8.computed)(() => {
        return props.height + sysinfo.value.bottom + 80;
      });
      return (_ctx, _cache) => {
        return (0, import_vue8.openBlock)(), (0, import_vue8.createBlock)(tmDrawer, {
          disabbleScroll: true,
          round: props.round,
          ref_key: "drawer",
          ref: drawer,
          height: (0, import_vue8.unref)(dHeight),
          ...
          default: (0, import_vue8.withCtx)(() => [
            (0, import_vue8.createVNode)(tmTimeView, {
              height: (0, import_vue8.unref)(dHeight) - 230,
            ...
            (0, import_vue8.createElementVNode)("view", {
              style: (0, import_vue8.normalizeStyle)({ height: (0, import_vue8.unref)(sysinfo).bottom + "px" })
            }, null, 4)
          ]),
          _: 1
  ...
  var tmTimePicker = /* @__PURE__ */ _export_sfc(_sfc_main8, [["__file", "F:/CoinQT/CoinQT_app/tmui/components/tm-time-picker/tm-time-picker.vue"]]);
  ...
  var _sfc_main9 = /* @__PURE__ */ (0, import_vue9.defineComponent)({
    ...
    setup(__props) {
      ...
      const props = __props;
      const store = useTmpiniaStore();
      const borderDir = (0, import_vue9.computed)(() => props.vertical ? "left" : "bottom");
      ...
      const _realColor = (0, import_vue9.computed)(() => props.realColor);
      const isDark = (0, import_vue9.computed)(() => computedDark(__spreadProps9(__spreadValues9({}, props), { borderDirection: borderDir.value }), tmcfg.value));
      const tmcomputed = (0, import_vue9.computed)(() => computedTheme(__spreadProps9(__spreadValues9({}, props), { borderDirection: borderDir.value }), isDark.value, tmcfg.value));
      return (_ctx, _cache) => {
        return (0, import_vue9.openBlock)(), (0, import_vue9.createElementBlock)("view", { renderWhole: true }, [
          !(0, import_vue9.unref)(_label) && props.vertical ? ((0, import_vue9.openBlock)(), (0, import_vue9.createElementBlock)("view", {
            key: 0,
            style: (0, import_vue9.normalizeStyle)([{ backgroundColor: (0, import_vue9.unref)(_realColor) ? (0, import_vue9.unref)(tmcomputed).color : (0, import_vue9.unref)(tmcomputed).border }, props.vertical ? { width: props.border + "rpx", height: props.height + "rpx" } : ""]),
            class: (0, import_vue9.normalizeClass)([props.vertical ? `mx-${props.margin[0]}` : `my-${props.margin[1]}`])
          }, null, 6)) : (0, import_vue9.createCommentVNode)("v-if", true),
          (0, import_vue9.unref)(_label) && !props.vertical ? ((0, import_vue9.openBlock)(), (0, import_vue9.createElementBlock)("view", {
            key: 1,
            class: "flex flex-row flex-center"
          }, [
            (0, import_vue9.createElementVNode)("view", {
              style: (0, import_vue9.normalizeStyle)([(0, import_vue9.unref)(tmcomputed) ? { backgroundColor: (0, import_vue9.unref)(_realColor) ? (0, import_vue9.unref)(tmcomputed).color : (0, import_vue9.unref)(tmcomputed).border, height: props.border + "rpx" } : ""]),
              class: (0, import_vue9.normalizeClass)([`my-${props.margin[1]}`, __props.align == "left" ? "flex-2" : "", __props.align == "right" ? "flex-10" : "", __props.align == "center" ? "flex-1" : ""])
            }, null, 6),
            props.label ? ((0, import_vue9.openBlock)(), (0, import_vue9.createElementBlock)("view", {
              key: 0,
              class: (0, import_vue9.normalizeClass)([(0, import_vue9.unref)(isDark) ? "opacity-4" : ""])
            }, [
            ...
            ], 2)) : (0, import_vue9.createCommentVNode)("v-if", true),
            (0, import_vue9.createElementVNode)("view", {
              style: (0, import_vue9.normalizeStyle)([(0, import_vue9.unref)(tmcomputed) ? { backgroundColor: (0, import_vue9.unref)(_realColor) ? (0, import_vue9.unref)(tmcomputed).color : (0, import_vue9.unref)(tmcomputed).border, height: props.border + "rpx" } : ""]),
              class: (0, import_vue9.normalizeClass)([`my-${props.margin[1]}`, __props.align == "left" ? "flex-10" : "", __props.align == "right" ? "flex-2" : "", __props.align == "center" ? "flex-1" : ""])
            }, null, 6)
          ...
          !(0, import_vue9.unref)(_label) && !props.vertical ? ((0, import_vue9.openBlock)(), (0, import_vue9.createElementBlock)("view", {
            ...
            (0, import_vue9.createElementVNode)("view", {
              class: (0, import_vue9.normalizeClass)(["flex-1", [`my-${props.margin[1]}`]]),
              style: (0, import_vue9.normalizeStyle)([(0, import_vue9.unref)(tmcomputed) ? { backgroundColor: (0, import_vue9.unref)(_realColor) ? (0, import_vue9.unref)(tmcomputed).color : (0, import_vue9.unref)(tmcomputed).border, height: props.border + "rpx" } : ""])
            }, null, 6)
          ])) : (0, import_vue9.createCommentVNode)("v-if", true)
        ]);
  ...
  var tmDivider = /* @__PURE__ */ _export_sfc(_sfc_main9, [["__file", "F:/CoinQT/CoinQT_app/tmui/components/tm-divider/tm-divider.vue"]]);
  ...
  var _sfc_main10 = /* @__PURE__ */ (0, import_vue10.defineComponent)({
    ...
    setup(__props, { emit: emits }) {
      var _a2, _b2, _c;
      const props = __props;
      const aniplay = (0, import_vue10.ref)(null);
      ...
      const img_width = (0, import_vue10.computed)(() => {
        return props.width;
      });
      const img_height = (0, import_vue10.computed)(() => {
        return props.height - props.padding[1];
      });
      const img_src = (0, import_vue10.computed)(() => props.src);
      const loading = (0, import_vue10.ref)(true);
      const error = (0, import_vue10.ref)(false);
      const isRmove = (0, import_vue10.ref)(false);
      ...
      const ImagGrupList = (0, import_vue10.inject)("ImagGrupList", (0, import_vue10.computed)(() => []));
      ...
      return (_ctx, _cache) => {
        return !isRmove.value ? ((0, import_vue10.openBlock)(), (0, import_vue10.createBlock)(tmTranslate, {
          key: 0,
          width: (0, import_vue10.unref)(img_width) + props.padding[0] * 2 + props.unit,
          onEnd: aniEnd,
          ref_key: "aniplay",
          ref: aniplay,
          autoPlay: false,
          ...
          default: (0, import_vue10.withCtx)(() => [
            (0, import_vue10.createVNode)(tmSheet, {
              color: props.color,
              transprent: props.transprent,
              margin: props.margin,
              round: props.round,
              ...
              class: (0, import_vue10.normalizeClass)(["round-" + props.round]),
              width: (0, import_vue10.unref)(img_width) - props.padding[0] * 2,
              unit: props.unit
            }, {
              default: (0, import_vue10.withCtx)(() => [
                (0, import_vue10.createElementVNode)("view", {
                  class: (0, import_vue10.normalizeClass)([`pb-${props.padding[1]}`])
                }, [
                  loading.value ? ((0, import_vue10.openBlock)(), (0, import_vue10.createElementBlock)("u-image", {
                    key: 0,
                    src: (0, import_vue10.unref)(img_src),
                    style: { "width": "10px", "height": "10px", "opacity": "0", "transform": "translateX(1200px)" },
                    onLoad: imageLoad,
                    onError: imageError,
                    mode: "scaleToFill"
                  }, null, 40, ["src"])) : (0, import_vue10.createCommentVNode)("v-if", true),
                  !loading.value && !error.value ? ((0, import_vue10.openBlock)(), (0, import_vue10.createElementBlock)("u-image", {
                    key: 1,
                    showMenuByLongpress: props.showMenuByLongPress,
                    onClick: imageClick,
                    class: (0, import_vue10.normalizeClass)(["round-" + props.round]),
                    src: (0, import_vue10.unref)(img_src),
                    style: (0, import_vue10.normalizeStyle)([{ width: (0, import_vue10.unref)(img_width) + props.unit, height: (0, import_vue10.unref)(img_height) + props.unit }]),
                    mode: props.model
                  }, null, 14, ["showMenuByLongpress", "src", "mode"])) : (0, import_vue10.createCommentVNode)("v-if", true),
                  loading.value && !error.value ? ((0, import_vue10.openBlock)(), (0, import_vue10.createElementBlock)("view", {
                    key: 2,
                    style: (0, import_vue10.normalizeStyle)([{ width: (0, import_vue10.unref)(img_width) + props.unit, height: (0, import_vue10.unref)(img_height) + props.unit }]),
                    class: "flex flex-center opacity-3"
                  }, [
                    props.showLoad ? ((0, import_vue10.openBlock)(), (0, import_vue10.createBlock)(tmIcon, {
                      key: 0,
                      "font-size": 26,
                      spin: "",
                      name: "tmicon-loading"
                  ...
                  !loading.value && error.value ? ((0, import_vue10.openBlock)(), (0, import_vue10.createElementBlock)("view", {
                    ...
                    (0, import_vue10.createVNode)(tmIcon, { name: "tmicon-exclamation-circle" }),
                  ...
                  (0, import_vue10.createCommentVNode)(" extra "),
                  props.extra ? ((0, import_vue10.openBlock)(), (0, import_vue10.createElementBlock)("view", {
                    key: 4,
                    onClick: (0, import_vue10.withModifiers)(imageClick, ["stop"]),
                    class: (0, import_vue10.normalizeClass)([
                      props.extraPosition == "in" ? "absolute l-0 b-0 zIndex-5" : "",
                      "flex flex-col flex-col-bottom-start"
                    ]),
                    style: (0, import_vue10.normalizeStyle)([
                      props.extra && props.extraPosition == "in" ? { height: (0, import_vue10.unref)(img_height) + props.unit, width: (0, import_vue10.unref)(img_width) + props.unit } : "",
                      props.extra && props.extraPosition == "out" ? { width: (0, import_vue10.unref)(img_width) + props.unit } : ""
                    ])
                  }, [
                    (0, import_vue10.renderSlot)(_ctx.$slots, "extra")
                  ], 14, ["onClick"])) : (0, import_vue10.createCommentVNode)("v-if", true),
                  (0, import_vue10.createCommentVNode)(" delete \u5C55\u793A\u5220\u9664\u6309\u94AE\u3002 "),
                  props.delete ? ((0, import_vue10.openBlock)(), (0, import_vue10.createElementBlock)("view", {
                    key: 5,
                    class: "absolute r-10 t-10 flex flex-col flex-col-center-end zIndex-10",
                    style: (0, import_vue10.normalizeStyle)([props.delete ? { width: (0, import_vue10.unref)(img_width) + props.unit } : ""])
                  }, [
          ...
          _: 3
        }, 8, ["width"])) : (0, import_vue10.createCommentVNode)("v-if", true);
      };
    }
  });
  var tmImage = /* @__PURE__ */ _export_sfc(_sfc_main10, [["__file", "F:/CoinQT/CoinQT_app/tmui/components/tm-image/tm-image.vue"]]);
  ...
  var _sfc_main11 = /* @__PURE__ */ (0, import_vue11.defineComponent)({
    ...
    setup(__props, { emit: emits }) {
      ...
      const _computedValue = (0, import_vue11.computed)(() => props);
      return (_ctx, _cache) => {
        return (0, import_vue11.openBlock)(), (0, import_vue11.createElementBlock)("view", {
          ...
          (0, import_vue11.createVNode)(tmSheet, {
            ...
            default: (0, import_vue11.withCtx)(() => [
              (0, import_vue11.createElementVNode)("view", {
                ...
                class: (0, import_vue11.normalizeClass)(["flex flex-row flex-row-center-center", [(0, import_vue11.unref)(_computedValue).url ? "url" : ""]])
              }, [
                (0, import_vue11.unref)(_computedValue).showAvatar ? ((0, import_vue11.openBlock)(), (0, import_vue11.createElementBlock)("view", {
                  key: 0,
                  style: (0, import_vue11.normalizeStyle)({
                    width: `${(0, import_vue11.unref)(_computedValue).avatarSize}rpx`,
                    height: `${(0, import_vue11.unref)(_computedValue).avatarSize}rpx`
                  }),
                  class: "flex flex-row flex-row-center-center"
                }, [
                  (0, import_vue11.renderSlot)(_ctx.$slots, "avatar", {}, () => [
                    (0, import_vue11.createVNode)(tmImage, {
                      round: (0, import_vue11.unref)(_computedValue).avatarRound,
                      width: (0, import_vue11.unref)(_computedValue).avatarSize,
                      height: (0, import_vue11.unref)(_computedValue).avatarSize,
                      src: (0, import_vue11.unref)(_computedValue).avatar
                ...
                (0, import_vue11.createElementVNode)("view", {
                  ...
                  (0, import_vue11.createElementVNode)("view", null, [
                    (0, import_vue11.createElementVNode)("view", {
                      class: (0, import_vue11.normalizeClass)(["flex flex-5 flex-col", [(0, import_vue11.unref)(_computedValue).showAvatar ? "pl-24" : ""]])
                    }, [
                      (0, import_vue11.renderSlot)(_ctx.$slots, "title", {}, () => [
                        (0, import_vue11.createVNode)(tmText, {
                          fontSize: (0, import_vue11.unref)(_computedValue).titleFontSize,
                          label: (0, import_vue11.unref)(_computedValue).title
                        }, null, 8, ["fontSize", "label"])
                      ]),
                      (0, import_vue11.renderSlot)(_ctx.$slots, "label", {}, () => [
                        (0, import_vue11.unref)(_computedValue).label ? ((0, import_vue11.openBlock)(), (0, import_vue11.createElementBlock)("view", {
                          key: 0,
                          class: "mt-6"
                        }, [
                          (0, import_vue11.createVNode)(tmText, {
                            color: (0, import_vue11.unref)(_computedValue).labelColor,
                            fontSize: 22,
                            label: (0, import_vue11.unref)(_computedValue).label
                          }, null, 8, ["color", "label"])
                  ...
                  (0, import_vue11.createElementVNode)("view", {
                    ...
                    (0, import_vue11.renderSlot)(_ctx.$slots, "rightText", {}, () => [
                      (0, import_vue11.unref)(_computedValue).rightText ? ((0, import_vue11.openBlock)(), (0, import_vue11.createBlock)(tmText, {
                        key: 0,
                        _class: "nowrap pr-12",
                        color: (0, import_vue11.unref)(_computedValue).rightColor,
                        fontSize: (0, import_vue11.unref)(_computedValue).rightTextSize,
                        label: (0, import_vue11.unref)(_computedValue).rightText
                      }, null, 8, ["color", "fontSize", "label"])) : (0, import_vue11.createCommentVNode)("v-if", true)
                    ]),
                    (0, import_vue11.renderSlot)(_ctx.$slots, "right", {}, () => [
                      (0, import_vue11.unref)(_computedValue).rightIcon ? ((0, import_vue11.openBlock)(), (0, import_vue11.createBlock)(tmIcon, {
                        key: 0,
                        _class: "opacity-3",
                        name: (0, import_vue11.unref)(_computedValue).rightIcon,
                        fontSize: 22
                      }, null, 8, ["name"])) : (0, import_vue11.createCommentVNode)("v-if", true)
                    ])
                  ])
                ])
              ], 2)
          ...
          (0, import_vue11.unref)(_computedValue).bottomBorder ? ((0, import_vue11.openBlock)(), (0, import_vue11.createBlock)(tmDivider, {
            key: 0,
            margin: [0, 0],
            style: (0, import_vue11.normalizeStyle)({
              left: `${(0, import_vue11.unref)(_computedValue).avatar !== "" ? (0, import_vue11.unref)(_computedValue).avatarSize + (0, import_vue11.unref)(_computedValue).margin[0] : 0}rpx`
            })
          }, null, 8, ["style"])) : (0, import_vue11.createCommentVNode)("v-if", true)
        ]);
      };
    }
  });
  var tmCell = /* @__PURE__ */ _export_sfc(_sfc_main11, [["styles", [_style_07]], ["__file", "F:/CoinQT/CoinQT_app/tmui/components/tm-cell/tm-cell.vue"]]);
  ...
  var _sfc_main12 = /* @__PURE__ */ (0, import_vue12.defineComponent)({
    __name: "time",
    setup(__props) {
      const dateStr = (0, import_vue12.ref)("");
      const showdate = (0, import_vue12.ref)(false);
      return (_ctx, _cache) => {
        return (0, import_vue12.openBlock)(), (0, import_vue12.createElementBlock)("scroll-view", {
          scrollY: true,
          showScrollbar: true,
          ...
          (0, import_vue12.createVNode)(tmApp, null, {
            default: (0, import_vue12.withCtx)(() => [
              (0, import_vue12.createVNode)(tmSheet, null, {
                default: (0, import_vue12.withCtx)(() => [
                  ...
                  (0, import_vue12.createVNode)(tmDivider),
                  (0, import_vue12.createVNode)(tmTimeView)
                ]),
                _: 1
              }),
              (0, import_vue12.createVNode)(tmCell, {
                onClick: _cache[0] || (_cache[0] = ($event) => showdate.value = true),
                title: "\u8BF7\u9009\u62E9\u65F6\u95F4",
                "right-text": dateStr.value || "\u8BF7\u9009\u62E9"
              }, null, 8, ["right-text"]),
              (0, import_vue12.createVNode)(tmTimePicker, {
  ...
  var time = /* @__PURE__ */ _export_sfc(_sfc_main12, [["__file", "F:/CoinQT/CoinQT_app/pages/form/time.nvue"]]);

  // <stdin>
  var webview = plus.webview.currentWebview();
  if (webview) {
    const __pageId = parseInt(webview.id);
    const __pagePath = "pages/form/time";
    let __pageQuery = {};
    try {
    ...
    time.mpType = "page";
    const app = Vue.createPageApp(time, { $store: getApp({ allowDefault: true }).$store, __pageId, __pagePath, __pageQuery });
    app.provide("__globalStyles", Vue.useCssStyles([...__uniConfig.styles, ...time.styles || []]));
    app.mount("#root");
  }
})();
