...
(() => {
  ...
  // F:/CoinQT/CoinQT_app/unpackage/dist/dev/.nvue/pages/form/weekbar.js
  ...
  var _sfc_main$12 = /* @__PURE__ */ (0, import_vue4.defineComponent)({
    ...
    setup(__props, { emit: emits }) {
      ...
      const _value = (0, import_vue4.ref)(DayJs(props.defaultValue).isValid() ? DayJs(props.defaultValue).format("YYYY-MM-DD") : DayJs().format("YYYY-MM-DD"));
      const nowWeek = (0, import_vue4.ref)(getweek_s_e("now", _value.value));
      const nowWeekDayArray = (0, import_vue4.computed)(() => getAllDay(nowWeek.value[0], nowWeek.value[1]));
      const weekStr = (0, import_vue4.ref)(["\u5468\u4E00", "\u5468\u4E8C", "\u5468\u4E09", "\u5468\u56DB", "\u5468\u4E94", "\u5468\u516D", "\u5468\u65E5"]);
      const weekStrIndex = {
        0: "\u5468\u65E5",
        1: "\u5468\u4E00",
        2: "\u5468\u4E8C",
      ...
      return (_ctx, _cache) => {
        return (0, import_vue4.openBlock)(), (0, import_vue4.createBlock)(tmSheet, {
          ...
          default: (0, import_vue4.withCtx)(() => [
            (0, import_vue4.createElementVNode)("view", { class: "flex flex-row flex-row-center-center" }, [
              __props.showArrow ? ((0, import_vue4.openBlock)(), (0, import_vue4.createElementBlock)("view", {
                key: 0,
                onClick: (0, import_vue4.withModifiers)(prevWeek, ["stop"]),
                class: "opacity-7"
              }, [
              ...
              ], 8, ["onClick"])) : (0, import_vue4.createCommentVNode)("v-if", true),
              (0, import_vue4.createElementVNode)("view", {
                class: "flex-1 flex flex-row",
                style: { "width": "0px" }
              }, [
                ((0, import_vue4.openBlock)(true), (0, import_vue4.createElementBlock)(import_vue4.Fragment, null, (0, import_vue4.renderList)((0, import_vue4.unref)(nowWeekDayArray), (item, index) => {
                  return (0, import_vue4.openBlock)(), (0, import_vue4.createElementBlock)("view", {
                    onClick: (0, import_vue4.withModifiers)(($event) => changeDate(item.date), ["stop"]),
                    class: (0, import_vue4.normalizeClass)([[item.date == _value.value ? "" : "opacity-7"], "flex-1 flex flex-col flex-col-center-center"]),
                    key: index
                  }, [
              ...
              __props.showArrow ? ((0, import_vue4.openBlock)(), (0, import_vue4.createElementBlock)("view", {
                key: 1,
                onClick: (0, import_vue4.withModifiers)(nexWeek, ["stop"]),
                class: "opacity-7"
              }, [
                (0, import_vue4.createVNode)(tmIcon, {
                  "font-size": 28,
  ...
  var tmWeekbar = /* @__PURE__ */ _export_sfc(_sfc_main$12, [["__file", "F:/CoinQT/CoinQT_app/tmui/components/tm-weekbar/tm-weekbar.vue"]]);
        ...
        return (0, import_vue4.openBlock)(), (0, import_vue4.createElementBlock)("scroll-view", {
          ...
          (0, import_vue4.createVNode)(tmApp, null, {
            default: (0, import_vue4.withCtx)(() => [
              ...
              (0, import_vue4.createVNode)(tmWeekbar),
              (0, import_vue4.createVNode)(tmWeekbar, {
                followTheme: false,
                activeColor: "white",
                color: "red"
  ...
  var weekbar = /* @__PURE__ */ _export_sfc(_sfc_main4, [["__file", "F:/CoinQT/CoinQT_app/pages/form/weekbar.nvue"]]);

  // <stdin>
  var webview = plus.webview.currentWebview();
  if (webview) {
    const __pageId = parseInt(webview.id);
    const __pagePath = "pages/form/weekbar";
    let __pageQuery = {};
    try {
    ...
    weekbar.mpType = "page";
    const app = Vue.createPageApp(weekbar, { $store: getApp({ allowDefault: true }).$store, __pageId, __pagePath, __pageQuery });
    app.provide("__globalStyles", Vue.useCssStyles([...__uniConfig.styles, ...weekbar.styles || []]));
    app.mount("#root");
  }
})();
