...
(() => {
  ...
  // F:/CoinQT/CoinQT_app/unpackage/dist/dev/.nvue/pages/form/cascader.js
  ...
  var _sfc_main$2 = /* @__PURE__ */ (0, import_vue6.defineComponent)({
    ...
    setup(__props, { emit: emits }) {
      ...
      const ParentActivedLs = (0, import_vue6.inject)("tmCascaderValue", (0, import_vue6.computed)(() => []));
      const _value = (0, import_vue6.computed)(() => props.data);
      const _activeId = (0, import_vue6.ref)("");
      function queryNode() {
        let xd = ParentActivedLs.value.filter((el) => el == _value.value.id);
        _activeId.value = xd.length > 0 ? xd[0] : "";
      }
      (0, import_vue6.watchEffect)(() => queryNode());
      const isSelected = (0, import_vue6.computed)(() => _activeId.value == _value.value.id);
      function nodeClick() {
        var _a22, _b22, _c2;
      ...
      return (_ctx, _cache) => {
        return (0, import_vue6.openBlock)(), (0, import_vue6.createElementBlock)("view", {
          onClick: (0, import_vue6.withModifiers)(nodeClick, ["stop"]),
          class: (0, import_vue6.normalizeClass)(["flex px-24", [(0, import_vue6.unref)(_value)["disabled"] ? "opacity-5" : ""]]),
          renderWhole: true
        }, [
          (0, import_vue6.createElementVNode)("view", {
            ...
            (0, import_vue6.createVNode)(tmText, {
              followTheme: (0, import_vue6.unref)(isSelected) ? props.followTheme : false,
              color: (0, import_vue6.unref)(isSelected) ? props.color : "",
              label: (0, import_vue6.unref)(_value).text
            }, null, 8, ["followTheme", "color", "label"]),
            (0, import_vue6.createElementVNode)("view", {
              fontSize: 30,
              class: "flex flex-row flex-row-center-end"
            }, [
              (0, import_vue6.unref)(isSelected) ? ((0, import_vue6.openBlock)(), (0, import_vue6.createBlock)(tmIcon, {
                key: 0,
                followTheme: (0, import_vue6.unref)(isSelected) ? props.followTheme : false,
                "font-size": 28,
                color: (0, import_vue6.unref)(isSelected) ? props.color : "",
                name: "tmicon-check"
              }, null, 8, ["followTheme", "color"])) : (0, import_vue6.createCommentVNode)("v-if", true),
              !(0, import_vue6.unref)(isSelected) && (0, import_vue6.unref)(_value)["children"] ? ((0, import_vue6.openBlock)(), (0, import_vue6.createBlock)(tmIcon, {
                key: 1,
                "font-size": 22,
  ...
  var _sfc_main$12 = /* @__PURE__ */ (0, import_vue6.defineComponent)({
    ...
    setup(__props) {
      ...
      const tmCascaderShowIndex = (0, import_vue6.inject)("tmCascaderShowIndex", (0, import_vue6.computed)(() => 0));
      const ParentActivedLs = (0, import_vue6.inject)("tmCascaderValue", (0, import_vue6.computed)(() => []));
      const nextChildData = (0, import_vue6.ref)([]);
      ...
      return (_ctx, _cache) => {
        return (0, import_vue6.openBlock)(), (0, import_vue6.createElementBlock)(import_vue6.Fragment, null, [
          (0, import_vue6.createCommentVNode)(' v-if="tmCascaderShowIndex==_level" '),
          (0, import_vue6.createElementVNode)("view", { class: "flex" }, [
            (0, import_vue6.unref)(tmCascaderShowIndex) == props.level ? ((0, import_vue6.openBlock)(), (0, import_vue6.createElementBlock)("scroll-view", {
              key: 0,
              style: (0, import_vue6.normalizeStyle)([{ height: `${props.height}rpx` }]),
              scrollY: ""
            }, [
              ((0, import_vue6.openBlock)(true), (0, import_vue6.createElementBlock)(import_vue6.Fragment, null, (0, import_vue6.renderList)((0, import_vue6.unref)(_value), (item, index) => {
                return (0, import_vue6.openBlock)(), (0, import_vue6.createElementBlock)("view", { key: index }, [
                  (0, import_vue6.createVNode)(nodeCellVue, {
                    followTheme: props.followTheme,
                    level: props.level,
                    data: item
            ...
            nextChildData.value.length > 0 ? ((0, import_vue6.openBlock)(), (0, import_vue6.createBlock)(BaseCascader, {
              key: 1,
              followTheme: props.followTheme,
              level: _level,
              height: props.height,
            ...
            }, null, 8, ["followTheme", "height", "color", "data"])) : (0, import_vue6.createCommentVNode)("v-if", true)
          ])
        ], 2112);
      };
    }
  });
  var BaseCascader = /* @__PURE__ */ _export_sfc(_sfc_main$12, [["__file", "F:/CoinQT/CoinQT_app/tmui/components/tm-cascader/base-cascader.vue"]]);
  ...
  var _sfc_main6 = /* @__PURE__ */ (0, import_vue6.defineComponent)({
    ...
    setup(__props, { expose, emit: emits }) {
      const props = __props;
      let listData = (0, import_vue6.ref)(props.data);
      const tmCascaderName = "tmCascader";
      let save_value_obj = (0, import_vue6.ref)([]);
      const _value = (0, import_vue6.ref)("");
      const _idArrays = (0, import_vue6.ref)([]);
      const _activeIndex = (0, import_vue6.ref)(0);
      const _nowLevel = (0, import_vue6.ref)(0);
      function initNode(once = false) {
        let moisref = (0, import_vue6.isProxy)(props.modelValue) ? (0, import_vue6.toRaw)(props.modelValue) : props.modelValue;
        if (once) {
          moisref = (0, import_vue6.isProxy)(props.defaultValue) ? (0, import_vue6.toRaw)(props.defaultValue) : props.defaultValue;
        }
        ...
        if (_value.value == "" || typeof _value.value == "undefined")
          return;
        let isParent = queryNodeIsParent((0, import_vue6.toRaw)(props.data), String(_value.value), "id");
        if (isParent)
          return;
      ...
      initNode(true);
      (0, import_vue6.provide)("tmCascaderValue", (0, import_vue6.computed)(() => _idArrays.value));
      (0, import_vue6.provide)("tmCascaderShowIndex", (0, import_vue6.computed)(() => _activeIndex.value));
      function pushValue(key, level, id) {
        if (_idArrays.value.length < level) {
          _idArrays.value.push(id);
        } else {
          _idArrays.value[level] = id;
          (0, import_vue6.nextTick)(() => _idArrays.value = _idArrays.value.slice(0, level + 1));
        }
      }
      ...
      (0, import_vue6.watch)(() => props.data, () => {
        save_value_obj.value = [];
        _activeIndex.value = 0;
        _nowLevel.value = 0;
        _idArrays.value = [];
      ...
      function getValueObject() {
        ...
        let moisref = (0, import_vue6.isProxy)(props.data) ? (0, import_vue6.toRaw)(props.data) : props.data;
      ...
      return (_ctx, _cache) => {
        return (0, import_vue6.openBlock)(), (0, import_vue6.createBlock)(tmSheet, {
          color: props.color,
          class: "flex flex-col",
          height: props.height,
          padding: [0, 0]
          ...
          default: (0, import_vue6.withCtx)(() => [
            (0, import_vue6.createVNode)(tmSheet, {
              ...
              default: (0, import_vue6.withCtx)(() => [
                (0, import_vue6.createElementVNode)("view", {
                  ...
                  ((0, import_vue6.openBlock)(true), (0, import_vue6.createElementBlock)(import_vue6.Fragment, null, (0, import_vue6.renderList)(_idArrays.value, (item, index) => {
                    return (0, import_vue6.openBlock)(), (0, import_vue6.createElementBlock)("view", {
                      key: index,
                      class: "flex flex-row flex-row-center-start"
                    }, [
                      ...
                      index < _idArrays.value.length - 1 ? ((0, import_vue6.openBlock)(), (0, import_vue6.createElementBlock)("view", {
                        key: 0,
                        class: "mx-10"
                      }, [
                        (0, import_vue6.createVNode)(tmText, {
                  ...
                  _nowLevel.value == _idArrays.value.length ? ((0, import_vue6.openBlock)(), (0, import_vue6.createBlock)(tmText, {
                    key: 0,
            ...
            (0, import_vue6.createElementVNode)("view", { style: { "height": "16rpx" } }),
            __props.slotTabHeigth ? ((0, import_vue6.openBlock)(), (0, import_vue6.createElementBlock)("view", {
              key: 0,
              class: "flex flex-row flex-row-center-start"
            }, [
            ...
            (0, import_vue6.createElementVNode)("view", { style: { "height": "16rpx" } }),
            (0, import_vue6.createVNode)(BaseCascader, {
              followTheme: props.followTheme,
              color: props.activeColor,
              height: props.height - 120 - __props.slotTabHeigth,
              data: (0, import_vue6.unref)(listData)
  ...
  var tmCascader = /* @__PURE__ */ _export_sfc(_sfc_main6, [["__file", "F:/CoinQT/CoinQT_app/tmui/components/tm-cascader/tm-cascader.vue"]]);
  ...
  var _sfc_main7 = /* @__PURE__ */ (0, import_vue7.defineComponent)({
    ...
    setup(__props) {
      ...
      const testValue = (0, import_vue7.ref)([]);
      const str = (0, import_vue7.computed)(() => testValue.value.join("/"));
      ...
      return (_ctx, _cache) => {
        return (0, import_vue7.openBlock)(), (0, import_vue7.createElementBlock)("scroll-view", {
          ...
          (0, import_vue7.createVNode)(tmApp, { color: "white" }, {
            default: (0, import_vue7.withCtx)(() => [
              (0, import_vue7.createVNode)(tmSheet, null, {
                default: (0, import_vue7.withCtx)(() => [
                  ...
                  (0, import_vue7.createVNode)(tmText, {
                    label: (0, import_vue7.unref)(str) ? (0, import_vue7.unref)(str) : "\u8BF7\u9009\u62E9"
                  }, null, 8, ["label"])
                ]),
                _: 1
              }),
              (0, import_vue7.createVNode)(tmCascader, {
  ...
  var cascader = /* @__PURE__ */ _export_sfc(_sfc_main7, [["__file", "F:/CoinQT/CoinQT_app/pages/form/cascader.nvue"]]);

  // <stdin>
  var webview = plus.webview.currentWebview();
  if (webview) {
    const __pageId = parseInt(webview.id);
    const __pagePath = "pages/form/cascader";
    let __pageQuery = {};
    try {
      __pageQuery = JSON.parse(webview.__query__);
    } catch (e) {
    }
    cascader.mpType = "page";
    const app = Vue.createPageApp(cascader, { $store: getApp({ allowDefault: true }).$store, __pageId, __pagePath, __pageQuery });
    app.provide("__globalStyles", Vue.useCssStyles([...__uniConfig.styles, ...cascader.styles || []]));
    app.mount("#root");
  }
})();
