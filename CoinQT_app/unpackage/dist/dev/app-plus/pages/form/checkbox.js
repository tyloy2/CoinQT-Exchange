...
(() => {
  ...
  // F:/CoinQT/CoinQT_app/unpackage/dist/dev/.nvue/pages/form/checkbox.js
  ...
  var _sfc_main6 = /* @__PURE__ */ (0, import_vue6.defineComponent)({
    ...
    setup(__props, { expose, emit: emits }) {
      ...
      let _cacheBoxList = [];
      const _mValue = (0, import_vue6.ref)([.../* @__PURE__ */ new Set([...props.defaultValue, ...props.modelValue])]);
      ...
      const _maxChecked = (0, import_vue6.computed)(() => _mValue.value.length >= props.max);
      ...
      pushFormItem();
      (0, import_vue6.provide)("tmCheckedBoxDisabled", (0, import_vue6.computed)(() => props.disabled));
      (0, import_vue6.provide)("tmCheckedBoxVal", (0, import_vue6.computed)(() => _mValue.value));
      (0, import_vue6.provide)("tmCheckedBoxMax", _maxChecked);
      expose({ pushKey, addKey, delKey, checkBoxkeyId });
      return (_ctx, _cache) => {
        return (0, import_vue6.openBlock)(), (0, import_vue6.createElementBlock)("view", {
          class: (0, import_vue6.normalizeClass)(["flex", [props.direction == "row" ? "flex-row " : "flex-col", (0, import_vue6.unref)(_align)]]),
          style: { flexWrap: "wrap" },
          renderWhole: true
        }, [
  ...
  var tmCheckboxGroup = /* @__PURE__ */ _export_sfc(_sfc_main6, [["__file", "F:/CoinQT/CoinQT_app/tmui/components/tm-checkbox-group/tm-checkbox-group.vue"]]);
  ...
  var _sfc_main8 = /* @__PURE__ */ (0, import_vue8.defineComponent)({
    __name: "checkbox",
    setup(__props) {
      const checkboxlist = (0, import_vue8.ref)(["banner"]);
      const str = (0, import_vue8.computed)(() => checkboxlist.value.join(" "));
      const banxuan = (0, import_vue8.ref)(true);
      const allCheckbox = (0, import_vue8.ref)(false);
            ...
            default: (0, import_vue8.withCtx)(() => [
              (0, import_vue8.createVNode)(tmSheet, null, {
                default: (0, import_vue8.withCtx)(() => [
                  ...
                  (0, import_vue8.createElementVNode)("view", { class: "flex flex-row" }, [
                    (0, import_vue8.createVNode)(TmCheckbox, { label: "\u82F9\u679C" }),
              ...
              (0, import_vue8.createVNode)(tmSheet, null, {
                default: (0, import_vue8.withCtx)(() => [
                  ...
                  (0, import_vue8.createVNode)(tmDivider),
                  (0, import_vue8.createElementVNode)("view", { class: "pb-24" }, [
                    (0, import_vue8.createVNode)(tmText, {
                      label: (0, import_vue8.unref)(str) ? (0, import_vue8.unref)(str) : "\u8BF7\u9009\u62E9"
                    }, null, 8, ["label"])
                  ]),
                  (0, import_vue8.createVNode)(TmCheckbox, {
                  ...
                  (0, import_vue8.createVNode)(tmCheckboxGroup, {
              ...
              (0, import_vue8.createVNode)(tmSheet, null, {
                default: (0, import_vue8.withCtx)(() => [
                  ...
                  (0, import_vue8.createVNode)(tmDivider),
                  (0, import_vue8.createElementVNode)("view", { class: "flex flex-row flex-wrap" }, [
                    (0, import_vue8.createVNode)(TmCheckbox, {
                      size: 54,
                      fontSize: 28,
                      value: "apple",
  ...
  var checkbox = /* @__PURE__ */ _export_sfc(_sfc_main8, [["__file", "F:/CoinQT/CoinQT_app/pages/form/checkbox.nvue"]]);

  // <stdin>
  var webview = plus.webview.currentWebview();
  if (webview) {
    const __pageId = parseInt(webview.id);
    const __pagePath = "pages/form/checkbox";
    let __pageQuery = {};
    try {
