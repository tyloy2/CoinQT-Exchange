...
(() => {
  ...
  // F:/CoinQT/CoinQT_app/unpackage/dist/dev/.nvue/pages/form/picker.js
  ...
  var _style_02 = { "top": { "": { "backgroundImage": "linear-gradient(to bottom,rgba(17, 17, 17, 1),rgba(36, 36, 36, 0.6))" } }, "bottom": { "": { "backgroundImage": "linear-gradient(to top,rgba(17, 17, 17, 1),rgba(36, 36, 36, 0.6))" } } };
  var _sfc_main$12 = /* @__PURE__ */ (0, import_vue4.defineComponent)({
    __name: "picker-panel",
    props: {
      followTheme: {
        type: [Boolean],
    ...
    setup(__props, { emit: emits }) {
      ...
      const store = useTmpiniaStore();
      const isDark = (0, import_vue4.computed)(() => store.tmStore.dark);
      const _data = (0, import_vue4.computed)(() => props.data);
      const colIndex = (0, import_vue4.ref)(0);
      const showDom = (0, import_vue4.ref)(false);
      const maskHeight = (0, import_vue4.computed)(() => {
        return (uni.upx2px(props.height) - 34) / 2;
      });
      const maskWidth = (0, import_vue4.ref)(0);
      (0, import_vue4.computed)(() => {
      ...
      (0, import_vue4.onUpdated)(() => nvuegetClientRect());
      (0, import_vue4.watch)(() => props.col, () => {
        colIndex.value = props.col;
      });
      ...
      return (_ctx, _cache) => {
        const _component_picker_view_column = (0, import_vue4.resolveComponent)("picker-view-column");
        const _component_picker_view = (0, import_vue4.resolveComponent)("picker-view");
        return (0, import_vue4.openBlock)(), (0, import_vue4.createElementBlock)("view", {
          class: "flex-1 relative",
          style: (0, import_vue4.normalizeStyle)({ height: props.height + "rpx" }),
          renderWhole: true
        }, [
          (0, import_vue4.createCommentVNode)(" uniapp\u6709bug\u5728nvue\u4E0A\uFF0C\u6682\u65F6\u4E0D\u8BBE\u7F6E "),
          (0, import_vue4.createCommentVNode)(` :mask-style="isDark?'background:linear-gradient(0deg,rgba(0,0,0,0.4),rgba(0,0,0,0),rgba(0,0,0,0.4))':'background:rgba(255,255,255,0)'" `),
          showDom.value ? ((0, import_vue4.openBlock)(), (0, import_vue4.createBlock)(_component_picker_view, {
            key: 0,
            ref: "picker",
            ...
            default: (0, import_vue4.withCtx)(() => [
              (0, import_vue4.createVNode)(_component_picker_view_column, {
                style: (0, import_vue4.normalizeStyle)([{ height: props.height + "rpx" }])
              }, {
                default: (0, import_vue4.withCtx)(() => [
                  ((0, import_vue4.openBlock)(true), (0, import_vue4.createElementBlock)(import_vue4.Fragment, null, (0, import_vue4.renderList)((0, import_vue4.unref)(_data), (item, index) => {
                    return (0, import_vue4.openBlock)(), (0, import_vue4.createElementBlock)("view", {
                      class: (0, import_vue4.normalizeClass)([[item["disabled"] ? "opacity-5" : ""], "flex"]),
                      key: index,
                      style: { "justify-content": "center", "height": "34px", "align-items": "center" }
                    }, [
                      typeof item == "string" ? ((0, import_vue4.openBlock)(), (0, import_vue4.createBlock)(tmText, {
                        key: 0,
                        _class: "text-align-center",
                        "font-size": item.length > 7 ? 24 : 30,
                        dark: (0, import_vue4.unref)(isDark),
                        label: item
                      }, null, 8, ["font-size", "dark", "label"])) : (0, import_vue4.createCommentVNode)("v-if", true),
                      typeof item == "object" ? ((0, import_vue4.openBlock)(), (0, import_vue4.createBlock)(tmText, {
                        key: 1,
                        _class: "text-align-center",
            ...
            _: 1
          }, 8, ["value", "style"])) : (0, import_vue4.createCommentVNode)("v-if", true),
          (0, import_vue4.unref)(isDark) ? ((0, import_vue4.openBlock)(), (0, import_vue4.createElementBlock)("view", {
            key: 1,
            userInteractionEnabled: false,
            class: "top absolute l-0 t-0",
            style: (0, import_vue4.normalizeStyle)({ height: (0, import_vue4.unref)(maskHeight) + "px", width: maskWidth.value + "px" })
  ...
  var pickerPanelVue = /* @__PURE__ */ _export_sfc(_sfc_main$12, [["styles", [_style_02]], ["__file", "F:/CoinQT/CoinQT_app/tmui/components/tm-picker-view/picker-panel.vue"]]);
  var _sfc_main4 = /* @__PURE__ */ (0, import_vue4.defineComponent)({
    ...
    setup(__props, { emit: emits }) {
      const props = __props;
      const _colIndex = (0, import_vue4.ref)([...props.defaultValue]);
      const _data = (0, import_vue4.ref)([]);
      const _modelStr = (0, import_vue4.computed)(() => {
        let str = [];
      ...
      (0, import_vue4.watch)(() => _colIndex.value, () => {
      ...
      (0, import_vue4.watch)(() => props.columns, () => {
        _data.value = getIndexLoop(0, props.columns);
      }, { deep: true });
      (0, import_vue4.watch)(() => props.modelValue, () => {
      ...
      function pickerChange(itemindex, levelIndex) {
        return __async(this, null, function* () {
          ...
          if (isActive) {
            ...
            emits("update:modelValue", (0, import_vue4.toRaw)(_colIndex.value));
          }
        });
      }
      (0, import_vue4.nextTick)(() => {
      ...
      return (_ctx, _cache) => {
        return (0, import_vue4.openBlock)(), (0, import_vue4.createElementBlock)("view", {
          ...
          ((0, import_vue4.openBlock)(true), (0, import_vue4.createElementBlock)(import_vue4.Fragment, null, (0, import_vue4.renderList)(_data.value, (item, index) => {
            return (0, import_vue4.openBlock)(), (0, import_vue4.createBlock)(pickerPanelVue, {
              followTheme: props.followTheme,
  ...
  var tmPickerView = /* @__PURE__ */ _export_sfc(_sfc_main4, [["__file", "F:/CoinQT/CoinQT_app/tmui/components/tm-picker-view/tm-picker-view.vue"]]);
  ...
  var _sfc_main5 = /* @__PURE__ */ (0, import_vue5.defineComponent)({
    ...
    setup(__props, { expose, emit: emits }) {
      ...
      const computedHeight = (0, import_vue5.computed)(() => {
      ...
      const computedWidth = (0, import_vue5.computed)(() => {
        if (!props.width) {
          return 0;
        }
      ...
      const animationName = (0, import_vue5.computed)(() => props.name || "fade");
      (0, import_vue5.computed)(() => props.duration);
      const computedReverse = (0, import_vue5.computed)(() => props.reverse);
      const reverseAniPrefxname = (0, import_vue5.computed)(() => computedReverse.value ? "-reverse" : "");
      const animationStatus = (0, import_vue5.ref)(0);
      const tmid = (0, import_vue5.ref)(Number(uni.$tm.u.getUid(3)));
      const isLoadEl = (0, import_vue5.ref)(false);
      const animationData = (0, import_vue5.ref)(null);
      (0, import_vue5.watch)(() => props.initByWechat, () => {
        reset();
      });
      function init() {
      ...
      function play() {
        ...
        (0, import_vue5.nextTick)(function() {
      ...
      return (_ctx, _cache) => {
        return (0, import_vue5.openBlock)(), (0, import_vue5.createElementBlock)("view", {
          ref: "bodywk",
          onClick: hanlder,
          class: (0, import_vue5.normalizeClass)([(0, import_vue5.unref)(customClass), "overflow"]),
          style: (0, import_vue5.normalizeStyle)([
            (0, import_vue5.unref)(computedHeight) ? { height: (0, import_vue5.unref)(computedHeight) } : "",
            (0, import_vue5.unref)(computedWidth) ? { width: (0, import_vue5.unref)(computedWidth) } : "",
            (0, import_vue5.unref)(customCSSStyle)
          ]),
          renderWhole: true
        }, [
          isLoadEl.value ? ((0, import_vue5.openBlock)(), (0, import_vue5.createElementBlock)("view", {
            key: 0,
            ref: "nvueElAni",
            animation: animationData.value,
            class: (0, import_vue5.normalizeClass)([
              "flex-col flex trani",
              (0, import_vue5.unref)(animationName) + (0, import_vue5.unref)(reverseAniPrefxname),
              (0, import_vue5.unref)(customClass)
            ])
          }, [
            (0, import_vue5.renderSlot)(_ctx.$slots, "default")
          ], 10, ["animation"])) : (0, import_vue5.createCommentVNode)("v-if", true)
        ], 6);
      };
    }
  });
  var tmTranslate = /* @__PURE__ */ _export_sfc(_sfc_main5, [["styles", [_style_03]], ["__file", "F:/CoinQT/CoinQT_app/tmui/components/tm-translate/tm-translate.vue"]]);
  ...
  var _sfc_main6 = /* @__PURE__ */ (0, import_vue6.defineComponent)({
    ...
    setup(__props, { emit: emits }) {
      ...
      const isDark = (0, import_vue6.computed)(() => computedDark(props, tmcfg.value));
      (0, import_vue6.computed)(() => computedTheme(props, isDark.value, tmcfg.value));
      function clickhandle(e) {
        emits("click", e);
      }
      const appTextColor = (0, import_vue6.inject)("appTextColor", (0, import_vue6.computed)(() => void 0));
      const textColor = (0, import_vue6.computed)(() => {
        if (props.followTheme && store.tmStore.color)
          return store.tmStore.color;
        let isColorHex = tool.isCssColor(props.color);
        if (isColorHex)
      ...
      const fontSizeComputed = (0, import_vue6.computed)(() => {
      ...
      const isImg = (0, import_vue6.computed)(() => {
      ...
      const prefx = (0, import_vue6.computed)(() => {
        let prefix = props.name.split("-")[0];
        return prefix;
      });
      const iconComputed = (0, import_vue6.computed)(() => {
        if (isImg.value)
          return props.name;
      ...
      const spinComputed = (0, import_vue6.computed)(() => props.spin);
      const custom_space_size = (0, import_vue6.inject)("custom_space_size", [0, 0]);
      (0, import_vue6.computed)(() => Math.ceil(props.fontSize || 34) + custom_space_size[0]);
      (0, import_vue6.computed)(() => Math.ceil(props.fontSize || 34) + custom_space_size[1]);
      ...
      (0, import_vue6.watch)(spinComputed, () => {
      ...
      return (_ctx, _cache) => {
        return (0, import_vue6.openBlock)(), (0, import_vue6.createElementBlock)("view", {
          ...
          style: (0, import_vue6.normalizeStyle)([{
            marginRight: (0, import_vue6.unref)(custom_space_size)[0] + "rpx",
            marginBottom: (0, import_vue6.unref)(custom_space_size)[1] + "rpx"
          }])
        }, [
          !(0, import_vue6.unref)(isImg) ? ((0, import_vue6.openBlock)(), (0, import_vue6.createElementBlock)("u-text", {
            key: 0,
            renderWhole: true,
            ref: "icon",
            onClick: clickhandle,
            onLongpress: _cache[0] || (_cache[0] = ($event) => emits("longpress", $event)),
            class: (0, import_vue6.normalizeClass)([(0, import_vue6.unref)(spinComputed) ? "spin" : "", "text-size-n d-inline-block ", "tmicon", (0, import_vue6.unref)(customClass)]),
            style: (0, import_vue6.normalizeStyle)([{ fontFamily: "tmicon", color: (0, import_vue6.unref)(textColor) }, (0, import_vue6.unref)(fontSizeComputed), (0, import_vue6.unref)(customCSSStyle)])
          }, (0, import_vue6.toDisplayString)((0, import_vue6.unref)(iconComputed)), 39)) : (0, import_vue6.createCommentVNode)("v-if", true),
          (0, import_vue6.unref)(isImg) ? ((0, import_vue6.openBlock)(), (0, import_vue6.createElementBlock)("u-image", {
            key: 1,
            renderWhole: true,
            onClick: clickhandle,
            onLongpress: _cache[1] || (_cache[1] = ($event) => emits("longpress", $event)),
            ref: "icon",
            src: (0, import_vue6.unref)(iconComputed),
            class: (0, import_vue6.normalizeClass)([(0, import_vue6.unref)(spinComputed) ? "spin" : "", (0, import_vue6.unref)(customClass)]),
            style: (0, import_vue6.normalizeStyle)([{ width: (props.fontSize || 30) + props.unit, height: (props.fontSize || 30) + props.unit }, (0, import_vue6.unref)(customCSSStyle)])
          }, null, 46, ["src"])) : (0, import_vue6.createCommentVNode)("v-if", true)
        ], 4);
      };
    }
  });
  var tmIcon = /* @__PURE__ */ _export_sfc(_sfc_main6, [["__file", "F:/CoinQT/CoinQT_app/tmui/components/tm-icon/tm-icon.vue"]]);
  ...
  var _sfc_main7 = /* @__PURE__ */ (0, import_vue7.defineComponent)({
    ...
    setup(__props, { expose, emit: emits }) {
      ...
      const sysinfo = (0, import_vue7.inject)("tmuiSysInfo", (0, import_vue7.computed)(() => {
        return { bottom: 0, height: 750, width: uni.upx2px(750), top: 0, isCustomHeader: false, sysinfo: null };
      }));
      const width = (0, import_vue7.computed)(() => sysinfo.value.width);
      const height = (0, import_vue7.computed)(() => sysinfo.value.height);
      const top = (0, import_vue7.computed)(() => sysinfo.value.top);
      (0, import_vue7.ref)(false);
      let timids = uni.$tm.u.getUid(1);
      let timerId = NaN;
      (0, import_vue7.ref)(null);
      const showMask = (0, import_vue7.ref)(false);
      const ani = (0, import_vue7.ref)(false);
      (0, import_vue7.onUnmounted)(() => clearTimeout(timerId));
      const align_rpx = (0, import_vue7.computed)(() => props.align);
      const bgColor_rp = (0, import_vue7.computed)(() => {
      ...
      (0, import_vue7.watch)(() => props.show, (newval) => {
        open(newval);
      });
      expose({
        close,
      ...
      return (_ctx, _cache) => {
        return showMask.value ? ((0, import_vue7.openBlock)(), (0, import_vue7.createElementBlock)("view", {
          key: 0,
          class: "l-0",
          style: (0, import_vue7.normalizeStyle)([{ width: (0, import_vue7.unref)(width) + "px", height: (0, import_vue7.unref)(height) + "px", top: (0, import_vue7.unref)(top) + "px", position: "fixed" }, __props.zIndex ? { zIndex: __props.zIndex } : ""]),
          renderWhole: true
        }, [
          (0, import_vue7.createElementVNode)("view", {
            ref: "overlay",
            class: (0, import_vue7.normalizeClass)([(0, import_vue7.unref)(bgColor_rp) && !props.transprent && ani.value ? "blurOn" : "blurOff", "overlay"]),
            style: (0, import_vue7.normalizeStyle)([
              (0, import_vue7.unref)(bgColor_rp) && !props.transprent ? { backgroundColor: showMask.value ? (0, import_vue7.unref)(bgColor_rp) : "" } : "",
              { width: (0, import_vue7.unref)(width) + "px", height: (0, import_vue7.unref)(height) + "px", transitionDuration: props.duration + "ms" }
            ])
          }, null, 6),
          (0, import_vue7.createElementVNode)("view", {
            onClick: (0, import_vue7.withModifiers)(closeByclick, ["stop"]),
            class: (0, import_vue7.normalizeClass)([(0, import_vue7.unref)(align_rpx), " absolute flex flex-col  l-0 t-0 ", (0, import_vue7.unref)(customClass)]),
            style: (0, import_vue7.normalizeStyle)([{ width: (0, import_vue7.unref)(width) + "px", height: (0, import_vue7.unref)(height) + "px" }, (0, import_vue7.unref)(customCSSStyle)])
          }, [
  ...
  var tmOverlay = /* @__PURE__ */ _export_sfc(_sfc_main7, [["styles", [_style_04]], ["__file", "F:/CoinQT/CoinQT_app/tmui/components/tm-overlay/tm-overlay.vue"]]);
  ...
  var _sfc_main8 = /* @__PURE__ */ (0, import_vue8.defineComponent)({
    ...
    setup(__props, { expose, emit: emits }) {
      var _a2, _b2;
      const props = __props;
      const drawerANI = (0, import_vue8.ref)(null);
      const overlayAni = (0, import_vue8.ref)(null);
      const store = useTmpiniaStore();
      (_b2 = (_a2 = (0, import_vue8.getCurrentInstance)()) == null ? void 0 : _a2.proxy) != null ? _b2 : null;
      const sysinfo = (0, import_vue8.inject)("tmuiSysInfo", (0, import_vue8.computed)(() => {
        return { bottom: 0, height: 750, width: uni.upx2px(750), top: 0, isCustomHeader: false, sysinfo: null };
      }));
      const tmcfg = (0, import_vue8.computed)(() => store.tmStore);
      const customCSSStyle = (0, import_vue8.computed)(() => computedStyle(props));
      const customClass = (0, import_vue8.computed)(() => computedClass(props));
      const isDark = (0, import_vue8.computed)(() => computedDark(props, tmcfg.value));
      const tmcomputed = (0, import_vue8.computed)(() => computedTheme(props, isDark.value, tmcfg.value));
      const syswidth = (0, import_vue8.computed)(() => sysinfo.value.width);
      const sysheight = (0, import_vue8.computed)(() => sysinfo.value.height);
      const reverse = (0, import_vue8.ref)(true);
      const timeid = (0, import_vue8.ref)(0);
      let timerId = NaN;
      let timerIdth_flas = false;
      uni.hideKeyboard();
      let _show = (0, import_vue8.ref)(props.show);
      ...
      (0, import_vue8.watch)(() => props.show, (val) => {
      ...
      const ok_loading = (0, import_vue8.computed)(() => props.okLoading);
      const round_rp = (0, import_vue8.computed)(() => {
      ...
      const reverse_rp = (0, import_vue8.computed)(() => {
        if (aniname.value != "zoom")
          return reverse.value;
        return !reverse.value;
      });
      const aniname = (0, import_vue8.computed)(() => {
      ...
      const anwidth = (0, import_vue8.computed)(() => {
        if (aniname.value == "zoom") {
      ...
      const anheight = (0, import_vue8.computed)(() => {
        let wucha = 0;
      ...
      const contentHeight = (0, import_vue8.computed)(() => {
      ...
      const align_rp = (0, import_vue8.computed)(() => {
        if (aniname.value == "down") {
      ...
      function OverLayOpen() {
        (0, import_vue8.nextTick)(function() {
          var _a22;
      ...
      return (_ctx, _cache) => {
        return (0, import_vue8.openBlock)(), (0, import_vue8.createBlock)(tmOverlay, {
          ref_key: "overlayAni",
          ref: overlayAni,
          ...
          align: (0, import_vue8.unref)(align_rp),
          overlayClick: false,
          show: (0, import_vue8.unref)(_show),
          "onUpdate:show": _cache[1] || (_cache[1] = ($event) => (0, import_vue8.isRef)(_show) ? _show.value = $event : _show = $event)
        }, {
          default: (0, import_vue8.withCtx)(() => [
            (0, import_vue8.createVNode)(tmTranslate, {
              reverse: (0, import_vue8.unref)(reverse_rp),
              width: (0, import_vue8.unref)(anwidth),
              height: (0, import_vue8.unref)(anheight),
              ref_key: "drawerANI",
              ref: drawerANI,
              "auto-play": false,
              name: (0, import_vue8.unref)(aniname),
              duration: props.duration
            }, {
              default: (0, import_vue8.withCtx)(() => [
                (0, import_vue8.createElementVNode)("view", {
                  onClick: _cache[0] || (_cache[0] = (0, import_vue8.withModifiers)(($event) => $event.stopPropagation(), ["stop"])),
                  style: (0, import_vue8.normalizeStyle)([
                    { width: (0, import_vue8.unref)(anwidth), height: (0, import_vue8.unref)(anheight) },
                    !props.transprent ? (0, import_vue8.unref)(tmcomputed).borderCss : "",
                    !props.transprent ? (0, import_vue8.unref)(tmcomputed).backgroundColorCss : "",
                    !props.transprent ? (0, import_vue8.unref)(tmcomputed).shadowColor : "",
                    (0, import_vue8.unref)(customCSSStyle)
                  ]),
                  class: (0, import_vue8.normalizeClass)([(0, import_vue8.unref)(round_rp), "flex flex-col overflow ", (0, import_vue8.unref)(customClass)])
                }, [
                  !props.closeable && !props.hideHeader ? ((0, import_vue8.openBlock)(), (0, import_vue8.createElementBlock)("view", {
                    key: 0,
                    class: "flex flex-row flex-row-center-center flex-between px-24",
                    style: { "height": "44px" }
                  }, [
                    (0, import_vue8.createElementVNode)("view", { class: "flex-4 flex-shrink" }, [
                      !props.hideCancel ? ((0, import_vue8.openBlock)(), (0, import_vue8.createBlock)(tmText, {
                        key: 0,
                        onClick: cancel,
                        label: props.cancelText
                      }, null, 8, ["label"])) : (0, import_vue8.createCommentVNode)("v-if", true)
                    ]),
                    (0, import_vue8.createElementVNode)("view", { class: "flex-8 px-32 flex-center" }, [
                    ...
                    (0, import_vue8.createElementVNode)("view", { class: "flex-4 flex-shrink flex-row flex-row-center-end" }, [
                      !(0, import_vue8.unref)(ok_loading) ? ((0, import_vue8.openBlock)(), (0, import_vue8.createBlock)(tmText, {
                        key: 0,
                        color: __props.okColor,
                        onClick: ok,
                        dark: props.dark,
                        label: props.okText
                      }, null, 8, ["color", "dark", "label"])) : (0, import_vue8.createCommentVNode)("v-if", true),
                      (0, import_vue8.unref)(ok_loading) ? ((0, import_vue8.openBlock)(), (0, import_vue8.createBlock)(tmIcon, {
                        key: 1,
                        color: __props.okColor,
                        spin: (0, import_vue8.unref)(ok_loading),
                        dark: (0, import_vue8.unref)(isDark),
                        _class: (0, import_vue8.unref)(isDark) !== true ? "opacity-4" : "",
                        fontSize: 34,
                        name: (0, import_vue8.unref)(ok_loading) ? "tmicon-jiazai_dan" : "tmicon-times-circle-fill"
                      }, null, 8, ["color", "spin", "dark", "_class", "name"])) : (0, import_vue8.createCommentVNode)("v-if", true)
                    ])
                  ...
                  props.closeable && !props.hideHeader ? ((0, import_vue8.openBlock)(), (0, import_vue8.createElementBlock)("view", {
                    ...
                    (0, import_vue8.createElementVNode)("view", { class: "flex-9 pr-32" }, [
                      (0, import_vue8.renderSlot)(_ctx.$slots, "title", {}, () => [
                        (0, import_vue8.createVNode)(tmText, {
                          _class: "text-overflow-1 opacity-7",
                          dark: props.dark,
                    ...
                    (0, import_vue8.createElementVNode)("view", { class: "flex-3 flex-shrink flex-row flex-row-center-end" }, [
                      (0, import_vue8.createVNode)(tmIcon, {
                        onClick: cancel,
                        dark: props.dark,
                        _class: (0, import_vue8.unref)(isDark) !== true ? "opacity-3" : "",
                        fontSize: 36,
                        name: "tmicon-times-circle-fill"
                      }, null, 8, ["dark", "_class"])
                    ])
                  ])) : (0, import_vue8.createCommentVNode)("v-if", true),
                  (0, import_vue8.createElementVNode)("scroll-view", {
                    scrollY: !props.disabbleScroll,
                    style: (0, import_vue8.normalizeStyle)([{ height: (0, import_vue8.unref)(contentHeight) }]),
                    class: "overflow"
                  }, [
  ...
  var tmDrawer = /* @__PURE__ */ _export_sfc(_sfc_main8, [["styles", [_style_05]], ["__file", "F:/CoinQT/CoinQT_app/tmui/components/tm-drawer/tm-drawer.vue"]]);
  ...
  var _style_06 = { "button": { "": { "backgroundColor": "rgba(0,0,0,0)", "borderWidth": 0, "borderStyle": "solid", "borderColor": "rgba(0,0,0,0)", "paddingTop": 0, "paddingRight": 0, "paddingBottom": 0, "paddingLeft": 0, "borderRadius": 0 } }, "buttonHover": { "": { "backgroundColor": "rgba(0,0,0,0)" } }, "bhover": { "": { "opacity": 0.7 } } };
  var _sfc_main9 = /* @__PURE__ */ (0, import_vue9.defineComponent)({
    ...
    setup(__props, { emit: emits }) {
      ...
      const customCSSStyle = (0, import_vue9.computed)(() => {
        return __spreadProps8(__spreadValues8({
  ...
  var TmButton = /* @__PURE__ */ _export_sfc(_sfc_main9, [["styles", [_style_06]], ["__file", "F:/CoinQT/CoinQT_app/tmui/components/tm-button/tm-button.vue"]]);
  ...
  var _sfc_main10 = /* @__PURE__ */ (0, import_vue10.defineComponent)({
    ...
    setup(__props, { emit: emits }) {
      var _a2, _b2;
      const props = __props;
      const drawer = (0, import_vue10.ref)(null);
      (_b2 = (_a2 = (0, import_vue10.getCurrentInstance)()) == null ? void 0 : _a2.proxy) != null ? _b2 : null;
      const showCity = (0, import_vue10.ref)(true);
      const _colIndex = (0, import_vue10.ref)([]);
      const _data = (0, import_vue10.computed)(() => props.columns);
      const _colStr = (0, import_vue10.ref)(props.modelStr);
      const aniover = (0, import_vue10.ref)(true);
      ...
      function confirm() {
        var _a22;
        setVal();
        emits("confirm", (0, import_vue10.toRaw)(_colIndex.value));
      ...
      const dHeight = (0, import_vue10.computed)(() => {
        return props.height + sysinfo.value.bottom + 80;
      });
      return (_ctx, _cache) => {
        return showCity.value ? ((0, import_vue10.openBlock)(), (0, import_vue10.createBlock)(tmDrawer, {
          key: 0,
          disabbleScroll: true,
          round: props.round,
          ref_key: "drawer",
          ref: drawer,
          height: (0, import_vue10.unref)(dHeight),
          closable: true,
          ...
          default: (0, import_vue10.withCtx)(() => [
            (0, import_vue10.createVNode)(tmPickerView, {
              dataKey: props.dataKey,
              height: (0, import_vue10.unref)(dHeight) - 230,
            ...
            (0, import_vue10.createElementVNode)("view", {
              style: (0, import_vue10.normalizeStyle)({ height: (0, import_vue10.unref)(sysinfo).bottom + "px" })
            }, null, 4)
          ]),
          _: 1
        }, 8, ["round", "height", "overlayClick", "show"])) : (0, import_vue10.createCommentVNode)("v-if", true);
      };
    }
  });
  var tmPicker = /* @__PURE__ */ _export_sfc(_sfc_main10, [["__file", "F:/CoinQT/CoinQT_app/tmui/components/tm-picker/tm-picker.vue"]]);
  ...
  var _sfc_main11 = /* @__PURE__ */ (0, import_vue11.defineComponent)({
    ...
    setup(__props, { emit: emits }) {
      var _a2, _b2, _c;
      const props = __props;
      const aniplay = (0, import_vue11.ref)(null);
      ...
      const img_width = (0, import_vue11.computed)(() => {
        return props.width;
      });
      const img_height = (0, import_vue11.computed)(() => {
        return props.height - props.padding[1];
      });
      const img_src = (0, import_vue11.computed)(() => props.src);
      const loading = (0, import_vue11.ref)(true);
      const error = (0, import_vue11.ref)(false);
      const isRmove = (0, import_vue11.ref)(false);
      ...
      const ImagGrupList = (0, import_vue11.inject)("ImagGrupList", (0, import_vue11.computed)(() => []));
      ...
      return (_ctx, _cache) => {
        return !isRmove.value ? ((0, import_vue11.openBlock)(), (0, import_vue11.createBlock)(tmTranslate, {
          key: 0,
          width: (0, import_vue11.unref)(img_width) + props.padding[0] * 2 + props.unit,
          onEnd: aniEnd,
          ref_key: "aniplay",
          ref: aniplay,
          autoPlay: false,
          ...
          default: (0, import_vue11.withCtx)(() => [
            (0, import_vue11.createVNode)(tmSheet, {
              ...
              class: (0, import_vue11.normalizeClass)(["round-" + props.round]),
              width: (0, import_vue11.unref)(img_width) - props.padding[0] * 2,
              unit: props.unit
            }, {
              default: (0, import_vue11.withCtx)(() => [
                (0, import_vue11.createElementVNode)("view", {
                  class: (0, import_vue11.normalizeClass)([`pb-${props.padding[1]}`])
                }, [
                  loading.value ? ((0, import_vue11.openBlock)(), (0, import_vue11.createElementBlock)("u-image", {
                    key: 0,
                    src: (0, import_vue11.unref)(img_src),
                    style: { "width": "10px", "height": "10px", "opacity": "0", "transform": "translateX(1200px)" },
                    onLoad: imageLoad,
                    onError: imageError,
                    mode: "scaleToFill"
                  }, null, 40, ["src"])) : (0, import_vue11.createCommentVNode)("v-if", true),
                  !loading.value && !error.value ? ((0, import_vue11.openBlock)(), (0, import_vue11.createElementBlock)("u-image", {
                    key: 1,
                    showMenuByLongpress: props.showMenuByLongPress,
                    onClick: imageClick,
                    class: (0, import_vue11.normalizeClass)(["round-" + props.round]),
                    src: (0, import_vue11.unref)(img_src),
                    style: (0, import_vue11.normalizeStyle)([{ width: (0, import_vue11.unref)(img_width) + props.unit, height: (0, import_vue11.unref)(img_height) + props.unit }]),
                    mode: props.model
                  }, null, 14, ["showMenuByLongpress", "src", "mode"])) : (0, import_vue11.createCommentVNode)("v-if", true),
                  loading.value && !error.value ? ((0, import_vue11.openBlock)(), (0, import_vue11.createElementBlock)("view", {
                    key: 2,
                    style: (0, import_vue11.normalizeStyle)([{ width: (0, import_vue11.unref)(img_width) + props.unit, height: (0, import_vue11.unref)(img_height) + props.unit }]),
                    class: "flex flex-center opacity-3"
                  }, [
                    props.showLoad ? ((0, import_vue11.openBlock)(), (0, import_vue11.createBlock)(tmIcon, {
                      key: 0,
                      "font-size": 26,
                      spin: "",
                      name: "tmicon-loading"
                    })) : (0, import_vue11.createCommentVNode)("v-if", true)
                  ], 4)) : (0, import_vue11.createCommentVNode)("v-if", true),
                  !loading.value && error.value ? ((0, import_vue11.openBlock)(), (0, import_vue11.createElementBlock)("view", {
                    key: 3,
                    style: (0, import_vue11.normalizeStyle)([{ width: (0, import_vue11.unref)(img_width) + props.unit, height: (0, import_vue11.unref)(img_height) + props.unit }]),
                    class: "flex flex-col flex-center opacity-5"
                  }, [
                    (0, import_vue11.createVNode)(tmIcon, { name: "tmicon-exclamation-circle" }),
                  ...
                  (0, import_vue11.createCommentVNode)(" extra "),
                  props.extra ? ((0, import_vue11.openBlock)(), (0, import_vue11.createElementBlock)("view", {
                    key: 4,
                    onClick: (0, import_vue11.withModifiers)(imageClick, ["stop"]),
                    ...
                    style: (0, import_vue11.normalizeStyle)([
                      props.extra && props.extraPosition == "in" ? { height: (0, import_vue11.unref)(img_height) + props.unit, width: (0, import_vue11.unref)(img_width) + props.unit } : "",
                      props.extra && props.extraPosition == "out" ? { width: (0, import_vue11.unref)(img_width) + props.unit } : ""
                    ])
                  }, [
                    (0, import_vue11.renderSlot)(_ctx.$slots, "extra")
                  ], 14, ["onClick"])) : (0, import_vue11.createCommentVNode)("v-if", true),
                  (0, import_vue11.createCommentVNode)(" delete \u5C55\u793A\u5220\u9664\u6309\u94AE\u3002 "),
                  props.delete ? ((0, import_vue11.openBlock)(), (0, import_vue11.createElementBlock)("view", {
                    key: 5,
                    class: "absolute r-10 t-10 flex flex-col flex-col-center-end zIndex-10",
                    style: (0, import_vue11.normalizeStyle)([props.delete ? { width: (0, import_vue11.unref)(img_width) + props.unit } : ""])
                  }, [
          ...
          _: 3
        }, 8, ["width"])) : (0, import_vue11.createCommentVNode)("v-if", true);
      };
    }
  });
  var tmImage = /* @__PURE__ */ _export_sfc(_sfc_main11, [["__file", "F:/CoinQT/CoinQT_app/tmui/components/tm-image/tm-image.vue"]]);
  ...
  var _sfc_main12 = /* @__PURE__ */ (0, import_vue12.defineComponent)({
    ...
    setup(__props, { emit: emits }) {
      ...
      const _computedValue = (0, import_vue12.computed)(() => props);
      return (_ctx, _cache) => {
        return (0, import_vue12.openBlock)(), (0, import_vue12.createElementBlock)("view", {
          ...
          (0, import_vue12.createVNode)(tmSheet, {
            ...
            default: (0, import_vue12.withCtx)(() => [
              (0, import_vue12.createElementVNode)("view", {
                ...
                class: (0, import_vue12.normalizeClass)(["flex flex-row flex-row-center-center", [(0, import_vue12.unref)(_computedValue).url ? "url" : ""]])
              }, [
                (0, import_vue12.unref)(_computedValue).showAvatar ? ((0, import_vue12.openBlock)(), (0, import_vue12.createElementBlock)("view", {
                  key: 0,
                  style: (0, import_vue12.normalizeStyle)({
                    width: `${(0, import_vue12.unref)(_computedValue).avatarSize}rpx`,
                    height: `${(0, import_vue12.unref)(_computedValue).avatarSize}rpx`
                  }),
                  class: "flex flex-row flex-row-center-center"
                }, [
                  (0, import_vue12.renderSlot)(_ctx.$slots, "avatar", {}, () => [
                    (0, import_vue12.createVNode)(tmImage, {
                      round: (0, import_vue12.unref)(_computedValue).avatarRound,
                      width: (0, import_vue12.unref)(_computedValue).avatarSize,
                      height: (0, import_vue12.unref)(_computedValue).avatarSize,
                      src: (0, import_vue12.unref)(_computedValue).avatar
                ...
                (0, import_vue12.createElementVNode)("view", {
                  ...
                  (0, import_vue12.createElementVNode)("view", null, [
                    (0, import_vue12.createElementVNode)("view", {
                      class: (0, import_vue12.normalizeClass)(["flex flex-5 flex-col", [(0, import_vue12.unref)(_computedValue).showAvatar ? "pl-24" : ""]])
                    }, [
                      (0, import_vue12.renderSlot)(_ctx.$slots, "title", {}, () => [
                        (0, import_vue12.createVNode)(tmText, {
                          fontSize: (0, import_vue12.unref)(_computedValue).titleFontSize,
                          label: (0, import_vue12.unref)(_computedValue).title
                        }, null, 8, ["fontSize", "label"])
                      ]),
                      (0, import_vue12.renderSlot)(_ctx.$slots, "label", {}, () => [
                        (0, import_vue12.unref)(_computedValue).label ? ((0, import_vue12.openBlock)(), (0, import_vue12.createElementBlock)("view", {
                          key: 0,
                          class: "mt-6"
                        }, [
                          (0, import_vue12.createVNode)(tmText, {
                            color: (0, import_vue12.unref)(_computedValue).labelColor,
                            fontSize: 22,
                            label: (0, import_vue12.unref)(_computedValue).label
                          }, null, 8, ["color", "label"])
                  ...
                  (0, import_vue12.createElementVNode)("view", {
                    ...
                    (0, import_vue12.renderSlot)(_ctx.$slots, "rightText", {}, () => [
                      (0, import_vue12.unref)(_computedValue).rightText ? ((0, import_vue12.openBlock)(), (0, import_vue12.createBlock)(tmText, {
                        key: 0,
                        _class: "nowrap pr-12",
                        color: (0, import_vue12.unref)(_computedValue).rightColor,
                        fontSize: (0, import_vue12.unref)(_computedValue).rightTextSize,
                        label: (0, import_vue12.unref)(_computedValue).rightText
                      }, null, 8, ["color", "fontSize", "label"])) : (0, import_vue12.createCommentVNode)("v-if", true)
                    ]),
                    (0, import_vue12.renderSlot)(_ctx.$slots, "right", {}, () => [
                      (0, import_vue12.unref)(_computedValue).rightIcon ? ((0, import_vue12.openBlock)(), (0, import_vue12.createBlock)(tmIcon, {
                        key: 0,
                        _class: "opacity-3",
                        name: (0, import_vue12.unref)(_computedValue).rightIcon,
                        fontSize: 22
                      }, null, 8, ["name"])) : (0, import_vue12.createCommentVNode)("v-if", true)
                    ])
                  ])
                ])
              ], 2)
          ...
          (0, import_vue12.unref)(_computedValue).bottomBorder ? ((0, import_vue12.openBlock)(), (0, import_vue12.createBlock)(tmDivider, {
            key: 0,
            margin: [0, 0],
            style: (0, import_vue12.normalizeStyle)({
              left: `${(0, import_vue12.unref)(_computedValue).avatar !== "" ? (0, import_vue12.unref)(_computedValue).avatarSize + (0, import_vue12.unref)(_computedValue).margin[0] : 0}rpx`
            })
          }, null, 8, ["style"])) : (0, import_vue12.createCommentVNode)("v-if", true)
        ]);
      };
    }
  });
  var tmCell = /* @__PURE__ */ _export_sfc(_sfc_main12, [["styles", [_style_07]], ["__file", "F:/CoinQT/CoinQT_app/tmui/components/tm-cell/tm-cell.vue"]]);
  ...
  var _sfc_main13 = /* @__PURE__ */ (0, import_vue13.defineComponent)({
    __name: "picker",
    setup(__props) {
      const dateStr = (0, import_vue13.ref)("");
      const pickydata = (0, import_vue13.ref)([]);
      const citydate = (0, import_vue13.ref)([
        { text: "\u82F9\u679C", id: 0 },
        { text: "\u9999\u8549", id: 1 },
        { text: "\u5176\u5B83\u6C34\u679C", id: 2 },
        { text: "\u8D8A\u5357\u6C34\u679C", id: 4 }
      ]);
      const citydate2 = (0, import_vue13.ref)([
      ...
      return (_ctx, _cache) => {
        return (0, import_vue13.openBlock)(), (0, import_vue13.createElementBlock)("scroll-view", {
          ...
          (0, import_vue13.createVNode)(tmApp, null, {
            default: (0, import_vue13.withCtx)(() => [
              (0, import_vue13.createVNode)(tmSheet, null, {
                default: (0, import_vue13.withCtx)(() => [
                  ...
                  (0, import_vue13.createVNode)(tmPickerView, { columns: citydate.value }, null, 8, ["columns"])
                ]),
                _: 1
              }),
              (0, import_vue13.createVNode)(tmCell, {
                onClick: _cache[0] || (_cache[0] = ($event) => showdate.value = true),
                title: "\u8BF7\u9009\u62E9\u6C34\u679C\u79CD\u7C7B",
                "right-text": dateStr.value || "\u8BF7\u9009\u62E9"
              }, null, 8, ["right-text"]),
              (0, import_vue13.createVNode)(tmPicker, {
                defaultValue: [1, 1],
                onConfirm: pickok,
                show: showdate.value,
              ...
              (0, import_vue13.createVNode)(tmSheet, null, {
                default: (0, import_vue13.withCtx)(() => [
                  ...
                  (0, import_vue13.createVNode)(tmDivider),
                  (0, import_vue13.createVNode)(tmPickerView, { columns: citydate2.value }, null, 8, ["columns"])
                ]),
                _: 1
              }),
              (0, import_vue13.createElementVNode)("view", { class: "py-32" })
            ]),
            _: 1
          })
        ]);
  ...
  var picker = /* @__PURE__ */ _export_sfc(_sfc_main13, [["__file", "F:/CoinQT/CoinQT_app/pages/form/picker.nvue"]]);

  // <stdin>
  var webview = plus.webview.currentWebview();
  if (webview) {
    const __pageId = parseInt(webview.id);
    const __pagePath = "pages/form/picker";
    let __pageQuery = {};
    try {
