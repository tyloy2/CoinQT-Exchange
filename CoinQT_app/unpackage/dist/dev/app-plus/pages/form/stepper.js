...
(() => {
  ...
  // F:/CoinQT/CoinQT_app/unpackage/dist/dev/.nvue/pages/form/stepper.js
  ...
  var _sfc_main$12 = /* @__PURE__ */ (0, import_vue5.defineComponent)({
    ...
    setup(__props, { emit: emits }) {
      ...
      const props = __props;
      const store = useTmpiniaStore();
      const setVal = (0, import_vue5.ref)((_a2 = props.defaultValue) != null ? _a2 : null);
      const tmcfg = (0, import_vue5.computed)(() => store.tmStore);
      const isDark = (0, import_vue5.computed)(() => computedDark(props, tmcfg.value));
      const tmcomputed = (0, import_vue5.computed)(() => computedTheme(__spreadProps5(__spreadValues5({}, props), { color: props.bgColor, text: true }), isDark.value, tmcfg.value));
      let timeid = NaN;
      const isJianDisabled = (0, import_vue5.computed)(() => {
        if (setVal.value <= props.min)
          return true;
        return false;
      });
      const isAddDisabled = (0, import_vue5.computed)(() => {
          ...
          (0, import_vue5.createVNode)(tmSheet, {
            ...
            default: (0, import_vue5.withCtx)(() => [
              (0, import_vue5.createElementVNode)("view", {
                class: (0, import_vue5.normalizeClass)([!props.circular ? `` : `round-${10}`, "overflow", props.disabled || (0, import_vue5.unref)(isJianDisabled) ? "opacity-5" : ""])
              }, [
                (0, import_vue5.createVNode)(tmSheet, {
                  followTheme: props.followTheme,
              ...
              (0, import_vue5.createElementVNode)("u-input", {
                ...
                value: setVal.value,
                autoBlur: "",
                style: (0, import_vue5.normalizeStyle)([{ height: `${props.height}rpx`, textAlign: "center", fontSize: props.fontSize + "rpx", width: `${props.width - 120}rpx`, color: (0, import_vue5.unref)(tmcomputed).textColor }]),
                type: "number"
              }, null, 44, ["disabled", "value"]),
              (0, import_vue5.createElementVNode)("view", {
                class: (0, import_vue5.normalizeClass)([!props.circular ? `` : `round-${10}`, "overflow", props.disabled || (0, import_vue5.unref)(isAddDisabled) ? "opacity-5" : ""])
              }, [
                (0, import_vue5.createVNode)(tmSheet, {
                  followTheme: props.followTheme,
                  round: props.circular ? 10 : props.round,
  ...
  var tmStepper = /* @__PURE__ */ _export_sfc(_sfc_main$12, [["styles", [_style_02]], ["__file", "F:/CoinQT/CoinQT_app/tmui/components/tm-stepper/tm-stepper.vue"]]);
            ...
            default: (0, import_vue5.withCtx)(() => [
              (0, import_vue5.createVNode)(tmSheet, null, {
                default: (0, import_vue5.withCtx)(() => [
                  ...
                  (0, import_vue5.createVNode)(tmStepper, { defaultValue: 20 })
                ]),
                _: 1
              }),
              (0, import_vue5.createVNode)(tmSheet, null, {
                default: (0, import_vue5.withCtx)(() => [
                  ...
                  (0, import_vue5.createVNode)(tmDivider),
                  (0, import_vue5.createVNode)(tmStepper, {
                    color: "primary",
                    bgColor: "primary",
                    circular: "",
                    defaultValue: 20
  ...
  var stepper = /* @__PURE__ */ _export_sfc(_sfc_main5, [["__file", "F:/CoinQT/CoinQT_app/pages/form/stepper.nvue"]]);

  // <stdin>
  var webview = plus.webview.currentWebview();
  if (webview) {
    const __pageId = parseInt(webview.id);
    const __pagePath = "pages/form/stepper";
    let __pageQuery = {};
    try {
    ...
    stepper.mpType = "page";
    const app = Vue.createPageApp(stepper, { $store: getApp({ allowDefault: true }).$store, __pageId, __pagePath, __pageQuery });
    app.provide("__globalStyles", Vue.useCssStyles([...__uniConfig.styles, ...stepper.styles || []]));
    app.mount("#root");
  }
})();
