...
(() => {
  ...
  // F:/CoinQT/CoinQT_app/unpackage/dist/dev/.nvue/pages/form/rate.js
  ...
  var _sfc_main4 = /* @__PURE__ */ (0, import_vue4.defineComponent)({
    ...
    setup(__props, { emit: emits }) {
      ...
      const _label = (0, import_vue4.computed)(() => {
        if (props.label != "")
          return props.label;
      ...
      return (_ctx, _cache) => {
        return (0, import_vue4.openBlock)(), (0, import_vue4.createElementBlock)("view", {
          ...
          onClick: _cache[0] || (_cache[0] = (0, import_vue4.withModifiers)(() => {
          }, ["stop"])),
          renderWhole: true
        }, [
          ((0, import_vue4.openBlock)(true), (0, import_vue4.createElementBlock)(import_vue4.Fragment, null, (0, import_vue4.renderList)((0, import_vue4.unref)(_count), (item, index) => {
            return (0, import_vue4.openBlock)(), (0, import_vue4.createElementBlock)("view", {
              key: item,
              class: (0, import_vue4.normalizeClass)([`pr-${__props.gutter}`, props.disabled ? "opacity-5" : ""])
            }, [
              (0, import_vue4.createVNode)(tmIcon, {
                "follow-dark": false,
                color: item <= _start.value ? (0, import_vue4.unref)(_color) : "grey-2",
          ...
          (0, import_vue4.renderSlot)(_ctx.$slots, "default", {}, () => [
            __props.showLabel ? ((0, import_vue4.openBlock)(), (0, import_vue4.createBlock)(tmText, {
              key: 0,
              dark: (0, import_vue4.unref)(isDark),
              color: (0, import_vue4.unref)(_color),
              label: (0, import_vue4.unref)(_label)
            }, null, 8, ["dark", "color", "label"])) : (0, import_vue4.createCommentVNode)("v-if", true)
          ])
        ]);
      };
    }
  });
  var tmRate = /* @__PURE__ */ _export_sfc(_sfc_main4, [["__file", "F:/CoinQT/CoinQT_app/tmui/components/tm-rate/tm-rate.vue"]]);
            ...
            default: (0, import_vue6.withCtx)(() => [
              (0, import_vue6.createVNode)(tmSheet, null, {
                default: (0, import_vue6.withCtx)(() => [
                  ...
                  (0, import_vue6.createVNode)(tmRate, { defaultValue: 2 })
                ]),
                _: 1
              }),
              (0, import_vue6.createVNode)(tmSheet, null, {
                default: (0, import_vue6.withCtx)(() => [
                  ...
                  (0, import_vue6.createVNode)(tmDivider),
                  (0, import_vue6.createVNode)(tmRate, {
                    color: "green",
                    readonly: "",
                    defaultValue: 4,
                    showLabel: ""
  ...
  var rate = /* @__PURE__ */ _export_sfc(_sfc_main6, [["__file", "F:/CoinQT/CoinQT_app/pages/form/rate.nvue"]]);

  // <stdin>
  var webview = plus.webview.currentWebview();
  if (webview) {
    const __pageId = parseInt(webview.id);
    const __pagePath = "pages/form/rate";
    let __pageQuery = {};
    try {
