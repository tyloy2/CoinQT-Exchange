...
(() => {
  ...
  // F:/CoinQT/CoinQT_app/unpackage/dist/dev/.nvue/pages/form/radio.js
  ...
  var _sfc_main7 = /* @__PURE__ */ (0, import_vue7.defineComponent)({
    __name: "radio",
    setup(__props) {
      const radio2 = (0, import_vue7.ref)(null);
      const radiolist = (0, import_vue7.ref)("banner");
      const str = (0, import_vue7.computed)(() => radiolist.value);
  ...
  var radio = /* @__PURE__ */ _export_sfc(_sfc_main7, [["__file", "F:/CoinQT/CoinQT_app/pages/form/radio.nvue"]]);

  // <stdin>
  var webview = plus.webview.currentWebview();
  if (webview) {
    const __pageId = parseInt(webview.id);
    const __pagePath = "pages/form/radio";
    let __pageQuery = {};
    try {
