...
(() => {
  ...
  // F:/CoinQT/CoinQT_app/unpackage/dist/dev/.nvue/pages/showdata/more.js
  ...
  var _style_03 = { "lightBg": { "": { "backgroundImage": "linear-gradient(to top, rgba(255, 255, 255, 1) 30%, rgba(255, 255, 255, 0.7) 50%)" } }, "darkBg": { "": { "backgroundImage": "linear-gradient(to top, rgba(0, 0, 0, 1), rgba(0, 0, 0, 0))" } } };
  var _sfc_main$12 = /* @__PURE__ */ (0, import_vue7.defineComponent)({
    ...
    setup(__props, { emit: emits }) {
      ...
      const isInit = (0, import_vue7.ref)(false);
      ...
      const isOpen = (0, import_vue7.ref)(false);
      const fontColor = (0, import_vue7.computed)(() => {
      ...
      const isMaxheight = (0, import_vue7.ref)(false);
      const maxHeight = (0, import_vue7.computed)(() => uni.upx2px(props.height));
      function open() {
        return __async(this, null, function* () {
          if (typeof props.beforeOpen === "function") {
            let p = yield props.beforeOpen().catch((e) => {
            });
      ...
      return (_ctx, _cache) => {
        return (0, import_vue7.openBlock)(), (0, import_vue7.createElementBlock)("view", {
          ...
          isMaxheight.value ? ((0, import_vue7.openBlock)(), (0, import_vue7.createElementBlock)("view", {
            key: 0,
            onClick: (0, import_vue7.withModifiers)(open, ["stop"]),
            class: (0, import_vue7.normalizeClass)(["flex zIndex-10 flex-row flex-row-bottom-center py-24", [
              !css_is_nvue.value && !isOpen.value ? "fulled-height" : "",
              isOpen.value ? "" : (0, import_vue7.unref)(isDark) ? "darkBg absolute" : "lightBg absolute"
            ]]),
            style: (0, import_vue7.normalizeStyle)([
            ...
            (0, import_vue7.renderSlot)(_ctx.$slots, "more", {}, () => [
              (0, import_vue7.createVNode)(tmIcon, {
                userInteractionEnabled: false,
                "font-size": 24,
                color: (0, import_vue7.unref)(fontColor),
  ...
  var tmMore = /* @__PURE__ */ _export_sfc(_sfc_main$12, [["styles", [_style_03]], ["__file", "F:/CoinQT/CoinQT_app/tmui/components/tm-more/tm-more.vue"]]);
            ...
            default: (0, import_vue7.withCtx)(() => [
              (0, import_vue7.createVNode)(tmSheet, null, {
                default: (0, import_vue7.withCtx)(() => [
                  ...
                  (0, import_vue7.createVNode)(tmMore, null, {
                    default: (0, import_vue7.withCtx)(() => [
                      (0, import_vue7.createVNode)(tmText, { label: text })
                    ]),
                    _: 1
                  }),
                  (0, import_vue7.createVNode)(tmDivider),
                  ...
                  (0, import_vue7.createVNode)(tmDivider),
                  (0, import_vue7.createVNode)(tmMore, { beforeOpen }, {
                    default: (0, import_vue7.withCtx)(() => [
  ...
  var more = /* @__PURE__ */ _export_sfc(_sfc_main7, [["__file", "F:/CoinQT/CoinQT_app/pages/showdata/more.nvue"]]);

  // <stdin>
  var webview = plus.webview.currentWebview();
  if (webview) {
    const __pageId = parseInt(webview.id);
    const __pagePath = "pages/showdata/more";
    let __pageQuery = {};
    try {
    ...
    more.mpType = "page";
    const app = Vue.createPageApp(more, { $store: getApp({ allowDefault: true }).$store, __pageId, __pagePath, __pageQuery });
    app.provide("__globalStyles", Vue.useCssStyles([...__uniConfig.styles, ...more.styles || []]));
    app.mount("#root");
  }
})();
