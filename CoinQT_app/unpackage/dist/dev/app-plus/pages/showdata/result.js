...
(() => {
  ...
  // F:/CoinQT/CoinQT_app/unpackage/dist/dev/.nvue/pages/showdata/result.js
  ...
  var _sfc_main5 = /* @__PURE__ */ (0, import_vue5.defineComponent)({
    ...
    setup(__props, { emit: emits }) {
      ...
      const icon_rp = (0, import_vue5.computed)(() => {
        if (props.icon)
          return props.icon;
        if (!props.status)
          return "";
      ...
      const icon_title = (0, import_vue5.computed)(() => {
        if (props.title)
          return props.title;
        if (!props.status)
          return "";
      ...
      const icon_subtitle = (0, import_vue5.computed)(() => {
        if (props.subTitle)
      ...
      const icon_color = (0, import_vue5.computed)(() => {
        if (props.color)
          return props.color;
        if (!props.status)
          return "";
        ...
        return (0, import_vue5.openBlock)(), (0, import_vue5.createElementBlock)("view", {
          ...
          (0, import_vue5.createVNode)(tmTranslate, {
            ...
            default: (0, import_vue5.withCtx)(() => [
              (0, import_vue5.createVNode)(tmSheet, {
                ...
                height: 140,
                round: 25,
                color: (0, import_vue5.unref)(icon_color),
                text: ""
              }, {
                default: (0, import_vue5.withCtx)(() => [
                  (0, import_vue5.createVNode)(tmIcon, {
                    ...
                    followDark: props.followDark,
                    fontSize: 80,
                    name: (0, import_vue5.unref)(icon_rp)
          ...
          (0, import_vue5.createElementVNode)("view", {
            ...
            (0, import_vue5.createVNode)(tmText, {
              ...
              fontSize: 34,
              label: (0, import_vue5.unref)(icon_title)
          ...
          (0, import_vue5.createElementVNode)("view", {
            ...
            (0, import_vue5.createVNode)(tmText, {
              ...
              _class: "opacity-6 ",
              fontSize: 24,
              label: (0, import_vue5.unref)(icon_subtitle)
            }, null, 8, ["dark", "followDark", "label"])
          ]),
          props.showBtn ? ((0, import_vue5.openBlock)(), (0, import_vue5.createElementBlock)("view", {
            key: 0,
            eventPenetrationEnabled: true,
  ...
  var tmResult = /* @__PURE__ */ _export_sfc(_sfc_main5, [["__file", "F:/CoinQT/CoinQT_app/tmui/components/tm-result/tm-result.vue"]]);
    ...
    setup(__props) {
      return (_ctx, _cache) => {
        return (0, import_vue6.openBlock)(), (0, import_vue6.createElementBlock)("scroll-view", {
          ...
          (0, import_vue6.createVNode)(tmApp, { color: "white" }, {
            default: (0, import_vue6.withCtx)(() => [
              ...
              (0, import_vue6.createVNode)(tmResult, {
                color: "green",
                status: "success"
              }),
              (0, import_vue6.createVNode)(tmResult, { showBtn: false }),
              (0, import_vue6.createVNode)(tmResult, {
                showBtn: false,
                color: "red",
                status: "network"
  ...
  var result = /* @__PURE__ */ _export_sfc(_sfc_main6, [["__file", "F:/CoinQT/CoinQT_app/pages/showdata/result.nvue"]]);

  // <stdin>
  var webview = plus.webview.currentWebview();
  if (webview) {
    const __pageId = parseInt(webview.id);
    const __pagePath = "pages/showdata/result";
    let __pageQuery = {};
    try {
    ...
    result.mpType = "page";
    const app = Vue.createPageApp(result, { $store: getApp({ allowDefault: true }).$store, __pageId, __pagePath, __pageQuery });
    app.provide("__globalStyles", Vue.useCssStyles([...__uniConfig.styles, ...result.styles || []]));
    app.mount("#root");
  }
})();
