...
(() => {
  ...
  // F:/CoinQT/CoinQT_app/unpackage/dist/dev/.nvue/pages/showdata/card.js
    ...
    setup(__props) {
      ...
      return (_ctx, _cache) => {
        return (0, import_vue4.openBlock)(), (0, import_vue4.createBlock)(tmSheet, {
          color: props.color,
          _class: [(0, import_vue4.unref)(customClass), "flex-col"],
          _style: [(0, import_vue4.unref)(customCSSStyle)],
          followTheme: props.followTheme,
          dark: props.dark,
          round: props.round,
          shadow: props.shadow,
          ...
          default: (0, import_vue4.withCtx)(() => [
            (0, import_vue4.createElementVNode)("view", { class: "flex-row flex flex-between pt-24" }, [
              ...
              (0, import_vue4.renderSlot)(_ctx.$slots, "status", {}, () => [
                (0, import_vue4.createVNode)(tmText, {
                  followTheme: false,
            ...
            (0, import_vue4.createElementVNode)("view", { class: "pb-24 flex" }, [
              (0, import_vue4.renderSlot)(_ctx.$slots, "content", {}, () => [
                (0, import_vue4.createVNode)(tmText, {
                  "font-size": 26,
                  _class: "wrap",
                  label: props.content
            ...
            (0, import_vue4.createElementVNode)("view", { class: "flex pb-24" }, [
              (0, import_vue4.renderSlot)(_ctx.$slots, "action")
            ])
          ]),
          _: 3
  ...
  var tmCard = /* @__PURE__ */ _export_sfc(_sfc_main4, [["__file", "F:/CoinQT/CoinQT_app/tmui/components/tm-card/tm-card.vue"]]);
  ...
  var _sfc_main5 = /* @__PURE__ */ (0, import_vue5.defineComponent)({
    ...
    setup(__props, { emit: emits }) {
      ...
      (0, import_vue5.computed)(() => computedTheme(props, isDark.value, tmcfg.value));
      function clickhandle(e) {
        emits("click", e);
      }
      const appTextColor = (0, import_vue5.inject)("appTextColor", (0, import_vue5.computed)(() => void 0));
      const textColor = (0, import_vue5.computed)(() => {
        if (props.followTheme && store.tmStore.color)
          return store.tmStore.color;
        let isColorHex = tool.isCssColor(props.color);
        if (isColorHex)
      ...
      const fontSizeComputed = (0, import_vue5.computed)(() => {
      ...
      const isImg = (0, import_vue5.computed)(() => {
      ...
      const prefx = (0, import_vue5.computed)(() => {
        let prefix = props.name.split("-")[0];
        return prefix;
      });
      const iconComputed = (0, import_vue5.computed)(() => {
        if (isImg.value)
          return props.name;
      ...
      const spinComputed = (0, import_vue5.computed)(() => props.spin);
      const custom_space_size = (0, import_vue5.inject)("custom_space_size", [0, 0]);
      (0, import_vue5.computed)(() => Math.ceil(props.fontSize || 34) + custom_space_size[0]);
      (0, import_vue5.computed)(() => Math.ceil(props.fontSize || 34) + custom_space_size[1]);
      ...
      (0, import_vue5.watch)(spinComputed, () => {
      ...
      return (_ctx, _cache) => {
        return (0, import_vue5.openBlock)(), (0, import_vue5.createElementBlock)("view", {
          ...
          style: (0, import_vue5.normalizeStyle)([{
            marginRight: (0, import_vue5.unref)(custom_space_size)[0] + "rpx",
            marginBottom: (0, import_vue5.unref)(custom_space_size)[1] + "rpx"
          }])
        }, [
          !(0, import_vue5.unref)(isImg) ? ((0, import_vue5.openBlock)(), (0, import_vue5.createElementBlock)("u-text", {
            key: 0,
            renderWhole: true,
            ref: "icon",
            onClick: clickhandle,
            onLongpress: _cache[0] || (_cache[0] = ($event) => emits("longpress", $event)),
            class: (0, import_vue5.normalizeClass)([(0, import_vue5.unref)(spinComputed) ? "spin" : "", "text-size-n d-inline-block ", "tmicon", (0, import_vue5.unref)(customClass)]),
            style: (0, import_vue5.normalizeStyle)([{ fontFamily: "tmicon", color: (0, import_vue5.unref)(textColor) }, (0, import_vue5.unref)(fontSizeComputed), (0, import_vue5.unref)(customCSSStyle)])
          }, (0, import_vue5.toDisplayString)((0, import_vue5.unref)(iconComputed)), 39)) : (0, import_vue5.createCommentVNode)("v-if", true),
          (0, import_vue5.unref)(isImg) ? ((0, import_vue5.openBlock)(), (0, import_vue5.createElementBlock)("u-image", {
            key: 1,
            renderWhole: true,
            onClick: clickhandle,
            onLongpress: _cache[1] || (_cache[1] = ($event) => emits("longpress", $event)),
            ref: "icon",
            src: (0, import_vue5.unref)(iconComputed),
            class: (0, import_vue5.normalizeClass)([(0, import_vue5.unref)(spinComputed) ? "spin" : "", (0, import_vue5.unref)(customClass)]),
            style: (0, import_vue5.normalizeStyle)([{ width: (props.fontSize || 30) + props.unit, height: (props.fontSize || 30) + props.unit }, (0, import_vue5.unref)(customCSSStyle)])
          }, null, 46, ["src"])) : (0, import_vue5.createCommentVNode)("v-if", true)
        ], 4);
      };
    }
  });
  var tmIcon = /* @__PURE__ */ _export_sfc(_sfc_main5, [["__file", "F:/CoinQT/CoinQT_app/tmui/components/tm-icon/tm-icon.vue"]]);
  ...
  var TmButton = /* @__PURE__ */ _export_sfc(_sfc_main6, [["styles", [_style_02]], ["__file", "F:/CoinQT/CoinQT_app/tmui/components/tm-button/tm-button.vue"]]);
        ...
        return (0, import_vue7.openBlock)(), (0, import_vue7.createElementBlock)("scroll-view", {
          ...
          (0, import_vue7.createVNode)(tmApp, null, {
            default: (0, import_vue7.withCtx)(() => [
              ...
              (0, import_vue7.createVNode)(tmCard, {
                status: "2022-5-2",
                title: "\u5361\u7247\u6807\u9898",
                content: "\u8FD9\u662F\u4E00\u4E2A\u57FA\u7840\u5361\u7247\u793A\u4F8B\uFF0C\u975E\u5E38\u7B80\u5355\u4E14\u5B9E\u7528\u3002\u8FD9\u662F\u4E00\u4E2A\u57FA\u7840\u5361\u7247\u793A\u4F8B\uFF0C\u975E\u5E38\u7B80\u5355\u4E14\u5B9E\u7528\u3002"
              }, {
                action: (0, import_vue7.withCtx)(() => [
                  (0, import_vue7.createElementVNode)("view", { class: "flex flex-row flex-row-center-end" }, [
  ...
  var card = /* @__PURE__ */ _export_sfc(_sfc_main7, [["__file", "F:/CoinQT/CoinQT_app/pages/showdata/card.nvue"]]);

  // <stdin>
  var webview = plus.webview.currentWebview();
  if (webview) {
    const __pageId = parseInt(webview.id);
    const __pagePath = "pages/showdata/card";
    let __pageQuery = {};
    try {
