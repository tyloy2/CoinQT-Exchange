...
(() => {
  ...
  // F:/CoinQT/CoinQT_app/unpackage/dist/dev/.nvue/pages/showdata/cell.js
  ...
  var _sfc_main5 = /* @__PURE__ */ (0, import_vue5.defineComponent)({
    ...
    setup(__props, { emit: emits }) {
      ...
      const _groupCheckedVal = (0, import_vue5.inject)("tmCheckedBoxVal", (0, import_vue5.computed)(() => []));
      const tmCheckedBoxDisabled = (0, import_vue5.inject)("tmCheckedBoxDisabled", (0, import_vue5.computed)(() => false));
      const tmCheckedBoxMax = (0, import_vue5.inject)("tmCheckedBoxMax", (0, import_vue5.computed)(() => false));
      ...
      return (_ctx, _cache) => {
        return (0, import_vue5.openBlock)(), (0, import_vue5.createElementBlock)("view", {
          class: (0, import_vue5.normalizeClass)(["flex flex-row", [(0, import_vue5.unref)(_disabled) ? "opacity-5" : ""]]),
          renderWhole: true
        }, [
          (0, import_vue5.createElementVNode)("view", {
            ...
            props.custom ? ((0, import_vue5.openBlock)(), (0, import_vue5.createBlock)(tmSheet, {
              ...
              width: props.size,
              height: props.size,
              text: !props.indeterminate && !_checked.value || (0, import_vue5.unref)(_disabled),
              border: props.border,
              borderStyle: props.borderStyle,
              transprent: props.transprent,
              padding: [0, 0],
              margin: [16, 8],
              color: (0, import_vue5.unref)(_disabled) ? "white" : props.color,
              round: props.round,
              _class: "flex-row flex-row-center-center"
            }, {
              default: (0, import_vue5.withCtx)(() => [
                !props.closeAni ? ((0, import_vue5.openBlock)(), (0, import_vue5.createElementBlock)("view", { key: 0 }, [
                  _checked.value && !props.indeterminate ? ((0, import_vue5.openBlock)(), (0, import_vue5.createBlock)(tmTranslate, {
                    key: 0,
                    duration: 100,
                    name: "zoom",
                    style: { "line-height": "1" }
                  ...
                  props.indeterminate ? ((0, import_vue5.openBlock)(), (0, import_vue5.createBlock)(tmTranslate, {
                    key: 1,
                    duration: 100,
                    name: "zoom",
                    style: { "line-height": "1" }
                ...
                props.closeAni ? ((0, import_vue5.openBlock)(), (0, import_vue5.createElementBlock)("view", { key: 1 }, [
                  _checked.value && !props.indeterminate ? ((0, import_vue5.openBlock)(), (0, import_vue5.createBlock)(tmIcon, {
                    key: 0,
                    "font-size": props.size * 0.54,
                    name: props.icon
                  }, null, 8, ["font-size", "name"])) : (0, import_vue5.createCommentVNode)("v-if", true),
                  props.indeterminate ? ((0, import_vue5.openBlock)(), (0, import_vue5.createBlock)(tmIcon, {
                    key: 1,
                    "font-size": props.size * 0.54,
                    name: "tmicon-minus"
                  }, null, 8, ["font-size"])) : (0, import_vue5.createCommentVNode)("v-if", true)
                ])) : (0, import_vue5.createCommentVNode)("v-if", true)
              ]),
              _: 1
            }, 8, ["linear", "linearDeep", "followTheme", "followDark", "dark", "shadow", "width", "height", "text", "border", "borderStyle", "transprent", "color", "round"])) : (0, import_vue5.createCommentVNode)("v-if", true),
  ...
  var TmCheckbox = /* @__PURE__ */ _export_sfc(_sfc_main5, [["__file", "F:/CoinQT/CoinQT_app/tmui/components/tm-checkbox/tm-checkbox.vue"]]);
  ...
  var _sfc_main7 = /* @__PURE__ */ (0, import_vue7.defineComponent)({
    ...
    setup(__props) {
      ...
      const props = __props;
      const store = useTmpiniaStore();
      const borderDir = (0, import_vue7.computed)(() => props.vertical ? "left" : "bottom");
      const _label = (0, import_vue7.computed)(() => props.label);
      (_b2 = (_a2 = (0, import_vue7.getCurrentInstance)()) == null ? void 0 : _a2.proxy) != null ? _b2 : null;
      const tmcfg = (0, import_vue7.computed)(() => store.tmStore);
      const _realColor = (0, import_vue7.computed)(() => props.realColor);
      const isDark = (0, import_vue7.computed)(() => computedDark(__spreadProps7(__spreadValues7({}, props), { borderDirection: borderDir.value }), tmcfg.value));
      const tmcomputed = (0, import_vue7.computed)(() => computedTheme(__spreadProps7(__spreadValues7({}, props), { borderDirection: borderDir.value }), isDark.value, tmcfg.value));
      return (_ctx, _cache) => {
        return (0, import_vue7.openBlock)(), (0, import_vue7.createElementBlock)("view", { renderWhole: true }, [
          !(0, import_vue7.unref)(_label) && props.vertical ? ((0, import_vue7.openBlock)(), (0, import_vue7.createElementBlock)("view", {
            key: 0,
            style: (0, import_vue7.normalizeStyle)([{ backgroundColor: (0, import_vue7.unref)(_realColor) ? (0, import_vue7.unref)(tmcomputed).color : (0, import_vue7.unref)(tmcomputed).border }, props.vertical ? { width: props.border + "rpx", height: props.height + "rpx" } : ""]),
            class: (0, import_vue7.normalizeClass)([props.vertical ? `mx-${props.margin[0]}` : `my-${props.margin[1]}`])
          }, null, 6)) : (0, import_vue7.createCommentVNode)("v-if", true),
          (0, import_vue7.unref)(_label) && !props.vertical ? ((0, import_vue7.openBlock)(), (0, import_vue7.createElementBlock)("view", {
            key: 1,
            class: "flex flex-row flex-center"
          }, [
            (0, import_vue7.createElementVNode)("view", {
              style: (0, import_vue7.normalizeStyle)([(0, import_vue7.unref)(tmcomputed) ? { backgroundColor: (0, import_vue7.unref)(_realColor) ? (0, import_vue7.unref)(tmcomputed).color : (0, import_vue7.unref)(tmcomputed).border, height: props.border + "rpx" } : ""]),
              class: (0, import_vue7.normalizeClass)([`my-${props.margin[1]}`, __props.align == "left" ? "flex-2" : "", __props.align == "right" ? "flex-10" : "", __props.align == "center" ? "flex-1" : ""])
            }, null, 6),
            props.label ? ((0, import_vue7.openBlock)(), (0, import_vue7.createElementBlock)("view", {
              key: 0,
              class: (0, import_vue7.normalizeClass)([(0, import_vue7.unref)(isDark) ? "opacity-4" : ""])
            }, [
            ...
            (0, import_vue7.createElementVNode)("view", {
              style: (0, import_vue7.normalizeStyle)([(0, import_vue7.unref)(tmcomputed) ? { backgroundColor: (0, import_vue7.unref)(_realColor) ? (0, import_vue7.unref)(tmcomputed).color : (0, import_vue7.unref)(tmcomputed).border, height: props.border + "rpx" } : ""]),
              class: (0, import_vue7.normalizeClass)([`my-${props.margin[1]}`, __props.align == "left" ? "flex-10" : "", __props.align == "right" ? "flex-2" : "", __props.align == "center" ? "flex-1" : ""])
            }, null, 6)
          ...
          !(0, import_vue7.unref)(_label) && !props.vertical ? ((0, import_vue7.openBlock)(), (0, import_vue7.createElementBlock)("view", {
            ...
            (0, import_vue7.createElementVNode)("view", {
              class: (0, import_vue7.normalizeClass)(["flex-1", [`my-${props.margin[1]}`]]),
              style: (0, import_vue7.normalizeStyle)([(0, import_vue7.unref)(tmcomputed) ? { backgroundColor: (0, import_vue7.unref)(_realColor) ? (0, import_vue7.unref)(tmcomputed).color : (0, import_vue7.unref)(tmcomputed).border, height: props.border + "rpx" } : ""])
            }, null, 6)
          ])) : (0, import_vue7.createCommentVNode)("v-if", true)
        ]);
  ...
  var tmDivider = /* @__PURE__ */ _export_sfc(_sfc_main7, [["__file", "F:/CoinQT/CoinQT_app/tmui/components/tm-divider/tm-divider.vue"]]);
        ...
        return (0, import_vue9.openBlock)(), (0, import_vue9.createElementBlock)("scroll-view", {
          ...
          (0, import_vue9.createVNode)(tmApp, null, {
            default: (0, import_vue9.withCtx)(() => [
              ...
              (0, import_vue9.createElementVNode)("view", { class: "mb-32 mx-32 round-3 overflow" }, [
                (0, import_vue9.createVNode)(tmCell, {
                  margin: [0, 0],
                  titleFontSize: 30,
                  title: "\u5934\u50CF Avatar"
                }),
              ...
              (0, import_vue9.createElementVNode)("view", { class: "mb-32 mx-32 round-3 overflow" }, [
                ...
                (0, import_vue9.createVNode)(tmCell, {
                  ...
                  right: (0, import_vue9.withCtx)(() => [
                    (0, import_vue9.createVNode)(TmCheckbox, { round: 12 })
                  ]),
                  _: 1
                }),
                (0, import_vue9.createVNode)(tmCell, {
  ...
  var cell = /* @__PURE__ */ _export_sfc(_sfc_main9, [["__file", "F:/CoinQT/CoinQT_app/pages/showdata/cell.nvue"]]);

  // <stdin>
  var webview = plus.webview.currentWebview();
  if (webview) {
    const __pageId = parseInt(webview.id);
    const __pagePath = "pages/showdata/cell";
    let __pageQuery = {};
    try {
