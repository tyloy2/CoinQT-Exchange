...
(() => {
  ...
  // F:/CoinQT/CoinQT_app/unpackage/dist/dev/.nvue/pages/showdata/datatable.js
  ...
  var _sfc_main5 = /* @__PURE__ */ (0, import_vue5.defineComponent)({
    ...
    setup(__props, { emit: emits }) {
      ...
      const formtype = (0, import_vue5.computed)(() => props.formType);
      let FormParent = null;
      ...
      const customCSSStyle = (0, import_vue5.computed)(() => {
        return __spreadProps5(__spreadValues5({
      ...
      const isclickOn = (0, import_vue5.ref)(false);
      const _load = (0, import_vue5.computed)(() => props.loading);
      const _disabled = (0, import_vue5.computed)(() => props.disabled);
      const _label = (0, import_vue5.computed)(() => props.label);
      const _icon = (0, import_vue5.computed)(() => props.icon);
      const sizeObj = (0, import_vue5.computed)(() => {
        if (props.unit == "px") {
          return {
      ...
      const btnSizeObj = (0, import_vue5.computed)(() => {
      ...
      return (_ctx, _cache) => {
        ...
        return (0, import_vue5.openBlock)(), (0, import_vue5.createBlock)(tmSheet, {
          "no-level": "",
          _style: { opacity: isclickOn.value || (0, import_vue5.unref)(_disabled) ? 0.7 : 1 },
          "hover-class": "none",
          round: (0, import_vue5.unref)(btnSizeObj).round,
          width: (0, import_vue5.unref)(btnSizeObj).w,
          height: (0, import_vue5.unref)(btnSizeObj).h,
          ...
          default: (0, import_vue5.withCtx)(() => [
            (0, import_vue5.createVNode)(_component_button, {
              ...
              loading: (0, import_vue5.unref)(_load),
              disabled: (0, import_vue5.unref)(_disabled),
              "hover-start-time": 1e7,
              "hover-stop-propagation": "",
              "hover-class": "bhover",
              class: (0, import_vue5.normalizeClass)(["button flex-1 flex-center", [(0, import_vue5.unref)(customClass)]]),
              style: (0, import_vue5.normalizeStyle)((0, import_vue5.unref)(customCSSStyle))
            }, {
              default: (0, import_vue5.withCtx)(() => [
                (0, import_vue5.renderSlot)(_ctx.$slots, "default", {}, () => [
                  (0, import_vue5.unref)(_icon) ? ((0, import_vue5.openBlock)(), (0, import_vue5.createBlock)(tmIcon, {
                    ...
                    _class: (0, import_vue5.unref)(_label) ? "pr-10" : "",
                    unit: props.unit,
                    fontSize: (0, import_vue5.unref)(btnSizeObj).fontSize * 0.9,
                    name: (0, import_vue5.unref)(_icon)
                  }, null, 8, ["color", "_class", "unit", "fontSize", "name"])) : (0, import_vue5.createCommentVNode)("v-if", true),
                  (0, import_vue5.createVNode)(tmText, {
                    userInteractionEnabled: false,
                    color: (0, import_vue5.unref)(_fontColor),
                    fontSize: (0, import_vue5.unref)(btnSizeObj).fontSize,
                    unit: props.unit,
                    label: (0, import_vue5.unref)(_label)
  ...
  var TmButton = /* @__PURE__ */ _export_sfc(_sfc_main5, [["styles", [_style_02]], ["__file", "F:/CoinQT/CoinQT_app/tmui/components/tm-button/tm-button.vue"]]);

  // F:/CoinQT/CoinQT_app/unpackage/dist/dev/.nvue/tm-tag.js
  ...
  var _sfc_main7 = /* @__PURE__ */ (0, import_vue7.defineComponent)({
    ...
    setup(__props, { emit: emits }) {
      ...
      requireNativePlugin("bindingx");
      requireNativePlugin("dom");
      const anitag = (0, import_vue7.ref)(null);
      const customCSSStyle = (0, import_vue7.computed)(() => computedStyle(props));
      (0, import_vue7.computed)(() => computedClass(props));
      const show = (0, import_vue7.ref)(true);
      const _checked_ = (0, import_vue7.ref)(false);
      const _fontColor = (0, import_vue7.computed)(() => props.fontColor);
      const loading = (0, import_vue7.computed)(() => props.load);
      const checked_com = (0, import_vue7.computed)({
        get: function() {
      ...
      (0, import_vue7.watch)(() => props.checked, (newval) => {
        checked_com.value = newval;
        emits("change", checked_com.value);
      });
      const wh = (0, import_vue7.computed)(() => {
        if (props.size == "xs") {
          return {
      ...
      return (_ctx, _cache) => {
        return show.value ? ((0, import_vue7.openBlock)(), (0, import_vue7.createElementBlock)("view", {
          key: 0,
          class: (0, import_vue7.normalizeClass)(["flex flex-row", [(0, import_vue7.unref)(loading) ? "opacity-5" : ""]]),
          renderWhole: true
        }, [
          (0, import_vue7.createVNode)(tmTranslate, {
            onEnd: aniEnd,
            ref_key: "anitag",
            ref: anitag,
            name: "zoom",
            ...
            default: (0, import_vue7.withCtx)(() => [
              (0, import_vue7.createVNode)(tmSheet, {
                ...
                _style: (0, import_vue7.unref)(customCSSStyle),
                followTheme: props.followTheme,
                followDark: props.followDark,
                dark: props.dark,
                round: props.round,
                shadow: props.checkable && (0, import_vue7.unref)(checked_com) || !props.checkable ? props.shadow : 0,
                outlined: props.checkable && !(0, import_vue7.unref)(checked_com) ? true : props.outlined,
                border: props.border,
                borderStyle: props.borderStyle,
                borderDirection: props.borderDirection,
                text: props.checkable && !(0, import_vue7.unref)(checked_com) ? true : props.text,
                linear: props.linear,
                linearDeep: props.linearDeep,
                margin: props.margin,
                padding: [(0, import_vue7.unref)(wh).px, (0, import_vue7.unref)(wh).py]
              }, {
                default: (0, import_vue7.withCtx)(() => [
                  props.icon ? ((0, import_vue7.openBlock)(), (0, import_vue7.createBlock)(tmIcon, {
                    key: 0,
                    color: (0, import_vue7.unref)(_fontColor),
                    name: props.icon,
                    followDark: props.followDark,
                    fontSize: (0, import_vue7.unref)(wh).fontSize,
                    dark: props.dark,
                    userInteractionEnabled: false
                  }, null, 8, ["color", "name", "followDark", "fontSize", "dark"])) : (0, import_vue7.createCommentVNode)("v-if", true),
                  (0, import_vue7.createElementVNode)("view", { class: "flex-1 flex flex-center" }, [
                  ...
                  (0, import_vue7.createElementVNode)("view", {
                    onClick: _cache[0] || (_cache[0] = (0, import_vue7.withModifiers)(() => {
                    }, ["stop"]))
                  }, [
                    props.closable && !(0, import_vue7.unref)(loading) ? ((0, import_vue7.openBlock)(), (0, import_vue7.createBlock)(tmIcon, {
                      key: 0,
                      color: (0, import_vue7.unref)(_fontColor),
                      onClick: closeTag,
                      followDark: props.followDark,
                      _class: "pl-10",
                      fontSize: (0, import_vue7.unref)(wh).fontSize * 0.8,
                      name: "tmicon-times",
                      dark: props.dark
                    }, null, 8, ["color", "followDark", "fontSize", "dark"])) : (0, import_vue7.createCommentVNode)("v-if", true)
                  ]),
                  (0, import_vue7.unref)(loading) ? ((0, import_vue7.openBlock)(), (0, import_vue7.createElementBlock)("view", {
                    key: 1,
                    userInteractionEnabled: false,
  ...
  var tmTag = /* @__PURE__ */ _export_sfc(_sfc_main7, [["__file", "F:/CoinQT/CoinQT_app/tmui/components/tm-tag/tm-tag.vue"]]);
  ...
  var _style_04 = { "switchbgani": { "": { "transitionTimingFunction": "ease", "transitionProperty": "backgroundColor", "transitionDuration": 300, "transitionDelay": 0 } }, "@TRANSITION": { "switchbgani": { "timingFunction": "ease", "property": "backgroundColor", "duration": 300, "delay": 0 } } };
  var _sfc_main8 = /* @__PURE__ */ (0, import_vue8.defineComponent)({
    ...
    setup(__props, { emit: emits }) {
      ...
      const viewSize = (0, import_vue8.computed)(() => {
        let width = 0;
        let height = 0;
        let fontSize = 24;
        let gutter = 2;
      ...
      const _value = (0, import_vue8.ref)(false);
      if (props.defaultValue) {
        _value.value = props.defaultValue;
      }
      const _load = (0, import_vue8.ref)(false);
      ...
      (0, import_vue8.watch)(() => props.modelValue, (newval) => {
        _value.value = newval;
        spinNvueAni(newval);
      });
      (0, import_vue8.onMounted)(() => {
        (0, import_vue8.nextTick)(() => spinNvueAni(_value.value));
      });
      function spinNvueAni(reveser = false) {
      ...
      return (_ctx, _cache) => {
        return (0, import_vue8.openBlock)(), (0, import_vue8.createBlock)(tmSheet, {
          ...
          round: (0, import_vue8.unref)(viewSize).round,
          color: _value.value ? props.color : props.unCheckedColor,
          height: (0, import_vue8.unref)(viewSize).height,
          width: (0, import_vue8.unref)(viewSize).width,
          ...
          default: (0, import_vue8.withCtx)(() => [
            (0, import_vue8.createElementVNode)("view", {
              ...
              style: (0, import_vue8.normalizeStyle)({ padding: "2px", width: `${(0, import_vue8.unref)(viewSize).width}px`, height: `${(0, import_vue8.unref)(viewSize).height}px` })
            }, [
              (0, import_vue8.createElementVNode)("view", {
                userInteractionEnabled: false,
                class: "flex flex-row flex-between",
                style: (0, import_vue8.normalizeStyle)([{ width: (0, import_vue8.unref)(viewSize).coenteWidth + "px", height: (0, import_vue8.unref)(viewSize).innerHeight + "px" }])
              }, [
                (0, import_vue8.createElementVNode)("view", { class: "flex-1 flex-row flex-row-center-center" }, [
                  (0, import_vue8.createVNode)(tmText, {
                    "font-size": (0, import_vue8.unref)(viewSize).fontSize,
                    label: props.label[0]
              ...
              (0, import_vue8.createElementVNode)("view", {
                userInteractionEnabled: false,
                class: (0, import_vue8.normalizeClass)([["absolute base nvue", _value.value ? "on" : "off"], "flex flex-col"]),
                ref: "switch",
                style: (0, import_vue8.normalizeStyle)({
                  width: (0, import_vue8.unref)(viewSize).innerWidth + "px",
                  height: (0, import_vue8.unref)(viewSize).innerHeight + "px"
                })
              }, [
                (0, import_vue8.createVNode)(tmSheet, {
                  ...
                  padding: [0, 0],
                  margin: [0, 0],
                  height: (0, import_vue8.unref)(viewSize).innerHeight,
                  width: (0, import_vue8.unref)(viewSize).innerWidth,
                  ...
                  default: (0, import_vue8.withCtx)(() => [
                    _load.value ? ((0, import_vue8.openBlock)(), (0, import_vue8.createBlock)(tmIcon, {
                      key: 0,
                      followTheme: props.followTheme,
                      "font-size": (0, import_vue8.unref)(viewSize).fontSize,
                      color: props.color,
                      name: "tmicon-loading",
                      spin: ""
                    }, null, 8, ["followTheme", "font-size", "color"])) : (0, import_vue8.createCommentVNode)("v-if", true),
                    !_load.value && _value.value ? ((0, import_vue8.openBlock)(), (0, import_vue8.createBlock)(tmTranslate, {
                      key: 1,
                      name: "zoom"
                    }, {
                      default: (0, import_vue8.withCtx)(() => [
  ...
  var TmSwitch = /* @__PURE__ */ _export_sfc(_sfc_main8, [["styles", [_style_04]], ["__file", "F:/CoinQT/CoinQT_app/tmui/components/tm-switch/tm-switch.vue"]]);

  // F:/CoinQT/CoinQT_app/unpackage/dist/dev/.nvue/pages/showdata/datatable.js
  var import_pinia2 = __toESM(require_pinia());
  var _style_05 = { "flex-nowrap": { "": { "flexWrap": "nowrap" } } };
  var _sfc_main$12 = /* @__PURE__ */ (0, import_vue9.defineComponent)({
    ...
    setup(__props, { emit: emits }) {
      const props = __props;
      const isNvue = (0, import_vue9.ref)(false);
      (0, import_vue9.ref)("");
      (0, import_vue9.ref)(0);
      (0, import_vue9.ref)(0);
      const columnsList = (0, import_vue9.ref)([]), sortKeys = (0, import_vue9.ref)({});
      isNvue.value = true;
      const defaultProps = (0, import_vue9.computed)(() => {
        var _a2, _b2, _c, _d, _e, _f, _g, _h, _i;
        if (props.unit == "px") {
          return {
            width: (_a2 = props.width) != null ? _a2 : 750,
            height: (_b2 = props.height) != null ? _b2 : 0,
      ...
      (0, import_vue9.onMounted)(() => {
        (0, import_vue9.nextTick)(() => setColData());
      });
      (0, import_vue9.watch)([() => props.data, () => props.columns], () => {
        setColData();
      }, { deep: true });
      const _columns = (0, import_vue9.computed)(() => {
        return JSON.parse(JSON.stringify(props.columns));
      });
      (0, import_vue9.computed)(() => {
        return props.data;
      });
      function setColData() {
        var _a2, _b2;
        ...
        (_a2 = _columns.value) == null ? void 0 : _a2.forEach((item) => {
          if (item.width) {
            colWidthNum += 1;
            colWidth += item.width;
          }
        ...
        (_b2 = _columns.value) == null ? void 0 : _b2.forEach((col, index) => {
          var _a22, _b22, _c, _d, _e, _f, _g, _h, _i, _j, _k, _l, _m, _n, _o, _p, _q, _r, _s, _t, _u;
          const _minWidth = (_a22 = col.minWidth) != null ? _a22 : 0, _width = (_b22 = col.width) != null ? _b22 : 0;
      ...
      return (_ctx, _cache) => {
        return (0, import_vue9.openBlock)(), (0, import_vue9.createElementBlock)("view", { renderWhole: true }, [
          __props.showHeader ? ((0, import_vue9.openBlock)(), (0, import_vue9.createElementBlock)("scroll-view", {
            key: 0,
            enableFlex: isNvue.value,
            class: (0, import_vue9.normalizeClass)([isNvue.value ? "flex-row flex" : "tableHeader relative"]),
            scrollX: true,
            scrollWithAnimation: false,
            showScrollbar: "",
            scrollY: (0, import_vue9.unref)(defaultProps).height > 0,
            style: (0, import_vue9.normalizeStyle)([(0, import_vue9.unref)(defaultProps).height ? { height: `${(0, import_vue9.unref)(defaultProps).height} ${(0, import_vue9.unref)(defaultProps).unit}` } : "", { width: `${(0, import_vue9.unref)(defaultProps).width}${(0, import_vue9.unref)(defaultProps).unit}` }])
          }, [
            (0, import_vue9.createCommentVNode)("============ S \u5934\u90E8\u533A\u57DF ============= "),
            (0, import_vue9.createElementVNode)("view", {
              class: "flex-1 flex flex-row flex-nowrap absolute zIndex-6",
              style: (0, import_vue9.normalizeStyle)({ height: `${(0, import_vue9.unref)(defaultProps).headerHeight}${(0, import_vue9.unref)(defaultProps).unit}` })
            }, [
              ((0, import_vue9.openBlock)(true), (0, import_vue9.createElementBlock)(import_vue9.Fragment, null, (0, import_vue9.renderList)(columnsList.value, (item, index) => {
                return (0, import_vue9.openBlock)(), (0, import_vue9.createBlock)(tmSheet, (0, import_vue9.mergeProps)(item.headerProps, {
                  key: index,
                  ...
                  default: (0, import_vue9.withCtx)(() => [
                    (0, import_vue9.createElementVNode)("view", {
                      userInteractionEnabled: false,
                      style: (0, import_vue9.normalizeStyle)({ width: `${item._headerProps.width}${item.headerProps.unit}`, height: (0, import_vue9.unref)(defaultProps).headerHeight - 6 + "rpx" }),
                      class: (0, import_vue9.normalizeClass)(["flex flex-row-center-center flex-row", [item.align]])
                    }, [
                      (0, import_vue9.createElementVNode)("view", {
                        onClick: _cache[0] || (_cache[0] = (0, import_vue9.withModifiers)(() => {
                        }, ["stop"])),
                        class: "flex-1 flex",
                        style: { "width": "0px" }
                      }, [
                      ...
                      item.sort ? ((0, import_vue9.openBlock)(), (0, import_vue9.createElementBlock)("view", {
                        key: 0,
                        onClick: _cache[1] || (_cache[1] = (0, import_vue9.withModifiers)(() => {
                        }, ["stop"])),
            ...
            (0, import_vue9.createCommentVNode)("============ E \u5934\u90E8\u533A\u57DF ============= "),
            (0, import_vue9.createCommentVNode)("============ S \u5185\u5BB9\u533A\u57DF ============= "),
            (0, import_vue9.createElementVNode)("view", {
              style: (0, import_vue9.normalizeStyle)({ paddingTop: `${(0, import_vue9.unref)(defaultProps).headerHeight}${(0, import_vue9.unref)(defaultProps).unit}` })
            }, [
              ((0, import_vue9.openBlock)(true), (0, import_vue9.createElementBlock)(import_vue9.Fragment, null, (0, import_vue9.renderList)(__props.data, (cell, cellIndex) => {
                return (0, import_vue9.openBlock)(), (0, import_vue9.createElementBlock)("view", {
                  class: "flex flex-row flex-nowrap",
                  key: cellIndex,
                  margin: [0, 0]
                }, [
                  ((0, import_vue9.openBlock)(true), (0, import_vue9.createElementBlock)(import_vue9.Fragment, null, (0, import_vue9.renderList)(columnsList.value, (col, colIndex) => {
                    return (0, import_vue9.openBlock)(), (0, import_vue9.createBlock)(tmSheet, (0, import_vue9.mergeProps)(col.cellProps, {
                      key: cellIndex + colIndex
                    }), {
                      default: (0, import_vue9.withCtx)(() => {
                        var _a2;
                        return [
                          col.slot ? (0, import_vue9.renderSlot)(_ctx.$slots, col.slot, {
                            key: 0,
                            record: cell,
                            index: cellIndex,
                            rowIndex: colIndex
                          }) : ((0, import_vue9.openBlock)(), (0, import_vue9.createBlock)(tmText, {
                            key: 1,
                            fontSize: col._cellProps.fontSize,
                            unit: (0, import_vue9.unref)(defaultProps).unit,
                            _class: col.ellipsis ? "text-overflow-1" : "",
                            label: (_a2 = cell[col.key]) != null ? _a2 : ""
            ...
            (0, import_vue9.createCommentVNode)("============ E \u5185\u5BB9\u533A\u57DF ============= ")
          ], 14, ["enableFlex", "scrollY"])) : (0, import_vue9.createCommentVNode)("v-if", true)
        ]);
      };
    }
  });
  var TmDataTable = /* @__PURE__ */ _export_sfc(_sfc_main$12, [["styles", [_style_05]], ["__file", "F:/CoinQT/CoinQT_app/tmui/components/tm-data-table/tm-data-table.vue"]]);
  var _sfc_main9 = /* @__PURE__ */ (0, import_vue9.defineComponent)({
    __name: "datatable",
    setup(__props) {
      const columns = (0, import_vue9.ref)([
      ...
      const tableWidth = (0, import_vue9.computed)(() => {
        return windowWidth - uni.upx2px(55) * 2;
      });
      const tableData = (0, import_vue9.computed)(() => {
        return [
          {
      ...
      return (_ctx, _cache) => {
        return (0, import_vue9.openBlock)(), (0, import_vue9.createBlock)(tmApp, null, {
          default: (0, import_vue9.withCtx)(() => [
            (0, import_vue9.createVNode)(tmSheet, null, {
              default: (0, import_vue9.withCtx)(() => [
                ...
                (0, import_vue9.createVNode)(TmDataTable, {
                  height: 0,
                  width: (0, import_vue9.unref)(tableWidth),
                  unit: "px",
                  data: (0, import_vue9.unref)(tableData),
                  columns: columns.value,
                  onSorter: handleSort
                }, {
                  operationSlot: (0, import_vue9.withCtx)(({ record, index, rowIndex }) => [
                    (0, import_vue9.createElementVNode)("view", { class: "flex flex-row" }, [
                  ...
                  amountSlot: (0, import_vue9.withCtx)(({ record, index, rowIndex }) => [
                    (0, import_vue9.createVNode)(tmText, {
                      label: record.amount,
                      unit: "px",
                      fontSize: 13,
                  ...
                  statusSlot: (0, import_vue9.withCtx)(({ record, index, rowIndex }) => [
                    record.status == 1 ? ((0, import_vue9.openBlock)(), (0, import_vue9.createBlock)(tmTag, {
                      key: 0,
                      color: "green",
                      size: "s",
                      label: "\u5DF2\u5BA1\u6838"
                    })) : ((0, import_vue9.openBlock)(), (0, import_vue9.createBlock)(tmTag, {
                      key: 1,
                      color: "red",
                      size: "s",
                      label: "\u5F85\u5BA1\u6838"
                  ...
                  showSlot: (0, import_vue9.withCtx)(({ record, index, rowIndex }) => [
                    (0, import_vue9.createVNode)(TmSwitch, {
                      size: "mini",
                      color: "green",
  ...
  var datatable = /* @__PURE__ */ _export_sfc(_sfc_main9, [["__file", "F:/CoinQT/CoinQT_app/pages/showdata/datatable.nvue"]]);

  // <stdin>
  var webview = plus.webview.currentWebview();
  if (webview) {
    const __pageId = parseInt(webview.id);
    const __pagePath = "pages/showdata/datatable";
    let __pageQuery = {};
    try {
      __pageQuery = JSON.parse(webview.__query__);
    } catch (e) {
    }
    datatable.mpType = "page";
    const app = Vue.createPageApp(datatable, { $store: getApp({ allowDefault: true }).$store, __pageId, __pagePath, __pageQuery });
    app.provide("__globalStyles", Vue.useCssStyles([...__uniConfig.styles, ...datatable.styles || []]));
    app.mount("#root");
  }
})();
