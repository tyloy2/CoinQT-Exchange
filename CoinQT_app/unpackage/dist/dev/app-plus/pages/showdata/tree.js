...
(() => {
  ...
  // F:/CoinQT/CoinQT_app/unpackage/dist/dev/.nvue/pages/showdata/tree.js
  ...
  var _sfc_main$6 = /* @__PURE__ */ (0, import_vue7.defineComponent)({
    __name: "child-node",
    props: {
      followTheme: {
        type: [Boolean, String],
    ...
    setup(__props) {
      var _a2, _b2, _c;
      const props = __props;
      const { proxy } = (0, import_vue7.getCurrentInstance)();
      ...
      const TreePareantSelectedIds = (0, import_vue7.inject)("TreePareantSelectedIds", (0, import_vue7.ref)([]));
      const color = (_b2 = parent == null ? void 0 : parent.$props.color) != null ? _b2 : "primary";
      const nodeData = (0, import_vue7.computed)(() => {
        var _a22, _b22;
        return {
          icon: (_a22 = props.data["icon"]) != null ? _a22 : "",
          color: props.data["color"] || color,
          disabled: (_b22 = props.data["disabled"]) != null ? _b22 : false,
          text: props.data[props.fieldNames.text],
          id: props.data[props.fieldNames.id]
        };
      });
      const showCheckbox = (0, import_vue7.inject)("TreeNodeCheckable", (0, import_vue7.computed)(() => true));
      const _checked = (0, import_vue7.ref)("");
      const _indeterminate = (0, import_vue7.ref)(false);
      ...
      (0, import_vue7.watchEffect)(() => setChecked());
      function checkboxChange(e) {
        ...
        parent == null ? void 0 : parent.onCheck({ checked: e, data: (0, import_vue7.toRaw)(props.data) });
      }
      return (_ctx, _cache) => {
        return (0, import_vue7.openBlock)(), (0, import_vue7.createElementBlock)("view", {
          ...
          (0, import_vue7.unref)(showCheckbox) ? ((0, import_vue7.openBlock)(), (0, import_vue7.createBlock)(TmCheckbox, {
            key: 0,
            followTheme: props.followTheme,
            closeAni: "",
            color: (0, import_vue7.unref)(nodeData)["color"],
            indeterminate: _indeterminate.value,
            onChange: checkboxChange,
            disabled: (0, import_vue7.unref)(nodeData)["disabled"],
            modelValue: _checked.value,
            "onUpdate:modelValue": _cache[0] || (_cache[0] = ($event) => _checked.value = $event),
            value: (0, import_vue7.unref)(nodeData)[props.fieldNames.id]
          }, null, 8, ["followTheme", "color", "indeterminate", "disabled", "modelValue", "value"])) : (0, import_vue7.createCommentVNode)("v-if", true)
        ]);
      };
    }
  });
  ...
  var treeFlat = function(arr = [], idmap = "id") {
    let res = [];
    arr.forEach((item) => {
      res.push(item[idmap]);
      if (item.children) {
  ...
  var queryParentNode = function(arr = [], idmap = "id") {
    let res = [];
    for (let i = 0, len = arr.length; i < len; i++) {
      let item = arr[i];
      if (item.children) {
  ...
  var _sfc_main$5 = /* @__PURE__ */ (0, import_vue7.defineComponent)({
    __name: "parent-node",
    props: {
      followTheme: {
        type: [Boolean, String],
    ...
    setup(__props) {
      ...
      const TreeParentIds = (0, import_vue7.inject)("TreeParentIds", (0, import_vue7.ref)([]));
      const TreePareantSelectedIds = (0, import_vue7.inject)("TreePareantSelectedIds", (0, import_vue7.ref)([]));
      const color = (_b2 = parent == null ? void 0 : parent.$props.color) != null ? _b2 : "primary";
      const nodeData = (0, import_vue7.computed)(() => {
        var _a22, _b22;
      ...
      const _indeterminate = (0, import_vue7.ref)(false);
      const _multiple = (_c = parent.$props.multiple) != null ? _c : true;
      const flatlist = (0, import_vue7.computed)(() => {
        var _a22;
        return treeFlat((_a22 = props.data["children"]) != null ? _a22 : [], props.fieldNames.id);
      });
      ...
      (0, import_vue7.toRaw)(nodeData.value.id);
      function setExpaned() {
      ...
      (0, import_vue7.watchEffect)(() => setExpaned());
      (0, import_vue7.watch)(() => _checked.value, (newval, oldval) => {
        let ar = /* @__PURE__ */ new Set([...TreePareantSelectedIds.value, ...TreeParentIds.value]);
        let _seleteds = flatlist.value.filter((el) => ar.has(el));
        if (_seleteds.length == flatlist.value.length) {
    ...
    setup(__props) {
      ...
      return (_ctx, _cache) => {
        return (0, import_vue7.openBlock)(), (0, import_vue7.createElementBlock)("view", {
          ...
          !props.data["children"] ? ((0, import_vue7.openBlock)(), (0, import_vue7.createBlock)(childNode, {
            key: 0,
            followTheme: props.followTheme,
            fieldNames: props.fieldNames,
            data: props.data
          }, null, 8, ["followTheme", "fieldNames", "data"])) : (0, import_vue7.createCommentVNode)("v-if", true),
          props.data["children"] ? ((0, import_vue7.openBlock)(), (0, import_vue7.createBlock)(parentNode, {
            key: 1,
            followTheme: props.followTheme,
            fieldNames: props.fieldNames,
            data: props.data
          }, null, 8, ["followTheme", "fieldNames", "data"])) : (0, import_vue7.createCommentVNode)("v-if", true),
          (0, import_vue7.unref)(nodeData)["icon"] ? ((0, import_vue7.openBlock)(), (0, import_vue7.createBlock)(tmIcon, {
            key: 2,
            _class: "pr-16",
            color: (0, import_vue7.unref)(nodeData)["color"],
            "font-size": 28,
            name: (0, import_vue7.unref)(nodeData)["icon"]
          }, null, 8, ["color", "name"])) : (0, import_vue7.createCommentVNode)("v-if", true),
          (0, import_vue7.createVNode)(tmText, {
            "font-size": 28,
            label: (0, import_vue7.unref)(nodeData).text
          }, null, 8, ["label"])
        ]);
      };
    }
  ...
  var _sfc_main$3 = /* @__PURE__ */ (0, import_vue7.defineComponent)({
    ...
    setup(__props) {
      ...
      const TreePareantSelectedExpandedId = (0, import_vue7.inject)("TreePareantSelectedExpandedId", (0, import_vue7.ref)([]));
      const expandedIconOpenIcon = (_b2 = parent == null ? void 0 : parent.$props.expandedIconOpen) != null ? _b2 : "tmicon-sort-down";
      const expandedIconCloseIcon = (_c = parent == null ? void 0 : parent.$props.expandedIconClose) != null ? _c : "tmicon-caret-right";
      const _item = (0, import_vue7.computed)(() => props.data);
      const _checked = (0, import_vue7.ref)("");
      function expandHandler() {
        _checked.value = _checked.value ? "" : _item.value[props.fieldNames.id];
        if (_checked.value) {
          parent == null ? void 0 : parent.onExpand({ data: (0, import_vue7.toRaw)(_item.value), expand: true });
        } else {
          parent == null ? void 0 : parent.onUnExpand({ data: (0, import_vue7.toRaw)(_item.value), expand: false });
        }
      }
      function isCheckedOpen() {
        var _a22;
        let sAr = TreePareantSelectedExpandedId.value.filter((el) => el == _item.value[props.fieldNames.id]);
        _checked.value = (_a22 = sAr[0]) != null ? _a22 : "";
      }
      (0, import_vue7.watchEffect)(() => isCheckedOpen());
      return (_ctx, _cache) => {
        return (0, import_vue7.openBlock)(), (0, import_vue7.createElementBlock)("view", { renderWhole: true }, [
          (0, import_vue7.createElementVNode)("view", { class: "flex flex-row flex-row-center-start" }, [
            (0, import_vue7.unref)(_item)["children"] ? ((0, import_vue7.openBlock)(), (0, import_vue7.createBlock)(tmIcon, {
              key: 0,
              onClick: _cache[0] || (_cache[0] = ($event) => expandHandler((0, import_vue7.unref)(_item)[props.fieldNames.id])),
              "font-size": 26,
              name: _checked.value ? (0, import_vue7.unref)(expandedIconOpenIcon) : (0, import_vue7.unref)(expandedIconCloseIcon)
            }, null, 8, ["name"])) : (0, import_vue7.createCommentVNode)("v-if", true),
            (0, import_vue7.renderSlot)(_ctx.$slots, "default")
          ]),
          (0, import_vue7.unref)(_item)["children"] && _checked.value ? ((0, import_vue7.openBlock)(), (0, import_vue7.createElementBlock)("view", { key: 0 }, [
            (0, import_vue7.createVNode)(baseNodeVue, {
              followTheme: props.followTheme,
              fieldNames: props.fieldNames,
              data: (0, import_vue7.unref)(_item)["children"]
  ...
  var _sfc_main$2 = /* @__PURE__ */ (0, import_vue7.defineComponent)({
    ...
    setup(__props) {
      const props = __props;
      const treeNodeData = (0, import_vue7.computed)(() => props.data);
      return (_ctx, _cache) => {
        return (0, import_vue7.openBlock)(), (0, import_vue7.createElementBlock)("view", {
          class: "pa-24",
          renderWhole: true
        }, [
          ((0, import_vue7.openBlock)(true), (0, import_vue7.createElementBlock)(import_vue7.Fragment, null, (0, import_vue7.renderList)((0, import_vue7.unref)(treeNodeData), (item, index) => {
            return (0, import_vue7.openBlock)(), (0, import_vue7.createElementBlock)("view", { key: index }, [
              (0, import_vue7.createVNode)(expandedNode, {
                followTheme: props.followTheme,
                fieldNames: props.fieldNames,
                data: item
              }, {
                default: (0, import_vue7.withCtx)(() => [
                  (0, import_vue7.createVNode)(treeNode, {
                    followTheme: props.followTheme,
                    fieldNames: props.fieldNames,
                    data: item
                  }, null, 8, ["followTheme", "fieldNames", "data"])
  ...
  var _sfc_main$12 = /* @__PURE__ */ (0, import_vue7.defineComponent)({
    ...
    setup(__props, { expose, emit: emits }) {
      const props = __props;
      let listData = (0, import_vue7.ref)(props.data);
      ...
      const selectedIds = (0, import_vue7.ref)([.../* @__PURE__ */ new Set([...props.defaultSelectedId, ...props.selectedId])]);
      const SelectedExpandedId = (0, import_vue7.ref)([.../* @__PURE__ */ new Set([...props.defaultExpandedId, ...props.expandedId])]);
      const parentIds = (0, import_vue7.ref)([]);
      ...
      (0, import_vue7.provide)("TreePareantSelectedIds", (0, import_vue7.readonly)(selectedIds));
      (0, import_vue7.provide)("TreePareantSelectedExpandedId", (0, import_vue7.readonly)(SelectedExpandedId));
      (0, import_vue7.provide)("TreeParentIds", (0, import_vue7.readonly)(parentIds));
      ...
      function onExpand(e) {
        ...
        emits("expand", __spreadProps7(__spreadValues7({}, e.data), { expanded: e.expand }));
      ...
      function getAllListData() {
        return (0, import_vue7.toRaw)(props.data);
      }
      (0, import_vue7.watch)([() => props.expandedId], () => {
        SelectedExpandedId.value = [...props.expandedId];
      });
      (0, import_vue7.watch)([() => props.data], () => {
      ...
      (0, import_vue7.provide)("TreeNodeCheckable", (0, import_vue7.computed)(() => props.checkable));
      ...
      function checkNode(key, checked) {
        ...
        let parentData = queryNodeIsParent((0, import_vue7.toRaw)(props.data), key, props.fieldNames.id);
        if (parentData) {
      ...
      function expandAll(checked = true) {
        let flatarray = queryParentNode((0, import_vue7.toRaw)(props.data), props.fieldNames.id);
        if (checked) {
      ...
      function expandNode(key, checked) {
        ...
        let parentData = queryNodeIsParent((0, import_vue7.toRaw)(props.data, props.fieldNames.id), key);
        if (!parentData) {
      ...
      function getCheckedNodes(strategy = "all") {
        if (strategy == "all") {
          return [...(0, import_vue7.toRaw)(selectedIds.value), ...parentIds.value];
        } else if (strategy == "parent") {
          return (0, import_vue7.toRaw)(parentIds.value);
        } else if (strategy == "children") {
          return (0, import_vue7.toRaw)(selectedIds.value);
        } else {
          return [];
        }
      }
      function getExpandedNodes() {
        return (0, import_vue7.toRaw)(SelectedExpandedId.value);
      }
      function getNodePath(key) {
        return getNodeRouter((0, import_vue7.toRaw)(props.data), key, props.fieldNames.id);
      }
      expose({
      ...
      return (_ctx, _cache) => {
        return (0, import_vue7.openBlock)(), (0, import_vue7.createElementBlock)("view", { renderWhole: true }, [
          (0, import_vue7.createVNode)(baseNodeVue, {
            followTheme: props.followTheme,
            fieldNames: props.fieldNames,
            data: (0, import_vue7.unref)(listData)
          }, null, 8, ["followTheme", "fieldNames", "data"])
        ]);
      };
    }
  });
  var tmTree = /* @__PURE__ */ _export_sfc(_sfc_main$12, [["__file", "F:/CoinQT/CoinQT_app/tmui/components/tm-tree/tm-tree.vue"]]);
  var _sfc_main7 = /* @__PURE__ */ (0, import_vue7.defineComponent)({
    __name: "tree",
    setup(__props) {
      const dlist = (0, import_vue7.ref)(loop());
      ...
      return (_ctx, _cache) => {
        return (0, import_vue7.openBlock)(), (0, import_vue7.createElementBlock)("scroll-view", {
          ...
          (0, import_vue7.createVNode)(tmApp, null, {
            default: (0, import_vue7.withCtx)(() => [
              (0, import_vue7.createVNode)(tmSheet, null, {
                default: (0, import_vue7.withCtx)(() => [
                  (0, import_vue7.createVNode)(tmText, {
                    "font-size": 30,
                  ...
                  (0, import_vue7.createVNode)(tmDivider),
                  (0, import_vue7.createVNode)(tmTree, { data: dlist.value }, null, 8, ["data"])
                ]),
                _: 1
              })
            ]),
  ...
  var tree = /* @__PURE__ */ _export_sfc(_sfc_main7, [["__file", "F:/CoinQT/CoinQT_app/pages/showdata/tree.nvue"]]);

  // <stdin>
  var webview = plus.webview.currentWebview();
  if (webview) {
    const __pageId = parseInt(webview.id);
    const __pagePath = "pages/showdata/tree";
    let __pageQuery = {};
    try {
    ...
    tree.mpType = "page";
    const app = Vue.createPageApp(tree, { $store: getApp({ allowDefault: true }).$store, __pageId, __pagePath, __pageQuery });
    app.provide("__globalStyles", Vue.useCssStyles([...__uniConfig.styles, ...tree.styles || []]));
    app.mount("#root");
  }
})();
