...
(() => {
  ...
  // F:/CoinQT/CoinQT_app/unpackage/dist/dev/.nvue/pages/showdata/countdown.js
  ...
  var _sfc_main$12 = /* @__PURE__ */ (0, import_vue6.defineComponent)({
    ...
    setup(__props, { expose, emit: emits }) {
      const props = __props;
      let timid = void 0;
      let now = (0, import_vue6.ref)(0);
      let time_data = (0, import_vue6.computed)(() => formatTime(props.time - now.value));
      const isfinish = (0, import_vue6.computed)(() => now.value == props.time || now.value === 0);
      const text = (0, import_vue6.computed)(() => {
        let ps = props.format;
      ...
      return (_ctx, _cache) => {
        return (0, import_vue6.openBlock)(), (0, import_vue6.createElementBlock)("view", {
          ...
          (0, import_vue6.renderSlot)(_ctx.$slots, "default", {
            data: { data: (0, import_vue6.unref)(time_data), finish: (0, import_vue6.unref)(isfinish) }
          }, () => [
            (0, import_vue6.createVNode)(tmText, {
              color: props.color,
              label: (0, import_vue6.unref)(text)
            }, null, 8, ["color", "label"])
          ])
        ]);
      };
  ...
  var tmCountdown = /* @__PURE__ */ _export_sfc(_sfc_main$12, [["__file", "F:/CoinQT/CoinQT_app/tmui/components/tm-countdown/tm-countdown.vue"]]);
  var _sfc_main6 = /* @__PURE__ */ (0, import_vue6.defineComponent)({
    __name: "countdown",
    setup(__props) {
      const cu = (0, import_vue6.ref)(null);
              ...
              (0, import_vue6.createVNode)(tmSheet, null, {
                default: (0, import_vue6.withCtx)(() => [
                  ...
                  (0, import_vue6.createElementVNode)("view", null, [
                    (0, import_vue6.createVNode)(tmCountdown, {
                      ref_key: "cu",
                      ref: cu,
                      autoStart: false
                    }, null, 512)
                  ]),
                  (0, import_vue6.createElementVNode)("view", { class: "mt-32 flex flex-row flex-around" }, [
  ...
  var countdown = /* @__PURE__ */ _export_sfc(_sfc_main6, [["__file", "F:/CoinQT/CoinQT_app/pages/showdata/countdown.nvue"]]);

  // <stdin>
  var webview = plus.webview.currentWebview();
  if (webview) {
    const __pageId = parseInt(webview.id);
    const __pagePath = "pages/showdata/countdown";
    let __pageQuery = {};
    try {
