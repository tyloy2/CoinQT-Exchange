...
(() => {
  ...
  // F:/CoinQT/CoinQT_app/unpackage/dist/dev/.nvue/pages/showdata/descriptions.js
  ...
  var _sfc_main$2 = /* @__PURE__ */ (0, import_vue4.defineComponent)({
    ...
    setup(__props) {
      const props = __props;
      const _width = (0, import_vue4.inject)("tmDescriptionsItem", "");
      const labelWidth = (0, import_vue4.inject)("tmDescriptionsLabelWidth", "");
      const _fontSize = (0, import_vue4.computed)(() => props.fontSize);
      return (_ctx, _cache) => {
        return (0, import_vue4.unref)(_width) != "0px" && (0, import_vue4.unref)(_width) != "0%" ? ((0, import_vue4.openBlock)(), (0, import_vue4.createElementBlock)("view", {
          key: 0,
          style: (0, import_vue4.normalizeStyle)([(0, import_vue4.unref)(_width) ? { width: (0, import_vue4.unref)(_width) } : ""]),
          class: "flex flex-row flex-row-center-start py-8",
          renderWhole: true
        }, [
          (0, import_vue4.createElementVNode)("view", {
            style: (0, import_vue4.normalizeStyle)([(0, import_vue4.unref)(labelWidth) ? { width: (0, import_vue4.unref)(labelWidth) + "rpx" } : ""]),
            class: "flex flex-row flex-row-center-start"
          }, [
            (0, import_vue4.createVNode)(tmText, {
              _class: "opacity-7",
              "font-size": (0, import_vue4.unref)(_fontSize),
              label: props.label
  ...
  var _sfc_main$12 = /* @__PURE__ */ (0, import_vue4.defineComponent)({
    ...
    setup(__props) {
      ...
      const tmDescriptions2 = (0, import_vue4.ref)(null);
      (_b2 = (_a2 = (0, import_vue4.getCurrentInstance)()) == null ? void 0 : _a2.proxy) != null ? _b2 : null;
      const _dataList = (0, import_vue4.computed)(() => {
      ...
      const _cellWidth = (0, import_vue4.ref)("0px");
      ...
      (0, import_vue4.provide)("tmDescriptionsItem", (0, import_vue4.computed)(() => _cellWidth.value));
      (0, import_vue4.provide)("tmDescriptionsLabelWidth", (0, import_vue4.computed)(() => props.labelWidth));
      return (_ctx, _cache) => {
        return (0, import_vue4.openBlock)(), (0, import_vue4.createBlock)(tmSheet, {
          ...
          default: (0, import_vue4.withCtx)(() => [
            (0, import_vue4.renderSlot)(_ctx.$slots, "title", {}, () => [
              props.title ? ((0, import_vue4.openBlock)(), (0, import_vue4.createBlock)(tmText, {
                key: 0,
                _class: "pb-12",
                label: props.title,
                "font-size": 30
            ...
            (0, import_vue4.createElementVNode)("view", {
              ...
              style: (0, import_vue4.normalizeStyle)([{ flexFlow: _cellWidth.value == "auto" ? "column" : "row wrap" }])
            }, [
              (0, import_vue4.renderSlot)(_ctx.$slots, "default", {}, () => [
                ((0, import_vue4.openBlock)(true), (0, import_vue4.createElementBlock)(import_vue4.Fragment, null, (0, import_vue4.renderList)((0, import_vue4.unref)(_dataList), (item, index) => {
                  return (0, import_vue4.openBlock)(), (0, import_vue4.createElementBlock)("view", { key: index }, [
                    (0, import_vue4.createVNode)(tmDescriptionsItem, {
                      label: item.label,
                      value: item.value
                    }, null, 8, ["label", "value"])
                  ]);
  ...
  var tmDescriptions = /* @__PURE__ */ _export_sfc(_sfc_main$12, [["__file", "F:/CoinQT/CoinQT_app/tmui/components/tm-descriptions/tm-descriptions.vue"]]);
      ...
      return (_ctx, _cache) => {
        return (0, import_vue4.openBlock)(), (0, import_vue4.createElementBlock)("scroll-view", {
          ...
          (0, import_vue4.createVNode)(tmApp, null, {
            default: (0, import_vue4.withCtx)(() => [
              (0, import_vue4.createVNode)(tmSheet, null, {
                default: (0, import_vue4.withCtx)(() => [
                  (0, import_vue4.createVNode)(tmText, {
                    "font-size": 24,
                  ...
                  (0, import_vue4.createVNode)(tmDescriptions, { data: list })
                ]),
                _: 1
              }),
              (0, import_vue4.createVNode)(tmSheet, null, {
                default: (0, import_vue4.withCtx)(() => [
                  ...
                  (0, import_vue4.createVNode)(tmDivider),
                  (0, import_vue4.createVNode)(tmDescriptions, {
                    transprent: "",
                    round: 3,
                    text: "",
                    title: "\u65F6\u95F4\u5DE5\u5177\u6807\u9898"
                    ...
                    default: (0, import_vue4.withCtx)(() => [
                      ((0, import_vue4.openBlock)(), (0, import_vue4.createElementBlock)(import_vue4.Fragment, null, (0, import_vue4.renderList)(list, (item, index) => {
                        return (0, import_vue4.createVNode)(tmDescriptionsItem, {
                          "font-size": 24,
                          key: index,
                          label: item.label,
                          value: item.value
  ...
  var descriptions = /* @__PURE__ */ _export_sfc(_sfc_main4, [["__file", "F:/CoinQT/CoinQT_app/pages/showdata/descriptions.nvue"]]);

  // <stdin>
  var webview = plus.webview.currentWebview();
  if (webview) {
    const __pageId = parseInt(webview.id);
    const __pagePath = "pages/showdata/descriptions";
    let __pageQuery = {};
    try {
      __pageQuery = JSON.parse(webview.__query__);
    } catch (e) {
    }
    descriptions.mpType = "page";
    const app = Vue.createPageApp(descriptions, { $store: getApp({ allowDefault: true }).$store, __pageId, __pagePath, __pageQuery });
    app.provide("__globalStyles", Vue.useCssStyles([...__uniConfig.styles, ...descriptions.styles || []]));
    app.mount("#root");
  }
})();
