...
(() => {
  ...
  // F:/CoinQT/CoinQT_app/unpackage/dist/dev/.nvue/pages/showdata/popover.js
  ...
  var _sfc_main$12 = /* @__PURE__ */ (0, import_vue5.defineComponent)({
    ...
    setup(__props) {
      ...
      const aniDom = (0, import_vue5.ref)(null);
      ...
      const windowHeight = (0, import_vue5.computed)(() => sysinfo.value.height);
      let isNvue = (0, import_vue5.ref)(false);
      isNvue.value = true;
      let timeid = (0, import_vue5.ref)(uni.$tm.u.getUid(5));
      let show = (0, import_vue5.ref)(false);
      let domNvuePosCss = (0, import_vue5.ref)({
        left: 0,
        right: 0,
        bottom: 0,
        top: 0,
      ...
      let domNvueContentCss = (0, import_vue5.ref)({
        left: 0,
        right: 0,
        bottom: 0,
        top: 0,
      ...
      const tarnslateName = (0, import_vue5.computed)(() => {
      ...
      (0, import_vue5.onUpdated)(() => {
        if (domNvuePosCss.value.width == 0 || !domNvueContentCss.value.height) {
          nvueDomPos();
        }
      });
      (0, import_vue5.onMounted)(() => nvueDomPos());
      (0, import_vue5.watch)(() => show.value, () => {
      ...
      return (_ctx, _cache) => {
        return (0, import_vue5.openBlock)(), (0, import_vue5.createElementBlock)("view", {
          ...
          (0, import_vue5.unref)(show) ? ((0, import_vue5.openBlock)(), (0, import_vue5.createElementBlock)("view", {
            key: 0,
            onClick: _cache[0] || (_cache[0] = (0, import_vue5.withModifiers)(($event) => (0, import_vue5.isRef)(show) ? show.value = false : show = false, ["stop"])),
            class: "l-0 t-0 fixed zIndex-9",
            style: (0, import_vue5.normalizeStyle)([{ width: (0, import_vue5.unref)(windowWidth) + "px", height: (0, import_vue5.unref)(windowHeight) + "px", background: "rgba(0,0,0,0)" }])
          }, null, 4)) : (0, import_vue5.createCommentVNode)("v-if", true),
          (0, import_vue5.createElementVNode)("view", {
            class: (0, import_vue5.normalizeClass)(["flex flex-col", [
            ...
            (0, import_vue5.createElementVNode)("view", {
              onClick: _cache[1] || (_cache[1] = ($event) => (0, import_vue5.isRef)(show) ? show.value = true : show = true),
            ...
            (0, import_vue5.unref)(show) ? ((0, import_vue5.openBlock)(), (0, import_vue5.createElementBlock)("view", {
              key: 0,
              class: (0, import_vue5.normalizeClass)(["zIndex-10", [
                (0, import_vue5.unref)(isNvue) ? "fixed" : "absolute",
              ...
              style: (0, import_vue5.normalizeStyle)([
                (0, import_vue5.unref)(isNvue) && props.position == "tc" ? {
                  top: (0, import_vue5.unref)(domNvuePosCss).top - (0, import_vue5.unref)(domNvueContentCss).height + "px",
                  left: (0, import_vue5.unref)(domNvuePosCss).left + (0, import_vue5.unref)(domNvuePosCss).width / 2 - (0, import_vue5.unref)(domNvueContentCss).width / 2 + "px"
                } : "",
                (0, import_vue5.unref)(isNvue) && props.position == "tl" ? {
                  top: (0, import_vue5.unref)(domNvuePosCss).top - (0, import_vue5.unref)(domNvueContentCss).height + "px",
                  left: (0, import_vue5.unref)(domNvuePosCss).left + "px"
                } : "",
                (0, import_vue5.unref)(isNvue) && props.position == "tr" ? {
                  top: (0, import_vue5.unref)(domNvuePosCss).top - (0, import_vue5.unref)(domNvueContentCss).height + "px",
                  left: (0, import_vue5.unref)(domNvuePosCss).right - (0, import_vue5.unref)(domNvueContentCss).width + "px"
                } : "",
                (0, import_vue5.unref)(isNvue) && props.position == "bc" ? {
                  top: (0, import_vue5.unref)(domNvuePosCss).bottom + "px",
                  left: (0, import_vue5.unref)(domNvuePosCss).left + (0, import_vue5.unref)(domNvuePosCss).width / 2 - (0, import_vue5.unref)(domNvueContentCss).width / 2 + "px"
                } : "",
                (0, import_vue5.unref)(isNvue) && props.position == "bl" ? {
                  top: (0, import_vue5.unref)(domNvuePosCss).bottom + "px",
                  left: (0, import_vue5.unref)(domNvuePosCss).left + "px"
                } : "",
                (0, import_vue5.unref)(isNvue) && props.position == "br" ? {
                  top: (0, import_vue5.unref)(domNvuePosCss).bottom + "px",
                  left: (0, import_vue5.unref)(domNvuePosCss).right - (0, import_vue5.unref)(domNvueContentCss).width + "px"
                } : ""
              ]),
              ...
              (0, import_vue5.createVNode)(tmTranslate, {
                ...
                ref: aniDom,
                reverse: "",
                name: (0, import_vue5.unref)(tarnslateName),
                duration: 120,
                autoPlay: !(0, import_vue5.unref)(isNvue)
              }, {
                default: (0, import_vue5.withCtx)(() => [
                  (0, import_vue5.createElementVNode)("view", {
                    ...
                    style: (0, import_vue5.normalizeStyle)([props.width ? { width: props.width + "rpx" } : ""])
                  }, [
                    props.position == "bc" || props.position == "bl" || props.position == "br" ? ((0, import_vue5.openBlock)(), (0, import_vue5.createBlock)(tmSheet, {
                      key: 0,
                      text: props.text,
                      color: props.color,
                      _class: props._class,
                      ...
                      width: 20,
                      height: 20
                    }, null, 8, ["text", "color", "_class", "followTheme", "dark", "shadow", "outlined", "border", "borderStyle", "borderDirection", "transprent", "linear", "linearDeep", "_style"])) : (0, import_vue5.createCommentVNode)("v-if", true),
                    ...
                    props.position == "tc" || props.position == "tl" || props.position == "tr" ? ((0, import_vue5.openBlock)(), (0, import_vue5.createBlock)(tmSheet, {
                      key: 1,
                      text: props.text,
                      color: props.color,
                      _class: props._class,
            ...
            ], 6)) : (0, import_vue5.createCommentVNode)("v-if", true)
          ], 2)
        ]);
      };
    }
  });
  var tmPopover = /* @__PURE__ */ _export_sfc(_sfc_main$12, [["styles", [_style_03]], ["__file", "F:/CoinQT/CoinQT_app/tmui/components/tm-popover/tm-popover.vue"]]);
            ...
            default: (0, import_vue5.withCtx)(() => [
              (0, import_vue5.createVNode)(tmSheet, null, {
                default: (0, import_vue5.withCtx)(() => [
                  ...
                  (0, import_vue5.createElementVNode)("view", { class: "flex flex-row" }, [
                    (0, import_vue5.createElementVNode)("view", { class: "mx-32" }, [
                      (0, import_vue5.createVNode)(tmPopover, { position: "tl" }, {
                        default: (0, import_vue5.withCtx)(() => [
                          (0, import_vue5.createVNode)(tmText, { label: "\u6C7D\u6CE1\u4E0A\u5DE6" })
                        ]),
                        _: 1
                      })
                    ]),
                    (0, import_vue5.createElementVNode)("view", { class: "mx-32" }, [
                      (0, import_vue5.createVNode)(tmPopover, { color: "red" }, {
                        default: (0, import_vue5.withCtx)(() => [
                          (0, import_vue5.createVNode)(tmText, { label: "\u6C7D\u6CE1\u4E0A\u4E2D" })
                        ]),
                        _: 1
                      })
                    ]),
                    (0, import_vue5.createElementVNode)("view", { class: "mx-32" }, [
                      (0, import_vue5.createVNode)(tmPopover, {
                        position: "tr",
                        color: "primary",
                        text: ""
                      }, {
                        default: (0, import_vue5.withCtx)(() => [
                          (0, import_vue5.createVNode)(tmText, { label: "\u6C7D\u6CE1\u4E0A\u53F3" })
                        ]),
                        _: 1
                      })
                    ])
                  ...
                  (0, import_vue5.createElementVNode)("view", { class: "flex flex-row" }, [
                    (0, import_vue5.createElementVNode)("view", { class: "mx-32" }, [
                      (0, import_vue5.createVNode)(tmPopover, {
                        ...
                        default: (0, import_vue5.withCtx)(() => [
                          (0, import_vue5.createVNode)(tmText, { label: "\u6C7D\u6CE1\u5E95\u5DE6" })
                        ]),
                        _: 1
                      })
                    ]),
                    (0, import_vue5.createElementVNode)("view", { class: "mx-32" }, [
                      (0, import_vue5.createVNode)(tmPopover, {
                        ...
                        default: (0, import_vue5.withCtx)(() => [
                          (0, import_vue5.createVNode)(tmText, { label: "\u6C7D\u6CE1\u5E95\u4E2D" })
                        ]),
                        _: 1
                      })
                    ]),
                    (0, import_vue5.createElementVNode)("view", { class: "mx-32" }, [
                      (0, import_vue5.createVNode)(tmPopover, {
                        ...
                        default: (0, import_vue5.withCtx)(() => [
                          (0, import_vue5.createVNode)(tmText, { label: "\u6C7D\u6CE1\u5E95\u53F3" })
                        ]),
                        _: 1
                      })
                    ])
  ...
  var popover = /* @__PURE__ */ _export_sfc(_sfc_main5, [["__file", "F:/CoinQT/CoinQT_app/pages/showdata/popover.nvue"]]);

  // <stdin>
  var webview = plus.webview.currentWebview();
  if (webview) {
    const __pageId = parseInt(webview.id);
    const __pagePath = "pages/showdata/popover";
    let __pageQuery = {};
    try {
    ...
    popover.mpType = "page";
    const app = Vue.createPageApp(popover, { $store: getApp({ allowDefault: true }).$store, __pageId, __pagePath, __pageQuery });
    app.provide("__globalStyles", Vue.useCssStyles([...__uniConfig.styles, ...popover.styles || []]));
    app.mount("#root");
  }
})();
