...
(() => {
  ...
  // F:/CoinQT/CoinQT_app/unpackage/dist/dev/.nvue/pages/showdata/timeline.js
  ...
  var _sfc_main$2 = /* @__PURE__ */ (0, import_vue5.defineComponent)({
    ...
    setup(__props) {
      const props = __props;
      (0, import_vue5.provide)("tmTimeLinePosition", (0, import_vue5.computed)(() => props.position));
      return (_ctx, _cache) => {
        return (0, import_vue5.openBlock)(), (0, import_vue5.createElementBlock)("view", {
          class: "flex",
          style: (0, import_vue5.normalizeStyle)({ "flex-direction": __props.reverse ? "column-reverse" : "column" }),
          renderWhole: true
        }, [
  ...
  var _sfc_main$12 = /* @__PURE__ */ (0, import_vue5.defineComponent)({
    ...
    setup(__props) {
      const props = __props;
      const _time = (0, import_vue5.computed)(() => props.time);
      const _position = (0, import_vue5.inject)("tmTimeLinePosition", (0, import_vue5.computed)(() => "left"));
      const _posSize = (0, import_vue5.computed)(() => {
        return props.size;
      });
      const _posSizeWidth = (0, import_vue5.computed)(() => {
        return props.size + props.size / 2;
      });
      const _posX = (0, import_vue5.computed)(() => {
      ...
      return (_ctx, _cache) => {
        return (0, import_vue5.openBlock)(), (0, import_vue5.createElementBlock)("view", {
          ...
          (0, import_vue5.createElementVNode)("view", {
            class: (0, import_vue5.normalizeClass)(["itemPos flex flex-col relative", [(0, import_vue5.unref)(_position) == "right" ? "flex-col-top-end" : ""]]),
            style: (0, import_vue5.normalizeStyle)([
              (0, import_vue5.unref)(_position) == "left" ? { left: "64rpx" } : "",
              (0, import_vue5.unref)(_position) == "right" ? { right: "64rpx" } : "",
              (0, import_vue5.unref)(_position) == "center" ? { transform: "translateX(50%)" } : "",
              { top: "0rpx" }
            ])
          }, [
            (0, import_vue5.createVNode)(tmSheet, {
              border: props.border,
              borderDirection: (0, import_vue5.unref)(_position) == "center" ? "left" : (0, import_vue5.unref)(_position),
              ...
              default: (0, import_vue5.withCtx)(() => [
                (0, import_vue5.createElementVNode)("view", {
                  class: "pb-24 flex-1",
                  style: (0, import_vue5.normalizeStyle)([
                    (0, import_vue5.unref)(_position) == "left" || (0, import_vue5.unref)(_position) == "center" ? { paddingLeft: (0, import_vue5.unref)(_posSizeWidth) + "rpx", marginRight: "132rpx" } : "",
                    (0, import_vue5.unref)(_position) == "right" ? { paddingRight: (0, import_vue5.unref)(_posSizeWidth) + "rpx", marginLeft: "132rpx" } : ""
                  ])
                }, [
                  (0, import_vue5.unref)(_time) ? ((0, import_vue5.openBlock)(), (0, import_vue5.createBlock)(tmText, {
                    key: 0,
                    _style: "line-height:20rpx;",
                    _class: "pb-16",
                    label: (0, import_vue5.unref)(_time),
                    fontSize: 24,
                    color: props.color
                  }, null, 8, ["label", "color"])) : (0, import_vue5.createCommentVNode)("v-if", true),
                  (0, import_vue5.renderSlot)(_ctx.$slots, "default")
                ], 4)
              ]),
              _: 3
          ...
          (0, import_vue5.unref)(_position) == "center" ? ((0, import_vue5.openBlock)(), (0, import_vue5.createElementBlock)("view", {
            key: 0,
            style: (0, import_vue5.normalizeStyle)([{
              transform: `translateX(50%)`,
              height: (0, import_vue5.unref)(_posSizeWidth) + "rpx",
              left: -(0, import_vue5.unref)(_posX) + "px"
            }]),
            class: ""
          }, [
            (0, import_vue5.createElementVNode)("view", {
              ...
              style: (0, import_vue5.normalizeStyle)([
                { transform: `translateX(${(0, import_vue5.unref)(_posX) / 2}px)` },
                { width: (0, import_vue5.unref)(_posSizeWidth) + "rpx", height: (0, import_vue5.unref)(_posSizeWidth) + "rpx" }
              ])
            }, [
              (0, import_vue5.createVNode)(tmSheet, {
                ...
                shadow: 2,
                color: props.color,
                width: (0, import_vue5.unref)(_posSize),
                height: (0, import_vue5.unref)(_posSize),
                margin: [0, 0],
                padding: [0, 0]
              }, {
                default: (0, import_vue5.withCtx)(() => [
          ...
          (0, import_vue5.unref)(_position) == "left" || (0, import_vue5.unref)(_position) == "right" ? ((0, import_vue5.openBlock)(), (0, import_vue5.createElementBlock)("view", {
            key: 1,
            class: (0, import_vue5.normalizeClass)(["absolute t-0 flex flex-col", [
              (0, import_vue5.unref)(_position) == "left" ? "l-0 flex-col-top-center" : "",
              (0, import_vue5.unref)(_position) == "right" ? "r-0 flex-col-top-center" : "",
              (0, import_vue5.unref)(_position) == "center" ? "flex-col-center-center" : ""
            ]]),
            style: (0, import_vue5.normalizeStyle)([
              (0, import_vue5.unref)(_position) == "left" || (0, import_vue5.unref)(_position) == "right" ? { transform: `translateX(${(0, import_vue5.unref)(_position) == "left" ? (0, import_vue5.unref)(_posX) : -(0, import_vue5.unref)(_posX)}px)` } : "",
              (0, import_vue5.unref)(_position) == "center" ? { transform: `translateX(${(0, import_vue5.unref)(_posX) / 2}px)` } : "",
              { width: (0, import_vue5.unref)(_posSizeWidth) + "rpx", height: (0, import_vue5.unref)(_posSizeWidth) + "rpx" }
            ])
          }, [
            (0, import_vue5.createVNode)(tmSheet, {
  ...
  var tmTimelineItem = /* @__PURE__ */ _export_sfc(_sfc_main$12, [["styles", [_style_02]], ["__file", "F:/CoinQT/CoinQT_app/tmui/components/tm-timeline-item/tm-timeline-item.vue"]]);
      ...
      return (_ctx, _cache) => {
        return (0, import_vue5.openBlock)(), (0, import_vue5.createElementBlock)("scroll-view", {
          ...
          (0, import_vue5.createVNode)(tmApp, null, {
            default: (0, import_vue5.withCtx)(() => [
              (0, import_vue5.createVNode)(tmSheet, { _class: "flex-col" }, {
                default: (0, import_vue5.withCtx)(() => [
                  ...
                  (0, import_vue5.createElementVNode)("view", null, [
                    (0, import_vue5.createVNode)(tmTimeline, null, {
                      default: (0, import_vue5.withCtx)(() => [
                        (0, import_vue5.createVNode)(tmTimelineItem, {
                          color: "green",
                          size: 32,
                          type: "fill",
                          icon: "tmicon-check",
                          ...
                          default: (0, import_vue5.withCtx)(() => [
                            (0, import_vue5.createVNode)(tmSheet, {
                              ...
                              default: (0, import_vue5.withCtx)(() => [
                                (0, import_vue5.createVNode)(tmText, { label: "\u5DF2\u7ECF\u5230\u4E86\u4E2D\u8F6C\u7AD9\uFF0C\u8BF7\u6CE8\u610F\u67E5\u6536\u5DF2\u7ECF\u5230\u4E86\u4E2D\u8F6C\u7AD9\uFF0C\u8BF7\u6CE8\u610F\u67E5\u6536\u5DF2\u7ECF\u5230\u4E86\u4E2D\u8F6C\u7AD9\uFF0C\u8BF7\u6CE8\u610F\u67E5\u6536\u5DF2\u7ECF\u5230\u4E86\u4E2D\u8F6C\u7AD9\uFF0C\u8BF7\u6CE8\u610F\u67E5\u6536" })
                              ]),
                              _: 1
                            })
                          ]),
  ...
  var timeline = /* @__PURE__ */ _export_sfc(_sfc_main5, [["__file", "F:/CoinQT/CoinQT_app/pages/showdata/timeline.nvue"]]);

  // <stdin>
  var webview = plus.webview.currentWebview();
  if (webview) {
    const __pageId = parseInt(webview.id);
    const __pagePath = "pages/showdata/timeline";
    let __pageQuery = {};
    try {
      __pageQuery = JSON.parse(webview.__query__);
    } catch (e) {
    }
    timeline.mpType = "page";
    const app = Vue.createPageApp(timeline, { $store: getApp({ allowDefault: true }).$store, __pageId, __pagePath, __pageQuery });
    app.provide("__globalStyles", Vue.useCssStyles([...__uniConfig.styles, ...timeline.styles || []]));
    app.mount("#root");
  }
})();
