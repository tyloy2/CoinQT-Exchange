...
(() => {
  ...
  // F:/CoinQT/CoinQT_app/unpackage/dist/dev/.nvue/pages/showdata/image.js
  ...
  var _sfc_main$12 = /* @__PURE__ */ (0, import_vue7.defineComponent)({
    ...
    setup(__props, { expose }) {
      const props = __props;
      const _width = (0, import_vue7.computed)(() => props.width);
      const _catchList = [];
      function pushKey(e) {
      ...
      (0, import_vue7.provide)("ImagGrupList", (0, import_vue7.computed)(() => {
      ...
      return (_ctx, _cache) => {
        return (0, import_vue7.openBlock)(), (0, import_vue7.createElementBlock)("view", {
          ...
          style: (0, import_vue7.normalizeStyle)([{ "flex-flow": "row wrap" }, [(0, import_vue7.unref)(_width) ? { width: (0, import_vue7.unref)(_width) + "rpx" } : ""]]),
          renderWhole: true
        }, [
  ...
  var tmImageGroup = /* @__PURE__ */ _export_sfc(_sfc_main$12, [["__file", "F:/CoinQT/CoinQT_app/tmui/components/tm-image-group/tm-image-group.vue"]]);
            ...
            default: (0, import_vue7.withCtx)(() => [
                  ...
                  (0, import_vue7.createVNode)(tmImage, {
                    ...
                    extra: (0, import_vue7.withCtx)(() => [
                      (0, import_vue7.createVNode)(tmSheet, {
                        ...
                        default: (0, import_vue7.withCtx)(() => [
                          (0, import_vue7.createElementVNode)("view", { class: "flex flex-row flex-center pl-16" }, [
              ...
              (0, import_vue7.createVNode)(tmSheet, null, {
                default: (0, import_vue7.withCtx)(() => [
                  ...
                  (0, import_vue7.createVNode)(tmDivider),
                  (0, import_vue7.createVNode)(tmImageGroup, null, {
                    default: (0, import_vue7.withCtx)(() => [
                      ((0, import_vue7.openBlock)(), (0, import_vue7.createElementBlock)(import_vue7.Fragment, null, (0, import_vue7.renderList)(14, (item) => {
                        return (0, import_vue7.createVNode)(tmImage, {
                          padding: [2, 2],
                          preview: "",
                          width: 155,
                          height: 156,
  ...
  var image = /* @__PURE__ */ _export_sfc(_sfc_main7, [["__file", "F:/CoinQT/CoinQT_app/pages/showdata/image.nvue"]]);

  // <stdin>
  var webview = plus.webview.currentWebview();
  if (webview) {
    const __pageId = parseInt(webview.id);
    const __pagePath = "pages/showdata/image";
    let __pageQuery = {};
    try {
    ...
    image.mpType = "page";
    const app = Vue.createPageApp(image, { $store: getApp({ allowDefault: true }).$store, __pageId, __pagePath, __pageQuery });
    app.provide("__globalStyles", Vue.useCssStyles([...__uniConfig.styles, ...image.styles || []]));
    app.mount("#root");
  }
})();
