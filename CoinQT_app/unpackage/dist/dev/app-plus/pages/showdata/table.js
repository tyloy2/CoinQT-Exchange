...
(() => {
  ...
  // F:/CoinQT/CoinQT_app/unpackage/dist/dev/.nvue/pages/showdata/table.js
  ...
  var _sfc_main$12 = /* @__PURE__ */ (0, import_vue6.defineComponent)({
    ...
    setup(__props, { emit: emits }) {
      const props = __props;
      const defaultProps = (0, import_vue6.computed)(() => {
        return {
          width: props.width,
          height: props.height,
      ...
      const _col = (0, import_vue6.ref)([]);
      const _tabel = (0, import_vue6.ref)([]);
      const _showBottomBorder = (0, import_vue6.computed)(() => props.showBottomBorder);
      const _showHeader = (0, import_vue6.computed)(() => props.showHeader);
      const isNvue = (0, import_vue6.ref)(false);
      isNvue.value = true;
      const headerLeft = (0, import_vue6.ref)(0);
      const tableLeft = (0, import_vue6.ref)([...new Array(props.tableData.length).fill(0)]);
      let scrollDong = (0, import_vue6.ref)("");
      let scrollIndex = (0, import_vue6.ref)(NaN);
      ...
      (0, import_vue6.onMounted)(() => {
        (0, import_vue6.nextTick)(() => setColData());
      });
      (0, import_vue6.watch)([() => props.tableData, () => props.header], () => {
        setColData();
      }, { deep: true });
      function setColData() {
        _col.value = [];
        ...
        props.tableData.forEach((el, index) => {
          ...
          dataRuslt = _col.value.map((el2, index2) => {
            var _a22, _b22, _c2, _d2, _e2, _f2, _g, _h, _i, _j, _k, _l;
            let color = "white";
            let light = false;
            if (typeof d[el2.key] !== "object") {
              color = (el == null ? void 0 : el.color) || ((_a22 = _col.value[index2]) == null ? void 0 : _a22.cellColor) || color;
              light = (el == null ? void 0 : el.light) || ((_b22 = _col.value[index2]) == null ? void 0 : _b22.light) || light;
            } else {
            ...
            if (typeof d[el.key] === "object") {
              cel = __spreadValues6(__spreadValues6({}, cel), d[el.key]);
            }
            return cel;
          });
          _tabel.value.push({
      ...
      function sort(descKey = "", type = "none") {
        ...
        const backTable = (0, import_vue6.toRaw)(_tabel.value);
        (0, import_vue6.nextTick)(() => {
          _col.value = _col.value.map((el) => {
            return __spreadProps6(__spreadValues6({}, el), { sortType: el.key == descKey ? type : el.sortType });
          });
      ...
      return (_ctx, _cache) => {
        return (0, import_vue6.openBlock)(), (0, import_vue6.createElementBlock)("view", { renderWhole: true }, [
          (0, import_vue6.unref)(_showHeader) ? ((0, import_vue6.openBlock)(), (0, import_vue6.createElementBlock)("scroll-view", {
            key: 0,
            enableFlex: isNvue.value,
            class: (0, import_vue6.normalizeClass)([isNvue.value ? "flex-row flex" : "tableHeader"]),
            scrollX: true,
            scrollWithAnimation: false,
            showScrollbar: false,
            onScroll: tableScroll,
            onTouchstart: _cache[2] || (_cache[2] = ($event) => (0, import_vue6.isRef)(scrollDong) ? scrollDong.value = "t" : scrollDong = "t"),
            onMouseup: _cache[3] || (_cache[3] = ($event) => (0, import_vue6.isRef)(scrollDong) ? scrollDong.value = "t" : scrollDong = "t"),
            scrollLeft: headerLeft.value,
            style: (0, import_vue6.normalizeStyle)({ width: `${(0, import_vue6.unref)(defaultProps).width}rpx`, height: `${(0, import_vue6.unref)(defaultProps).headerHeight}rpx` })
          }, [
            ((0, import_vue6.openBlock)(true), (0, import_vue6.createElementBlock)(import_vue6.Fragment, null, (0, import_vue6.renderList)(_col.value, (item, index) => {
              return (0, import_vue6.openBlock)(), (0, import_vue6.createBlock)(tmSheet, {
                border: (0, import_vue6.unref)(_showBottomBorder) ? 1 : 0,
                "border-direction": "bottom",
                color: item.bgColor,
                text: item.light,
                _class: "flex flex-col " + item.align,
                height: (0, import_vue6.unref)(defaultProps).headerHeight - 6,
                width: item.width - 10,
                key: index,
                margin: [0, 0],
                padding: [10, 6],
                ...
                default: (0, import_vue6.withCtx)(() => [
                  (0, import_vue6.createElementVNode)("view", {
                    userInteractionEnabled: false,
                    style: (0, import_vue6.normalizeStyle)({ width: item.width - 10 + "rpx", height: (0, import_vue6.unref)(defaultProps).headerHeight - 6 + "rpx" }),
                    class: (0, import_vue6.normalizeClass)(["flex flex-row-center-center flex-row", [item.align]])
                  }, [
                    (0, import_vue6.createElementVNode)("view", {
                      onClick: _cache[0] || (_cache[0] = (0, import_vue6.withModifiers)(() => {
                      }, ["stop"])),
                      class: "flex-1 flex",
                      style: { "width": "0px" }
                    }, [
                    ...
                    item.sort ? ((0, import_vue6.openBlock)(), (0, import_vue6.createElementBlock)("view", {
                      key: 0,
                      onClick: _cache[1] || (_cache[1] = (0, import_vue6.withModifiers)(() => {
                      }, ["stop"])),
          ...
          ], 46, ["enableFlex", "scrollLeft"])) : (0, import_vue6.createCommentVNode)("v-if", true),
          (0, import_vue6.createElementVNode)("scroll-view", {
            scrollWithAnimation: false,
            enableFlex: isNvue.value,
            class: (0, import_vue6.normalizeClass)([isNvue.value ? "flex-col flex" : ""]),
            scrollY: true,
            style: (0, import_vue6.normalizeStyle)([(0, import_vue6.unref)(defaultProps).height ? { height: `${(0, import_vue6.unref)(defaultProps).height}rpx` } : "", { width: `${(0, import_vue6.unref)(defaultProps).width}rpx` }])
          }, [
            ((0, import_vue6.openBlock)(true), (0, import_vue6.createElementBlock)(import_vue6.Fragment, null, (0, import_vue6.renderList)(_tabel.value, (item2, index2) => {
              return (0, import_vue6.openBlock)(), (0, import_vue6.createElementBlock)("scroll-view", {
                ...
                showScrollbar: false,
                enableFlex: isNvue.value,
                class: (0, import_vue6.normalizeClass)([isNvue.value ? "flex-row flex" : ""]),
                scrollX: true,
                style: (0, import_vue6.normalizeStyle)([
                  { width: `${(0, import_vue6.unref)(defaultProps).width}rpx` }
                ]),
                key: index2,
                margin: [0, 0]
              }, [
                (0, import_vue6.createElementVNode)("view", { class: "flex flex-row flex-nowrap" }, [
                  ((0, import_vue6.openBlock)(true), (0, import_vue6.createElementBlock)(import_vue6.Fragment, null, (0, import_vue6.renderList)(item2.data, (item, index) => {
                    return (0, import_vue6.openBlock)(), (0, import_vue6.createBlock)(tmSheet, {
                      border: (0, import_vue6.unref)(_showBottomBorder) ? 1 : 0,
                      "border-direction": "bottom",
                      key: index,
                      ...
                      height: (0, import_vue6.unref)(defaultProps).cellHeight - 6,
                      width: item.width - 10,
                      padding: [10, 6]
                    }, {
                      default: (0, import_vue6.withCtx)(() => {
                        var _a2;
                        return [
                          item.type == "text" ? ((0, import_vue6.openBlock)(), (0, import_vue6.createBlock)(tmText, {
                            key: 0,
                            "font-size": 24,
                            label: item.text
                          }, null, 8, ["label"])) : (0, import_vue6.createCommentVNode)("v-if", true),
                          item.type == "button" ? ((0, import_vue6.openBlock)(), (0, import_vue6.createBlock)(TmButton, {
                            key: 1,
                            ...
                            "font-size": 24,
                            label: item.text
                          }, null, 8, ["onClick", "color", "width", "label"])) : (0, import_vue6.createCommentVNode)("v-if", true)
                        ];
                      }),
                      _: 2
  ...
  var tmTable = /* @__PURE__ */ _export_sfc(_sfc_main$12, [["__file", "F:/CoinQT/CoinQT_app/tmui/components/tm-table/tm-table.vue"]]);
  var _sfc_main6 = /* @__PURE__ */ (0, import_vue6.defineComponent)({
    __name: "table",
    setup(__props) {
      const header = (0, import_vue6.ref)([
      ...
      const tableData = (0, import_vue6.ref)([
        {
          data: {
            unpayamount: 100,
            paytime: "2022/2/5",
      ...
      return (_ctx, _cache) => {
        return (0, import_vue6.openBlock)(), (0, import_vue6.createBlock)(tmApp, null, {
          default: (0, import_vue6.withCtx)(() => [
            (0, import_vue6.createVNode)(tmSheet, null, {
              default: (0, import_vue6.withCtx)(() => [
                ...
                (0, import_vue6.createVNode)(tmTable, {
                  onRowClick: onClick,
                  height: 450,
                  width: 638,
  ...
  var table = /* @__PURE__ */ _export_sfc(_sfc_main6, [["__file", "F:/CoinQT/CoinQT_app/pages/showdata/table.nvue"]]);

  // <stdin>
  var webview = plus.webview.currentWebview();
  if (webview) {
    const __pageId = parseInt(webview.id);
    const __pagePath = "pages/showdata/table";
    let __pageQuery = {};
    try {
