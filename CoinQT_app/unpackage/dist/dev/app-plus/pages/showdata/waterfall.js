...
(() => {
  ...
  // F:/CoinQT/CoinQT_app/unpackage/dist/dev/.nvue/pages/showdata/waterfall.js
  ...
  var _sfc_main$2 = /* @__PURE__ */ (0, import_vue7.defineComponent)({
    ...
    setup(__props, { expose }) {
      const props = __props;
      const _containerWidth = (0, import_vue7.computed)(() => props.width);
      const _itemRealWidth = (0, import_vue7.computed)(() => {
        return (_containerWidth.value - props.gutter) / 2;
      });
      const parentNameId = "tmWaterfallId";
      const _cacheList = (0, import_vue7.ref)([]);
      const _totalSort = (0, import_vue7.ref)([[], []]);
      const _list = (0, import_vue7.ref)([]);
      const _totalNum = (0, import_vue7.ref)([]);
      const _containerHeight = (0, import_vue7.computed)(() => {
      ...
      (0, import_vue7.provide)("tmWaterFallItemRealWidth", (0, import_vue7.computed)(() => uni.upx2px(_itemRealWidth.value)));
      ...
      return (_ctx, _cache) => {
        return (0, import_vue7.openBlock)(), (0, import_vue7.createElementBlock)("view", { renderWhole: true }, [
          (0, import_vue7.createElementVNode)("view", {
            ...
            style: (0, import_vue7.normalizeStyle)([{ width: (0, import_vue7.unref)(_containerWidth) + "rpx", height: (0, import_vue7.unref)(_containerHeight).maxHeight + 50 + "px" }])
          }, [
            (0, import_vue7.renderSlot)(_ctx.$slots, "default")
          ], 4),
          (0, import_vue7.createCommentVNode)(" \u865A\u62DF\u52A0\u8F7D\u5360\u4F4D\u7B26\u3002 "),
          _totalNum.value.length != _list.value.length ? ((0, import_vue7.openBlock)(), (0, import_vue7.createBlock)(tmSheet, {
            key: 0,
  ...
  var _sfc_main$12 = /* @__PURE__ */ (0, import_vue7.defineComponent)({
    ...
    setup(__props, { emit: emits }) {
      ...
      const _width = (0, import_vue7.inject)("tmWaterFallItemRealWidth", (0, import_vue7.computed)(() => uni.upx2px(_width.value)));
      let _nodeInfo = (0, import_vue7.ref)({
      ...
      const isimgLoad = (0, import_vue7.ref)(props.img ? false : true);
      const _parentComs = getParent();
      const isPush = (0, import_vue7.ref)(false);
      if (!_parentComs) {
      ...
      function imgLoadSuccess(e) {
        ...
        _nodeInfo.value = __spreadProps7(__spreadValues7({}, _nodeInfo.value), { imgWidth: _w, imgHeight: _height });
        setTimeout(() => {
          (0, import_vue7.nextTick)(() => nvuegetClientRect());
        }, 50);
      }
      function getParent() {
        var _a22;
          ...
          dom.getComponentRect(proxy.$refs.itemWall, function(res) {
            if (res == null ? void 0 : res.size) {
              if (res.size.height == 0 && res.size.width == 0) {
                ...
                _nodeInfo.value = __spreadProps7(__spreadValues7({}, _nodeInfo.value), {
                  height
                });
      ...
      function pushKey() {
        return __async(this, null, function* () {
          if (_parentComs) {
            let pos = yield _parentComs.pushKey((0, import_vue7.toRaw)(_nodeInfo.value));
            _nodeInfo.value = pos;
          }
        });
      }
      ...
      return (_ctx, _cache) => {
        return (0, import_vue7.openBlock)(), (0, import_vue7.createElementBlock)("view", {
          ...
          style: (0, import_vue7.normalizeStyle)([
            ...
            isPush.value ? { transform: `translateX(${(0, import_vue7.unref)(_nodeInfo).left}px) translateY(${(0, import_vue7.unref)(_nodeInfo).top}px)` } : ""
          ]),
          renderWhole: true
        }, [
          (0, import_vue7.createVNode)(tmSheet, {
            ...
            padding: [0, 0],
            round: props.round,
            width: (0, import_vue7.unref)(_width),
            unit: "px",
            color: props.color,
            _class: "flex flex-col flex-col-top-start"
          }, {
            default: (0, import_vue7.withCtx)(() => [
              props.img ? ((0, import_vue7.openBlock)(), (0, import_vue7.createBlock)(tmImage, {
                key: 0,
                onClick: onImgClick,
                round: props.round,
                ...
                src: props.img,
                unit: "px",
                height: (0, import_vue7.unref)(_nodeInfo).imgHeight,
                width: (0, import_vue7.unref)(_nodeInfo).imgWidth
              }, null, 8, ["round", "src", "height", "width"])) : (0, import_vue7.createCommentVNode)("v-if", true),
              (0, import_vue7.createElementVNode)("view", { class: "flex flex-col flex-1 flex-col-top-start" }, [
                (0, import_vue7.renderSlot)(_ctx.$slots, "default")
              ])
            ]),
            _: 3
  ...
  var tmWaterfallItem = /* @__PURE__ */ _export_sfc(_sfc_main$12, [["__file", "F:/CoinQT/CoinQT_app/tmui/components/tm-waterfall-item/tm-waterfall-item.vue"]]);
  var _sfc_main7 = /* @__PURE__ */ (0, import_vue7.defineComponent)({
    __name: "waterfall",
    setup(__props) {
      const imglist = (0, import_vue7.ref)([]);
      for (let i = 0; i < 21; i++) {
        imglist.value.push({
            ...
            default: (0, import_vue7.withCtx)(() => [
              (0, import_vue7.createVNode)(tmSheet, null, {
                default: (0, import_vue7.withCtx)(() => [
                  ...
                  (0, import_vue7.createElementVNode)("view", { class: "flex flex-col flex-col-top-center" }, [
                    (0, import_vue7.createVNode)(tmWaterfall, { width: 626 }, {
                      default: (0, import_vue7.withCtx)(() => [
                        ((0, import_vue7.openBlock)(true), (0, import_vue7.createElementBlock)(import_vue7.Fragment, null, (0, import_vue7.renderList)(imglist.value, (item, index) => {
                          return (0, import_vue7.openBlock)(), (0, import_vue7.createBlock)(tmWaterfallItem, {
                            img: item.img
                          }, {
                            default: (0, import_vue7.withCtx)(() => [
                              (0, import_vue7.createElementVNode)("view", { class: "py-24" }, [
                                (0, import_vue7.createVNode)(tmText, {
                                  label: item.text
                                }, null, 8, ["label"])
                              ])
  ...
  var waterfall = /* @__PURE__ */ _export_sfc(_sfc_main7, [["__file", "F:/CoinQT/CoinQT_app/pages/showdata/waterfall.nvue"]]);

  // <stdin>
  var webview = plus.webview.currentWebview();
  if (webview) {
    const __pageId = parseInt(webview.id);
    const __pagePath = "pages/showdata/waterfall";
    let __pageQuery = {};
    try {
      __pageQuery = JSON.parse(webview.__query__);
    } catch (e) {
    }
    waterfall.mpType = "page";
    const app = Vue.createPageApp(waterfall, { $store: getApp({ allowDefault: true }).$store, __pageId, __pagePath, __pageQuery });
    app.provide("__globalStyles", Vue.useCssStyles([...__uniConfig.styles, ...waterfall.styles || []]));
    app.mount("#root");
  }
})();
