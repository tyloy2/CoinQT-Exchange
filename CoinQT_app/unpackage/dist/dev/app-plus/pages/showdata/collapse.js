...
(() => {
  ...
  // F:/CoinQT/CoinQT_app/unpackage/dist/dev/.nvue/pages/showdata/collapse.js
  ...
  var _sfc_main$2 = /* @__PURE__ */ (0, import_vue4.defineComponent)({
    ...
    setup(__props, { expose, emit: emits }) {
      const props = __props;
      const _activeKey = (0, import_vue4.ref)([...props.activeKey, ...props.defaultActiveKey]);
      if (props.accordion) {
        if (_activeKey.value.length > 0) {
          _activeKey.value = [_activeKey.value[0]];
        }
      }
      const cacheKey = (0, import_vue4.ref)([]);
      ...
      (0, import_vue4.provide)("tmCollapseKeyList", (0, import_vue4.computed)(() => _activeKey.value));
      (0, import_vue4.provide)("tmCollapseIconPos", (0, import_vue4.computed)(() => props.iconPos));
      (0, import_vue4.provide)("tmCollapseopenIcon", (0, import_vue4.computed)(() => props.openIcon));
      (0, import_vue4.provide)("tmCollapsecloseIcon", (0, import_vue4.computed)(() => props.closeIcon));
      return (_ctx, _cache) => {
  ...
  var _sfc_main$12 = /* @__PURE__ */ (0, import_vue4.defineComponent)({
    ...
    setup(__props, { emit: emits }) {
      ...
      const _activekeyArray = (0, import_vue4.inject)("tmCollapseKeyList", (0, import_vue4.computed)(() => []));
      const _tmCollapseIconPos = (0, import_vue4.inject)("tmCollapseIconPos", (0, import_vue4.computed)(() => "left"));
      const _tmCollapsecloseIcon = (0, import_vue4.inject)("tmCollapsecloseIcon", (0, import_vue4.computed)(() => "tmicon-caret-right"));
      const _tmCollapseopenIcon = (0, import_vue4.inject)("tmCollapseopenIcon", (0, import_vue4.computed)(() => "tmicon-sort-down"));
      const _leftIcon = (0, import_vue4.computed)(() => props.leftIcon);
      const isActiveAfter = (0, import_vue4.ref)(false);
      ...
      const cborder = (0, import_vue4.ref)(props.border ? props.border : parent == null ? void 0 : parent.border);
      const isActive = (0, import_vue4.computed)(() => {
        let index = _activekeyArray.value.findIndex((el) => {
          return el == props.name;
        });
        return index > -1;
      });
      const _leftIconColor = (0, import_vue4.computed)(() => {
      ...
      return (_ctx, _cache) => {
        return (0, import_vue4.openBlock)(), (0, import_vue4.createElementBlock)("view", {
          class: (0, import_vue4.normalizeClass)(["flex flex-col overflow", [__props.disabled ? "opacity-7" : ""]]),
          renderWhole: true
        }, [
          (0, import_vue4.createVNode)(tmSheet, {
            ...
            border: (0, import_vue4.unref)(isActive) ? 0 : cborder.value,
            linear: props.linear,
            ...
            default: (0, import_vue4.withCtx)(() => [
              (0, import_vue4.createElementVNode)("view", {
                ...
                (0, import_vue4.unref)(_tmCollapseIconPos) == "left" ? ((0, import_vue4.openBlock)(), (0, import_vue4.createElementBlock)("view", {
                  key: 0,
                  ...
                  (0, import_vue4.createVNode)(tmIcon, {
                    dark: props.dark,
                    followDark: props.followDark,
                    color: (0, import_vue4.unref)(isActive) ? props.activeColor : "grey-1",
                    name: (0, import_vue4.unref)(isActive) ? (0, import_vue4.unref)(_tmCollapseopenIcon) : (0, import_vue4.unref)(_tmCollapsecloseIcon),
                    "font-size": 20
                  }, null, 8, ["dark", "followDark", "color", "name"])
                ])) : (0, import_vue4.createCommentVNode)("v-if", true),
                (0, import_vue4.renderSlot)(_ctx.$slots, "icon", {}, () => [
                  (0, import_vue4.unref)(_leftIcon) ? ((0, import_vue4.openBlock)(), (0, import_vue4.createElementBlock)("view", {
                    key: 0,
                    class: "flex flex-center pr-16"
                  }, [
                    (0, import_vue4.createVNode)(tmIcon, {
                      style: { "line-height": "0px" },
                      color: (0, import_vue4.unref)(_leftIconColor),
                      "font-size": 24,
                      name: (0, import_vue4.unref)(_leftIcon)
                    }, null, 8, ["color", "name"])
                  ])) : (0, import_vue4.createCommentVNode)("v-if", true)
                ]),
                (0, import_vue4.createElementVNode)("view", {
                  ...
                  (0, import_vue4.renderSlot)(_ctx.$slots, "title", {
                    data: { isActive: (0, import_vue4.unref)(isActive) }
                  }, () => [
                    (0, import_vue4.createVNode)(tmText, {
                      ...
                      color: (0, import_vue4.unref)(isActive) ? props.activeColor : "",
                      label: props.title
                    }, null, 8, ["dark", "followDark", "fontSize", "color", "label"])
                  ])
                ]),
                (0, import_vue4.renderSlot)(_ctx.$slots, "rightLabel"),
                (0, import_vue4.unref)(_tmCollapseIconPos) == "right" ? ((0, import_vue4.openBlock)(), (0, import_vue4.createElementBlock)("view", {
                  key: 1,
          ...
          (0, import_vue4.unref)(isActive) ? ((0, import_vue4.openBlock)(), (0, import_vue4.createElementBlock)("view", {
            key: 0,
            class: "flex overflow"
          }, [
            (0, import_vue4.createElementVNode)("view", {
              class: (0, import_vue4.normalizeClass)(["flex content flex-col flex-1", [isActiveAfter.value ? "on" : ""]])
            }, [
              (0, import_vue4.renderSlot)(_ctx.$slots, "default")
            ], 2)
          ])) : (0, import_vue4.createCommentVNode)("v-if", true)
  ...
  var tmCollapseItem = /* @__PURE__ */ _export_sfc(_sfc_main$12, [["__file", "F:/CoinQT/CoinQT_app/tmui/components/tm-collapse-item/tm-collapse-item.vue"]]);
      ...
      return (_ctx, _cache) => {
        return (0, import_vue4.openBlock)(), (0, import_vue4.createElementBlock)("scroll-view", {
          ...
          (0, import_vue4.createVNode)(tmApp, null, {
            default: (0, import_vue4.withCtx)(() => [
              (0, import_vue4.createVNode)(tmCollapse, { defaultActiveKey: ["2"] }, {
                default: (0, import_vue4.withCtx)(() => [
                  (0, import_vue4.createVNode)(tmCollapseItem, {
                    title: "\u9762\u677F\u6807\u98981",
                    name: "1"
                  }, {
                    default: (0, import_vue4.withCtx)(() => [
                      (0, import_vue4.createElementVNode)("view", { class: "pa-24" }, [
                        (0, import_vue4.createVNode)(tmText, {
                          "font-size": 28,
                  ...
                  (0, import_vue4.createVNode)(tmCollapseItem, {
                    ...
                    default: (0, import_vue4.withCtx)(() => [
                      (0, import_vue4.createElementVNode)("view", { class: "pa-24" }, [
                        (0, import_vue4.createVNode)(tmCollapse, {
                          iconPos: "right",
                          defaultActiveKey: ["1"]
                        }, {
                          default: (0, import_vue4.withCtx)(() => [
              ...
              (0, import_vue4.createVNode)(tmSheet, { color: "primary" }, {
                default: (0, import_vue4.withCtx)(() => [
                  (0, import_vue4.createVNode)(tmText, {
                    "font-size": 24,
                    _class: "font-weight-b",
  ...
  var collapse = /* @__PURE__ */ _export_sfc(_sfc_main4, [["__file", "F:/CoinQT/CoinQT_app/pages/showdata/collapse.nvue"]]);

  // <stdin>
  var webview = plus.webview.currentWebview();
  if (webview) {
    const __pageId = parseInt(webview.id);
    const __pagePath = "pages/showdata/collapse";
    let __pageQuery = {};
    try {
