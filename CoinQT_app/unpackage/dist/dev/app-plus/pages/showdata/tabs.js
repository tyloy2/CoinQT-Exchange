...
(() => {
  ...
  // F:/CoinQT/CoinQT_app/unpackage/dist/dev/.nvue/pages/showdata/tabs.js
  ...
  var _sfc_main4 = /* @__PURE__ */ (0, import_vue4.defineComponent)({
    ...
    setup(__props, { emit: emits }) {
      ...
      const istext = (0, import_vue4.computed)(() => {
        return isNaN(parseInt(String(props.count)));
      });
      const show = (0, import_vue4.computed)(() => {
        if (!props.dot && !props.icon && !props.count)
          return false;
        return true;
      });
      const size = (0, import_vue4.computed)(() => {
      ...
      const _dot = (0, import_vue4.computed)(() => props.dot);
      const _count = (0, import_vue4.computed)(() => props.count);
      return (_ctx, _cache) => {
        return (0, import_vue4.openBlock)(), (0, import_vue4.createElementBlock)("view", {
          class: (0, import_vue4.normalizeClass)(["flex relative", [props.status ? "flex-row flex-row-center-center mx-8" : ""]]),
          renderWhole: true
        }, [
          !props.status ? ((0, import_vue4.openBlock)(), (0, import_vue4.createElementBlock)("view", { key: 0 }, [
            (0, import_vue4.renderSlot)(_ctx.$slots, "default")
          ])) : (0, import_vue4.createCommentVNode)("v-if", true),
          (0, import_vue4.unref)(show) ? ((0, import_vue4.openBlock)(), (0, import_vue4.createElementBlock)("view", {
            key: 1,
            class: (0, import_vue4.normalizeClass)([
              ((0, import_vue4.unref)(_dot) || (0, import_vue4.unref)(_count) || (0, import_vue4.unref)(_icon)) && !props.status ? "absolute flex-top-start-end r-0" : ""
            ]),
            style: { zIndex: 10 }
          }, [
            (0, import_vue4.createVNode)(tmSheet, {
              onClick: _cache[0] || (_cache[0] = ($event) => emits("click", $event)),
              color: props.color,
              _class: [(0, import_vue4.unref)(customClass), "flex-center flex-col"],
              _style: [(0, import_vue4.unref)(customCSSStyle), { flexShrink: 1 }],
              ...
              width: (0, import_vue4.unref)(size).w,
              height: (0, import_vue4.unref)(size).h,
              margin: props.margin,
              padding: props.padding
            }, {
              default: (0, import_vue4.withCtx)(() => [
                (0, import_vue4.unref)(_count) > 0 && !(0, import_vue4.unref)(istext) ? ((0, import_vue4.openBlock)(), (0, import_vue4.createBlock)(tmText, {
                  key: 0,
                  color: "white",
                  "font-size": props.fontSize,
                  _class: (0, import_vue4.unref)(size).h == 0 ? "py-3 px-8" : "",
                  label: (0, import_vue4.unref)(_count) > props.maxCount ? props.maxCount + "+" : (0, import_vue4.unref)(_count)
                }, null, 8, ["font-size", "_class", "label"])) : (0, import_vue4.createCommentVNode)("v-if", true),
                (0, import_vue4.unref)(_count) && (0, import_vue4.unref)(istext) ? ((0, import_vue4.openBlock)(), (0, import_vue4.createBlock)(tmText, {
                  key: 1,
                  color: "white",
                  "font-size": props.fontSize,
                  _class: (0, import_vue4.unref)(size).h == 0 ? "py-3 px-8" : "",
                  label: (0, import_vue4.unref)(_count)
                }, null, 8, ["font-size", "_class", "label"])) : (0, import_vue4.createCommentVNode)("v-if", true),
                ...
                }, null, 8, ["font-size", "name"])) : (0, import_vue4.createCommentVNode)("v-if", true)
              ]),
              _: 1
          ...
          props.status ? ((0, import_vue4.openBlock)(), (0, import_vue4.createBlock)(tmText, {
            key: 2,
            "font-size": props.fontSize,
            _class: "ml-10",
            label: props.label
          }, null, 8, ["font-size", "label"])) : (0, import_vue4.createCommentVNode)("v-if", true)
        ], 2);
      };
    }
  });
  var tmBadge = /* @__PURE__ */ _export_sfc(_sfc_main4, [["__file", "F:/CoinQT/CoinQT_app/tmui/components/tm-badge/tm-badge.vue"]]);
  ...
  var _sfc_main$2 = /* @__PURE__ */ (0, import_vue6.defineComponent)({
    __name: "tm-tabs",
    ...
    setup(__props, { expose, emit: emits }) {
      ...
      const bindxToken = (0, import_vue6.ref)(null);
      const _align = (0, import_vue6.computed)(() => {
        let align_list = {
      ...
      const _active = (0, import_vue6.ref)(props.defaultName);
      emits("update:activeName", _active.value);
      const cstomClass = (0, import_vue6.computed)(() => computedClass(props));
      const _scrollToId = (0, import_vue6.ref)("");
      const modelStyle = (0, import_vue6.computed)(() => {
      ...
      const _tabPos = (0, import_vue6.computed)(() => props.tabPos);
      const cacheTabs = (0, import_vue6.ref)([]);
      const isDulitabs = (0, import_vue6.computed)(() => props.list.length > 0);
      const tabsid = "tabs_id_" + uni.$tm.u.getUid(1) + "_";
      const isNvue = (0, import_vue6.ref)(false);
      const _itemheight = Math.ceil(uni.upx2px(props.itemHeight));
      const totalWidth = (0, import_vue6.computed)(() => uni.upx2px(cacheTabs.value.length * props.width));
      ...
      const contentWidth = (0, import_vue6.computed)(() => {
      ...
      const anitLineLeft = (0, import_vue6.ref)(0);
      isNvue.value = true;
      let timerId = NaN;
      ...
      const _startx = (0, import_vue6.ref)(0);
      const _starty = (0, import_vue6.ref)(0);
      (0, import_vue6.ref)(0);
      (0, import_vue6.ref)(0);
      const _x = (0, import_vue6.ref)(0);
      const _y = (0, import_vue6.ref)(0);
      (0, import_vue6.ref)(0);
      (0, import_vue6.ref)(0);
      const directoStyle = (0, import_vue6.ref)(0);
      const isEndMove = (0, import_vue6.ref)(true);
      const maxLen = 80;
      const activeIndex = (0, import_vue6.computed)(() => cacheTabs.value.findIndex((el) => el.key == _active.value));
      let ctxLeft = 0;
      let ctxTop = 0;
      let timeDetail = 1;
      let isMoveEnb = false;
      let dirType = (0, import_vue6.ref)("none");
      (0, import_vue6.ref)(false);
      let sliderBarWidth = uni.upx2px(40);
      let widthDrag = (0, import_vue6.ref)(sliderBarWidth);
      ...
      (0, import_vue6.watch)(() => props.activeName, () => {
      ...
      (0, import_vue6.watch)(() => _active.value, () => {
        (0, import_vue6.nextTick)(() => {
          var _a22, _b22;
      ...
      let isMoveing = (0, import_vue6.ref)(false);
      ...
      function pushKey(o) {
        ...
        if (index > -1) {
          cacheTabs.value.splice(index, 1, __spreadValues6(__spreadValues6({}, cacheTabs.value[0]), o));
        } else {
      ...
      function changeKey(key, isclick = true) {
        ...
        timeDetail = 1;
        emits("change", key);
        emits("update:activeName", (0, import_vue6.toRaw)(_active.value));
        if (isclick) {
          emits("click", key);
        }
      }
      ...
      (0, import_vue6.provide)("tabsActiveName", (0, import_vue6.computed)(() => _active.value));
      (0, import_vue6.provide)("tabsActiveactiveIndex", activeIndex);
      (0, import_vue6.provide)("tabsActiveCacheTabse", (0, import_vue6.computed)(() => cacheTabs.value));
      (0, import_vue6.provide)("tabsWidth", (0, import_vue6.computed)(() => props.width));
      (0, import_vue6.provide)("tabsheight", (0, import_vue6.computed)(() => {
        if (!props.height)
          return 0;
        return props.height - props.itemHeight - props.gutter;
      }));
      (0, import_vue6.provide)("tabsSwiper", (0, import_vue6.computed)(() => props.swiper));
      (0, import_vue6.provide)("tabsSwiperIsMoveing", (0, import_vue6.computed)(() => isMoveing.value));
      expose({
        pushKey,
        changeKey,
        unbindKey,
      ...
      return (_ctx, _cache) => {
        return (0, import_vue6.openBlock)(), (0, import_vue6.createElementBlock)("view", {
          ...
          style: (0, import_vue6.normalizeStyle)([
            props.height && (0, import_vue6.unref)(isDulitabs) == false ? { height: __props.height + "rpx" } : "",
            { width: props.width + "rpx" }
          ]),
          renderWhole: true
        }, [
          (0, import_vue6.createCommentVNode)(" \u6B64\u6E90\u7801\u6709uniapp bug.\u5982\u679C\u5728nvue\u9875\u9762\u7F16\u8BD1\u81F3h5\u5E73\u53F0\u65F6\uFF0C\u5F00\u542Fenable-flexr\u540E\u9700\u8981\u91CC\u9762\u518D\u5957\u5C42view\u518D\u5199flex\u624D\u80FD\u771F\u6B63\u7684\u5F00flex "),
          (0, import_vue6.createCommentVNode)(" \u56E0\u6B64\u4E0B\u9762\u7684\u5185\u5BB9\u4F5C\u4E86\u6761\u4EF6\u7F16\u8BD1\u5206\u4E3Anvue\u548C\u975Envue "),
          (0, import_vue6.createCommentVNode)(" https://ask.dcloud.net.cn/question/143230 "),
          (0, import_vue6.createCommentVNode)(' @touchmove="onMove"\r\n		@touchend="onEnd" \r\n		@touchstart="onStart" '),
          (0, import_vue6.unref)(_tabPos) == "bottom" && (0, import_vue6.unref)(isDulitabs) == false ? ((0, import_vue6.openBlock)(), (0, import_vue6.createElementBlock)("view", {
            key: 0,
            onTouchstart: spinNvueAni,
            ref: "tabsDom",
            style: (0, import_vue6.normalizeStyle)({ width: props.swiper ? `${(0, import_vue6.unref)(totalWidth)}px` : `${props.width}rpx`, transform: `translateX(0px)` }),
            class: "flex flex-row flex-nowrap overflow"
          }, [
            (0, import_vue6.renderSlot)(_ctx.$slots, "default")
          ], 36)) : (0, import_vue6.createCommentVNode)("v-if", true),
          (0, import_vue6.createVNode)(tmSheet, {
            ...
            margin: [0, 0],
            padding: [0, 0],
            height: props.itemHeight + (0, import_vue6.unref)(modelStyle).border + props.gutter + 4,
            _class: ["flex-center flex-row nonvue", (0, import_vue6.unref)(cstomClass)],
            _style: props._style,
            width: props.width
          }, {
            default: (0, import_vue6.withCtx)(() => [
              (0, import_vue6.createCommentVNode)(" \u6807\u9898 "),
              (0, import_vue6.createCommentVNode)(" \u6807\u9898 "),
              !props.showTabsLineAni && props.itemWidth == 0 ? ((0, import_vue6.openBlock)(), (0, import_vue6.createElementBlock)("scroll-view", {
                key: 0,
                ...
                showScrollbar: false,
                enableFlex: "",
                class: (0, import_vue6.normalizeClass)(["flex-row", [(0, import_vue6.unref)(_align)]]),
                style: (0, import_vue6.normalizeStyle)([{ width: `${props.width}rpx`, height: `${props.itemHeight + 4}rpx` }])
              }, [
                ((0, import_vue6.openBlock)(true), (0, import_vue6.createElementBlock)(import_vue6.Fragment, null, (0, import_vue6.renderList)(cacheTabs.value, (item, index) => {
                  return (0, import_vue6.openBlock)(), (0, import_vue6.createElementBlock)("view", {
                    id: tabsid + item.key,
                    key: index
                  }, [
                    (0, import_vue6.createVNode)(tmSheet, {
                      ...
                      text: item.key === _active.value ? (0, import_vue6.unref)(modelStyle).text : false,
                      border: item.key === _active.value ? (0, import_vue6.unref)(modelStyle).border : 0,
                      transprent: item.key === _active.value ? (0, import_vue6.unref)(modelStyle).transprent : true,
                      ...
                      default: (0, import_vue6.withCtx)(() => [
                        (0, import_vue6.createVNode)(tmBadge, {
                          dot: item.dot,
                          count: item.count,
                          color: item.dotColor
                        }, {
                          default: (0, import_vue6.withCtx)(() => [
                            (0, import_vue6.createElementVNode)("view", {
                              class: "flex flex-row flex-center",
                              style: (0, import_vue6.normalizeStyle)({ height: props.itemHeight - 20 + "rpx" })
                            }, [
                              item.icon ? ((0, import_vue6.openBlock)(), (0, import_vue6.createBlock)(tmIcon, {
                                key: 0,
                                ...
                                name: item.icon
                              }, null, 8, ["color", "font-size", "name"])) : (0, import_vue6.createCommentVNode)("v-if", true),
                ...
                props.showTabsLineAni && props.itemWidth > 0 ? ((0, import_vue6.openBlock)(), (0, import_vue6.createElementBlock)("view", {
                  key: 0,
                  class: "absolute l-0 b-0",
                  style: (0, import_vue6.normalizeStyle)({
                    width: `${(0, import_vue6.unref)(contentWidth)}rpx`,
                    height: "1px",
                    backgroundColor: props.showTabsLineAni ? (0, import_vue6.unref)(store).tmStore.dark ? "#616161" : "#ebebeb" : ""
                  })
                }, null, 4)) : (0, import_vue6.createCommentVNode)("v-if", true),
                props.showTabsLineAni && props.itemWidth > 0 ? ((0, import_vue6.openBlock)(), (0, import_vue6.createElementBlock)("view", {
                  key: 1,
                  class: "anilineBar absolute l-0 b-0",
                  style: (0, import_vue6.normalizeStyle)({ transform: `translateX(${anitLineLeft.value}px)` })
                }, [
                  (0, import_vue6.createVNode)(tmSheet, {
                    round: 10,
                    "follow-dark": false,
              ...
              ], 14, ["scrollIntoView"])) : (0, import_vue6.createCommentVNode)("v-if", true),
              props.showTabsLineAni && props.itemWidth > 0 ? ((0, import_vue6.openBlock)(), (0, import_vue6.createElementBlock)("scroll-view", {
                key: 1,
                scrollIntoView: _scrollToId.value,
                scrollX: true,
                ...
                enableFlex: "",
                class: (0, import_vue6.normalizeClass)(["flex-row", [(0, import_vue6.unref)(_align)]]),
                style: (0, import_vue6.normalizeStyle)([{ width: `${(0, import_vue6.unref)(_width)}px`, height: `${props.itemHeight + 4}rpx` }])
              }, [
                ((0, import_vue6.openBlock)(true), (0, import_vue6.createElementBlock)(import_vue6.Fragment, null, (0, import_vue6.renderList)(cacheTabs.value, (item, index) => {
                  return (0, import_vue6.openBlock)(), (0, import_vue6.createElementBlock)("view", {
                    id: tabsid + item.key,
                    ...
                    (0, import_vue6.createVNode)(tmSheet, {
                      ...
                      transprent: item.key === _active.value ? (0, import_vue6.unref)(modelStyle).transprent : true,
                      color: props.activeColor && item.key === _active.value ? props.activeColor : props.color,
                      width: (0, import_vue6.unref)(_itemwidth),
                      _class: "flex-center flex-row",
                      margin: [0, 0],
                      padding: [0, 0],
                      height: (0, import_vue6.unref)(_itemheight),
                      unit: "px"
                    }, {
                      default: (0, import_vue6.withCtx)(() => [
                        (0, import_vue6.createVNode)(tmBadge, {
                          ...
                          default: (0, import_vue6.withCtx)(() => [
                            (0, import_vue6.createElementVNode)("view", { class: "flex flex-row flex-center" }, [
                              item.icon ? ((0, import_vue6.openBlock)(), (0, import_vue6.createBlock)(tmIcon, {
                                key: 0,
                                userInteractionEnabled: false,
                                _class: "pr-5",
                ...
                props.showTabsLineAni && props.itemWidth > 0 ? ((0, import_vue6.openBlock)(), (0, import_vue6.createElementBlock)("view", {
                  ...
                  style: (0, import_vue6.normalizeStyle)({ transform: `translateX(${anitLineLeft.value}px)`, width: (0, import_vue6.unref)(_itemwidth) + "px", height: "4px" })
                }, [
                  (0, import_vue6.createVNode)(tmSheet, {
                    ref: "sliderBarDom",
                    round: 10,
                    "follow-dark": false,
                    width: (0, import_vue6.unref)(sliderBarWidth),
                    unit: "px",
                    height: 4,
                    color: props.tabsLineAniColor,
                    margin: [0, 0],
          ...
          (0, import_vue6.createCommentVNode)(' @touchmove="onMove"\r\n		@touchend="onEnd" \r\n		@touchstart="onStart" '),
          (0, import_vue6.createCommentVNode)(' @touchmove="onMove" @touchend="onEnd" @touchcancel="onEnd"  '),
          (0, import_vue6.unref)(_tabPos) == "top" ? ((0, import_vue6.openBlock)(), (0, import_vue6.createElementBlock)("view", {
            key: 1,
            onTouchstart: spinNvueAni,
            onTouchmove: onMove,
            ref: "tabsDom",
  ...
  var _style_02 = { "contentx": { "": { "transitionDuration": 500, "transitionTimingFunction": "ease", "transitionDelay": 0, "transform": "translateY(0px)", "transitionProperty": "transform,top" } }, "@TRANSITION": { "contentx": { "duration": 500, "timingFunction": "ease", "delay": 0, "property": "transform,top" } } };
  var _sfc_main$12 = /* @__PURE__ */ (0, import_vue6.defineComponent)({
    __name: "tm-tabs-pane",
    props: __spreadProps6(__spreadValues6({}, custom_props), {
      transprent: {
        type: [Boolean, String],
    ...
    setup(__props) {
      var _a2, _b2, _c;
      const props = __props;
      (0, import_vue6.ref)(null);
      const proxy = (_b2 = (_a2 = (0, import_vue6.getCurrentInstance)()) == null ? void 0 : _a2.proxy) != null ? _b2 : null;
      const sc_top = (0, import_vue6.ref)(0);
      const refreshJuli = -100;
      const reFresh = (0, import_vue6.ref)(0);
      const isyesResh = (0, import_vue6.ref)(false);
      const isUpToogle = (0, import_vue6.ref)(true);
      const _pname = (0, import_vue6.computed)(() => String(props.name));
      ...
      const _width = (0, import_vue6.inject)("tabsWidth", (0, import_vue6.computed)(() => 0));
      const _height = (0, import_vue6.inject)("tabsheight", (0, import_vue6.computed)(() => 0));
      (0, import_vue6.inject)("tabsActiveName", (0, import_vue6.computed)(() => void 0));
      const tabsActiveCacheTabse = (0, import_vue6.inject)("tabsActiveCacheTabse", (0, import_vue6.computed)(() => {
        return [];
      }));
      const tabsSwiper = (0, import_vue6.inject)("tabsSwiper", (0, import_vue6.computed)(() => false));
      const tabsSwiperIsMoveing = (0, import_vue6.inject)("tabsSwiperIsMoveing", (0, import_vue6.computed)(() => false));
      const activeIndex = (0, import_vue6.inject)("tabsActiveactiveIndex", (0, import_vue6.computed)(() => 0));
      const selfIndex = (0, import_vue6.computed)(() => tabsActiveCacheTabse.value.findIndex((el) => el.key == _pname.value));
      const isShowRender = (0, import_vue6.computed)(() => {
      ...
      (0, import_vue6.watch)([() => props.title, () => props.icon, () => props.dot, () => props.dotColor], () => {
      ...
      return (_ctx, _cache) => {
        const _component_tm_icon = (0, import_vue6.resolveComponent)("tm-icon");
        const _component_tm_text = (0, import_vue6.resolveComponent)("tm-text");
        return (0, import_vue6.unref)(tabsSwiper) || !(0, import_vue6.unref)(tabsSwiper) && (0, import_vue6.unref)(isShowRender) ? ((0, import_vue6.openBlock)(), (0, import_vue6.createBlock)(tmSheet, {
          key: 0,
          transprent: props.transprent,
          color: props.color,
          followTheme: props.followTheme,
          ...
          margin: [0, 0],
          padding: [0, 0],
          width: (0, import_vue6.unref)(_width),
          height: (0, import_vue6.unref)(_height)
        }, {
          default: (0, import_vue6.withCtx)(() => [
            sc_top.value < -30 && reFresh.value != 0 ? ((0, import_vue6.openBlock)(), (0, import_vue6.createElementBlock)("view", {
              key: 0,
              style: (0, import_vue6.normalizeStyle)({ top: (reFresh.value == 2 ? -refreshJuli / 2 : -sc_top.value - 30) + "px", width: (0, import_vue6.unref)(_width) + "rpx" }),
              class: "zIndex-17 absolute l-0 flex flex-row flex-row-center-center"
            }, [
              (0, import_vue6.createElementVNode)("view", { class: "pr-32" }, [
                sc_top.value > refreshJuli && reFresh.value != 2 ? ((0, import_vue6.openBlock)(), (0, import_vue6.createBlock)(_component_tm_icon, {
                  key: 0,
                ...
                reFresh.value == 2 ? ((0, import_vue6.openBlock)(), (0, import_vue6.createBlock)(_component_tm_icon, {
                  key: 2,
                  spin: "",
                  name: "tmicon-shuaxin"
                })) : (0, import_vue6.createCommentVNode)("v-if", true)
              ...
              (0, import_vue6.createElementVNode)("view", null, [
                sc_top.value > refreshJuli ? ((0, import_vue6.openBlock)(), (0, import_vue6.createBlock)(_component_tm_text, {
                  key: 0,
                ...
                (0, import_vue6.createVNode)(_component_tm_text, {
                  _class: "text-align-center",
                  label: "\u66F4\u65B0\u4E8E\u4ECA\u65E58:30"
                })
              ])
            ...
            (0, import_vue6.createElementVNode)("scroll-view", {
              onScroll,
              scrollY: (0, import_vue6.unref)(_height) ? true : false,
              enableFlex: "",
              class: "flex-col",
              style: (0, import_vue6.normalizeStyle)([{ width: (0, import_vue6.unref)(_width) + "rpx" }, (0, import_vue6.unref)(_height) ? { height: (0, import_vue6.unref)(_height) + "rpx" } : ""])
            }, [
              (0, import_vue6.unref)(isShowRender) ? ((0, import_vue6.openBlock)(), (0, import_vue6.createElementBlock)("view", {
                key: 0,
                onTouchStart: onScrollStart,
                onTouchend: onScrollEnd,
                style: (0, import_vue6.normalizeStyle)({ transform: `translateY(${reFresh.value == 2 ? -refreshJuli : 0}px)` }),
                class: "flex contentx"
              }, [
                (0, import_vue6.renderSlot)(_ctx.$slots, "default")
              ], 36)) : (0, import_vue6.createCommentVNode)("v-if", true)
          ...
          _: 3
        }, 8, ["transprent", "color", "followTheme", "followDark", "dark", "round", "shadow", "outlined", "border", "borderStyle", "borderDirection", "text", "linear", "linearDeep", "_style", "_class", "width", "height"])) : (0, import_vue6.createCommentVNode)("v-if", true);
      };
    }
  });
  var tmTabsPane = /* @__PURE__ */ _export_sfc(_sfc_main$12, [["styles", [_style_02]], ["__file", "F:/CoinQT/CoinQT_app/tmui/components/tm-tabs-pane/tm-tabs-pane.vue"]]);
  var _sfc_main6 = /* @__PURE__ */ (0, import_vue6.defineComponent)({
    __name: "tabs",
    setup(__props) {
      const tabsTitle = (0, import_vue6.ref)([
      ...
      return (_ctx, _cache) => {
        return (0, import_vue6.openBlock)(), (0, import_vue6.createElementBlock)("scroll-view", {
          ...
          (0, import_vue6.createVNode)(tmApp, null, {
            default: (0, import_vue6.withCtx)(() => [
              (0, import_vue6.createVNode)(tmSheet, null, {
                default: (0, import_vue6.withCtx)(() => [
                  (0, import_vue6.createVNode)(tmTabs, {
                    showTabsLineAni: "",
                    "item-width": 110,
                    swiper: "",
                    width: 636,
                    ...
                    default: (0, import_vue6.withCtx)(() => [
                      ((0, import_vue6.openBlock)(), (0, import_vue6.createElementBlock)(import_vue6.Fragment, null, (0, import_vue6.renderList)(20, (item, index) => {
                        return (0, import_vue6.createVNode)(tmTabsPane, {
                          dot: item == 3,
                          key: index,
                          name: item,
                          title: "\u6807\u9898"
                          ...
                          default: (0, import_vue6.withCtx)(() => [
                            (0, import_vue6.createVNode)(tmSheet, { margin: [0, 0] }, {
                              default: (0, import_vue6.withCtx)(() => [
                                (0, import_vue6.createVNode)(tmText, {
                                  "font-size": 30,
                                ...
                                (0, import_vue6.createVNode)(tmDivider)
                              ]),
                              _: 2
                            }, 1024)
                          ]),
  ...
  var tabs = /* @__PURE__ */ _export_sfc(_sfc_main6, [["__file", "F:/CoinQT/CoinQT_app/pages/showdata/tabs.nvue"]]);

  // <stdin>
  var webview = plus.webview.currentWebview();
  if (webview) {
    const __pageId = parseInt(webview.id);
    const __pagePath = "pages/showdata/tabs";
    let __pageQuery = {};
    try {
