...
(() => {
  ...
  // F:/CoinQT/CoinQT_app/unpackage/dist/dev/.nvue/pages/showdata/statistic.js
  ...
  var _sfc_main$12 = /* @__PURE__ */ (0, import_vue4.defineComponent)({
    ...
    setup(__props, { expose, emit: emits }) {
      ...
      let displayValue = (0, import_vue4.ref)(formatNumber(props.startVal));
      let printVal = null;
      ...
      (0, import_vue4.watch)([() => props.startVal, () => props.endVal], () => {
        start();
      });
      ...
      (0, import_vue4.onBeforeUnmount)(() => clearInterval(timer));
      ...
      return (_ctx, _cache) => {
        return (0, import_vue4.openBlock)(), (0, import_vue4.createElementBlock)("view", {
          ...
          (0, import_vue4.renderSlot)(_ctx.$slots, "prefix", {}, () => [
          ...
          (0, import_vue4.renderSlot)(_ctx.$slots, "default", {}, () => [
            (0, import_vue4.createVNode)(tmText, {
              ...
              label: (0, import_vue4.unref)(displayValue)
            }, null, 8, ["followTheme", "color", "font-size", "label"])
          ]),
          (0, import_vue4.renderSlot)(_ctx.$slots, "suffix", {}, () => [
            (0, import_vue4.createVNode)(tmText, {
              followTheme: props.followTheme,
              color: props.color,
              "font-size": props.fontSize * 0.7,
  ...
  var tmStatistic = /* @__PURE__ */ _export_sfc(_sfc_main$12, [["__file", "F:/CoinQT/CoinQT_app/tmui/components/tm-statistic/tm-statistic.vue"]]);
            ...
            default: (0, import_vue4.withCtx)(() => [
              (0, import_vue4.createVNode)(tmSheet, null, {
                default: (0, import_vue4.withCtx)(() => [
                  ...
                  (0, import_vue4.createVNode)(tmStatistic, {
                    endVal: 2022,
                    fontSize: 62,
                    suffix: "\u5E74",
                    color: "primary"
              ...
              (0, import_vue4.createVNode)(tmSheet, null, {
                default: (0, import_vue4.withCtx)(() => [
                  ...
                  (0, import_vue4.createVNode)(tmDivider),
                  (0, import_vue4.createElementVNode)("view", { class: "flex flex-row flex-between" }, [
                    (0, import_vue4.createElementVNode)("view", { class: "px-12" }, [
                      (0, import_vue4.createVNode)(tmStatistic, {
                        prefix: "\u2191",
                        startVal: 0,
                        decimals: 2,
  ...
  var statistic = /* @__PURE__ */ _export_sfc(_sfc_main4, [["__file", "F:/CoinQT/CoinQT_app/pages/showdata/statistic.nvue"]]);

  // <stdin>
  var webview = plus.webview.currentWebview();
  if (webview) {
    const __pageId = parseInt(webview.id);
    const __pagePath = "pages/showdata/statistic";
    let __pageQuery = {};
    try {
      __pageQuery = JSON.parse(webview.__query__);
    } catch (e) {
    }
    statistic.mpType = "page";
    const app = Vue.createPageApp(statistic, { $store: getApp({ allowDefault: true }).$store, __pageId, __pagePath, __pageQuery });
    app.provide("__globalStyles", Vue.useCssStyles([...__uniConfig.styles, ...statistic.styles || []]));
    app.mount("#root");
  }
})();
