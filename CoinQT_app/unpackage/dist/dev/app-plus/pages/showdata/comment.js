...
(() => {
  ...
  // F:/CoinQT/CoinQT_app/unpackage/dist/dev/.nvue/pages/showdata/comment.js
  ...
  var _sfc_main5 = /* @__PURE__ */ (0, import_vue5.defineComponent)({
    ...
    setup(__props) {
      ...
      const props = __props;
      const store = useTmpiniaStore();
      const borderDir = (0, import_vue5.computed)(() => props.vertical ? "left" : "bottom");
      const _label = (0, import_vue5.computed)(() => props.label);
      ...
      const _realColor = (0, import_vue5.computed)(() => props.realColor);
      const isDark = (0, import_vue5.computed)(() => computedDark(__spreadProps5(__spreadValues5({}, props), { borderDirection: borderDir.value }), tmcfg.value));
      const tmcomputed = (0, import_vue5.computed)(() => computedTheme(__spreadProps5(__spreadValues5({}, props), { borderDirection: borderDir.value }), isDark.value, tmcfg.value));
      return (_ctx, _cache) => {
        return (0, import_vue5.openBlock)(), (0, import_vue5.createElementBlock)("view", { renderWhole: true }, [
          !(0, import_vue5.unref)(_label) && props.vertical ? ((0, import_vue5.openBlock)(), (0, import_vue5.createElementBlock)("view", {
            key: 0,
            style: (0, import_vue5.normalizeStyle)([{ backgroundColor: (0, import_vue5.unref)(_realColor) ? (0, import_vue5.unref)(tmcomputed).color : (0, import_vue5.unref)(tmcomputed).border }, props.vertical ? { width: props.border + "rpx", height: props.height + "rpx" } : ""]),
            class: (0, import_vue5.normalizeClass)([props.vertical ? `mx-${props.margin[0]}` : `my-${props.margin[1]}`])
          }, null, 6)) : (0, import_vue5.createCommentVNode)("v-if", true),
          (0, import_vue5.unref)(_label) && !props.vertical ? ((0, import_vue5.openBlock)(), (0, import_vue5.createElementBlock)("view", {
            key: 1,
            class: "flex flex-row flex-center"
          }, [
            (0, import_vue5.createElementVNode)("view", {
              style: (0, import_vue5.normalizeStyle)([(0, import_vue5.unref)(tmcomputed) ? { backgroundColor: (0, import_vue5.unref)(_realColor) ? (0, import_vue5.unref)(tmcomputed).color : (0, import_vue5.unref)(tmcomputed).border, height: props.border + "rpx" } : ""]),
              class: (0, import_vue5.normalizeClass)([`my-${props.margin[1]}`, __props.align == "left" ? "flex-2" : "", __props.align == "right" ? "flex-10" : "", __props.align == "center" ? "flex-1" : ""])
            }, null, 6),
            props.label ? ((0, import_vue5.openBlock)(), (0, import_vue5.createElementBlock)("view", {
              key: 0,
              class: (0, import_vue5.normalizeClass)([(0, import_vue5.unref)(isDark) ? "opacity-4" : ""])
            }, [
              (0, import_vue5.createVNode)(tmText, {
                fontSize: props.fontSize,
                dark: (0, import_vue5.unref)(isDark),
            ...
            (0, import_vue5.createElementVNode)("view", {
              style: (0, import_vue5.normalizeStyle)([(0, import_vue5.unref)(tmcomputed) ? { backgroundColor: (0, import_vue5.unref)(_realColor) ? (0, import_vue5.unref)(tmcomputed).color : (0, import_vue5.unref)(tmcomputed).border, height: props.border + "rpx" } : ""]),
              class: (0, import_vue5.normalizeClass)([`my-${props.margin[1]}`, __props.align == "left" ? "flex-10" : "", __props.align == "right" ? "flex-2" : "", __props.align == "center" ? "flex-1" : ""])
            }, null, 6)
          ...
          !(0, import_vue5.unref)(_label) && !props.vertical ? ((0, import_vue5.openBlock)(), (0, import_vue5.createElementBlock)("view", {
            ...
            (0, import_vue5.createElementVNode)("view", {
              class: (0, import_vue5.normalizeClass)(["flex-1", [`my-${props.margin[1]}`]]),
              style: (0, import_vue5.normalizeStyle)([(0, import_vue5.unref)(tmcomputed) ? { backgroundColor: (0, import_vue5.unref)(_realColor) ? (0, import_vue5.unref)(tmcomputed).color : (0, import_vue5.unref)(tmcomputed).border, height: props.border + "rpx" } : ""])
            }, null, 6)
          ])) : (0, import_vue5.createCommentVNode)("v-if", true)
        ]);
  ...
  var tmDivider = /* @__PURE__ */ _export_sfc(_sfc_main5, [["__file", "F:/CoinQT/CoinQT_app/tmui/components/tm-divider/tm-divider.vue"]]);

  // F:/CoinQT/CoinQT_app/unpackage/dist/dev/.nvue/tm-avatar.js
  ...
  var _sfc_main6 = /* @__PURE__ */ (0, import_vue6.defineComponent)({
    ...
    setup(__props, { emit: emits }) {
      ...
      const width = (0, import_vue6.computed)(() => {
        var _a2;
        return (_a2 = props.size) != null ? _a2 : 90;
      });
      const height = (0, import_vue6.computed)(() => {
        var _a2;
        return (_a2 = props.size) != null ? _a2 : 90;
      });
      const fontSize = (0, import_vue6.computed)(() => {
        var _a2;
        if (props.fontSize)
      ...
      const imgsize = (0, import_vue6.computed)(() => {
        return uni.upx2px(fontSize.value - 4) + "px";
      });
      const triggSize = (0, import_vue6.computed)(() => {
      ...
      return (_ctx, _cache) => {
        return (0, import_vue6.openBlock)(), (0, import_vue6.createElementBlock)("view", {
          ref: "avatar",
          class: (0, import_vue6.normalizeClass)(["flex-col flex", [__props.trigger ? "trigger" : "", `mx-${props.margin[0]} my-${props.margin[1]}`]]),
          style: (0, import_vue6.normalizeStyle)({ width: (0, import_vue6.unref)(width) + props.unit, height: (0, import_vue6.unref)(height) + props.unit }),
          renderWhole: true
        }, [
          (0, import_vue6.createVNode)(tmSheet, {
            onClick: _cache[0] || (_cache[0] = ($event) => emits("click", $event)),
            color: props.color,
            _class: [(0, import_vue6.unref)(customClass), "flex-center flex-col"],
            _style: [(0, import_vue6.unref)(customCSSStyle), { flexShrink: 1 }],
            followTheme: props.followTheme,
            dark: props.dark,
            round: props.round,
            shadow: props.shadow,
            ...
            width: (0, import_vue6.unref)(width),
            height: (0, import_vue6.unref)(height),
            margin: [0, 0],
            padding: props.padding,
            unit: props.unit
          }, {
            default: (0, import_vue6.withCtx)(() => [
              (0, import_vue6.renderSlot)(_ctx.$slots, "default", {}, () => [
                props.label && !props.icon && !props.img ? ((0, import_vue6.openBlock)(), (0, import_vue6.createBlock)(tmText, {
                  key: 0,
                  userInteractionEnabled: false,
                  label: props.label,
                  "font-size": (0, import_vue6.unref)(fontSize),
                  unit: props.unit
                }, null, 8, ["label", "font-size", "unit"])) : (0, import_vue6.createCommentVNode)("v-if", true),
                !props.label && props.icon && !props.img ? ((0, import_vue6.openBlock)(), (0, import_vue6.createBlock)(tmIcon, {
                  key: 1,
                  userInteractionEnabled: false,
                  name: props.icon,
                  "font-size": (0, import_vue6.unref)(fontSize),
                  unit: props.unit
                }, null, 8, ["name", "font-size", "unit"])) : (0, import_vue6.createCommentVNode)("v-if", true),
                !props.label && !props.icon && props.img ? ((0, import_vue6.openBlock)(), (0, import_vue6.createElementBlock)("u-image", {
                  key: 2,
                  userInteractionEnabled: false,
                  src: props.img,
                  mode: "scaleToFill",
                  style: (0, import_vue6.normalizeStyle)({ width: (0, import_vue6.unref)(imgsize), height: (0, import_vue6.unref)(imgsize) }),
                  class: (0, import_vue6.normalizeClass)(["round-" + props.round])
                }, null, 14, ["src"])) : (0, import_vue6.createCommentVNode)("v-if", true)
              ])
            ]),
            _: 3
          ...
          props.triggerIcon ? ((0, import_vue6.openBlock)(), (0, import_vue6.createElementBlock)("view", {
            key: 0,
            onClick: _cache[1] || (_cache[1] = (0, import_vue6.withModifiers)(($event) => emits("click", $event), ["stop"])),
            class: "absolute flex flex-col-bottom-end b-0 r-0",
            style: (0, import_vue6.normalizeStyle)({ width: `${(0, import_vue6.unref)(width)}${props.unit}` })
          }, [
            (0, import_vue6.createVNode)(tmSheet, {
              userInteractionEnabled: false,
              width: (0, import_vue6.unref)(triggSize).size,
              height: (0, import_vue6.unref)(triggSize).size,
              ...
              default: (0, import_vue6.withCtx)(() => [
                (0, import_vue6.createVNode)(tmIcon, {
                  ...
                  "font-size": (0, import_vue6.unref)(triggSize).fontSize,
                  unit: props.unit
                }, null, 8, ["name", "font-size", "unit"])
              ]),
              _: 1
            }, 8, ["width", "height", "_style", "text", "color", "dark", "unit"])
          ], 4)) : (0, import_vue6.createCommentVNode)("v-if", true)
        ], 6);
      };
    }
  });
  var tmAvatar = /* @__PURE__ */ _export_sfc(_sfc_main6, [["styles", [_style_03]], ["__file", "F:/CoinQT/CoinQT_app/tmui/components/tm-avatar/tm-avatar.vue"]]);
  ...
  var _sfc_main7 = /* @__PURE__ */ (0, import_vue7.defineComponent)({
    ...
    setup(__props, { emit: emits }) {
      ...
      const isAndroid = (0, import_vue7.ref)(false);
      isAndroid.value = uni.getSystemInfoSync().osName == "android" ? true : false;
      const _height = (0, import_vue7.computed)(() => props.height);
      const _inputPadding = (0, import_vue7.computed)(() => {
      ...
      const propsDetail = (0, import_vue7.computed)(() => {
        return {
          focus: props.focus,
          prefix: props.prefix,
      ...
      const tmcfg = (0, import_vue7.computed)(() => store.tmStore);
      (0, import_vue7.computed)(() => computedStyle(props));
      (0, import_vue7.computed)(() => computedClass(props));
      const isDark = (0, import_vue7.computed)(() => computedDark(props, tmcfg.value));
      const _requiredError = (0, import_vue7.ref)(false);
      const _foucsActive = (0, import_vue7.ref)(props.focus || false);
      (0, import_vue7.watch)(() => props.focus, () => {
        _foucsActive.value = props.focus;
      });
      const _color = (0, import_vue7.computed)(() => {
      ...
      const tmcomputed = (0, import_vue7.computed)(() => {
        const _props = __spreadProps7(__spreadValues7({}, props), { color: _color.value });
        return computedTheme(_props, isDark.value, tmcfg.value);
      });
      const showPasswordText = (0, import_vue7.ref)(propsDetail.value.password);
      const showPasswordIcon = (0, import_vue7.computed)(() => props.password);
      (0, import_vue7.ref)(props.errorLabel);
      const _value = (0, import_vue7.ref)(props.modelValue);
      const _valueLenChar = (0, import_vue7.computed)(() => {
        let str = String(_value.value).split("");
        return str.length;
      });
      (0, import_vue7.watch)(() => props.modelValue, () => _value.value = props.modelValue);
      ...
      (0, import_vue7.watch)(_value, () => debounce(pushFormItem, 200));
        ...
        return (0, import_vue7.openBlock)(), (0, import_vue7.createBlock)(tmSheet, {
          ...
          default: (0, import_vue7.withCtx)(() => [
            (0, import_vue7.createVNode)(tmSheet, {
              ...
              "no-level": "",
              margin: [0, 0],
              padding: (0, import_vue7.unref)(_inputPadding),
              border: props.border,
              text: props.text,
              color: (0, import_vue7.unref)(_color),
              outlined: props.outlined,
              shadow: props.shadow,
              linear: props.linear,
              linearDeep: props.linearDeep
              ...
              default: (0, import_vue7.withCtx)(() => [
                (0, import_vue7.createElementVNode)("view", {
                  class: (0, import_vue7.normalizeClass)(["flex flex-row", [(0, import_vue7.unref)(propsDetail).type == "textarea" ? "flex-row-top-center" : "flex-row-center-center"]]),
                  onClick: _cache[7] || (_cache[7] = ($event) => inputClick($event, "")),
                  style: (0, import_vue7.normalizeStyle)([{ height: `${(0, import_vue7.unref)(_height)}rpx` }])
                }, [
                  (0, import_vue7.unref)(propsDetail).search || (0, import_vue7.unref)(propsDetail).searchLabel ? ((0, import_vue7.openBlock)(), (0, import_vue7.createElementBlock)("view", {
                    key: 0,
                    class: "px-9"
                  })) : (0, import_vue7.createCommentVNode)("v-if", true),
                  (0, import_vue7.renderSlot)(_ctx.$slots, "left"),
                  (0, import_vue7.unref)(propsDetail).prefix ? ((0, import_vue7.openBlock)(), (0, import_vue7.createElementBlock)("view", {
                    key: 1,
                    class: "pr-16"
                  }, [
                    (0, import_vue7.createVNode)(tmIcon, {
                      "font-size": (0, import_vue7.unref)(propsDetail).fontSize,
                      name: (0, import_vue7.unref)(propsDetail).prefix
                    }, null, 8, ["font-size", "name"])
                  ])) : (0, import_vue7.createCommentVNode)("v-if", true),
                  (0, import_vue7.unref)(propsDetail).prefixLabel ? ((0, import_vue7.openBlock)(), (0, import_vue7.createElementBlock)("view", {
                    key: 2,
                    class: "pr-24"
                  }, [
                    (0, import_vue7.createVNode)(tmText, {
                      "font-size": (0, import_vue7.unref)(propsDetail).fontSize,
                      label: (0, import_vue7.unref)(propsDetail).prefixLabel
                    }, null, 8, ["font-size", "label"])
                  ])) : (0, import_vue7.createCommentVNode)("v-if", true),
                  !isAndroid.value ? ((0, import_vue7.openBlock)(), (0, import_vue7.createElementBlock)("view", {
                    key: 3,
                    onClick: _cache[2] || (_cache[2] = (0, import_vue7.withModifiers)(($event) => inputClick($event, "ali"), ["stop"])),
                    class: "flex-1 relative flex-row flex",
                    style: (0, import_vue7.normalizeStyle)([{ width: "0px" }])
                  }, [
                    (0, import_vue7.createCommentVNode)(` <view @click.stop="emits('click',$event)" class=" l-0 t-0 flex-1 " :style="{height: \`\${_height}rpx\`,background:'red'}"></view> `),
                    (0, import_vue7.unref)(propsDetail).type != "textarea" ? ((0, import_vue7.openBlock)(), (0, import_vue7.createElementBlock)("u-input", {
                      key: 0,
                      class: "flex-1",
                      userInteractionEnabled: false,
                      value: _value.value,
                      focus: (0, import_vue7.unref)(propsDetail).focus,
                      onFocus: focus,
                      onBlur: blur,
                      onConfirm: confirm,
                      ...
                      maxlength: (0, import_vue7.unref)(propsDetail).maxlength,
                      disabled: (0, import_vue7.unref)(propsDetail).disabled,
                      cursorSpacing: (0, import_vue7.unref)(propsDetail).cursorSpacing,
                      confirmType: (0, import_vue7.unref)(propsDetail).confirmType,
                      confirmHold: (0, import_vue7.unref)(propsDetail).confirmHold,
                      autoBlur: (0, import_vue7.unref)(propsDetail).autoBlur,
                      holdKeyboard: (0, import_vue7.unref)(propsDetail).holdKeyboard,
                      adjustPosition: (0, import_vue7.unref)(propsDetail).adjustPosition,
                      type: (0, import_vue7.unref)(propsDetail).type,
                      placeholder: (0, import_vue7.unref)(propsDetail).placeholder,
                      style: (0, import_vue7.normalizeStyle)([
                        {
                          height: `${(0, import_vue7.unref)(_height)}rpx`,
                          color: (0, import_vue7.unref)(propsDetail).fontColor ? (0, import_vue7.unref)(propsDetail).fontColor : (0, import_vue7.unref)(tmcomputed).textColor,
                          "text-align": props.align,
                          "fontSize": `${(0, import_vue7.unref)(propsDetail).fontSize_px}px`
                        }
                      ]),
                      placeholderStyle: `fontSize:${(0, import_vue7.unref)(propsDetail).fontSize_px}px`
                    }, null, 44, ["value", "focus", "password", "maxlength", "disabled", "cursorSpacing", "confirmType", "confirmHold", "autoBlur", "holdKeyboard", "adjustPosition", "type", "placeholder", "placeholderStyle"])) : (0, import_vue7.createCommentVNode)("v-if", true),
                    (0, import_vue7.unref)(propsDetail).type == "textarea" ? ((0, import_vue7.openBlock)(), (0, import_vue7.createElementBlock)("u-textarea", {
                      key: 1,
                      userInteractionEnabled: false,
                      value: _value.value,
                      focus: (0, import_vue7.unref)(propsDetail).focus,
                      ...
                      autoBlur: (0, import_vue7.unref)(propsDetail).autoBlur,
                      holdKeyboard: (0, import_vue7.unref)(propsDetail).holdKeyboard,
                      cursor: (0, import_vue7.unref)(propsDetail).cursor,
                      showConfirmBar: (0, import_vue7.unref)(propsDetail).showConfirmBar,
                      selectionStart: (0, import_vue7.unref)(propsDetail).selectionStart,
                      selectionEnd: (0, import_vue7.unref)(propsDetail).selectionEnd,
                      disableDefaultPadding: (0, import_vue7.unref)(propsDetail).disableDefaultPadding,
                      fixed: (0, import_vue7.unref)(propsDetail).fixed,
                      adjustPosition: (0, import_vue7.unref)(propsDetail).adjustPosition,
                      type: (0, import_vue7.unref)(propsDetail).type,
                      style: (0, import_vue7.normalizeStyle)([
                        {
                      ...
                      placeholderStyle: `fontSize:${(0, import_vue7.unref)(propsDetail).fontSize_px}px`
                    }, null, 44, ["value", "focus", "maxlength", "disabled", "placeholder", "cursorSpacing", "confirmHold", "autoBlur", "holdKeyboard", "cursor", "showConfirmBar", "selectionStart", "selectionEnd", "disableDefaultPadding", "fixed", "adjustPosition", "type", "placeholderStyle"])) : (0, import_vue7.createCommentVNode)("v-if", true)
                  ])) : (0, import_vue7.createCommentVNode)("v-if", true),
                  isAndroid.value ? ((0, import_vue7.openBlock)(), (0, import_vue7.createElementBlock)("view", {
                    key: 4,
                    class: "flex-1 relative flex-row flex",
                    ...
                    (0, import_vue7.unref)(propsDetail).type != "textarea" ? ((0, import_vue7.openBlock)(), (0, import_vue7.createElementBlock)("u-input", {
                      key: 0,
                      class: "flex-1",
                      onClick: _cache[3] || (_cache[3] = (0, import_vue7.withModifiers)(($event) => emits("click", $event), ["stop"])),
                      userInteractionEnabled: false,
                      value: _value.value,
                      focus: (0, import_vue7.unref)(propsDetail).focus,
                      onFocus: focus,
                      ...
                      placeholderStyle: `fontSize:${(0, import_vue7.unref)(propsDetail).fontSize_px}px`
                    }, null, 44, ["value", "focus", "password", "disabled", "cursorSpacing", "confirmType", "confirmHold", "autoBlur", "holdKeyboard", "adjustPosition", "maxlength", "type", "placeholder", "placeholderStyle"])) : (0, import_vue7.createCommentVNode)("v-if", true),
                    (0, import_vue7.unref)(propsDetail).type == "textarea" ? ((0, import_vue7.openBlock)(), (0, import_vue7.createElementBlock)("u-textarea", {
                      key: 1,
                      onClick: _cache[5] || (_cache[5] = (0, import_vue7.withModifiers)(($event) => emits("click", $event), ["stop"])),
                      userInteractionEnabled: false,
                      value: _value.value,
                      focus: (0, import_vue7.unref)(propsDetail).focus,
                      onFocus: focus,
                      ...
                      adjustPosition: (0, import_vue7.unref)(propsDetail).adjustPosition,
                      maxlength: (0, import_vue7.unref)(propsDetail).maxlength,
                      autoHeight: (0, import_vue7.unref)(propsDetail).autoHeight,
                      cursor: (0, import_vue7.unref)(propsDetail).cursor,
                      showConfirmBar: (0, import_vue7.unref)(propsDetail).showConfirmBar,
                      selectionStart: (0, import_vue7.unref)(propsDetail).selectionStart,
                      selectionEnd: (0, import_vue7.unref)(propsDetail).selectionEnd,
                      ...
                      placeholderStyle: `fontSize:${(0, import_vue7.unref)(propsDetail).fontSize_px}px`
                    }, null, 44, ["value", "focus", "disabled", "placeholder", "cursorSpacing", "confirmHold", "autoBlur", "holdKeyboard", "adjustPosition", "maxlength", "autoHeight", "cursor", "showConfirmBar", "selectionStart", "selectionEnd", "disableDefaultPadding", "fixed", "type", "placeholderStyle"])) : (0, import_vue7.createCommentVNode)("v-if", true)
                  ])) : (0, import_vue7.createCommentVNode)("v-if", true),
                  (0, import_vue7.unref)(propsDetail).showClear && (0, import_vue7.unref)(_valueLenChar) > 0 ? ((0, import_vue7.openBlock)(), (0, import_vue7.createElementBlock)("view", {
                    key: 5,
                    class: "pl-16"
                  }, [
                    (0, import_vue7.createVNode)(tmIcon, {
                      onClick: clearBtn,
                      "font-size": (0, import_vue7.unref)(propsDetail).fontSize * 0.9,
                      name: "tmicon-times-circle-fill"
                    }, null, 8, ["font-size"])
                  ])) : (0, import_vue7.createCommentVNode)("v-if", true),
                  _requiredError.value ? ((0, import_vue7.openBlock)(), (0, import_vue7.createElementBlock)("view", {
                    key: 6,
                    class: "pl-16"
                  }, [
                    (0, import_vue7.createVNode)(tmIcon, {
                  ...
                  (0, import_vue7.unref)(propsDetail).suffix ? ((0, import_vue7.openBlock)(), (0, import_vue7.createElementBlock)("view", {
                    key: 7,
                    class: "pl-16"
                  }, [
                    (0, import_vue7.createVNode)(tmIcon, {
                      "font-size": (0, import_vue7.unref)(propsDetail).fontSize * 0.85,
                      name: (0, import_vue7.unref)(propsDetail).suffix
                    }, null, 8, ["font-size", "name"])
                  ])) : (0, import_vue7.createCommentVNode)("v-if", true),
                  (0, import_vue7.unref)(propsDetail).suffixLabel ? ((0, import_vue7.openBlock)(), (0, import_vue7.createElementBlock)("view", {
                    key: 8,
                    class: "pl-16"
                  }, [
                    (0, import_vue7.createVNode)(tmText, {
                      "font-size": (0, import_vue7.unref)(propsDetail).fontSize,
                      label: (0, import_vue7.unref)(propsDetail).suffixLabel
                    }, null, 8, ["font-size", "label"])
                  ])) : (0, import_vue7.createCommentVNode)("v-if", true),
                  (0, import_vue7.unref)(showPasswordIcon) ? ((0, import_vue7.openBlock)(), (0, import_vue7.createElementBlock)("view", {
                    key: 9,
                    class: "pl-16"
                  }, [
                    (0, import_vue7.createCommentVNode)(" tmicon-eyeslash-fill "),
                    (0, import_vue7.createVNode)(tmIcon, {
                  ...
                  (0, import_vue7.unref)(propsDetail).showCharNumber && (0, import_vue7.unref)(_valueLenChar) > 0 && (0, import_vue7.unref)(propsDetail).type != "textarea" ? ((0, import_vue7.openBlock)(), (0, import_vue7.createElementBlock)("view", {
                    key: 10,
                    class: "pl-16 flex-row flex"
                  }, [
                    (0, import_vue7.createVNode)(tmText, { label: (0, import_vue7.unref)(_valueLenChar) }, null, 8, ["label"]),
                    (0, import_vue7.unref)(propsDetail).maxlength > 0 ? ((0, import_vue7.openBlock)(), (0, import_vue7.createBlock)(tmText, {
                      key: 0,
                      label: "/" + (0, import_vue7.unref)(propsDetail).maxlength
                    }, null, 8, ["label"])) : (0, import_vue7.createCommentVNode)("v-if", true)
                  ])) : (0, import_vue7.createCommentVNode)("v-if", true),
                  (0, import_vue7.createCommentVNode)(" \u539F\u56E0\u662F\u652F\u4ED8\u5B9D\u5C0F\u7A0B\u5E8F\u81EA\u5E26\u4E86\u8BA1\u6570\u5668\u3002\u4F1A\u5BFC\u81F4\u91CD\u53E0\u3002 "),
                  (0, import_vue7.unref)(propsDetail).showCharNumber && (0, import_vue7.unref)(_valueLenChar) > 0 && (0, import_vue7.unref)(propsDetail).type == "textarea" ? ((0, import_vue7.openBlock)(), (0, import_vue7.createElementBlock)("view", {
                    key: 11,
                  ...
                  (0, import_vue7.renderSlot)(_ctx.$slots, "right", {}, () => [
                    (0, import_vue7.unref)(propsDetail).search || (0, import_vue7.unref)(propsDetail).searchLabel ? ((0, import_vue7.openBlock)(), (0, import_vue7.createElementBlock)("view", {
                      ...
                      (0, import_vue7.createVNode)(TmButton, {
                        followTheme: props.followTheme,
                        onClick: searchClick,
                        color: props.focusColor,
                        "font-size": 24,
                        height: (0, import_vue7.unref)(_height) - 11,
                        padding: [16, 0],
                        block: "",
                        margin: [0, 0],
                        icon: (0, import_vue7.unref)(propsDetail).search,
                        label: (0, import_vue7.unref)(propsDetail).searchLabel
            ...
            (0, import_vue7.createCommentVNode)(' <view v-if="propsDetail.showBottomBotder" :class="[`mt-${props.margin[1]*2}`]">\r\n            <tm-divider :margin="[0,0]"></tm-divider>\r\n        </view> '),
            (0, import_vue7.createCommentVNode)(" _requiredError "),
            (0, import_vue7.createCommentVNode)(' <view v-if="false" class="pt-12">\r\n            <tmText :font-size="24" color="red" :label="_errorLabel"></tmText>\r\n        </view> ')
          ]),
          _: 3
        }, 8, ["margin", "padding"]);
      };
  ...
  var tmInput = /* @__PURE__ */ _export_sfc(_sfc_main7, [["__file", "F:/CoinQT/CoinQT_app/tmui/components/tm-input/tm-input.vue"]]);
  ...
  var _sfc_main$12 = /* @__PURE__ */ (0, import_vue8.defineComponent)({
    ...
    setup(__props, { emit: emits }) {
      const props = __props;
      const _time = (0, import_vue8.computed)(() => uni.$tm.u.getDateToNewData(props.time));
      ...
      const ctl = (0, import_vue8.computed)(() => {
        return {
          time: props.time,
      ...
      return (_ctx, _cache) => {
        return (0, import_vue8.openBlock)(), (0, import_vue8.createBlock)(tmSheet, {
          ...
          default: (0, import_vue8.withCtx)(() => [
            (0, import_vue8.createElementVNode)("view", { class: "flex flex-row flex-row-top-start" }, [
              (0, import_vue8.unref)(ctl).avatar ? ((0, import_vue8.openBlock)(), (0, import_vue8.createElementBlock)("view", {
                key: 0,
                class: "mr-24",
                style: { "min-width": "60rpx", "align-items": "stretch" }
              }, [
                (0, import_vue8.createVNode)(tmAvatar, {
                  round: 12,
                  ...
                  followDark: props.followDark,
                  size: 60,
                  img: (0, import_vue8.unref)(ctl).avatar
                }, null, 8, ["followTheme", "dark", "followDark", "img"])
              ])) : (0, import_vue8.createCommentVNode)("v-if", true),
              (0, import_vue8.createElementVNode)("view", { class: "flex flex-9 flex-col wh5" }, [
                (0, import_vue8.createElementVNode)("view", {
                  class: (0, import_vue8.normalizeClass)(["flex flex-row", [(0, import_vue8.unref)(_align).time]])
                }, [
                  (0, import_vue8.renderSlot)(_ctx.$slots, "author", {}, () => [
                    (0, import_vue8.createVNode)(tmText, {
                      onClick: _cache[1] || (_cache[1] = ($event) => emits("author-click", $event)),
                      followTheme: props.followTheme,
                      dark: props.dark,
                      followDark: props.followDark,
                      color: (0, import_vue8.unref)(ctl).authorColor,
                      fontSize: 26,
                      label: (0, import_vue8.unref)(ctl).author
                    }, null, 8, ["followTheme", "dark", "followDark", "color", "label"])
                  ]),
                  (0, import_vue8.renderSlot)(_ctx.$slots, "time", {}, () => [
                    (0, import_vue8.unref)(_time) ? ((0, import_vue8.openBlock)(), (0, import_vue8.createBlock)(tmText, {
                      key: 0,
                      ...
                      fontSize: 22,
                      label: (0, import_vue8.unref)(_time)
                    }, null, 8, ["followTheme", "dark", "followDark", "label"])) : (0, import_vue8.createCommentVNode)("v-if", true)
                  ])
                ], 2),
                (0, import_vue8.createElementVNode)("view", { class: "flex flex-col py-12" }, [
                  (0, import_vue8.renderSlot)(_ctx.$slots, "content", {}, () => [
                    (0, import_vue8.createVNode)(tmText, {
  ...
  var tmComment = /* @__PURE__ */ _export_sfc(_sfc_main$12, [["styles", [_style_04]], ["__file", "F:/CoinQT/CoinQT_app/tmui/components/tm-comment/tm-comment.vue"]]);
    ...
    setup(__props) {
      return (_ctx, _cache) => {
        return (0, import_vue8.openBlock)(), (0, import_vue8.createElementBlock)("scroll-view", {
          ...
          (0, import_vue8.createVNode)(tmApp, null, {
            default: (0, import_vue8.withCtx)(() => [
              (0, import_vue8.createVNode)(tmSheet, null, {
                default: (0, import_vue8.withCtx)(() => [
                  (0, import_vue8.createVNode)(tmText, {
                    "font-size": 24,
              ...
              (0, import_vue8.createVNode)(tmComment, {
                author: "\u540C\u540D\u81EA\u5B9A\u4E49",
              ...
              (0, import_vue8.createVNode)(tmComment, {
                ...
                actions: (0, import_vue8.withCtx)(() => [
                  (0, import_vue8.createElementVNode)("view", { class: "flex flex-row norwap" }, [
                    (0, import_vue8.createElementVNode)("view", { class: "flex flex-row flex-center pl-16" }, [
              ...
              (0, import_vue8.createVNode)(tmComment, {
                ...
                default: (0, import_vue8.withCtx)(() => [
                  (0, import_vue8.createVNode)(tmInput),
                  (0, import_vue8.createElementVNode)("view", { class: "flex flex-row flex-row-center-end" }, [
  ...
  var comment = /* @__PURE__ */ _export_sfc(_sfc_main8, [["__file", "F:/CoinQT/CoinQT_app/pages/showdata/comment.nvue"]]);

  // <stdin>
  var webview = plus.webview.currentWebview();
  if (webview) {
    const __pageId = parseInt(webview.id);
    const __pagePath = "pages/showdata/comment";
    let __pageQuery = {};
    try {
    ...
    comment.mpType = "page";
    const app = Vue.createPageApp(comment, { $store: getApp({ allowDefault: true }).$store, __pageId, __pagePath, __pageQuery });
    app.provide("__globalStyles", Vue.useCssStyles([...__uniConfig.styles, ...comment.styles || []]));
    app.mount("#root");
  }
})();
