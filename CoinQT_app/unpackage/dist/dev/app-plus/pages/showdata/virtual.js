...
(() => {
  ...
  // F:/CoinQT/CoinQT_app/unpackage/dist/dev/.nvue/pages/showdata/virtual.js
  ...
  var _sfc_main$12 = /* @__PURE__ */ (0, import_vue7.defineComponent)({
    ...
    setup(__props, { emit: emits }) {
      ...
      const scrollTop = (0, import_vue7.ref)(0);
      const renderAhead = 2;
      const rowCount = (0, import_vue7.computed)(() => props.data.length);
      const childPositions = (0, import_vue7.computed)(() => {
        const results = [0];
      ...
      const totalHeight = (0, import_vue7.computed)(() => {
        return rowCount.value ? childPositions.value[rowCount.value - 1] + rowHeight : 0;
      });
      const firstVisibleNode = (0, import_vue7.computed)(() => findStartNode());
      const startNode = (0, import_vue7.computed)(() => Math.max(0, firstVisibleNode.value - renderAhead));
      const lastVisibleNode = (0, import_vue7.computed)(() => findEndNode());
      const endNode = (0, import_vue7.computed)(() => Math.min(rowCount.value - 1, lastVisibleNode.value + renderAhead));
      const visibleNodeCount = (0, import_vue7.computed)(() => endNode.value - startNode.value + 1);
      const offsetY = (0, import_vue7.computed)(() => childPositions.value[startNode.value]);
      const visibleItems = (0, import_vue7.computed)(() => {
        return props.data.slice(startNode.value, startNode.value + visibleNodeCount.value);
      });
      const Loading = (0, import_vue7.ref)(false);
      const pullType = (0, import_vue7.ref)("");
      const status = (0, import_vue7.ref)("never");
      ...
      const pullStart = (e) => __async(this, null, function* () {
        emits("pullStart");
      ...
      const pullEnd = (e) => __async(this, null, function* () {
        emits("pullEnd");
        if (typeof props.load === "function") {
          if (Loading.value)
            return;
      ...
      return (_ctx, _cache) => {
        return (0, import_vue7.openBlock)(), (0, import_vue7.createElementBlock)("view", {
          ...
          (0, import_vue7.createElementVNode)("scroll-view", {
            ...
            onScroll: scroll,
            scrollY: true,
            style: (0, import_vue7.normalizeStyle)([{ height: (0, import_vue7.unref)(rootHeight) + "px", "overflow-anchor": "auto", width: `${props.width}rpx` }])
          }, [
            Loading.value && pullType.value == "top" ? ((0, import_vue7.openBlock)(), (0, import_vue7.createBlock)(tmSheet, {
              key: 0,
              height: 40,
              unit: "px",
              margin: [0, 0],
              ...
              default: (0, import_vue7.withCtx)(() => [
                status.value == "loading" ? ((0, import_vue7.openBlock)(), (0, import_vue7.createBlock)(tmIcon, {
                  key: 0,
                  color: props.color,
                  "font-size": 24,
                  spin: "",
                  name: "tmicon-loading"
                }, null, 8, ["color"])) : (0, import_vue7.createCommentVNode)("v-if", true),
                status.value == "error" ? ((0, import_vue7.openBlock)(), (0, import_vue7.createElementBlock)("view", {
                  key: 1,
            ...
            (0, import_vue7.createElementVNode)("view", {
              class: "flex flex-col relative",
              style: (0, import_vue7.normalizeStyle)([{ height: (0, import_vue7.unref)(totalHeight) + "px" }])
            }, [
              (0, import_vue7.createElementVNode)("view", {
                class: "absolute l-0 t-0 flex flex-col",
                style: (0, import_vue7.normalizeStyle)({ transform: `translateY(${(0, import_vue7.unref)(offsetY)}px)`, width: `${props.width}rpx` })
              }, [
                (0, import_vue7.renderSlot)(_ctx.$slots, "default", { data: (0, import_vue7.unref)(visibleItems) })
              ], 4)
            ], 4),
            Loading.value && pullType.value == "bottom" ? ((0, import_vue7.openBlock)(), (0, import_vue7.createBlock)(tmSheet, {
              key: 1,
              height: 40,
              unit: "px",
              margin: [0, 0],
  ...
  var tmVirtualList = /* @__PURE__ */ _export_sfc(_sfc_main$12, [["__file", "F:/CoinQT/CoinQT_app/tmui/components/tm-virtual-list/tm-virtual-list.vue"]]);
              ...
              (0, import_vue7.createVNode)(tmSheet, null, {
                default: (0, import_vue7.withCtx)(() => [
                  ...
                  (0, import_vue7.createElementVNode)("view", { class: "flex flex-col flex-col-top-center" }, [
                    (0, import_vue7.createVNode)(tmVirtualList, {
                      load: getdata,
                      width: 626,
                      height: 900,
                      data: imglist.value,
                      ...
                      default: (0, import_vue7.withCtx)(({ data }) => [
                        ((0, import_vue7.openBlock)(true), (0, import_vue7.createElementBlock)(import_vue7.Fragment, null, (0, import_vue7.renderList)(data, (item, index) => {
                          return (0, import_vue7.openBlock)(), (0, import_vue7.createBlock)(tmSheet, {
                            ...
                            default: (0, import_vue7.withCtx)(() => [
                              (0, import_vue7.createElementVNode)("view", { class: "flex flex-row flex-row-center-between flex-1" }, [
  ...
  var virtual = /* @__PURE__ */ _export_sfc(_sfc_main7, [["__file", "F:/CoinQT/CoinQT_app/pages/showdata/virtual.nvue"]]);

  // <stdin>
  var webview = plus.webview.currentWebview();
  if (webview) {
    const __pageId = parseInt(webview.id);
    const __pagePath = "pages/showdata/virtual";
    let __pageQuery = {};
    try {
    ...
    virtual.mpType = "page";
    const app = Vue.createPageApp(virtual, { $store: getApp({ allowDefault: true }).$store, __pageId, __pagePath, __pageQuery });
    app.provide("__globalStyles", Vue.useCssStyles([...__uniConfig.styles, ...virtual.styles || []]));
    app.mount("#root");
  }
})();
