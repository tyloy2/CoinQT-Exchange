...
(() => {
  ...
  // F:/CoinQT/CoinQT_app/unpackage/dist/dev/.nvue/pages/showdata/indexes.js
  ...
  var _sfc_main$2 = /* @__PURE__ */ (0, import_vue3.defineComponent)({
    ...
    setup(__props, { emit: emits }) {
      ...
      const _height = (0, import_vue3.computed)(() => {
        if (_title.value === "")
          return props.height;
        return _titleHeight;
      });
      ...
      (0, import_vue3.onUnmounted)(() => parent.delKey(_height.value, readId));
      function itemClick() {
        emits("click");
      }
      return (_ctx, _cache) => {
        return (0, import_vue3.openBlock)(), (0, import_vue3.createElementBlock)("view", {
          ...
          (0, import_vue3.unref)(_title) !== "" ? ((0, import_vue3.openBlock)(), (0, import_vue3.createBlock)(tmSheet, {
            key: 0,
            "no-level": "",
            ...
            _: 1
          }, 8, ["margin", "padding"])) : (0, import_vue3.createCommentVNode)("v-if", true),
          (0, import_vue3.createVNode)(tmSheet, {
            onClick: itemClick,
            color: "white",
            border: 1,
            borderDirection: "bottom",
            height: (0, import_vue3.unref)(_height),
            margin: props.margin,
            padding: props.padding
          }, {
            default: (0, import_vue3.withCtx)(() => [
              (0, import_vue3.unref)(_title) === "" ? ((0, import_vue3.openBlock)(), (0, import_vue3.createElementBlock)("view", {
                key: 0,
                userInteractionEnabled: false,
  ...
  var _sfc_main$12 = /* @__PURE__ */ (0, import_vue3.defineComponent)({
    ...
    setup(__props, { expose, emit: emits }) {
      ...
      const _cureent_id = (0, import_vue3.ref)(0);
      const _cureent_item = (0, import_vue3.ref)(null);
      const _isNvue = (0, import_vue3.ref)(false);
      const _showCenterTitle = (0, import_vue3.ref)(false);
      let _timeid = uni.$tm.u.getUid(1);
      (0, import_vue3.ref)(false);
      const parentLeft = (0, import_vue3.ref)(0);
      _isNvue.value = true;
      const _cacheHeightArrays = (0, import_vue3.ref)([]);
      const _cureent_top = (0, import_vue3.ref)(0);
      const compentNameId = "tmIndexesId";
      const navright = (0, import_vue3.computed)(() => {
      ...
      (0, import_vue3.onMounted)(() => nvuegetClientRect());
      ...
      return (_ctx, _cache) => {
        return (0, import_vue3.openBlock)(), (0, import_vue3.createElementBlock)("view", {
          ref: "tmIndexes",
          class: (0, import_vue3.normalizeClass)(["overflow relative", `mx-${(0, import_vue3.unref)(_margin)[0]} my-${(0, import_vue3.unref)(_padding)[1]} px-${(0, import_vue3.unref)(_margin)[0]} py-${(0, import_vue3.unref)(_padding)[1]}`]),
          style: (0, import_vue3.normalizeStyle)([{ height: `${(0, import_vue3.unref)(_height)}rpx` }]),
          renderWhole: true
        }, [
          (0, import_vue3.createElementVNode)("scroll-view", {
            ...
            style: (0, import_vue3.normalizeStyle)([
              (0, import_vue3.unref)(_width) ? { width: (0, import_vue3.unref)(_width) + "rpx" } : "",
              (0, import_vue3.unref)(_height) ? { height: (0, import_vue3.unref)(_height) + "rpx" } : ""
            ])
          }, [
            (0, import_vue3.renderSlot)(_ctx.$slots, "default")
          ], 44, ["scrollTop"]),
          (0, import_vue3.createElementVNode)("view", {
            ...
            style: (0, import_vue3.normalizeStyle)([{ height: `${(0, import_vue3.unref)(_height)}rpx`, width: "60rpx" }])
          }, [
            (0, import_vue3.createVNode)(tmSheet, {
              "no-level": "",
              round: 10,
              ...
              default: (0, import_vue3.withCtx)(() => [
                ((0, import_vue3.openBlock)(true), (0, import_vue3.createElementBlock)(import_vue3.Fragment, null, (0, import_vue3.renderList)((0, import_vue3.unref)(navright), (item, index) => {
                  return (0, import_vue3.openBlock)(), (0, import_vue3.createElementBlock)("view", {
          ...
          _showCenterTitle.value ? ((0, import_vue3.openBlock)(), (0, import_vue3.createElementBlock)("view", {
            key: 0,
            class: "absolute l-0 t-0 fulled",
            style: (0, import_vue3.normalizeStyle)([
              {
                top: ((0, import_vue3.unref)(_height) - 70) / 2 + "rpx"
              },
              _isNvue.value ? { left: parentLeft.value + "px" } : { left: "calc(50% - 70rpx)" }
            ])
          }, [
            _cureent_item.value != null ? ((0, import_vue3.openBlock)(), (0, import_vue3.createBlock)(tmSheet, {
              key: 0,
  ...
  var tmIndexes = /* @__PURE__ */ _export_sfc(_sfc_main$12, [["__file", "F:/CoinQT/CoinQT_app/tmui/components/tm-indexes/tm-indexes.vue"]]);
  var _sfc_main3 = /* @__PURE__ */ (0, import_vue3.defineComponent)({
    __name: "indexes",
    setup(__props) {
      const imglist = (0, import_vue3.ref)([]);
      ...
      return (_ctx, _cache) => {
        return (0, import_vue3.openBlock)(), (0, import_vue3.createElementBlock)("scroll-view", {
          ...
          (0, import_vue3.createVNode)(tmApp, null, {
            default: (0, import_vue3.withCtx)(() => [
              (0, import_vue3.createVNode)(tmSheet, null, {
                default: (0, import_vue3.withCtx)(() => [
                  (0, import_vue3.createVNode)(tmText, {
                    "font-size": 30,
              ...
              (0, import_vue3.createVNode)(tmIndexes, null, {
                default: (0, import_vue3.withCtx)(() => [
                  ((0, import_vue3.openBlock)(), (0, import_vue3.createElementBlock)(import_vue3.Fragment, null, (0, import_vue3.renderList)(60, (item, index) => {
                    return (0, import_vue3.createVNode)(tmIndexesItem, {
  ...
  var indexes = /* @__PURE__ */ _export_sfc(_sfc_main3, [["__file", "F:/CoinQT/CoinQT_app/pages/showdata/indexes.nvue"]]);

  // <stdin>
  var webview = plus.webview.currentWebview();
  if (webview) {
    const __pageId = parseInt(webview.id);
    const __pagePath = "pages/showdata/indexes";
    let __pageQuery = {};
    try {
    ...
    indexes.mpType = "page";
    const app = Vue.createPageApp(indexes, { $store: getApp({ allowDefault: true }).$store, __pageId, __pagePath, __pageQuery });
    app.provide("__globalStyles", Vue.useCssStyles([...__uniConfig.styles, ...indexes.styles || []]));
    app.mount("#root");
  }
})();
