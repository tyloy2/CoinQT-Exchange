...
(() => {
  ...
  // F:/CoinQT/CoinQT_app/unpackage/dist/dev/.nvue/pages/yewu/coupon.js
  ...
  var _sfc_main4 = /* @__PURE__ */ (0, import_vue4.defineComponent)({
    ...
    setup(__props, { emit: emits }) {
      ...
      const width = (0, import_vue4.computed)(() => {
        var _a2;
        return (_a2 = props.size) != null ? _a2 : 90;
      });
      const height = (0, import_vue4.computed)(() => {
        var _a2;
        return (_a2 = props.size) != null ? _a2 : 90;
      });
      const fontSize = (0, import_vue4.computed)(() => {
        var _a2;
        if (props.fontSize)
      ...
      const imgsize = (0, import_vue4.computed)(() => {
        return uni.upx2px(fontSize.value - 4) + "px";
      });
      const triggSize = (0, import_vue4.computed)(() => {
      ...
      return (_ctx, _cache) => {
        return (0, import_vue4.openBlock)(), (0, import_vue4.createElementBlock)("view", {
          ref: "avatar",
          class: (0, import_vue4.normalizeClass)(["flex-col flex", [__props.trigger ? "trigger" : "", `mx-${props.margin[0]} my-${props.margin[1]}`]]),
          style: (0, import_vue4.normalizeStyle)({ width: (0, import_vue4.unref)(width) + props.unit, height: (0, import_vue4.unref)(height) + props.unit }),
          renderWhole: true
        }, [
          (0, import_vue4.createVNode)(tmSheet, {
            ...
            width: (0, import_vue4.unref)(width),
            height: (0, import_vue4.unref)(height),
            margin: [0, 0],
            ...
            default: (0, import_vue4.withCtx)(() => [
              (0, import_vue4.renderSlot)(_ctx.$slots, "default", {}, () => [
                props.label && !props.icon && !props.img ? ((0, import_vue4.openBlock)(), (0, import_vue4.createBlock)(tmText, {
                  key: 0,
                  userInteractionEnabled: false,
                  label: props.label,
                  "font-size": (0, import_vue4.unref)(fontSize),
                  unit: props.unit
                }, null, 8, ["label", "font-size", "unit"])) : (0, import_vue4.createCommentVNode)("v-if", true),
                !props.label && props.icon && !props.img ? ((0, import_vue4.openBlock)(), (0, import_vue4.createBlock)(tmIcon, {
                  key: 1,
                  userInteractionEnabled: false,
                  name: props.icon,
                  "font-size": (0, import_vue4.unref)(fontSize),
                  unit: props.unit
                }, null, 8, ["name", "font-size", "unit"])) : (0, import_vue4.createCommentVNode)("v-if", true),
                !props.label && !props.icon && props.img ? ((0, import_vue4.openBlock)(), (0, import_vue4.createElementBlock)("u-image", {
                  key: 2,
                  userInteractionEnabled: false,
                  src: props.img,
                  mode: "scaleToFill",
                  style: (0, import_vue4.normalizeStyle)({ width: (0, import_vue4.unref)(imgsize), height: (0, import_vue4.unref)(imgsize) }),
                  class: (0, import_vue4.normalizeClass)(["round-" + props.round])
                }, null, 14, ["src"])) : (0, import_vue4.createCommentVNode)("v-if", true)
              ])
            ]),
            _: 3
          ...
          props.triggerIcon ? ((0, import_vue4.openBlock)(), (0, import_vue4.createElementBlock)("view", {
            key: 0,
            onClick: _cache[1] || (_cache[1] = (0, import_vue4.withModifiers)(($event) => emits("click", $event), ["stop"])),
            class: "absolute flex flex-col-bottom-end b-0 r-0",
            style: (0, import_vue4.normalizeStyle)({ width: `${(0, import_vue4.unref)(width)}${props.unit}` })
          }, [
            (0, import_vue4.createVNode)(tmSheet, {
              userInteractionEnabled: false,
              width: (0, import_vue4.unref)(triggSize).size,
              height: (0, import_vue4.unref)(triggSize).size,
              ...
              default: (0, import_vue4.withCtx)(() => [
                (0, import_vue4.createVNode)(tmIcon, {
                  ...
                  "font-size": (0, import_vue4.unref)(triggSize).fontSize,
                  unit: props.unit
  ...
  var tmAvatar = /* @__PURE__ */ _export_sfc(_sfc_main4, [["styles", [_style_02]], ["__file", "F:/CoinQT/CoinQT_app/tmui/components/tm-avatar/tm-avatar.vue"]]);
  ...
  var TmButton = /* @__PURE__ */ _export_sfc(_sfc_main5, [["styles", [_style_03]], ["__file", "F:/CoinQT/CoinQT_app/tmui/components/tm-button/tm-button.vue"]]);
  ...
  var tmTranslate = /* @__PURE__ */ _export_sfc(_sfc_main6, [["styles", [_style_04]], ["__file", "F:/CoinQT/CoinQT_app/tmui/components/tm-translate/tm-translate.vue"]]);
  ...
  var _sfc_main7 = /* @__PURE__ */ (0, import_vue7.defineComponent)({
    ...
    setup(__props, { emit: emits }) {
      ...
      const _groupCheckedVal = (0, import_vue7.inject)("tmCheckedBoxVal", (0, import_vue7.computed)(() => []));
      const tmCheckedBoxDisabled = (0, import_vue7.inject)("tmCheckedBoxDisabled", (0, import_vue7.computed)(() => false));
      const tmCheckedBoxMax = (0, import_vue7.inject)("tmCheckedBoxMax", (0, import_vue7.computed)(() => false));
      ...
      return (_ctx, _cache) => {
        return (0, import_vue7.openBlock)(), (0, import_vue7.createElementBlock)("view", {
          class: (0, import_vue7.normalizeClass)(["flex flex-row", [(0, import_vue7.unref)(_disabled) ? "opacity-5" : ""]]),
          renderWhole: true
        }, [
          (0, import_vue7.createElementVNode)("view", {
            ...
            props.custom ? ((0, import_vue7.openBlock)(), (0, import_vue7.createBlock)(tmSheet, {
              ...
              width: props.size,
              height: props.size,
              text: !props.indeterminate && !_checked.value || (0, import_vue7.unref)(_disabled),
              border: props.border,
              borderStyle: props.borderStyle,
              transprent: props.transprent,
              padding: [0, 0],
              margin: [16, 8],
              color: (0, import_vue7.unref)(_disabled) ? "white" : props.color,
              round: props.round,
              _class: "flex-row flex-row-center-center"
            }, {
              default: (0, import_vue7.withCtx)(() => [
                !props.closeAni ? ((0, import_vue7.openBlock)(), (0, import_vue7.createElementBlock)("view", { key: 0 }, [
                  _checked.value && !props.indeterminate ? ((0, import_vue7.openBlock)(), (0, import_vue7.createBlock)(tmTranslate, {
                    key: 0,
                    duration: 100,
                    name: "zoom",
                    style: { "line-height": "1" }
                  ...
                  props.indeterminate ? ((0, import_vue7.openBlock)(), (0, import_vue7.createBlock)(tmTranslate, {
                    key: 1,
                    duration: 100,
                    name: "zoom",
                    style: { "line-height": "1" }
                ...
                props.closeAni ? ((0, import_vue7.openBlock)(), (0, import_vue7.createElementBlock)("view", { key: 1 }, [
                  _checked.value && !props.indeterminate ? ((0, import_vue7.openBlock)(), (0, import_vue7.createBlock)(tmIcon, {
                    key: 0,
                    "font-size": props.size * 0.54,
                    name: props.icon
                  }, null, 8, ["font-size", "name"])) : (0, import_vue7.createCommentVNode)("v-if", true),
                  props.indeterminate ? ((0, import_vue7.openBlock)(), (0, import_vue7.createBlock)(tmIcon, {
                    key: 1,
                    "font-size": props.size * 0.54,
                    name: "tmicon-minus"
                  }, null, 8, ["font-size"])) : (0, import_vue7.createCommentVNode)("v-if", true)
                ])) : (0, import_vue7.createCommentVNode)("v-if", true)
              ]),
              _: 1
            }, 8, ["linear", "linearDeep", "followTheme", "followDark", "dark", "shadow", "width", "height", "text", "border", "borderStyle", "transprent", "color", "round"])) : (0, import_vue7.createCommentVNode)("v-if", true),
  ...
  var TmCheckbox = /* @__PURE__ */ _export_sfc(_sfc_main7, [["__file", "F:/CoinQT/CoinQT_app/tmui/components/tm-checkbox/tm-checkbox.vue"]]);
  ...
  var _sfc_main$12 = /* @__PURE__ */ (0, import_vue8.defineComponent)({
    ...
    setup(__props, { emit: emits }) {
      const props = __props;
      const store = useTmpiniaStore();
      const _priceDetail = (0, import_vue8.computed)(() => props.priceDetail);
      const _rightDetail = (0, import_vue8.computed)(() => props.rightDetail);
      const _thumb = (0, import_vue8.computed)(() => props.thumb);
      const _extraActive = (0, import_vue8.ref)(props.extraActive);
      const _moreText = (0, import_vue8.computed)(() => props.moreText);
      const _btnLabel = (0, import_vue8.computed)(() => props.btnLabel);
      const _disable = (0, import_vue8.computed)(() => props.disable);
      (0, import_vue8.computed)(() => store.tmStore.dark);
      const _fontColor = (0, import_vue8.computed)(() => {
      ...
      return (_ctx, _cache) => {
        return (0, import_vue8.openBlock)(), (0, import_vue8.createElementBlock)("view", {
          class: (0, import_vue8.normalizeClass)(["flex flex-row", `px-${props.margin[0]}`, `pb-${props.margin[1]}`]),
          renderWhole: true
        }, [
          (0, import_vue8.createVNode)(tmSheet, {
            ...
            "paren-class": "flex-1",
            class: "flex-1",
            color: (0, import_vue8.unref)(_disable) ? "grey-3" : props.color,
            _style: props._style,
            followTheme: props.followTheme,
            dark: props.dark,
            round: props.round,
            ...
            default: (0, import_vue8.withCtx)(() => [
              props.showRight ? ((0, import_vue8.openBlock)(), (0, import_vue8.createElementBlock)("view", {
                key: 0,
                class: "pr-24 flex flex-col"
              }, [
                (0, import_vue8.renderSlot)(_ctx.$slots, "thumb", {}, () => [
                  (0, import_vue8.unref)(_thumb) ? ((0, import_vue8.openBlock)(), (0, import_vue8.createBlock)(tmAvatar, {
                    key: 0,
                    size: 80,
                    round: 24,
                    img: (0, import_vue8.unref)(_thumb)
                  }, null, 8, ["img"])) : (0, import_vue8.createCommentVNode)("v-if", true),
                  !(0, import_vue8.unref)(_thumb) ? ((0, import_vue8.openBlock)(), (0, import_vue8.createElementBlock)("view", {
                    key: 1,
                    class: "flex flex-col"
                  }, [
                    (0, import_vue8.createElementVNode)("view", { class: "flex-row flex flex-row-bottom-center" }, [
                      (0, import_vue8.createVNode)(tmText, {
                        "follow-dark": true,
                        userInteractionEnabled: false,
                        color: (0, import_vue8.unref)(_disable) ? "grey-1" : props.mainColor,
                        "font-size": 22,
                        label: (0, import_vue8.unref)(_priceDetail).prefix
                      }, null, 8, ["color", "label"]),
                      (0, import_vue8.createVNode)(tmText, {
                        userInteractionEnabled: false,
                        color: (0, import_vue8.unref)(_disable) ? "grey-1" : props.mainColor,
                        ...
                        "font-size": 42,
                        label: (0, import_vue8.unref)(_priceDetail).price
                      }, null, 8, ["color", "label"]),
                      (0, import_vue8.createVNode)(tmText, {
                        "follow-dark": true,
                        userInteractionEnabled: false,
                        color: (0, import_vue8.unref)(_disable) ? "grey-1" : props.mainColor,
                        "font-size": 22,
                        label: (0, import_vue8.unref)(_priceDetail).suffix
                      }, null, 8, ["color", "label"])
                    ]),
                    (0, import_vue8.createElementVNode)("view", { class: "flex flex-center" }, [
                      (0, import_vue8.createVNode)(tmText, {
                        userInteractionEnabled: false,
                        color: (0, import_vue8.unref)(_disable) ? "grey-1" : (0, import_vue8.unref)(_fontColor),
                        _class: "pr-10 opacity-7",
                        "font-size": 22,
                        label: (0, import_vue8.unref)(_priceDetail).subtext
                      }, null, 8, ["color", "label"])
                    ])
              ...
              (0, import_vue8.createElementVNode)("view", {
                ...
                (0, import_vue8.createElementVNode)("view", { class: "flex flex-row flex-between" }, [
                  (0, import_vue8.createElementVNode)("view", { class: "flex flex-col flex-1" }, [
                    (0, import_vue8.renderSlot)(_ctx.$slots, "default", {}, () => [
                      (0, import_vue8.createVNode)(tmText, {
                        ...
                        label: (0, import_vue8.unref)(_rightDetail).title
                      }, null, 8, ["color", "label"]),
                      (0, import_vue8.createVNode)(tmText, {
                        "follow-dark": true,
                        _class: "opacity-7",
                        color: (0, import_vue8.unref)(_disable) ? "grey-1" : (0, import_vue8.unref)(_fontColor),
                        "font-size": 24,
                        label: (0, import_vue8.unref)(_rightDetail).subtitle
                      }, null, 8, ["color", "label"])
                    ])
                  ]),
                  (0, import_vue8.createElementVNode)("view", {
                    ...
                    (0, import_vue8.renderSlot)(_ctx.$slots, "btn", {}, () => [
                      (0, import_vue8.createVNode)(TmButton, {
                        onClick: _cache[0] || (_cache[0] = ($event) => emits("click", $event)),
                        disabled: (0, import_vue8.unref)(_disable),
                        color: (0, import_vue8.unref)(_disable) ? "grey-1" : props.mainColor,
                        "font-color": (0, import_vue8.unref)(_disable) ? "grey" : "",
                        text: props.btnTextMode,
                        size: "small",
                        width: 120,
                        label: (0, import_vue8.unref)(_btnLabel)
                      }, null, 8, ["disabled", "color", "font-color", "text", "label"])
                    ])
                  ])
                ]),
                (0, import_vue8.createElementVNode)("view", { class: "flex flex-col pt-16" }, [
                  (0, import_vue8.createElementVNode)("view", { class: "flex flex-row flex-between" }, [
                    (0, import_vue8.createVNode)(tmText, {
                      _class: "opacity-7",
                      color: (0, import_vue8.unref)(_disable) ? "grey-1" : (0, import_vue8.unref)(_fontColor),
                      "font-size": 22,
                      label: (0, import_vue8.unref)(_rightDetail).time
                    }, null, 8, ["color", "label"]),
                    props.extra && !_extraActive.value ? ((0, import_vue8.openBlock)(), (0, import_vue8.createElementBlock)("view", {
                      key: 0,
                      ...
                      (0, import_vue8.createVNode)(tmText, {
                        ...
                        _class: "pr-10",
                        "font-size": 22,
                        label: (0, import_vue8.unref)(_moreText)
                      }, null, 8, ["color", "label"]),
                  ...
                  props.extra && _extraActive.value ? ((0, import_vue8.openBlock)(), (0, import_vue8.createElementBlock)("view", {
                    ...
                    (0, import_vue8.createElementVNode)("view", {
                      ...
                      props.extra && _extraActive.value ? ((0, import_vue8.openBlock)(), (0, import_vue8.createBlock)(tmIcon, {
                        key: 0,
                        userInteractionEnabled: false,
                        color: (0, import_vue8.unref)(_disable) ? "grey-1" : (0, import_vue8.unref)(_fontColor),
                        "font-size": 20,
                        name: "tmicon-angle-up"
                      }, null, 8, ["color"])) : (0, import_vue8.createCommentVNode)("v-if", true)
                    ])
                  ])) : (0, import_vue8.createCommentVNode)("v-if", true)
                ])
              ])
  ...
  var tmCoupon = /* @__PURE__ */ _export_sfc(_sfc_main$12, [["__file", "F:/CoinQT/CoinQT_app/tmui/components/tm-coupon/tm-coupon.vue"]]);
          ...
          (0, import_vue8.createVNode)(tmApp, null, {
            default: (0, import_vue8.withCtx)(() => [
              (0, import_vue8.createVNode)(tmSheet, null, {
                default: (0, import_vue8.withCtx)(() => [
                  (0, import_vue8.createVNode)(tmText, { label: "\u4F18\u60E0\u5238\u6837\u4F8B" })
                ]),
                _: 1
              }),
              (0, import_vue8.createVNode)(tmCoupon, {
                extra: "",
                thumb: "https://picsum.photos/200/300"
              }, {
                extra: (0, import_vue8.withCtx)(() => [
                  (0, import_vue8.createVNode)(tmText, {
                    "font-size": 22,
                    _class: "opacity-7",
                    label: "1.\u4F7F\u7528\u4E0D\u53D7\u9650\u5236"
              ...
              (0, import_vue8.createVNode)(tmCoupon, { mainColor: "pink" }),
              (0, import_vue8.createVNode)(tmCoupon, { mainColor: "pink" }, {
                btn: (0, import_vue8.withCtx)(() => [
                  (0, import_vue8.createVNode)(TmCheckbox, {
                    color: "pink",
                    round: 24
                  })
                ]),
              ...
              (0, import_vue8.createVNode)(tmSheet, null, {
                default: (0, import_vue8.withCtx)(() => [
                  (0, import_vue8.createVNode)(tmText, { label: "\u5176\u5B83\u6837\u5F0F\u8BBE\u5B9A" })
                ]),
                _: 1
              }),
              (0, import_vue8.createVNode)(tmCoupon, {
  ...
  var coupon = /* @__PURE__ */ _export_sfc(_sfc_main8, [["__file", "F:/CoinQT/CoinQT_app/pages/yewu/coupon.nvue"]]);

  // <stdin>
  var webview = plus.webview.currentWebview();
  if (webview) {
    const __pageId = parseInt(webview.id);
    const __pagePath = "pages/yewu/coupon";
    let __pageQuery = {};
    try {
    ...
    coupon.mpType = "page";
    const app = Vue.createPageApp(coupon, { $store: getApp({ allowDefault: true }).$store, __pageId, __pagePath, __pageQuery });
    app.provide("__globalStyles", Vue.useCssStyles([...__uniConfig.styles, ...coupon.styles || []]));
    app.mount("#root");
  }
})();
