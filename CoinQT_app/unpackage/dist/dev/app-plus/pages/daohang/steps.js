...
(() => {
  ...
  // F:/CoinQT/CoinQT_app/unpackage/dist/dev/.nvue/pages/daohang/steps.js
  ...
  var _sfc_main$2 = /* @__PURE__ */ (0, import_vue5.defineComponent)({
    ...
    setup(__props, { expose, emit: emits }) {
      var _a2;
      const props = __props;
      const _current = (0, import_vue5.ref)((_a2 = props.defaultCurrent) != null ? _a2 : -1);
      (0, import_vue5.provide)("tmStepsCureent", (0, import_vue5.computed)(() => _current.value));
      const _countCurrent = (0, import_vue5.ref)(-1);
      (0, import_vue5.provide)("tmStepsCountCureent", (0, import_vue5.computed)(() => _countCurrent.value));
      (0, import_vue5.provide)("tmStepsCountActiveColor", (0, import_vue5.computed)(() => props.activeColor));
      (0, import_vue5.provide)("tmStepsCountColor", (0, import_vue5.computed)(() => props.color));
      const compoenentName = "tmSteps";
      function pushKey() {
        _countCurrent.value += 1;
        return _countCurrent.value;
      }
      (0, import_vue5.watch)(() => props.current, () => {
      ...
      return (_ctx, _cache) => {
        return (0, import_vue5.openBlock)(), (0, import_vue5.createElementBlock)("view", {
          class: (0, import_vue5.normalizeClass)(["flex relative flex-row flex-row-start-center px-24", [props.direction == "horizontal" ? "flex-row" : ""]]),
          renderWhole: true
        }, [
          (0, import_vue5.renderSlot)(_ctx.$slots, "default"),
          (0, import_vue5.createElementVNode)("view", {
            style: (0, import_vue5.normalizeStyle)([{ "clear": "both" }, [{ height: __props.contentHeight + "rpx" }]])
          }, null, 4)
        ], 2);
      };
    }
  ...
  var _sfc_main$12 = /* @__PURE__ */ (0, import_vue5.defineComponent)({
    ...
    setup(__props) {
      ...
      const _isNvue = (0, import_vue5.ref)(false);
      _isNvue.value = true;
      const _cureent = (0, import_vue5.ref)((_d = parent == null ? void 0 : parent.pushKey()) != null ? _d : 0);
      const _countCurrent = (0, import_vue5.inject)("tmStepsCountCureent", (0, import_vue5.computed)(() => 0));
      const _tmStepsCureent = (0, import_vue5.inject)("tmStepsCureent", (0, import_vue5.computed)(() => -1));
      const tmStepsCountActiveColor = (0, import_vue5.inject)("tmStepsCountActiveColor", (0, import_vue5.computed)(() => "primary"));
      const tmStepsCountColor = (0, import_vue5.inject)("tmStepsCountColor", (0, import_vue5.computed)(() => "grey-3"));
      const _activeColor = (0, import_vue5.computed)(() => {
        if (props.activeColor)
          return props.activeColor;
        return tmStepsCountActiveColor.value;
      });
      const _typeModel = (0, import_vue5.computed)(() => parent.$props.type);
      const status_obj = {
        wait: {
      ...
      const status = (0, import_vue5.computed)(() => {
        if (!_isActive.value)
          return null;
      ...
      const _isActive = (0, import_vue5.computed)(() => _cureent.value === _tmStepsCureent.value);
      const _isCheck = (0, import_vue5.computed)(() => _cureent.value < _tmStepsCureent.value);
      ...
      const _icon = (0, import_vue5.computed)(() => {
        return props.icon;
      });
      const showLine = (0, import_vue5.computed)(() => parent.$props.showLine);
      const _width = (0, import_vue5.computed)(() => 100 / (_countCurrent.value + 1) + "%");
      const offsetLeft = (0, import_vue5.computed)(() => {
      ...
      function stepClick() {
        return __async(this, null, function* () {
          ...
          if (typeof parent.$props.beforeStepChange === "function") {
            ...
            let p = yield parent.$props.beforeStepChange();
      ...
      return (_ctx, _cache) => {
        return (0, import_vue5.openBlock)(), (0, import_vue5.createElementBlock)("view", {
          class: (0, import_vue5.normalizeClass)([
            ...
            _cureent.value < (0, import_vue5.unref)(_countCurrent) ? "flex-1" : ""
          ]),
          style: (0, import_vue5.normalizeStyle)([
            !_isNvue.value ? { width: _cureent.value < (0, import_vue5.unref)(_countCurrent) ? (0, import_vue5.unref)(_width) : "auto", left: `${(0, import_vue5.unref)(offsetLeft)}%`, marginLeft: "24rpx" } : ""
          ]),
          renderWhole: true
        }, [
          (0, import_vue5.createCommentVNode)(" \u5185\u5BB9 \u533A\u57DF\u3002 "),
          (0, import_vue5.createElementVNode)("view", {
            class: "flex flex-col",
            ...
            (0, import_vue5.createVNode)(tmSheet, {
              ...
              text: (0, import_vue5.unref)(_isCheck) ? false : !(0, import_vue5.unref)(status),
              ...
              margin: [0, 0],
              padding: [0, 0],
              width: (0, import_vue5.unref)(_typeModel) != "dot" ? props.size : 20,
              height: (0, import_vue5.unref)(_typeModel) != "dot" ? props.size : 20
            }, {
              default: (0, import_vue5.withCtx)(() => [
                !(0, import_vue5.unref)(_icon) && !(0, import_vue5.unref)(status) && (0, import_vue5.unref)(_typeModel) != "dot" ? ((0, import_vue5.openBlock)(), (0, import_vue5.createBlock)(tmText, {
                  key: 0,
                  onClick: stepClick,
                ...
                (0, import_vue5.unref)(status) && (0, import_vue5.unref)(_isActive) && (0, import_vue5.unref)(_typeModel) != "dot" ? ((0, import_vue5.openBlock)(), (0, import_vue5.createBlock)(tmIcon, {
                  key: 1,
                  "font-size": 22,
                  onClick: stepClick,
                  name: (0, import_vue5.unref)(status).icon
                }, null, 8, ["name"])) : (0, import_vue5.createCommentVNode)("v-if", true),
                !(0, import_vue5.unref)(status) && (0, import_vue5.unref)(_icon) && (0, import_vue5.unref)(_typeModel) != "dot" ? ((0, import_vue5.openBlock)(), (0, import_vue5.createBlock)(tmIcon, {
                  key: 2,
                  "font-size": 22,
                  onClick: stepClick,
            ...
            (0, import_vue5.createElementVNode)("view", {
              onClick: (0, import_vue5.withModifiers)(stepClick, ["stop"]),
              style: { "width": "120rpx" },
              class: "flex flex-col flex-col-center-center mt-12"
            }, [
              (0, import_vue5.renderSlot)(_ctx.$slots, "default", {}, () => [
                props.title ? ((0, import_vue5.openBlock)(), (0, import_vue5.createBlock)(tmText, {
                  key: 0,
                  onClick: stepClick,
                  userInteractionEnabled: false,
                  color: (0, import_vue5.unref)(_isCheck) ? (0, import_vue5.unref)(_activeColor) : "",
                  _class: "text-overflow-2",
                  "font-size": 24,
                  label: props.title
                }, null, 8, ["color", "label"])) : (0, import_vue5.createCommentVNode)("v-if", true),
                props.label ? ((0, import_vue5.openBlock)(), (0, import_vue5.createBlock)(tmText, {
                  key: 1,
                  onClick: stepClick,
                  userInteractionEnabled: false,
                  color: (0, import_vue5.unref)(_isCheck) ? (0, import_vue5.unref)(_activeColor) : "",
          ...
          (0, import_vue5.createCommentVNode)(" \u7EBF "),
          _cureent.value < (0, import_vue5.unref)(_countCurrent) && (0, import_vue5.unref)(showLine) ? ((0, import_vue5.openBlock)(), (0, import_vue5.createElementBlock)("view", {
            key: 0,
            class: "flex-1 flex-col flex-col-start-start",
            style: { "width": "0" }
          }, [
            (0, import_vue5.createElementVNode)("view", {
              style: (0, import_vue5.normalizeStyle)([{ marginTop: ((0, import_vue5.unref)(_typeModel) != "dot" ? props.size / 2 : 10) + "rpx" }])
            }, [
  ...
  var tmStepsItem = /* @__PURE__ */ _export_sfc(_sfc_main$12, [["__file", "F:/CoinQT/CoinQT_app/tmui/components/tm-steps-item/tm-steps-item.vue"]]);
  var _sfc_main5 = /* @__PURE__ */ (0, import_vue5.defineComponent)({
    __name: "steps",
    setup(__props) {
      const list = (0, import_vue5.ref)([
        { title: "\u5F00\u59CB" },
        { title: "\u6295\u653E\u4E2D" },
        { title: "\u5BA1\u6838" },
        { title: "\u6700\u540E\u5BA1\u67E5" },
          ...
          (0, import_vue5.createVNode)(tmApp, null, {
            default: (0, import_vue5.withCtx)(() => [
              ...
              (0, import_vue5.createVNode)(tmSheet, {
                ...
                default: (0, import_vue5.withCtx)(() => [
                  (0, import_vue5.createVNode)(tmSteps, {
                    color: "primary",
                    defaultCurrent: 1,
                    contentHeight: 80
                  }, {
                    default: (0, import_vue5.withCtx)(() => [
                      ((0, import_vue5.openBlock)(true), (0, import_vue5.createElementBlock)(import_vue5.Fragment, null, (0, import_vue5.renderList)(list.value, (item, index) => {
                        return (0, import_vue5.openBlock)(), (0, import_vue5.createBlock)(tmStepsItem, {
                          title: item.title,
                          key: index
                        }, null, 8, ["title"]);
                      }), 128))
              ...
              (0, import_vue5.createVNode)(tmSheet, {
                ...
                default: (0, import_vue5.withCtx)(() => [
                  (0, import_vue5.createVNode)(tmSteps, {
                    ...
                    default: (0, import_vue5.withCtx)(() => [
                      ((0, import_vue5.openBlock)(true), (0, import_vue5.createElementBlock)(import_vue5.Fragment, null, (0, import_vue5.renderList)(list2.value, (item, index) => {
                        return (0, import_vue5.openBlock)(), (0, import_vue5.createBlock)(tmStepsItem, {
                          title: item.title,
                          key: index
                        }, null, 8, ["title"]);
  ...
  var steps = /* @__PURE__ */ _export_sfc(_sfc_main5, [["__file", "F:/CoinQT/CoinQT_app/pages/daohang/steps.nvue"]]);

  // <stdin>
  var webview = plus.webview.currentWebview();
  if (webview) {
    const __pageId = parseInt(webview.id);
    const __pagePath = "pages/daohang/steps";
    let __pageQuery = {};
    try {
    ...
    steps.mpType = "page";
    const app = Vue.createPageApp(steps, { $store: getApp({ allowDefault: true }).$store, __pageId, __pagePath, __pageQuery });
    app.provide("__globalStyles", Vue.useCssStyles([...__uniConfig.styles, ...steps.styles || []]));
    app.mount("#root");
  }
})();
