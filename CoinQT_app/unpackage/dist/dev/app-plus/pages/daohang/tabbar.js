...
(() => {
  ...
  // F:/CoinQT/CoinQT_app/unpackage/dist/dev/.nvue/pages/daohang/tabbar.js
  ...
  var _style_02 = { "barcont": { "": { "display": "flex", "flexDirection": "row", "justifyContent": "space-around", "alignItems": "center" } } };
  var _sfc_main$2 = /* @__PURE__ */ (0, import_vue5.defineComponent)({
    __name: "tm-tabbar",
    ...
    setup(__props, { expose, emit: emits }) {
      ...
      const _width = (0, import_vue5.computed)(() => uni.upx2px(props.width) || (sys == null ? void 0 : sys.windowWidth) || 750);
      const _blur = (0, import_vue5.computed)(() => props.blur);
      const _activeUrl = (0, import_vue5.ref)("");
      const _activeUid = (0, import_vue5.ref)("");
      const tmTabbarId = "tmTabbarId";
      const _cachlist = (0, import_vue5.ref)([]);
      const _showSafe = (0, import_vue5.ref)(props.showSafe);
      const _activeIndex = (0, import_vue5.ref)(props.active);
      const win_bottom = (_b2 = (_a2 = sys == null ? void 0 : sys.safeAreaInsets) == null ? void 0 : _a2.bottom) != null ? _b2 : 0;
      if (win_bottom > 0) {
        _showSafe.value = true;
      }
      const _totalBarHeight = (0, import_vue5.computed)(() => {
        if (_showSafe.value)
          return 90;
        return 75;
      });
      const _BarHeight = (0, import_vue5.computed)(() => {
        if (_showSafe.value)
          return 75;
        return 60;
      });
      ...
      (0, import_vue5.provide)("tmTabbarUrl", (0, import_vue5.computed)(() => _activeUrl.value));
      (0, import_vue5.provide)("tmTabbarUid", (0, import_vue5.computed)(() => _activeUid.value));
      (0, import_vue5.provide)("tmTabbarWidth", (0, import_vue5.computed)(() => Math.ceil(_width / _cachlist.value.length)));
      (0, import_vue5.provide)("tmTabbarItemList", (0, import_vue5.computed)(() => _cachlist.value));
      (0, import_vue5.provide)("tmTabbarItemActive", (0, import_vue5.computed)(() => _activeIndex.value));
      (0, import_vue5.provide)("tmTabbarItemSafe", _showSafe.value);
      (0, import_vue5.provide)("tmTabbarItemAutoSelect", (0, import_vue5.computed)(() => props.autoSelect));
      (0, import_vue5.watch)(() => props.active, () => {
        if (props.active == _activeIndex.value)
          return;
        _activeIndex.value = props.active;
      });
      (0, import_vue5.watch)(_activeIndex, () => {
      ...
      return (_ctx, _cache) => {
        return (0, import_vue5.openBlock)(), (0, import_vue5.createElementBlock)("view", {
          ...
          style: (0, import_vue5.normalizeStyle)({ width: (0, import_vue5.unref)(_width) + "px", height: (0, import_vue5.unref)(_totalBarHeight) + "px", transform: `translateY(${props.bottom}rpx)` }),
          renderWhole: true
        }, [
          (0, import_vue5.createCommentVNode)(` 			@click="emits('click', $event)"    `),
          (0, import_vue5.createElementVNode)("view", {
            class: "relative",
            style: { "top": "15px" }
          }, [
            (0, import_vue5.createVNode)(tmSheet, {
              blur: (0, import_vue5.unref)(_blur),
              color: props.color,
              parenClass: "relative",
              class: "relative",
              followTheme: props.followTheme,
              ...
              margin: [0, 0],
              padding: [0, 0],
              height: (0, import_vue5.unref)(_BarHeight),
              width: (0, import_vue5.unref)(_width),
              unit: "px"
          ...
          (0, import_vue5.createElementVNode)("view", {
            ...
            style: (0, import_vue5.normalizeStyle)({ width: (0, import_vue5.unref)(_width) + "px", height: (0, import_vue5.unref)(_totalBarHeight) + "px" })
          }, [
            (0, import_vue5.createElementVNode)("view", {
              class: "relative barcont flex flex-row flex-row-top-center flex-around flex-1",
              style: (0, import_vue5.normalizeStyle)({ width: (0, import_vue5.unref)(_width) + "px" })
            }, [
  ...
  var tmTabbar = /* @__PURE__ */ _export_sfc(_sfc_main$2, [["styles", [_style_02]], ["__file", "F:/CoinQT/CoinQT_app/tmui/components/tm-tabbar/tm-tabbar.vue"]]);
  var _sfc_main$12 = /* @__PURE__ */ (0, import_vue5.defineComponent)({
    ...
    setup(__props, { emit: emits }) {
      ...
      const _btnTop = (0, import_vue5.computed)(() => props.btnTop);
      const _transprent = (0, import_vue5.computed)(() => {
        if (_btnTop.value === true)
          return false;
        return true;
      });
      const _styletop = (0, import_vue5.computed)(() => {
        if (_btnTop.value !== true)
          return "top:15px";
        return "top:0px";
      });
      const _padding = (0, import_vue5.computed)(() => {
        return [0, 0];
      });
      const _load = (0, import_vue5.ref)(props.load);
      const _active = (0, import_vue5.ref)(false);
      const c_font_style = (0, import_vue5.computed)(() => {
      ...
      const tmTabbarWidth = (0, import_vue5.inject)("tmTabbarWidth", (0, import_vue5.computed)(() => 50));
      const _width = (0, import_vue5.computed)(() => {
        if (_btnTop.value === true)
          return 60;
        return tmTabbarWidth.value;
      });
      (0, import_vue5.inject)("tmTabbarUrl", (0, import_vue5.computed)(() => ""));
      const tmTabbarItemList = (0, import_vue5.inject)("tmTabbarItemList", (0, import_vue5.computed)(() => []));
      const nowUid = (0, import_vue5.inject)("tmTabbarUid", (0, import_vue5.computed)(() => ""));
      (0, import_vue5.inject)("tmTabbarItemSafe", false);
      const tmTabbarItemActive = (0, import_vue5.inject)("tmTabbarItemActive", (0, import_vue5.computed)(() => -1));
      const tmTabbarItemAutoSelect = (0, import_vue5.inject)("tmTabbarItemAutoSelect", (0, import_vue5.computed)(() => false));
      ...
      (0, import_vue5.watch)([nowUid, () => props.active], () => {
        if (tmTabbarItemAutoSelect.value) {
          setActive();
        }
      });
      (0, import_vue5.watch)(tmTabbarItemActive, () => {
        if (!tmTabbarItemAutoSelect.value) {
          if (tmTabbarItemList.value[tmTabbarItemActive.value] == uid) {
      ...
      (0, import_vue5.watch)([() => props.load], () => {
      ...
      return (_ctx, _cache) => {
        return (0, import_vue5.openBlock)(), (0, import_vue5.createElementBlock)("view", {
          ...
          (0, import_vue5.createVNode)(tmSheet, {
            ...
            parenClass: "relative",
            class: "relative",
            _style: (0, import_vue5.unref)(_styletop),
            followTheme: (0, import_vue5.unref)(_btnTop) && props.followTheme,
            transprent: (0, import_vue5.unref)(_transprent),
            color: props.color,
            margin: [0, 0],
            padding: (0, import_vue5.unref)(_padding),
            shadow: props.shadow,
            outlined: props.outlined,
            border: props.border,
            borderStyle: props.borderStyle,
            ...
            default: (0, import_vue5.withCtx)(() => [
              (0, import_vue5.createVNode)(tmBadge, {
                fontSize: 20,
                color: (0, import_vue5.unref)(c_font_style).dotColor,
                ...
                default: (0, import_vue5.withCtx)(() => [
                  (0, import_vue5.createElementVNode)("view", {
                    class: (0, import_vue5.normalizeClass)([[_active.value ? "anifun" : ""], "flex flex-col flex-col-center-center"]),
                    style: { width: 65 + "px", height: "30px" }
                  }, [
                    (0, import_vue5.renderSlot)(_ctx.$slots, "default", {}, () => [
                      !_load.value ? ((0, import_vue5.openBlock)(), (0, import_vue5.createBlock)(tmIcon, {
                        key: 0,
                        _style: "line-height: 0px;",
                        color: (0, import_vue5.unref)(_color),
                        "font-size": (0, import_vue5.unref)(c_font_style).iconSize,
                        name: _active.value ? (0, import_vue5.unref)(c_font_style).icon : (0, import_vue5.unref)(c_font_style).unicon || (0, import_vue5.unref)(c_font_style).icon
                    ...
                    _load.value ? ((0, import_vue5.openBlock)(), (0, import_vue5.createBlock)(tmIcon, {
                      ...
                      "font-size": (0, import_vue5.unref)(c_font_style).iconSize,
                      name: "tmicon-loading"
                    }, null, 8, ["color", "font-size"])) : (0, import_vue5.createCommentVNode)("v-if", true)
                  ], 2)
                ]),
                _: 3
              }, 8, ["color", "dot", "count", "icon", "maxCount"]),
              (0, import_vue5.unref)(c_font_style).text !== "" ? ((0, import_vue5.openBlock)(), (0, import_vue5.createBlock)(tmText, {
                key: 0,
                color: (0, import_vue5.unref)(_color),
                _class: "pb-0",
                "font-size": (0, import_vue5.unref)(c_font_style).textSize,
                label: (0, import_vue5.unref)(c_font_style).text
              }, null, 8, ["color", "font-size", "label"])) : (0, import_vue5.createCommentVNode)("v-if", true)
            ]),
            _: 3
  ...
  var tmTabbarItem = /* @__PURE__ */ _export_sfc(_sfc_main$12, [["__file", "F:/CoinQT/CoinQT_app/tmui/components/tm-tabbar-item/tm-tabbar-item.vue"]]);
          ...
          (0, import_vue5.createVNode)(tmApp, null, {
            default: (0, import_vue5.withCtx)(() => [
              (0, import_vue5.createVNode)(tmSheet, null, {
                default: (0, import_vue5.withCtx)(() => [
                  (0, import_vue5.createVNode)(tmText, { label: "\u70B9\u51FB\u4E2D\u95F4+\u6309\u94AE\u53EF\u4EE5\u4F53\u9A8C\u5F02\u6B65\u52A0\u8F7D\u52A8\u6001\u6548\u679C." })
                ]),
                _: 1
              }),
              (0, import_vue5.createVNode)(tmTabbar, null, {
                default: (0, import_vue5.withCtx)(() => [
                  (0, import_vue5.createVNode)(tmTabbarItem, {
                    activeColor: "orange",
                    count: "HOT",
                    "open-type": "reLaunch",
  ...
  var tabbar = /* @__PURE__ */ _export_sfc(_sfc_main5, [["__file", "F:/CoinQT/CoinQT_app/pages/daohang/tabbar.nvue"]]);

  // <stdin>
  var webview = plus.webview.currentWebview();
  if (webview) {
    const __pageId = parseInt(webview.id);
    const __pagePath = "pages/daohang/tabbar";
    let __pageQuery = {};
    try {
