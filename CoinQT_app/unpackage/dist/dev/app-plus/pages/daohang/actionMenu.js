...
(() => {
  ...
  // F:/CoinQT/CoinQT_app/unpackage/dist/dev/.nvue/pages/daohang/actionMenu.js
  ...
  var _sfc_main$12 = /* @__PURE__ */ (0, import_vue9.defineComponent)({
    ...
    setup(__props, { emit: emits }) {
      var _a2;
      const props = __props;
      const drawer = (0, import_vue9.ref)(null);
      const sysinfo = (0, import_vue9.inject)("tmuiSysInfo", { bottom: 0, height: 750, width: uni.upx2px(750), top: 0, isCustomHeader: false, sysinfo: null });
      const show = (0, import_vue9.ref)((_a2 = props == null ? void 0 : props.modelValue) != null ? _a2 : false);
      const _active = (0, import_vue9.ref)(props.active);
      const _list = (0, import_vue9.computed)(() => {
        var _a22;
        let plist = (_a22 = props == null ? void 0 : props.list) != null ? _a22 : [];
        let listdata = [];
        listdata = plist.map((el) => {
          ...
          if (typeof el == "string" || typeof el == "number") {
            ...
            d = __spreadValues9(__spreadValues9({}, d), el);
          }
          return d;
        });
        return listdata;
      });
      const cHeight = (0, import_vue9.computed)(() => {
        let len = _list.value.length + 1;
        return len * 80 + 180 + sysinfo.bottom;
      });
      const _color = (0, import_vue9.computed)(() => props.color);
      (0, import_vue9.watchEffect)(() => {
        show.value = props.modelValue;
      });
      (0, import_vue9.watch)(() => props.active, () => {
      ...
      return (_ctx, _cache) => {
        return (0, import_vue9.openBlock)(), (0, import_vue9.createBlock)(tmDrawer, {
          ref_key: "drawer",
          ref: drawer,
          onClose: drawerClose,
          onOpen: drawerOpen,
          duration: props.duration,
          height: (0, import_vue9.unref)(cHeight),
          ...
          default: (0, import_vue9.withCtx)(() => [
            (0, import_vue9.createElementVNode)("view", {
              ...
              (0, import_vue9.createElementVNode)("view", { style: { "height": "24rpx" } }),
              (0, import_vue9.createVNode)(tmSheet, { round: 2 }, {
                default: (0, import_vue9.withCtx)(() => [
                  (0, import_vue9.createElementVNode)("view", { class: "flex flex-col round-2 overflow mx-32" }, [
                    (0, import_vue9.createVNode)(tmText, {
                      _class: "opacity-5 text-align-center",
                      "font-size": 24,
                      label: "\u8BF7\u9009\u62E9"
                    }),
                    ((0, import_vue9.openBlock)(true), (0, import_vue9.createElementBlock)(import_vue9.Fragment, null, (0, import_vue9.renderList)((0, import_vue9.unref)(_list), (item, index) => {
                      return (0, import_vue9.openBlock)(), (0, import_vue9.createBlock)(TmButton, {
                        transprent: true,
              ...
              (0, import_vue9.createElementVNode)("view", {
                style: (0, import_vue9.normalizeStyle)({ height: (0, import_vue9.unref)(sysinfo).bottom + "px" })
              }, null, 4)
            ])
          ]),
          _: 1
  ...
  var tmActionMenu = /* @__PURE__ */ _export_sfc(_sfc_main$12, [["__file", "F:/CoinQT/CoinQT_app/tmui/components/tm-action-menu/tm-action-menu.vue"]]);
        ...
        return (0, import_vue9.openBlock)(), (0, import_vue9.createElementBlock)("scroll-view", {
          ...
          (0, import_vue9.createVNode)(tmApp, null, {
            default: (0, import_vue9.withCtx)(() => [
              ...
              (0, import_vue9.createVNode)(tmActionMenu, {
  ...
  var actionMenu = /* @__PURE__ */ _export_sfc(_sfc_main9, [["__file", "F:/CoinQT/CoinQT_app/pages/daohang/actionMenu.nvue"]]);

  // <stdin>
  var webview = plus.webview.currentWebview();
  if (webview) {
    const __pageId = parseInt(webview.id);
    const __pagePath = "pages/daohang/actionMenu";
    let __pageQuery = {};
    try {
      __pageQuery = JSON.parse(webview.__query__);
    } catch (e) {
    }
    actionMenu.mpType = "page";
    const app = Vue.createPageApp(actionMenu, { $store: getApp({ allowDefault: true }).$store, __pageId, __pagePath, __pageQuery });
    app.provide("__globalStyles", Vue.useCssStyles([...__uniConfig.styles, ...actionMenu.styles || []]));
    app.mount("#root");
  }
})();
