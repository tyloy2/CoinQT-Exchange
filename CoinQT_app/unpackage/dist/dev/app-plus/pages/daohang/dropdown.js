...
(() => {
  ...
  // F:/CoinQT/CoinQT_app/unpackage/dist/dev/.nvue/pages/daohang/dropdown.js
  ...
  var _style_03 = { "popover-tcc": { "": { "transform": "translateY(-15rpx)" } }, "popover-bcc": { "": { "transform": "translateY(15rpx)" } }, "popover-tr": { "": { "display": "flex", "justifyContent": "flex-start", "alignItems": "flex-start" } } };
  var _sfc_main$12 = /* @__PURE__ */ (0, import_vue6.defineComponent)({
    ...
    setup(__props, { emit: emits }) {
      ...
      const aniDom = (0, import_vue6.ref)(null);
      const windowWidth = (0, import_vue6.computed)(() => sysinfo.value.width);
      const windowHeight = (0, import_vue6.computed)(() => sysinfo.value.height);
      let isNvue = (0, import_vue6.ref)(false);
      isNvue.value = true;
      let timeid = (0, import_vue6.ref)(uni.$tm.u.getUid(5));
      let show = (0, import_vue6.ref)(false);
      let domNvuePosCss = (0, import_vue6.ref)({
        left: 0,
        right: 0,
        bottom: 0,
        top: 0,
      ...
      let domNvueContentCss = (0, import_vue6.ref)({
        left: 0,
        right: 0,
        bottom: 0,
        top: 0,
      ...
      const listData = (0, import_vue6.computed)(() => {
        let list = props.list.map((item) => {
          ...
          if (typeof item === "string" || typeof item === "number") {
            ...
            el = __spreadValues6(__spreadValues6({}, el), item);
          }
          return el;
        });
        return list;
      });
      const tarnslateName = (0, import_vue6.computed)(() => {
        ...
        try {
          (0, import_vue6.nextTick)(function() {
            dom.getComponentRect(proxy.$refs.popver, function(res) {
              domNvuePosCss.value = __spreadValues6({}, res.size);
            });
            dom.getComponentRect(proxy.$refs.content, function(res) {
              if (res == null ? void 0 : res.size) {
                domNvueContentCss.value = __spreadValues6({}, res.size);
              }
            });
          });
        } catch (e) {
      ...
      (0, import_vue6.onUpdated)(() => {
        if (domNvuePosCss.value.width == 0 || !domNvueContentCss.value.height) {
          nvueDomPos();
        }
      });
      (0, import_vue6.onMounted)(() => nvueDomPos());
      (0, import_vue6.watch)(() => show.value, () => {
        clearTimeout(timeid.value);
        if (show.value == true) {
          timeid.value = setTimeout(function() {
            var _a22;
            (_a22 = aniDom.value) == null ? void 0 : _a22.play();
          }, 80);
        }
      });
      ...
      return (_ctx, _cache) => {
        return (0, import_vue6.openBlock)(), (0, import_vue6.createElementBlock)("view", {
          ...
          (0, import_vue6.unref)(show) ? ((0, import_vue6.openBlock)(), (0, import_vue6.createElementBlock)("view", {
            key: 0,
            onClick: (0, import_vue6.withModifiers)(closeDromenu, ["stop"]),
            class: "l-0 t-0 fixed zIndex-9",
            style: (0, import_vue6.normalizeStyle)([{ width: (0, import_vue6.unref)(windowWidth) + "px", height: (0, import_vue6.unref)(windowHeight) + "px", background: "rgba(0,0,0,0)" }])
          }, null, 12, ["onClick"])) : (0, import_vue6.createCommentVNode)("v-if", true),
          (0, import_vue6.createElementVNode)("view", {
            class: (0, import_vue6.normalizeClass)(["flex flex-col", [
            ...
            (0, import_vue6.createElementVNode)("view", {
              onClick: (0, import_vue6.withModifiers)(openDromenu, ["stop"]),
            ...
            (0, import_vue6.unref)(show) ? ((0, import_vue6.openBlock)(), (0, import_vue6.createElementBlock)("view", {
              key: 0,
              style: (0, import_vue6.normalizeStyle)([{ "z-index": "400" }, [
                (0, import_vue6.unref)(isNvue) && props.position == "tc" ? {
                  top: (0, import_vue6.unref)(domNvuePosCss).top - (0, import_vue6.unref)(domNvueContentCss).height + "px",
                  left: (0, import_vue6.unref)(domNvuePosCss).left + (0, import_vue6.unref)(domNvuePosCss).width / 2 - (0, import_vue6.unref)(domNvueContentCss).width / 2 + "px"
                } : "",
                (0, import_vue6.unref)(isNvue) && props.position == "tl" ? {
                  top: (0, import_vue6.unref)(domNvuePosCss).top - (0, import_vue6.unref)(domNvueContentCss).height + "px",
                  left: (0, import_vue6.unref)(domNvuePosCss).left + "px"
                } : "",
                (0, import_vue6.unref)(isNvue) && props.position == "tr" ? {
                  top: (0, import_vue6.unref)(domNvuePosCss).top - (0, import_vue6.unref)(domNvueContentCss).height + "px",
                  left: (0, import_vue6.unref)(domNvuePosCss).right - (0, import_vue6.unref)(domNvueContentCss).width + "px"
                } : "",
                (0, import_vue6.unref)(isNvue) && props.position == "bc" ? {
                  top: (0, import_vue6.unref)(domNvuePosCss).bottom + "px",
                  left: (0, import_vue6.unref)(domNvuePosCss).left + (0, import_vue6.unref)(domNvuePosCss).width / 2 - (0, import_vue6.unref)(domNvueContentCss).width / 2 + "px"
                } : "",
                (0, import_vue6.unref)(isNvue) && props.position == "bl" ? {
                  top: (0, import_vue6.unref)(domNvuePosCss).bottom + "px",
                  left: (0, import_vue6.unref)(domNvuePosCss).left + "px"
                } : "",
                (0, import_vue6.unref)(isNvue) && props.position == "br" ? {
                  top: (0, import_vue6.unref)(domNvuePosCss).bottom + "px",
                  left: (0, import_vue6.unref)(domNvuePosCss).right - (0, import_vue6.unref)(domNvueContentCss).width + "px"
                } : ""
              ]]),
              class: (0, import_vue6.normalizeClass)([
                (0, import_vue6.unref)(isNvue) ? "fixed" : "absolute",
              ...
              (0, import_vue6.createVNode)(tmTranslate, {
                ...
                ref: aniDom,
                reverse: "",
                name: (0, import_vue6.unref)(tarnslateName),
                duration: 180,
                autoPlay: !(0, import_vue6.unref)(isNvue)
              }, {
                default: (0, import_vue6.withCtx)(() => [
                  (0, import_vue6.createElementVNode)("view", {
                    ...
                    style: (0, import_vue6.normalizeStyle)([props.width ? { width: props.width + "rpx" } : ""])
                  }, [
                    props.position == "bc" || props.position == "bl" || props.position == "br" ? ((0, import_vue6.openBlock)(), (0, import_vue6.createBlock)(tmSheet, {
                      key: 0,
                      color: props.color,
                      _class: props._class,
                      followTheme: props.followTheme,
                      ...
                      width: 20,
                      height: 20
                    }, null, 8, ["color", "_class", "followTheme", "dark", "shadow", "outlined", "border", "borderStyle", "borderDirection", "text", "transprent", "linear", "linearDeep", "_style"])) : (0, import_vue6.createCommentVNode)("v-if", true),
                    (0, import_vue6.createVNode)(tmSheet, {
                      ...
                      default: (0, import_vue6.withCtx)(() => [
                        (0, import_vue6.createElementVNode)("view", { style: { "height": "24rpx" } }),
                        ((0, import_vue6.openBlock)(true), (0, import_vue6.createElementBlock)(import_vue6.Fragment, null, (0, import_vue6.renderList)((0, import_vue6.unref)(listData), (item, index) => {
                          return (0, import_vue6.openBlock)(), (0, import_vue6.createElementBlock)("view", {
                            hoverClass: "opacity-7",
                            onClick: (0, import_vue6.withModifiers)(($event) => onclick(index, item), ["stop"]),
                            key: index,
                            class: "flex-1 flex px-24 py-16"
                          }, [
                            (0, import_vue6.createElementVNode)("view", { class: "flex-row flex pb-12 flex-between" }, [
                              (0, import_vue6.createElementVNode)("view", { class: "flex flex-row flex-row-center-start flex-1" }, [
                                item.icon ? ((0, import_vue6.openBlock)(), (0, import_vue6.createBlock)(tmIcon, {
                                  ...
                                  _class: "pr-12",
                                  name: item.icon
                                }, null, 8, ["color", "dark", "name"])) : (0, import_vue6.createCommentVNode)("v-if", true),
                        ...
                        (0, import_vue6.createElementVNode)("view", { style: { "height": "8rpx" } })
                      ]),
                      _: 1
                    ...
                    props.position == "tc" || props.position == "tl" || props.position == "tr" ? ((0, import_vue6.openBlock)(), (0, import_vue6.createBlock)(tmSheet, {
                      key: 1,
                      color: props.color,
                      _class: props._class,
                      followTheme: props.followTheme,
            ...
            ], 6)) : (0, import_vue6.createCommentVNode)("v-if", true)
          ], 2)
        ]);
      };
    }
  });
  var tmDropdown = /* @__PURE__ */ _export_sfc(_sfc_main$12, [["styles", [_style_03]], ["__file", "F:/CoinQT/CoinQT_app/tmui/components/tm-dropdown/tm-dropdown.vue"]]);
            ...
            default: (0, import_vue6.withCtx)(() => [
              (0, import_vue6.createVNode)(tmSheet, null, {
                default: (0, import_vue6.withCtx)(() => [
                  ...
                  (0, import_vue6.createElementVNode)("view", { class: "flex flex-between flex-row px-32" }, [
                    (0, import_vue6.createVNode)(tmDropdown, {
                      position: "bl",
                      color: "grey-darken-4",
                      width: 220,
                      list: list.value
                      ...
                      default: (0, import_vue6.withCtx)(() => [
                        (0, import_vue6.createVNode)(tmText, { label: "\u663E\u793A\u83DC\u5355" })
                      ]),
                      _: 1
                    }, 8, ["list"]),
                    (0, import_vue6.createVNode)(tmDropdown, {
                      ...
                      default: (0, import_vue6.withCtx)(() => [
                        (0, import_vue6.createVNode)(tmText, { label: "\u6837\u5F0F1" })
                      ]),
                      _: 1
                    }, 8, ["list"]),
                    (0, import_vue6.createVNode)(tmDropdown, {
                      ...
                      default: (0, import_vue6.withCtx)(() => [
                        (0, import_vue6.createVNode)(tmText, { label: "\u53F3\u5BF9\u9F50" })
                      ]),
                      _: 1
                    }, 8, ["list"])
                  ])
  ...
  var dropdown = /* @__PURE__ */ _export_sfc(_sfc_main6, [["__file", "F:/CoinQT/CoinQT_app/pages/daohang/dropdown.nvue"]]);

  // <stdin>
  var webview = plus.webview.currentWebview();
  if (webview) {
    const __pageId = parseInt(webview.id);
    const __pagePath = "pages/daohang/dropdown";
    let __pageQuery = {};
    try {
