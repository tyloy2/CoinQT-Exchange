...
(() => {
  ...
  // F:/CoinQT/CoinQT_app/unpackage/dist/dev/.nvue/pages/daohang/segtab.js
  ...
  var _style_02 = { "bgbtnpos": { "": { "transitionTimingFunction": "linear", "transitionDuration": 200, "transitionProperty": "left,width,transform", "transitionDelay": 0 } }, "@TRANSITION": { "bgbtnpos": { "timingFunction": "linear", "duration": 200, "property": "left,width,transform", "delay": 0 } } };
  var _sfc_main3 = /* @__PURE__ */ (0, import_vue3.defineComponent)({
    ...
    setup(__props, { emit: emits }) {
      ...
      const leftPos = (0, import_vue3.ref)(0);
      const leftWidth = (0, import_vue3.ref)(0);
      let timid = uni.$tm.u.getUid();
      const _list = (0, import_vue3.computed)(() => {
        var _a22;
        let templist = [];
      ...
      const _cId = (0, import_vue3.ref)((_c = props.defaultValue) != null ? _c : 0);
      ...
      (0, import_vue3.watch)([() => props.modelValue, () => props.list], () => {
        _cId.value = props.modelValue;
      }, { deep: true });
      (0, import_vue3.watch)([_cId], () => {
        initPos();
      }, { deep: true });
      ...
      function initPos() {
        ...
        clearTimeout(timid);
        timid = setTimeout(() => {
          (0, import_vue3.nextTick)(() => getDomRectBound(indexel));
        }, 300);
      }
      function getEl(el) {
        if (typeof el === "string" || typeof el === "number")
      ...
      return (_ctx, _cache) => {
        return (0, import_vue3.openBlock)(), (0, import_vue3.createElementBlock)("view", {
          class: (0, import_vue3.normalizeClass)(["tm-segtab relative flex flex-col", [`round-${props.round}`]]),
          ref: "tm-segtab",
          style: (0, import_vue3.normalizeStyle)({ width: props.width + props.gutter * 2 + "rpx" }),
          renderWhole: true
        }, [
          (0, import_vue3.createVNode)(tmSheet, {
            ...
            default: (0, import_vue3.withCtx)(() => [
              _cId.value !== "" ? ((0, import_vue3.openBlock)(), (0, import_vue3.createElementBlock)("view", {
                key: 0,
                ref: "tmBgEl",
                class: "relative flex flex-row",
                style: (0, import_vue3.normalizeStyle)([{ width: leftWidth.value + "px" }])
              }, [
                (0, import_vue3.createCommentVNode)(" left:leftPos+'px',width:leftWidth+'px' "),
                (0, import_vue3.createVNode)(tmSheet, {
              ...
              (0, import_vue3.createElementVNode)("view", {
                class: (0, import_vue3.normalizeClass)(["absolute flex flex-row flex-row-center-start", [`pa-${props.gutter}`, `l--${props.gutter / 2}`]]),
                style: (0, import_vue3.normalizeStyle)([{ width: `${props.width}rpx`, height: `${props.height - props.gutter}rpx` }])
              }, [
                ((0, import_vue3.openBlock)(true), (0, import_vue3.createElementBlock)(import_vue3.Fragment, null, (0, import_vue3.renderList)((0, import_vue3.unref)(_list), (item, index) => {
                  return (0, import_vue3.openBlock)(), (0, import_vue3.createElementBlock)("view", {
                    onClick: ($event) => itemClick(index, item.id),
                    ref_for: true,
                    ref: "tab_",
                    class: (0, import_vue3.normalizeClass)([["tab" + index], "flex-1 flex flex-row flex-row-center-center"]),
                    style: (0, import_vue3.normalizeStyle)({ height: `${props.height - props.gutter}rpx` }),
                    key: index
                  }, [
  ...
  var tmSegtab = /* @__PURE__ */ _export_sfc(_sfc_main3, [["styles", [_style_02]], ["__file", "F:/CoinQT/CoinQT_app/tmui/components/tm-segtab/tm-segtab.vue"]]);
            ...
            default: (0, import_vue5.withCtx)(() => [
              (0, import_vue5.createVNode)(tmSheet, null, {
                default: (0, import_vue5.withCtx)(() => [
                  ...
                  (0, import_vue5.createVNode)(tmSegtab, {
                    width: 636,
                    list: list.value,
                    defaultValue: "2"
                  }, null, 8, ["list"])
  ...
  var segtab = /* @__PURE__ */ _export_sfc(_sfc_main5, [["__file", "F:/CoinQT/CoinQT_app/pages/daohang/segtab.nvue"]]);

  // <stdin>
  var webview = plus.webview.currentWebview();
  if (webview) {
    const __pageId = parseInt(webview.id);
    const __pagePath = "pages/daohang/segtab";
    let __pageQuery = {};
    try {
    ...
    segtab.mpType = "page";
    const app = Vue.createPageApp(segtab, { $store: getApp({ allowDefault: true }).$store, __pageId, __pagePath, __pageQuery });
    app.provide("__globalStyles", Vue.useCssStyles([...__uniConfig.styles, ...segtab.styles || []]));
    app.mount("#root");
  }
})();
