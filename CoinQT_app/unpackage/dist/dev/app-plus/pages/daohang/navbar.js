...
(() => {
  ...
  // F:/CoinQT/CoinQT_app/unpackage/dist/dev/.nvue/pages/daohang/navbar.js
            ...
            default: (0, import_vue5.withCtx)(() => [
              (0, import_vue5.createVNode)(tmNavbar, {
                ...
                right: (0, import_vue5.withCtx)(() => [
                  (0, import_vue5.createVNode)(tmIcon, { name: "tmicon-plus" })
                ]),
                _: 1
              }),
  ...
  var navbar = /* @__PURE__ */ _export_sfc(_sfc_main5, [["__file", "F:/CoinQT/CoinQT_app/pages/daohang/navbar.nvue"]]);

  // <stdin>
  var webview = plus.webview.currentWebview();
  if (webview) {
    const __pageId = parseInt(webview.id);
    const __pagePath = "pages/daohang/navbar";
    let __pageQuery = {};
    try {
