...
(() => {
  ...
  // F:/CoinQT/CoinQT_app/unpackage/dist/dev/.nvue/pages/daohang/pagination.js
  ...
  var _style_02 = { "keywordBoradAni": { "": { "transitionDuration": 100, "transitionTimingFunction": "linear", "transitionDelay": 0, "transitionProperty": "transform", "transform": "scale(0.85)" } }, "@TRANSITION": { "keywordBoradAni": { "duration": 100, "timingFunction": "linear", "delay": 0, "property": "transform" } } };
  var _sfc_main$12 = /* @__PURE__ */ (0, import_vue4.defineComponent)({
    ...
    setup(__props, { emit: emits }) {
      const props = __props;
      const p_current = (0, import_vue4.ref)(props.defaultCurrent || 1);
      const _pageSize = (0, import_vue4.ref)(props.pageSize || 10);
      const computedCurrent = (0, import_vue4.computed)(() => p_current.value);
      const computedPageSize = (0, import_vue4.computed)(() => _pageSize.value);
      const pages = (0, import_vue4.computed)(() => Math.ceil(props.total / computedPageSize.value));
      const pageList = (0, import_vue4.computed)(() => {
        const pageList2 = [];
      ...
      return (_ctx, _cache) => {
        return (0, import_vue4.openBlock)(), (0, import_vue4.createElementBlock)("view", {
          ...
          !__props.simple ? ((0, import_vue4.openBlock)(), (0, import_vue4.createElementBlock)("view", {
            key: 0,
            class: (0, import_vue4.normalizeClass)(["flex flex-row relative flex-center", [props.disabled ? "opacity-5" : ""]])
          }, [
            ((0, import_vue4.openBlock)(true), (0, import_vue4.createElementBlock)(import_vue4.Fragment, null, (0, import_vue4.renderList)((0, import_vue4.unref)(pageList), (item, index) => {
              return (0, import_vue4.openBlock)(), (0, import_vue4.createBlock)(tmSheet, {
                ...
                followTheme: (0, import_vue4.unref)(computedCurrent) == item.page ? props.followTheme : false,
                followDark: props.followDark,
                dark: props.dark,
                text: props.text,
                linear: (0, import_vue4.unref)(computedCurrent) == item.page ? props.linear : "",
                linearDeep: props.linearDeep,
                _class: "flex-center",
                transprent: item.page == "...",
                color: (0, import_vue4.unref)(computedCurrent) == item.page ? props.color : props.btnColor,
                margin: [16, 24],
                key: index
              }, {
          ...
          __props.simple ? ((0, import_vue4.openBlock)(), (0, import_vue4.createElementBlock)("view", {
            ...
            (0, import_vue4.createVNode)(tmSheet, {
              ...
              dark: props.dark,
              text: props.text,
              _class: ["flex-center", (0, import_vue4.unref)(computedCurrent) == 1 ? "opacity-3" : ""],
            ...
            (0, import_vue4.createVNode)(tmText, {
              ...
              _class: "px-40",
              label: `${(0, import_vue4.unref)(computedCurrent)}/${(0, import_vue4.unref)(pages)}`
            }, null, 8, ["dark", "label"]),
            (0, import_vue4.createVNode)(tmSheet, {
              noLevel: "",
              "hover-class": "keywordBoradAni opacity-5",
              ...
              dark: props.dark,
              text: props.text,
              _class: ["flex-center", (0, import_vue4.unref)(computedCurrent) == (0, import_vue4.unref)(pages) ? "opacity-3" : ""],
              color: props.btnColor,
              margin: [10, 24]
            }, {
              default: (0, import_vue4.withCtx)(() => [
  ...
  var tmPagination = /* @__PURE__ */ _export_sfc(_sfc_main$12, [["styles", [_style_02]], ["__file", "F:/CoinQT/CoinQT_app/tmui/components/tm-pagination/tm-pagination.vue"]]);
          ...
          (0, import_vue4.createVNode)(tmApp, null, {
            default: (0, import_vue4.withCtx)(() => [
              ...
              (0, import_vue4.createVNode)(tmSheet, {
                ...
                default: (0, import_vue4.withCtx)(() => [
                  (0, import_vue4.createVNode)(tmPagination, { total: 100 })
                ]),
                _: 1
              }),
              (0, import_vue4.createVNode)(tmSheet, {
                ...
                default: (0, import_vue4.withCtx)(() => [
                  (0, import_vue4.createVNode)(tmPagination, {
                    color: "red",
                    total: 100
                  })
                ]),
  ...
  var pagination = /* @__PURE__ */ _export_sfc(_sfc_main4, [["__file", "F:/CoinQT/CoinQT_app/pages/daohang/pagination.nvue"]]);

  // <stdin>
  var webview = plus.webview.currentWebview();
  if (webview) {
    const __pageId = parseInt(webview.id);
    const __pagePath = "pages/daohang/pagination";
    let __pageQuery = {};
    try {
