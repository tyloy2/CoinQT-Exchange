...
(() => {
  ...
  // F:/CoinQT/CoinQT_app/unpackage/dist/dev/.nvue/pages/layout/sheet.js
        ...
        return (0, import_vue3.openBlock)(), (0, import_vue3.createElementBlock)("scroll-view", {
          ...
          (0, import_vue3.createVNode)(tmApp, null, {
            default: (0, import_vue3.withCtx)(() => [
              ...
              (0, import_vue3.createVNode)(tmSheet, { color: "primary" }, {
                default: (0, import_vue3.withCtx)(() => [
                  (0, import_vue3.createVNode)(tmText, {
                    "font-size": 24,
                    _class: "font-weight-b",
  ...
  var sheet = /* @__PURE__ */ _export_sfc(_sfc_main3, [["__file", "F:/CoinQT/CoinQT_app/pages/layout/sheet.nvue"]]);

  // <stdin>
  var webview = plus.webview.currentWebview();
  if (webview) {
    const __pageId = parseInt(webview.id);
    const __pagePath = "pages/layout/sheet";
    let __pageQuery = {};
    try {
    ...
    sheet.mpType = "page";
    const app = Vue.createPageApp(sheet, { $store: getApp({ allowDefault: true }).$store, __pageId, __pagePath, __pageQuery });
    app.provide("__globalStyles", Vue.useCssStyles([...__uniConfig.styles, ...sheet.styles || []]));
    app.mount("#root");
  }
})();
