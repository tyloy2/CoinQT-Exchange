...
(() => {
  ...
  // F:/CoinQT/CoinQT_app/unpackage/dist/dev/.nvue/pages/layout/divider.js
            ...
            default: (0, import_vue4.withCtx)(() => [
              (0, import_vue4.createVNode)(tmSheet, null, {
                default: (0, import_vue4.withCtx)(() => [
                  ...
                  (0, import_vue4.createVNode)(tmDivider, { color: "green" })
                ]),
                _: 1
              }),
              (0, import_vue4.createVNode)(tmSheet, null, {
                default: (0, import_vue4.withCtx)(() => [
                  (0, import_vue4.createElementVNode)("view", { class: "mb-24" }, [
                    (0, import_vue4.createVNode)(tmText, {
                      "font-size": 24,
                      _class: "font-weight-b",
                  ...
                  (0, import_vue4.createElementVNode)("view", { class: "flex flex-row flex-center" }, [
                    (0, import_vue4.createVNode)(tmDivider, {
                      vertical: "",
                      height: 200
                    }),
  ...
  var divider = /* @__PURE__ */ _export_sfc(_sfc_main4, [["__file", "F:/CoinQT/CoinQT_app/pages/layout/divider.nvue"]]);

  // <stdin>
  var webview = plus.webview.currentWebview();
  if (webview) {
    const __pageId = parseInt(webview.id);
    const __pagePath = "pages/layout/divider";
    let __pageQuery = {};
    try {
