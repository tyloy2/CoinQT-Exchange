...
(() => {
  ...
  // F:/CoinQT/CoinQT_app/unpackage/dist/dev/.nvue/pages/layout/row.js
  ...
  var _sfc_main$12 = /* @__PURE__ */ (0, import_vue3.defineComponent)({
    ...
    setup(__props, { emit: emits }) {
      ...
      const tmcomputed = (0, import_vue3.computed)(() => computedTheme(props, isDark.value, tmcfg.value));
      const width_px_rect = (0, import_vue3.computed)(() => props.width);
      const width_px_rect_rp = (0, import_vue3.computed)(() => width_px_rect.value);
      const justifyAlign2 = {
        start: "flex-start",
        end: "flex-end",
        center: "center",
      ...
      const justify_rp = (0, import_vue3.computed)(() => justifyAlign2[props.justify] || "start");
      const AlignAlign = {
        start: "flex-start",
        end: "flex-end",
        center: "center",
      ...
      const align_rp = (0, import_vue3.computed)(() => AlignAlign[props.align] || "start");
      (0, import_vue3.provide)("TmRowWidth", width_px_rect_rp);
      (0, import_vue3.provide)("TmRowColumn", (0, import_vue3.computed)(() => props.column));
      (0, import_vue3.provide)("TmRowGutter", (0, import_vue3.computed)(() => props.gutter));
      let textColor = (0, import_vue3.computed)(() => tmcomputed.value.textColor);
      (0, import_vue3.provide)("appTextColor", textColor);
      return (_ctx, _cache) => {
        return (0, import_vue3.openBlock)(), (0, import_vue3.createElementBlock)("view", {
          ref: "tmRow",
          onClick: _cache[0] || (_cache[0] = (0, import_vue3.withModifiers)(($event) => emits("click", $event), ["stop"])),
          class: (0, import_vue3.normalizeClass)(["flex tm-row", ["overflow ", `round-${props.round}`, (0, import_vue3.unref)(customClass), `mx-${props.margin[0]} my-${__props.margin[1]}`]]),
          style: (0, import_vue3.normalizeStyle)([
            { flexDirection: "row", flexWrap: "wrap" },
            props.height ? { height: props.height + "rpx" } : "",
            (0, import_vue3.unref)(width_px_rect) ? { width: (0, import_vue3.unref)(width_px_rect) + "rpx" } : "",
            { justifyContent: (0, import_vue3.unref)(justify_rp), alignItems: (0, import_vue3.unref)(align_rp) },
            !props.transprent ? (0, import_vue3.unref)(tmcomputed).backgroundColorCss : "",
            !props.transprent ? (0, import_vue3.unref)(tmcomputed).shadowColor : "",
  ...
  var _sfc_main3 = /* @__PURE__ */ (0, import_vue3.defineComponent)({
    ...
    setup(__props, { emit: emits }) {
      ...
      const isDark = (0, import_vue3.computed)(() => computedDark(props, tmcfg.value));
      const tmcomputed = (0, import_vue3.computed)(() => computedTheme(props, isDark.value, tmcfg.value));
      const TmRowWidth = (0, import_vue3.inject)("TmRowWidth", (0, import_vue3.computed)(() => 0));
      const TmRowColumn = (0, import_vue3.inject)("TmRowColumn", (0, import_vue3.computed)(() => 0));
      const TmRowGutter = (0, import_vue3.inject)("TmRowGutter", (0, import_vue3.computed)(() => 0));
      const colWidth = (0, import_vue3.computed)(() => {
        if (TmRowWidth.value == 0)
          return 0;
        return TmRowWidth.value / TmRowColumn.value;
      });
      const alignComputed = (0, import_vue3.computed)(() => justifyAlign[props.align]);
      let textColor = (0, import_vue3.computed)(() => tmcomputed.value.textColor);
      (0, import_vue3.provide)("appTextColor", textColor);
      return (_ctx, _cache) => {
        return (0, import_vue3.openBlock)(), (0, import_vue3.createElementBlock)("view", {
          onClick: _cache[0] || (_cache[0] = ($event) => emits("click", $event)),
          class: (0, import_vue3.normalizeClass)(["flex flex-col", [(0, import_vue3.unref)(colWidth) ? "" : "flex-1"]]),
          style: (0, import_vue3.normalizeStyle)([(0, import_vue3.unref)(colWidth) ? { width: (0, import_vue3.unref)(colWidth) + "rpx" } : ""]),
          renderWhole: true
        }, [
          (0, import_vue3.createElementVNode)("view", {
            eventPenetrationEnabled: true,
            style: (0, import_vue3.normalizeStyle)([
              (0, import_vue3.unref)(TmRowGutter) ? { marginLeft: `${(0, import_vue3.unref)(TmRowGutter)}rpx`, marginRight: `${(0, import_vue3.unref)(TmRowGutter)}rpx` } : "",
              props.height ? { height: props.height + "rpx" } : "",
              !__props.transprent ? (0, import_vue3.unref)(tmcomputed).backgroundColorCss : "",
              { alignItems: (0, import_vue3.unref)(alignComputed), justifyContent: "center" },
              (0, import_vue3.unref)(customCSSStyle)
            ]),
            class: (0, import_vue3.normalizeClass)(["flex flex-col", (0, import_vue3.unref)(customClass)])
          }, [
            (0, import_vue3.renderSlot)(_ctx.$slots, "default")
          ], 6)
        ], 6);
  ...
  var tmCol = /* @__PURE__ */ _export_sfc(_sfc_main3, [["__file", "F:/CoinQT/CoinQT_app/tmui/components/tm-col/tm-col.vue"]]);
            ...
            default: (0, import_vue5.withCtx)(() => [
              ...
              (0, import_vue5.createVNode)(tmSheet, null, {
                default: (0, import_vue5.withCtx)(() => [
                  ...
                  (0, import_vue5.createVNode)(tmRow, { gutter: 5 }, {
                    default: (0, import_vue5.withCtx)(() => [
                      (0, import_vue5.createVNode)(tmCol, {
                        color: "red",
                        align: "start",
                        class: "flex-1"
                      }, {
                        default: (0, import_vue5.withCtx)(() => [
                          (0, import_vue5.createVNode)(tmText, { label: "\u5DE6\u5BF9\u9F501" })
                        ]),
                        _: 1
                      }),
                      (0, import_vue5.createVNode)(tmCol, {
                        ...
                        default: (0, import_vue5.withCtx)(() => [
                          (0, import_vue5.createVNode)(tmText, { label: "flex2\u6587\u672C1" })
                        ]),
                        _: 1
                      }),
                      (0, import_vue5.createVNode)(tmCol, {
                        ...
                        default: (0, import_vue5.withCtx)(() => [
                          (0, import_vue5.createVNode)(tmText, { label: "\u53F3\u5BF9\u9F501" })
                        ]),
                        _: 1
                      })
                    ]),
                  ...
                  (0, import_vue5.createVNode)(tmRow, {
                    margin: [0, 5],
                    gutter: 5,
                    color: "blue-grey"
                  }, {
                    default: (0, import_vue5.withCtx)(() => [
                      (0, import_vue5.createVNode)(tmCol, {
                        ...
                        default: (0, import_vue5.withCtx)(() => [
                          (0, import_vue5.createVNode)(tmText, { label: "1" })
                        ]),
                        _: 1
                      }),
                      (0, import_vue5.createVNode)(tmCol, {
                        ...
                        default: (0, import_vue5.withCtx)(() => [
                          (0, import_vue5.createVNode)(tmText, { label: "2" })
                        ]),
                        _: 1
                      }),
                      (0, import_vue5.createVNode)(tmCol, {
                        ...
                        default: (0, import_vue5.withCtx)(() => [
                          (0, import_vue5.createVNode)(tmText, { label: "3" })
                        ]),
                        _: 1
                      })
                    ]),
                  ...
                  (0, import_vue5.createVNode)(tmRow, {
                    ...
                    default: (0, import_vue5.withCtx)(() => [
                      ...
                      (0, import_vue5.createVNode)(tmCol, {
                        ...
                        default: (0, import_vue5.withCtx)(() => [
                          (0, import_vue5.createVNode)(tmText, { label: "11" })
                        ]),
                        _: 1
                      })
                    ]),
                  ...
                  (0, import_vue5.createVNode)(tmRow, {
                    ...
                    default: (0, import_vue5.withCtx)(() => [
                      (0, import_vue5.createVNode)(tmCol, {
                        ...
                        default: (0, import_vue5.withCtx)(() => [
                          (0, import_vue5.createVNode)(tmText, { label: "6" })
                        ]),
                        _: 1
                      }),
                      (0, import_vue5.createVNode)(tmCol, {
                  ...
                  (0, import_vue5.createVNode)(tmRow, {
                    ...
                    default: (0, import_vue5.withCtx)(() => [
                      ((0, import_vue5.openBlock)(), (0, import_vue5.createElementBlock)(import_vue5.Fragment, null, (0, import_vue5.renderList)(5, (item) => {
                        return (0, import_vue5.createVNode)(tmCol, {
                          key: item,
                          class: "flex-1",
                          color: "green"
                        }, {
                          default: (0, import_vue5.withCtx)(() => [
                            (0, import_vue5.createVNode)(tmText, { label: item }, null, 8, ["label"])
                          ]),
                          _: 2
                        }, 1024);
                      }), 64))
                      ...
                      (0, import_vue5.createVNode)(tmCol, {
                        ...
                        default: (0, import_vue5.withCtx)(() => [
                          (0, import_vue5.createVNode)(tmRow, {
                            ...
                            default: (0, import_vue5.withCtx)(() => [
                              ((0, import_vue5.openBlock)(), (0, import_vue5.createElementBlock)(import_vue5.Fragment, null, (0, import_vue5.renderList)(3, (item) => {
                                return (0, import_vue5.createVNode)(tmCol, {
                                  color: "blue",
                                  key: item,
                                  class: "flex-1"
              ...
              (0, import_vue5.createVNode)(tmSheet, null, {
                default: (0, import_vue5.withCtx)(() => [
                  ...
                  (0, import_vue5.createVNode)(tmRow, {
                    ...
                    default: (0, import_vue5.withCtx)(() => [
                      (0, import_vue5.createVNode)(tmCol, { color: "green" }, {
                        default: (0, import_vue5.withCtx)(() => [
                          (0, import_vue5.createVNode)(tmText, { label: "\u6587\u672C" })
                        ]),
                        _: 1
                      }),
                      (0, import_vue5.createVNode)(tmCol, { color: "red" }, {
                        default: (0, import_vue5.withCtx)(() => [
                          (0, import_vue5.createVNode)(tmText, { label: "\u6587\u672C" })
                        ]),
                        _: 1
                      }),
                      (0, import_vue5.createVNode)(tmCol, { color: "blue" }, {
                        default: (0, import_vue5.withCtx)(() => [
                          (0, import_vue5.createVNode)(tmText, { label: "\u6587\u672C" })
                        ]),
                        _: 1
  ...
  var row = /* @__PURE__ */ _export_sfc(_sfc_main5, [["__file", "F:/CoinQT/CoinQT_app/pages/layout/row.nvue"]]);

  // <stdin>
  var webview = plus.webview.currentWebview();
  if (webview) {
    const __pageId = parseInt(webview.id);
    const __pagePath = "pages/layout/row";
    let __pageQuery = {};
    try {
    ...
    row.mpType = "page";
    const app = Vue.createPageApp(row, { $store: getApp({ allowDefault: true }).$store, __pageId, __pagePath, __pageQuery });
    app.provide("__globalStyles", Vue.useCssStyles([...__uniConfig.styles, ...row.styles || []]));
    app.mount("#root");
  }
})();
