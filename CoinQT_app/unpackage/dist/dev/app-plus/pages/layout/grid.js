...
(() => {
  ...
  // F:/CoinQT/CoinQT_app/unpackage/dist/dev/.nvue/pages/layout/grid.js
  ...
  var _sfc_main7 = /* @__PURE__ */ (0, import_vue7.defineComponent)({
    __name: "grid",
    setup(__props) {
      const testNum = (0, import_vue7.ref)([]);
      for (let i = 0; i < 6; i++) {
            ...
            default: (0, import_vue7.withCtx)(() => [
              (0, import_vue7.createVNode)(tmSheet, null, {
                default: (0, import_vue7.withCtx)(() => [
                  ...
                  (0, import_vue7.createVNode)(tmGrid, {
                    width: 630,
                    col: 3
                  }, {
                    default: (0, import_vue7.withCtx)(() => [
                      ((0, import_vue7.openBlock)(true), (0, import_vue7.createElementBlock)(import_vue7.Fragment, null, (0, import_vue7.renderList)(testNum.value, (item, index) => {
                        return (0, import_vue7.openBlock)(), (0, import_vue7.createBlock)(tmGridItem, {
                          onClick: ($event) => del(index),
                          key: index
                        }, {
                          default: (0, import_vue7.withCtx)(() => [
                            (0, import_vue7.createVNode)(tmText, { label: item }, null, 8, ["label"])
                          ]),
                          _: 2
                        }, 1032, ["onClick"]);
                      }), 128))
              ...
              (0, import_vue7.createVNode)(tmSheet, null, {
                default: (0, import_vue7.withCtx)(() => [
                  ...
                  (0, import_vue7.createVNode)(tmGrid, {
                    ...
                    default: (0, import_vue7.withCtx)(() => [
                      (0, import_vue7.createVNode)(tmGridItem, { dot: "" }, {
                        default: (0, import_vue7.withCtx)(() => [
                          (0, import_vue7.createVNode)(tmText, { label: "\u5BAB\u683C\u6587\u672C" })
                        ]),
                        _: 1
                      }),
                      (0, import_vue7.createVNode)(tmGridItem, { count: "HOT" }, {
                        default: (0, import_vue7.withCtx)(() => [
                          (0, import_vue7.createVNode)(tmText, { label: "\u5BAB\u683C\u6587\u672C" })
                        ]),
                        _: 1
                      }),
                      (0, import_vue7.createVNode)(tmGridItem, { count: 55 }, {
                        default: (0, import_vue7.withCtx)(() => [
                          (0, import_vue7.createVNode)(tmText, { label: "\u5BAB\u683C\u6587\u672C" })
                        ]),
                        _: 1
                      }),
                      (0, import_vue7.createVNode)(tmGridItem, { icon: "tmicon-gem" }, {
                        default: (0, import_vue7.withCtx)(() => [
                          (0, import_vue7.createVNode)(tmText, { label: "\u5BAB\u683C\u6587\u672C" })
                        ]),
                        _: 1
              ...
              (0, import_vue7.createVNode)(tmSheet, null, {
                default: (0, import_vue7.withCtx)(() => [
                  ...
                  (0, import_vue7.createVNode)(tmGrid, {
                    ...
                    default: (0, import_vue7.withCtx)(() => [
                      (0, import_vue7.createVNode)(tmGridItem, {
                        height: 120,
                        dot: ""
                      }, {
                        default: (0, import_vue7.withCtx)(() => [
                      ...
                      (0, import_vue7.createVNode)(tmGridItem, { height: 120 }, {
                        default: (0, import_vue7.withCtx)(() => [
                          (0, import_vue7.createVNode)(tmIcon, {
                            color: "blue",
  ...
  var grid = /* @__PURE__ */ _export_sfc(_sfc_main7, [["__file", "F:/CoinQT/CoinQT_app/pages/layout/grid.nvue"]]);

  // <stdin>
  var webview = plus.webview.currentWebview();
  if (webview) {
    const __pageId = parseInt(webview.id);
    const __pagePath = "pages/layout/grid";
    let __pageQuery = {};
    try {
