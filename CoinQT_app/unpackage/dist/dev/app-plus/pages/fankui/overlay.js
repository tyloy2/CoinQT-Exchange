...
(() => {
  ...
  // F:/CoinQT/CoinQT_app/unpackage/dist/dev/.nvue/pages/fankui/overlay.js
  ...
  var _sfc_main6 = /* @__PURE__ */ (0, import_vue6.defineComponent)({
    ...
    setup(__props, { expose, emit: emits }) {
      ...
      const width = (0, import_vue6.computed)(() => sysinfo.value.width);
      const height = (0, import_vue6.computed)(() => sysinfo.value.height);
      const top = (0, import_vue6.computed)(() => sysinfo.value.top);
      (0, import_vue6.ref)(false);
      let timids = uni.$tm.u.getUid(1);
      let timerId = NaN;
      (0, import_vue6.ref)(null);
      const showMask = (0, import_vue6.ref)(false);
      const ani = (0, import_vue6.ref)(false);
      (0, import_vue6.onUnmounted)(() => clearTimeout(timerId));
      const align_rpx = (0, import_vue6.computed)(() => props.align);
      const bgColor_rp = (0, import_vue6.computed)(() => {
      ...
      (0, import_vue6.watch)(() => props.show, (newval) => {
        open(newval);
      });
      expose({
        close,
      ...
      return (_ctx, _cache) => {
        return showMask.value ? ((0, import_vue6.openBlock)(), (0, import_vue6.createElementBlock)("view", {
          key: 0,
          class: "l-0",
          style: (0, import_vue6.normalizeStyle)([{ width: (0, import_vue6.unref)(width) + "px", height: (0, import_vue6.unref)(height) + "px", top: (0, import_vue6.unref)(top) + "px", position: "fixed" }, __props.zIndex ? { zIndex: __props.zIndex } : ""]),
          renderWhole: true
        }, [
          (0, import_vue6.createElementVNode)("view", {
            ref: "overlay",
            class: (0, import_vue6.normalizeClass)([(0, import_vue6.unref)(bgColor_rp) && !props.transprent && ani.value ? "blurOn" : "blurOff", "overlay"]),
            style: (0, import_vue6.normalizeStyle)([
              (0, import_vue6.unref)(bgColor_rp) && !props.transprent ? { backgroundColor: showMask.value ? (0, import_vue6.unref)(bgColor_rp) : "" } : "",
              { width: (0, import_vue6.unref)(width) + "px", height: (0, import_vue6.unref)(height) + "px", transitionDuration: props.duration + "ms" }
            ])
          }, null, 6),
          (0, import_vue6.createElementVNode)("view", {
            onClick: (0, import_vue6.withModifiers)(closeByclick, ["stop"]),
            class: (0, import_vue6.normalizeClass)([(0, import_vue6.unref)(align_rpx), " absolute flex flex-col  l-0 t-0 ", (0, import_vue6.unref)(customClass)]),
            style: (0, import_vue6.normalizeStyle)([{ width: (0, import_vue6.unref)(width) + "px", height: (0, import_vue6.unref)(height) + "px" }, (0, import_vue6.unref)(customCSSStyle)])
          }, [
  ...
  var tmOverlay = /* @__PURE__ */ _export_sfc(_sfc_main6, [["styles", [_style_03]], ["__file", "F:/CoinQT/CoinQT_app/tmui/components/tm-overlay/tm-overlay.vue"]]);
  ...
  var _sfc_main7 = /* @__PURE__ */ (0, import_vue7.defineComponent)({
    __name: "overlay",
    setup(__props) {
      const showWin = (0, import_vue7.ref)(false);
      (0, import_vue7.ref)("bottom");
      return (_ctx, _cache) => {
        return (0, import_vue7.openBlock)(), (0, import_vue7.createElementBlock)("scroll-view", {
          ...
          (0, import_vue7.createVNode)(tmApp, null, {
            default: (0, import_vue7.withCtx)(() => [
              ...
              (0, import_vue7.createVNode)(tmOverlay, {
                show: showWin.value,
                "onUpdate:show": _cache[2] || (_cache[2] = ($event) => showWin.value = $event)
              }, {
                default: (0, import_vue7.withCtx)(() => [
                  (0, import_vue7.createElementVNode)("view", {
                    onClick: _cache[1] || (_cache[1] = (0, import_vue7.withModifiers)(() => {
                    }, ["stop"]))
                  }, [
                    (0, import_vue7.createVNode)(tmSheet, null, {
                      default: (0, import_vue7.withCtx)(() => [
                        (0, import_vue7.createVNode)(tmText, { label: "\u66F4\u591A\u5C5E\u6027\u52A8\u753B\u65F6\u957F\u8FD9\u4E9B\u8BF7\u524D\u6587\u6863" })
                      ]),
                      _: 1
                    })
                  ])
  ...
  var overlay = /* @__PURE__ */ _export_sfc(_sfc_main7, [["__file", "F:/CoinQT/CoinQT_app/pages/fankui/overlay.nvue"]]);

  // <stdin>
  var webview = plus.webview.currentWebview();
  if (webview) {
    const __pageId = parseInt(webview.id);
    const __pagePath = "pages/fankui/overlay";
    let __pageQuery = {};
    try {
