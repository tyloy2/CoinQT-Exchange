...
(() => {
  ...
  // F:/CoinQT/CoinQT_app/unpackage/dist/dev/.nvue/pages/fankui/notification.js
  ...
  var _sfc_main6 = /* @__PURE__ */ (0, import_vue6.defineComponent)({
    ...
    setup(__props, { emit: emits }) {
      ...
      const formtype = (0, import_vue6.computed)(() => props.formType);
      let FormParent = null;
      ...
      const customCSSStyle = (0, import_vue6.computed)(() => {
      ...
      const isclickOn = (0, import_vue6.ref)(false);
      const _load = (0, import_vue6.computed)(() => props.loading);
      const _disabled = (0, import_vue6.computed)(() => props.disabled);
      const _label = (0, import_vue6.computed)(() => props.label);
      const _icon = (0, import_vue6.computed)(() => props.icon);
      const sizeObj = (0, import_vue6.computed)(() => {
        if (props.unit == "px") {
          return {
      ...
      const btnSizeObj = (0, import_vue6.computed)(() => {
      ...
      const _fontColor = (0, import_vue6.computed)(() => props.fontColor);
      function touchstart(e) {
      ...
      return (_ctx, _cache) => {
        ...
        return (0, import_vue6.openBlock)(), (0, import_vue6.createBlock)(tmSheet, {
          "no-level": "",
          _style: { opacity: isclickOn.value || (0, import_vue6.unref)(_disabled) ? 0.7 : 1 },
          "hover-class": "none",
          round: (0, import_vue6.unref)(btnSizeObj).round,
          width: (0, import_vue6.unref)(btnSizeObj).w,
          height: (0, import_vue6.unref)(btnSizeObj).h,
          ...
          default: (0, import_vue6.withCtx)(() => [
            (0, import_vue6.createVNode)(_component_button, {
              ...
              loading: (0, import_vue6.unref)(_load),
              disabled: (0, import_vue6.unref)(_disabled),
              "hover-start-time": 1e7,
              "hover-stop-propagation": "",
              "hover-class": "bhover",
              class: (0, import_vue6.normalizeClass)(["button flex-1 flex-center", [(0, import_vue6.unref)(customClass)]]),
              style: (0, import_vue6.normalizeStyle)((0, import_vue6.unref)(customCSSStyle))
            }, {
              default: (0, import_vue6.withCtx)(() => [
                (0, import_vue6.renderSlot)(_ctx.$slots, "default", {}, () => [
                  (0, import_vue6.unref)(_icon) ? ((0, import_vue6.openBlock)(), (0, import_vue6.createBlock)(tmIcon, {
                    key: 0,
                    userInteractionEnabled: false,
                    color: (0, import_vue6.unref)(_fontColor),
                    _class: (0, import_vue6.unref)(_label) ? "pr-10" : "",
                    unit: props.unit,
                    fontSize: (0, import_vue6.unref)(btnSizeObj).fontSize * 0.9,
                    name: (0, import_vue6.unref)(_icon)
                  }, null, 8, ["color", "_class", "unit", "fontSize", "name"])) : (0, import_vue6.createCommentVNode)("v-if", true),
                  (0, import_vue6.createVNode)(tmText, {
                    userInteractionEnabled: false,
                    color: (0, import_vue6.unref)(_fontColor),
                    fontSize: (0, import_vue6.unref)(btnSizeObj).fontSize,
                    unit: props.unit,
                    label: (0, import_vue6.unref)(_label)
  ...
  var TmButton = /* @__PURE__ */ _export_sfc(_sfc_main6, [["styles", [_style_03]], ["__file", "F:/CoinQT/CoinQT_app/tmui/components/tm-button/tm-button.vue"]]);
  ...
  var _sfc_main$12 = /* @__PURE__ */ (0, import_vue7.defineComponent)({
    ...
    setup(__props, { expose, emit: emits }) {
      ...
      const tranmatioan = (0, import_vue7.ref)(null);
      ...
      let windowBottom = (0, import_vue7.computed)(() => sysinfo.value.bottom);
      let windowTop = (0, import_vue7.computed)(() => sysinfo.value.top);
      let windowWidth = (0, import_vue7.computed)(() => sysinfo.value.width);
      const timeid = (0, import_vue7.ref)(uni.$tm.u.getUid(5));
      const iconProxy = (0, import_vue7.ref)("");
      const labelProxy = (0, import_vue7.ref)("");
      const isEnd = (0, import_vue7.ref)(true);
      const showDom = (0, import_vue7.ref)(false);
      const handleClose = (0, import_vue7.ref)(false);
      const label_str = (0, import_vue7.computed)({
        ...
        set: (val) => {
          ...
          (0, import_vue7.nextTick)(function() {
            var _a22;
            if (tranmatioan.value) {
              (_a22 = tranmatioan.value) == null ? void 0 : _a22.play();
            }
          });
        }
      });
      const icon_str = (0, import_vue7.computed)({
        get: () => iconProxy.value,
        set: (val) => {
          iconProxy.value = val;
          if (props.label !== "") {
      ...
      const tranName = (0, import_vue7.computed)(() => {
      ...
      const pos = (0, import_vue7.computed)(() => {
      ...
      const reverse = (0, import_vue7.ref)(true);
      ...
      function hide() {
        ...
        if (tranmatioan.value) {
          (0, import_vue7.nextTick)(() => {
            var _a22;
            return (_a22 = tranmatioan.value) == null ? void 0 : _a22.play();
          });
        } else {
          showDom.value = false;
          reverse.value = true;
      ...
      expose({ show, hide });
      return (_ctx, _cache) => {
        return showDom.value ? ((0, import_vue7.openBlock)(), (0, import_vue7.createElementBlock)("view", {
          key: 0,
          class: (0, import_vue7.normalizeClass)(["fixed "]),
          style: (0, import_vue7.normalizeStyle)([
            (0, import_vue7.unref)(pos).left !== null ? { left: (0, import_vue7.unref)(pos).left + "px" } : "",
            (0, import_vue7.unref)(pos).right !== null ? { right: (0, import_vue7.unref)(pos).right + "px" } : "",
            (0, import_vue7.unref)(pos).top !== null ? { top: (0, import_vue7.unref)(pos).top + "px" } : "",
            (0, import_vue7.unref)(pos).bottom !== null ? { bottom: (0, import_vue7.unref)(pos).bottom + "px" } : "",
            (0, import_vue7.unref)(pos).width !== null ? { width: (0, import_vue7.unref)(pos).width + "px" } : "",
          ...
          (0, import_vue7.createVNode)(tmTranslate, {
            ...
            ref: tranmatioan,
            autoPlay: false,
            name: (0, import_vue7.unref)(tranName),
            onEnd: endAnimation,
              ...
              (0, import_vue7.createVNode)(tmSheet, {
                ...
                default: (0, import_vue7.withCtx)(() => [
                  (0, import_vue7.renderSlot)(_ctx.$slots, "default", {}, () => [
                    (0, import_vue7.createElementVNode)("view", { class: "flex flex-row flex-row-center-between relative" }, [
                      (0, import_vue7.createElementVNode)("view", { class: "flex flex-1 flex-row overflow flex-row-center-start" }, [
                        (0, import_vue7.createVNode)(tmIcon, {
                          _class: "pr-10",
                          fontSize: 26,
                          name: (0, import_vue7.unref)(icon_str)
                        }, null, 8, ["name"]),
                        (0, import_vue7.renderSlot)(_ctx.$slots, "default", {}, () => [
                          (0, import_vue7.createVNode)(tmText, {
                            _class: "text-overflow-1",
                            label: (0, import_vue7.unref)(label_str)
                          }, null, 8, ["label"])
                        ])
                      ]),
  ...
  var tmNotification = /* @__PURE__ */ _export_sfc(_sfc_main$12, [["__file", "F:/CoinQT/CoinQT_app/tmui/components/tm-notification/tm-notification.vue"]]);
  var _sfc_main7 = /* @__PURE__ */ (0, import_vue7.defineComponent)({
    __name: "notification",
    setup(__props) {
      const msg = (0, import_vue7.ref)(null);
      const placement = (0, import_vue7.ref)("topLeft");
      function show(e) {
        placement.value = e;
        msg.value.show();
      }
            ...
            default: (0, import_vue7.withCtx)(() => [
              (0, import_vue7.createVNode)(tmSheet, null, {
                default: (0, import_vue7.withCtx)(() => [
                  ...
                  (0, import_vue7.createElementVNode)("view", { class: "flex flex-row flex-wrap" }, [
              ...
              (0, import_vue7.createVNode)(tmNotification, {
  ...
  var notification = /* @__PURE__ */ _export_sfc(_sfc_main7, [["__file", "F:/CoinQT/CoinQT_app/pages/fankui/notification.nvue"]]);

  // <stdin>
  var webview = plus.webview.currentWebview();
  if (webview) {
    const __pageId = parseInt(webview.id);
    const __pagePath = "pages/fankui/notification";
    let __pageQuery = {};
    try {
      __pageQuery = JSON.parse(webview.__query__);
    } catch (e) {
    }
    notification.mpType = "page";
    const app = Vue.createPageApp(notification, { $store: getApp({ allowDefault: true }).$store, __pageId, __pagePath, __pageQuery });
    app.provide("__globalStyles", Vue.useCssStyles([...__uniConfig.styles, ...notification.styles || []]));
    app.mount("#root");
  }
})();
