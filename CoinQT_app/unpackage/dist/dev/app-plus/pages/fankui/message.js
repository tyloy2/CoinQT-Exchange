...
(() => {
  ...
  // F:/CoinQT/CoinQT_app/unpackage/dist/dev/.nvue/pages/fankui/message.js
...
${codeFrame}` : message2);
  ...
  var _sfc_main7 = /* @__PURE__ */ (0, import_vue7.defineComponent)({
    ...
    setup(__props) {
      ...
      const isDark = (0, import_vue7.computed)(() => computedDark(__spreadProps6(__spreadValues6({}, props), { borderDirection: borderDir.value }), tmcfg.value));
      const tmcomputed = (0, import_vue7.computed)(() => computedTheme(__spreadProps6(__spreadValues6({}, props), { borderDirection: borderDir.value }), isDark.value, tmcfg.value));
      return (_ctx, _cache) => {
  ...
  var _sfc_main8 = /* @__PURE__ */ (0, import_vue8.defineComponent)({
    ...
    setup(__props, { emit: emits }) {
      ...
      const formtype = (0, import_vue8.computed)(() => props.formType);
      let FormParent = null;
      ...
      const customCSSStyle = (0, import_vue8.computed)(() => {
      ...
      const isclickOn = (0, import_vue8.ref)(false);
      const _load = (0, import_vue8.computed)(() => props.loading);
      const _disabled = (0, import_vue8.computed)(() => props.disabled);
      const _label = (0, import_vue8.computed)(() => props.label);
      const _icon = (0, import_vue8.computed)(() => props.icon);
      const sizeObj = (0, import_vue8.computed)(() => {
        if (props.unit == "px") {
          return {
      ...
      const btnSizeObj = (0, import_vue8.computed)(() => {
      ...
      const _fontColor = (0, import_vue8.computed)(() => props.fontColor);
      function touchstart(e) {
      ...
      return (_ctx, _cache) => {
        ...
        return (0, import_vue8.openBlock)(), (0, import_vue8.createBlock)(tmSheet, {
          "no-level": "",
          _style: { opacity: isclickOn.value || (0, import_vue8.unref)(_disabled) ? 0.7 : 1 },
          "hover-class": "none",
          round: (0, import_vue8.unref)(btnSizeObj).round,
          width: (0, import_vue8.unref)(btnSizeObj).w,
          height: (0, import_vue8.unref)(btnSizeObj).h,
          padding: props.padding,
          margin: props.margin,
          color: props.color,
          shadow: props.shadow,
          ...
          default: (0, import_vue8.withCtx)(() => [
            (0, import_vue8.createVNode)(_component_button, {
              onClick: onclick,
              onTouchstart: touchstart,
              onTouchend: touchend,
              onLongpress: _cache[0] || (_cache[0] = ($event) => emits("longpress", $event)),
              ...
              loading: (0, import_vue8.unref)(_load),
              disabled: (0, import_vue8.unref)(_disabled),
              "hover-start-time": 1e7,
              "hover-stop-propagation": "",
              "hover-class": "bhover",
              class: (0, import_vue8.normalizeClass)(["button flex-1 flex-center", [(0, import_vue8.unref)(customClass)]]),
              style: (0, import_vue8.normalizeStyle)((0, import_vue8.unref)(customCSSStyle))
            }, {
              default: (0, import_vue8.withCtx)(() => [
                (0, import_vue8.renderSlot)(_ctx.$slots, "default", {}, () => [
                  (0, import_vue8.unref)(_icon) ? ((0, import_vue8.openBlock)(), (0, import_vue8.createBlock)(tmIcon, {
                    key: 0,
                    userInteractionEnabled: false,
                    color: (0, import_vue8.unref)(_fontColor),
                    _class: (0, import_vue8.unref)(_label) ? "pr-10" : "",
                    unit: props.unit,
                    fontSize: (0, import_vue8.unref)(btnSizeObj).fontSize * 0.9,
                    name: (0, import_vue8.unref)(_icon)
                  }, null, 8, ["color", "_class", "unit", "fontSize", "name"])) : (0, import_vue8.createCommentVNode)("v-if", true),
                  (0, import_vue8.createVNode)(tmText, {
                    userInteractionEnabled: false,
                    color: (0, import_vue8.unref)(_fontColor),
                    fontSize: (0, import_vue8.unref)(btnSizeObj).fontSize,
                    unit: props.unit,
                    label: (0, import_vue8.unref)(_label)
  ...
  var TmButton = /* @__PURE__ */ _export_sfc(_sfc_main8, [["styles", [_style_04]], ["__file", "F:/CoinQT/CoinQT_app/tmui/components/tm-button/tm-button.vue"]]);
  ...
  var _sfc_main9 = /* @__PURE__ */ (0, import_vue9.defineComponent)({
    __name: "message",
    setup(__props) {
      const msg = (0, import_vue9.ref)(null);
      return (_ctx, _cache) => {
        return (0, import_vue9.openBlock)(), (0, import_vue9.createElementBlock)("scroll-view", {
          ...
          (0, import_vue9.createVNode)(tmApp, null, {
            default: (0, import_vue9.withCtx)(() => [
              ...
              (0, import_vue9.createVNode)(tmMessage, {
                ref_key: "msg",
                ref: msg
              }, null, 512)
            ]),
  ...
  var message = /* @__PURE__ */ _export_sfc(_sfc_main9, [["__file", "F:/CoinQT/CoinQT_app/pages/fankui/message.nvue"]]);

  // <stdin>
  var webview = plus.webview.currentWebview();
  if (webview) {
    const __pageId = parseInt(webview.id);
    const __pagePath = "pages/fankui/message";
    let __pageQuery = {};
    try {
    ...
    message.mpType = "page";
    const app = Vue.createPageApp(message, { $store: getApp({ allowDefault: true }).$store, __pageId, __pagePath, __pageQuery });
    app.provide("__globalStyles", Vue.useCssStyles([...__uniConfig.styles, ...message.styles || []]));
    app.mount("#root");
  }
})();
/*!
