...
(() => {
  ...
  // F:/CoinQT/CoinQT_app/unpackage/dist/dev/.nvue/pages/fankui/darglist.js
  ...
  var _style_02 = { "tm-dragList-item": { "": { "transitionDelay": 0, "transitionProperty": "top,left,transform", "transitionTimingFunction": "ease", "transitionDuration": 150 } }, "@TRANSITION": { "tm-dragList-item": { "delay": 0, "property": "top,left,transform", "timingFunction": "ease", "duration": 150 } } };
  var _sfc_main$12 = /* @__PURE__ */ (0, import_vue4.defineComponent)({
    ...
    setup(__props, { emit: emits }) {
      const props = __props;
      const w = (0, import_vue4.ref)(0);
      const h = (0, import_vue4.ref)(0);
      const totalH = (0, import_vue4.ref)(0);
      let y = 0;
      const new_index = (0, import_vue4.ref)(NaN);
      const nowMove_index = (0, import_vue4.ref)(NaN);
      const listData = (0, import_vue4.ref)([]);
      const endDrage = (0, import_vue4.ref)(false);
      const isNvue = (0, import_vue4.ref)(false);
      isNvue.value = true;
      (0, import_vue4.onMounted)(() => jishunTopData());
      ...
      function m_move(event, index) {
        ...
        listData.value.splice(index, 1, __spreadProps4(__spreadValues4({}, listData.value[index]), {
          top: ch
        }));
      ...
      function moveChange() {
        if (props.disabled)
          return;
        emits("change", (0, import_vue4.toRaw)(listData.value));
      }
      return (_ctx, _cache) => {
        return (0, import_vue4.openBlock)(), (0, import_vue4.createElementBlock)("view", {
          ...
          (0, import_vue4.createElementVNode)("view", {
            style: (0, import_vue4.normalizeStyle)({ height: h.value * __props.list.length + "px", width: w.value + "px" }),
            class: (0, import_vue4.normalizeClass)(["relative flex flex-col", [__props.disabled ? "opacity-4" : ""]])
          }, [
            ((0, import_vue4.openBlock)(true), (0, import_vue4.createElementBlock)(import_vue4.Fragment, null, (0, import_vue4.renderList)(listData.value, (item, index) => {
              return (0, import_vue4.openBlock)(), (0, import_vue4.createElementBlock)("view", {
                class: (0, import_vue4.normalizeClass)(["overflow flex flex-col", [
                  "absolute",
                  "tm-dragList-item",
                  "flex-between"
                ]]),
                ...
                (0, import_vue4.createVNode)(tmSheet, {
                  ...
                  default: (0, import_vue4.withCtx)(() => [
                    (0, import_vue4.createElementVNode)("view", {
                      ...
                      style: (0, import_vue4.normalizeStyle)({ height: h.value - 1 + "px" })
                    }, [
                      item["icon"] ? ((0, import_vue4.openBlock)(), (0, import_vue4.createElementBlock)("view", {
                        key: 0,
                    ...
                    (0, import_vue4.createElementVNode)("view", {
                      style: (0, import_vue4.normalizeStyle)({ height: h.value - 1 + "px", width: "100rpx" }),
                      onTouchstart: (0, import_vue4.withModifiers)(($event) => m_start($event, index), ["stop", "prevent"]),
                      onLongpress: ($event) => m_start_longpress(index),
                      onMousedown: ($event) => m_start($event, index),
                      onTouchmove: (0, import_vue4.withModifiers)(($event) => m_move($event, index), ["stop", "prevent"]),
                      onMousemove: (0, import_vue4.withModifiers)(($event) => m_move($event, index), ["stop", "prevent"]),
  ...
  var tmDragList = /* @__PURE__ */ _export_sfc(_sfc_main$12, [["styles", [_style_02]], ["__file", "F:/CoinQT/CoinQT_app/tmui/components/tm-drag-list/tm-drag-list.vue"]]);
  var _sfc_main4 = /* @__PURE__ */ (0, import_vue4.defineComponent)({
    __name: "darglist",
    setup(__props) {
      (0, import_vue4.ref)(false);
      (0, import_vue4.ref)("bottom");
      const lsit = (0, import_vue4.ref)([
        { text: "\u6D4B\u8BD5\u9879\u76EE1-1" },
        { text: "\u6D4B\u8BD5\u9879\u76EE2-1" },
        { text: "\u6D4B\u8BD5\u9879\u76EE3-1" },
        { text: "\u6D4B\u8BD5\u9879\u76EE4-1" },
        ...
        return (0, import_vue4.openBlock)(), (0, import_vue4.createElementBlock)("scroll-view", {
          ...
          (0, import_vue4.createVNode)(tmApp, null, {
            default: (0, import_vue4.withCtx)(() => [
              ...
              (0, import_vue4.createVNode)(tmDragList, { list: lsit.value }, null, 8, ["list"])
            ]),
            _: 1
          })
        ]);
  ...
  var darglist = /* @__PURE__ */ _export_sfc(_sfc_main4, [["__file", "F:/CoinQT/CoinQT_app/pages/fankui/darglist.nvue"]]);

  // <stdin>
  var webview = plus.webview.currentWebview();
  if (webview) {
    const __pageId = parseInt(webview.id);
    const __pagePath = "pages/fankui/darglist";
    let __pageQuery = {};
    try {
      __pageQuery = JSON.parse(webview.__query__);
    } catch (e) {
    }
    darglist.mpType = "page";
    const app = Vue.createPageApp(darglist, { $store: getApp({ allowDefault: true }).$store, __pageId, __pagePath, __pageQuery });
    app.provide("__globalStyles", Vue.useCssStyles([...__uniConfig.styles, ...darglist.styles || []]));
    app.mount("#root");
  }
})();
