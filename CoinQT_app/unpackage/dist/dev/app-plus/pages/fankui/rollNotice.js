...
(() => {
  ...
  // F:/CoinQT/CoinQT_app/unpackage/dist/dev/.nvue/pages/fankui/rollNotice.js
  ...
  var _sfc_main$12 = /* @__PURE__ */ (0, import_vue4.defineComponent)({
    ...
    setup(__props, { emit: emits }) {
      ...
      const _list = (0, import_vue4.computed)(() => {
      ...
      const _duration = (0, import_vue4.computed)(() => props.duration);
      const _width = (0, import_vue4.computed)(() => props.width - props.margin[0] * 2 - 24);
      const _Left = (0, import_vue4.computed)(() => {
        if (_icon.value !== "") {
      ...
      return (_ctx, _cache) => {
        return (0, import_vue4.openBlock)(), (0, import_vue4.createBlock)(tmSheet, {
          ...
          default: (0, import_vue4.withCtx)(() => [
            (0, import_vue4.unref)(_icon) ? ((0, import_vue4.openBlock)(), (0, import_vue4.createElementBlock)("view", {
              key: 0,
            ...
            (0, import_vue4.createElementVNode)("view", {
              ...
              (0, import_vue4.createElementVNode)("view", {
                ref: "content",
                style: (0, import_vue4.normalizeStyle)({ animationDuration: (0, import_vue4.unref)(_duration) + "s", paddingLeft: (isNvue.value ? 0 : (0, import_vue4.unref)(_Left)) + "rpx", width: (0, import_vue4.unref)(_Left) * __props.list.length + "rpx" }),
                class: "aniRow flex-row flex-row-center-start"
              }, [
                ((0, import_vue4.openBlock)(true), (0, import_vue4.createElementBlock)(import_vue4.Fragment, null, (0, import_vue4.renderList)((0, import_vue4.unref)(_list), (item, index) => {
            ...
            props.showRight ? ((0, import_vue4.openBlock)(), (0, import_vue4.createElementBlock)("view", {
              key: 1,
  ...
  var tmRollNotice = /* @__PURE__ */ _export_sfc(_sfc_main$12, [["__file", "F:/CoinQT/CoinQT_app/tmui/components/tm-roll-notice/tm-roll-notice.vue"]]);
  var _sfc_main4 = /* @__PURE__ */ (0, import_vue4.defineComponent)({
    __name: "rollNotice",
    setup(__props) {
      const content = (0, import_vue4.ref)(["11\u6D4B\u8BD5\u6EDA\u52A8\u8BD5\u6EDAend", "22\u6D4B\u8BD5\u6EDA\u52A8\u6D4B\u8BD5\u6EDA\u52A8\u6D4B\u8BD5\u6EDA\u52A8\u6D4B\u8BD5\u6EDA\u52A8\u6D4B\u8BD5\u6EDA\u52A8"]);
      const test = (index) => {
      ...
      return (_ctx, _cache) => {
        return (0, import_vue4.openBlock)(), (0, import_vue4.createElementBlock)("scroll-view", {
          ...
          (0, import_vue4.createVNode)(tmApp, null, {
            default: (0, import_vue4.withCtx)(() => [
              (0, import_vue4.createVNode)(tmRollNotice, {
                onClick: test,
                list: content.value
              }, null, 8, ["list"]),
              (0, import_vue4.createVNode)(tmRollNotice, {
  ...
  var rollNotice = /* @__PURE__ */ _export_sfc(_sfc_main4, [["__file", "F:/CoinQT/CoinQT_app/pages/fankui/rollNotice.nvue"]]);

  // <stdin>
  var webview = plus.webview.currentWebview();
  if (webview) {
    const __pageId = parseInt(webview.id);
    const __pagePath = "pages/fankui/rollNotice";
    let __pageQuery = {};
    try {
      __pageQuery = JSON.parse(webview.__query__);
    } catch (e) {
    }
    rollNotice.mpType = "page";
    const app = Vue.createPageApp(rollNotice, { $store: getApp({ allowDefault: true }).$store, __pageId, __pagePath, __pageQuery });
    app.provide("__globalStyles", Vue.useCssStyles([...__uniConfig.styles, ...rollNotice.styles || []]));
    app.mount("#root");
  }
})();
