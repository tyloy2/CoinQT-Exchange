...
(() => {
  ...
  // F:/CoinQT/CoinQT_app/unpackage/dist/dev/.nvue/pages/fankui/spin.js
  ...
  var _sfc_main$12 = /* @__PURE__ */ (0, import_vue7.defineComponent)({
    ...
    setup(__props, { emit: emits }) {
      ...
      const css_is_nvue = (0, import_vue7.ref)(true);
      const css_nvue_size = (0, import_vue7.ref)([0, 0]);
      const bgColorComputed = (0, import_vue7.computed)(() => isDark.value ? "rgba(0,0,0,0.9)" : props.bgColor);
      const loadingComputed = (0, import_vue7.computed)(() => props.load);
      const _color = (0, import_vue7.computed)(() => props.color);
      ...
      return (_ctx, _cache) => {
        return (0, import_vue7.openBlock)(), (0, import_vue7.createElementBlock)("view", {
          ref: "tmspin",
          class: (0, import_vue7.normalizeClass)([[(0, import_vue7.unref)(customClass)], "flex relative flex-col"]),
          style: (0, import_vue7.normalizeStyle)([(0, import_vue7.unref)(customCSSStyle)]),
          renderWhole: true
        }, [
          (0, import_vue7.createElementVNode)("view", { class: "relative zIndex-1" }, [
            (0, import_vue7.renderSlot)(_ctx.$slots, "default")
          ]),
          (0, import_vue7.unref)(loadingComputed) ? ((0, import_vue7.openBlock)(), (0, import_vue7.createElementBlock)("view", {
            key: 0,
            onClick: (0, import_vue7.withModifiers)(clickMask, ["stop"]),
            class: (0, import_vue7.normalizeClass)(["absolute zIndex-10 flex-center blur", [
              css_is_nvue.value ? "" : " fulled-height   "
            ]]),
            style: (0, import_vue7.normalizeStyle)([
              css_is_nvue.value ? "" : { width: "100%" },
              { backgroundColor: (0, import_vue7.unref)(bgColorComputed) },
  ...
  var tmSpin = /* @__PURE__ */ _export_sfc(_sfc_main$12, [["__file", "F:/CoinQT/CoinQT_app/tmui/components/tm-spin/tm-spin.vue"]]);
  var _sfc_main7 = /* @__PURE__ */ (0, import_vue7.defineComponent)({
    __name: "spin",
    setup(__props) {
      (0, import_vue7.getCurrentInstance)();
      const load = (0, import_vue7.ref)(true);
      return (_ctx, _cache) => {
            ...
            default: (0, import_vue7.withCtx)(() => [
              (0, import_vue7.createVNode)(tmSheet, null, {
                default: (0, import_vue7.withCtx)(() => [
                  ...
                  (0, import_vue7.createVNode)(tmSpin, {
                    load: load.value,
                    tip: "\u70B9\u6211\u53D6\u6D88\u52A0\u8F7D",
                    ...
                    default: (0, import_vue7.withCtx)(() => [
                      (0, import_vue7.createVNode)(tmSheet, {
                        ...
                        default: (0, import_vue7.withCtx)(() => [
                          ...
                          (0, import_vue7.createVNode)(tmText, { label: "\u52A0\u8F7D\u4E2D Spin\u53EF\u4EE5\u5E94\u7528\u4E8E\u4EFB\u4F55\u5143\u7D20\u4E2D\uFF0C\u5F53\u7136\u4F7F\u7528\u573A\u666F\u4E3B\u8981\u662F\u5C40\u90E8\u5185\u5BB9\u52A0\u8F7D\u53CD\u9988\u7B49\u7B49\u3002\u52A0\u8F7D\u4E2D Spin\u53EF\u4EE5\u5E94\u7528\u4E8E\u4EFB\u4F55\u5143\u7D20\u4E2D\uFF0C\u5F53\u7136\u4F7F\u7528\u573A\u666F\u4E3B\u8981\u662F\u5C40\u90E8\u5185\u5BB9\u52A0\u8F7D\u53CD\u9988\u7B49\u7B49\u3002" })
                        ]),
                        _: 1
                      })
                    ]),
  ...
  var spin = /* @__PURE__ */ _export_sfc(_sfc_main7, [["__file", "F:/CoinQT/CoinQT_app/pages/fankui/spin.nvue"]]);

  // <stdin>
  var webview = plus.webview.currentWebview();
  if (webview) {
    const __pageId = parseInt(webview.id);
    const __pagePath = "pages/fankui/spin";
    let __pageQuery = {};
    try {
    ...
    spin.mpType = "page";
    const app = Vue.createPageApp(spin, { $store: getApp({ allowDefault: true }).$store, __pageId, __pagePath, __pageQuery });
    app.provide("__globalStyles", Vue.useCssStyles([...__uniConfig.styles, ...spin.styles || []]));
    app.mount("#root");
  }
})();
