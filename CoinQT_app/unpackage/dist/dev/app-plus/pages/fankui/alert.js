...
(() => {
  ...
  // F:/CoinQT/CoinQT_app/unpackage/dist/dev/.nvue/pages/fankui/alert.js
  ...
  var _sfc_main$12 = /* @__PURE__ */ (0, import_vue5.defineComponent)({
    ...
    setup(__props, { emit: emits }) {
      const props = __props;
      const bodyani = (0, import_vue5.ref)(null);
      const activeIndex = (0, import_vue5.ref)(0);
      const showBody = (0, import_vue5.ref)(true);
      let timeid = uni.$tm.u.getUid(5);
      const reani = (0, import_vue5.computed)(() => props.hidnAniName == "zoom" || props.hidnAniName == "fade" ? true : false);
      const list = (0, import_vue5.computed)(() => {
      ...
      const len = (0, import_vue5.computed)(() => list.value.length);
      (0, import_vue5.onUnmounted)(() => clearTimeout(timeid));
      ...
      return (_ctx, _cache) => {
        return showBody.value ? ((0, import_vue5.openBlock)(), (0, import_vue5.createBlock)(tmTranslate, {
          key: 0,
          onEnd: hide,
          ref_key: "bodyani",
          ref: bodyani,
          reverse: (0, import_vue5.unref)(reani),
          ...
          default: (0, import_vue5.withCtx)(() => [
            (0, import_vue5.createVNode)(tmSheet, {
              ...
              default: (0, import_vue5.withCtx)(() => [
                (0, import_vue5.createElementVNode)("view", { class: "relative bdcld flex flex-row flex-row-top-start" }, [
                  (0, import_vue5.createElementVNode)("view", {
                    style: { "width": "0px" },
                    class: (0, import_vue5.normalizeClass)(["flex flex-12 flex-row flex-row-top-start", [__props.closable ? "pr-24 " : ""]])
                  }, [
                    ((0, import_vue5.openBlock)(true), (0, import_vue5.createElementBlock)(import_vue5.Fragment, null, (0, import_vue5.renderList)((0, import_vue5.unref)(list), (item, index) => {
                      return (0, import_vue5.openBlock)(), (0, import_vue5.createElementBlock)("view", {
                        key: index,
                        class: (0, import_vue5.normalizeClass)([[activeIndex.value == index ? "flex-12 " : " flex-0 "], "flex flex-row flex-row-top-start anifun"])
                      }, [
                        activeIndex.value == index ? ((0, import_vue5.openBlock)(), (0, import_vue5.createBlock)(tmTranslate, {
                          key: 0,
                          name: "zoom",
                          style: { "width": "100%" },
                          ...
                          default: (0, import_vue5.withCtx)(() => [
                            (0, import_vue5.createElementVNode)("view", { class: "flex-12 flex flex-row flex-row-top-start" }, [
                              item["icon"] ? ((0, import_vue5.openBlock)(), (0, import_vue5.createElementBlock)("view", {
                                key: 0,
                                class: "pr-32"
                              }, [
                              ...
                              (0, import_vue5.createElementVNode)("view", {
                                ...
                                item["title"] ? ((0, import_vue5.openBlock)(), (0, import_vue5.createElementBlock)("view", {
                                  key: 0,
                                  class: "pb-12"
                                }, [
                                ...
                                item["content"] ? ((0, import_vue5.openBlock)(), (0, import_vue5.createElementBlock)("view", {
                                  key: 1,
                                  ...
                                  (0, import_vue5.unref)(len) > 1 && props.showDot ? ((0, import_vue5.openBlock)(), (0, import_vue5.createBlock)(tmText, {
                                    key: 0,
                                    _class: "pt-24",
                                    label: `${activeIndex.value + 1}/${(0, import_vue5.unref)(len)}`
                          ...
                          _: 2
                        }, 1024)) : (0, import_vue5.createCommentVNode)("v-if", true)
                      ], 2);
                    }), 128))
                  ], 2),
                  __props.closable ? ((0, import_vue5.openBlock)(), (0, import_vue5.createElementBlock)("view", {
                    key: 0,
          ...
          _: 1
        }, 8, ["reverse", "name"])) : (0, import_vue5.createCommentVNode)("v-if", true);
      };
    }
  });
  var tmAlert = /* @__PURE__ */ _export_sfc(_sfc_main$12, [["__file", "F:/CoinQT/CoinQT_app/tmui/components/tm-alert/tm-alert.vue"]]);
  var _sfc_main5 = /* @__PURE__ */ (0, import_vue5.defineComponent)({
    __name: "alert",
    setup(__props) {
      const content = (0, import_vue5.ref)([
        {
          icon: "tmicon-alert",
          content: "\u8FD9\u662F\u4E00\u6761\u65B0\u95FB\u8FD9\u662F\u4E00\u6761\u65B0\u95FB\u8FD9\u662F\u4E00\u6761\u65B0\u95FB\u8FD9\u662F\u4E00\u6761\u65B0\u95FB\u8FD9\u662F\u4E00\u6761\u65B0\u95FB\u8FD9\u662F\u4E00\u6761\u65B0\u95FB22\u8FD9\u662F\u4E00\u6761\u65B0\u95FB\u8FD9\u662F\u4E00\u6761\u65B0\u95FB\u8FD9\u662F\u4E00\u6761\u65B0\u95FB"
        }
      ]);
      const content2 = (0, import_vue5.ref)([
        {
          title: "\u6211\u662F\u6807\u9898",
          content: "\u6211\u662F\u4ECB\u7ECD\u5185\u5BB9\u54E6"
        }
      ...
      return (_ctx, _cache) => {
        return (0, import_vue5.openBlock)(), (0, import_vue5.createElementBlock)("scroll-view", {
          ...
          (0, import_vue5.createVNode)(tmApp, null, {
            default: (0, import_vue5.withCtx)(() => [
              (0, import_vue5.createVNode)(tmAlert, {
                shadow: 2,
  ...
  var alert = /* @__PURE__ */ _export_sfc(_sfc_main5, [["__file", "F:/CoinQT/CoinQT_app/pages/fankui/alert.nvue"]]);

  // <stdin>
  var webview = plus.webview.currentWebview();
  if (webview) {
    const __pageId = parseInt(webview.id);
    const __pagePath = "pages/fankui/alert";
    let __pageQuery = {};
    try {
