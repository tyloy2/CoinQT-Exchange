...
(() => {
  ...
  // F:/CoinQT/CoinQT_app/unpackage/dist/dev/.nvue/pages/fankui/progress.js
  ...
  var WebGLRenderingContext = class {
    constructor(canvas, type, attrs) {
      ...
      this.stencilFunc = function(func, ref5, mask) {
        WebGLRenderingContext.GBridge.callNative(this._canvas.id, GLmethod.stencilFunc + "," + func + "," + ref5 + "," + mask, true);
      };
      this.stencilFuncSeparate = function(face, func, ref5, mask) {
        WebGLRenderingContext.GBridge.callNative(this._canvas.id, GLmethod.stencilFuncSeparate + "," + face + "," + func + "," + ref5 + "," + mask, true);
      };
  ...
  var _style_03 = { "tmRogress": { "": { "transitionDuration": 500, "transitionTimingFunction": "ease-in-out", "transitionProperty": "width" } }, "@TRANSITION": { "tmRogress": { "duration": 500, "timingFunction": "ease-in-out", "property": "width" } } };
  var _sfc_main$12 = /* @__PURE__ */ (0, import_vue6.defineComponent)({
    ...
    setup(__props, { emit: emits }) {
      ...
      const canvasId = (0, import_vue6.ref)("canvasId");
      canvasId.value = "tm" + String(new Date().getTime());
      let ctx;
      const shadow_pr = (0, import_vue6.computed)(() => props.shadow * 4);
      ...
      const _bgColor = (0, import_vue6.computed)(() => computedTheme(__spreadProps6(__spreadValues6({}, props), { color: props.bgColor, followTheme: false }), isDark.value, tmcfg.value).backgroundColor);
      tool.getColor(props.color).value;
      tmcomputed.value.backgroundColor;
      const activeWidth = (0, import_vue6.computed)(() => {
        let pr = props.percent >= 100 ? 100 : props.percent;
        let w = Math.floor(pr / 100 * props.width);
        w = w >= props.width ? props.width : w;
        return w;
      });
      const percent_rp = (0, import_vue6.computed)(() => {
        let pr = props.percent >= 100 ? 100 : props.percent;
        return pr;
      });
      (0, import_vue6.watch)(() => props.percent, (val) => {
        if (props.disabled)
          return;
        drawNvue_draw();
      ...
      return (_ctx, _cache) => {
        return (0, import_vue6.openBlock)(), (0, import_vue6.createElementBlock)("view", {
          ...
          __props.model == "line" ? ((0, import_vue6.openBlock)(), (0, import_vue6.createElementBlock)("view", {
            key: 0,
            style: (0, import_vue6.normalizeStyle)([{ width: __props.width + "rpx", paddingTop: "16rpx", paddingBottom: "16rpx" }]),
            class: "flex relative flex flex-col overflow"
          }, [
            (0, import_vue6.createElementVNode)("view", { class: "relative" }, [
            ...
            (0, import_vue6.createElementVNode)("view", {
              ...
              style: (0, import_vue6.normalizeStyle)([{ width: (0, import_vue6.unref)(activeWidth) + "rpx", top: 16 + "rpx" }])
            }, [
              (0, import_vue6.createVNode)(tmSheet, {
                round: props.round,
                followTheme: props.followTheme,
                ...
                width: (0, import_vue6.unref)(activeWidth),
                height: props.height,
                color: props.color,
                padding: [0, 0]
              }, null, 8, ["round", "followTheme", "dark", "linear", "linearDeep", "width", "height", "color"])
            ], 4),
            props.showBar ? ((0, import_vue6.openBlock)(), (0, import_vue6.createElementBlock)("view", {
              key: 0,
              class: "absolute l-0 t-0 tmRogress flex flex-col",
              style: (0, import_vue6.normalizeStyle)([
                { width: (0, import_vue6.unref)(activeWidth) + "rpx", height: props.height + 32 + "rpx", "align-items": "flex-end", "justify-content": "center" }
              ])
            }, [
          ...
          __props.model == "circle" ? ((0, import_vue6.openBlock)(), (0, import_vue6.createElementBlock)("view", {
            key: 1,
            style: (0, import_vue6.normalizeStyle)({ width: `${props.width}rpx`, height: `${props.semicircle ? props.width / 2 + 16 : props.width}rpx` }),
            class: "flex relative flex-col"
          }, [
            (0, import_vue6.createElementVNode)("gcanvas", {
              id: canvasId.value,
              ref: canvasId.value,
              class: "canvas",
              style: (0, import_vue6.normalizeStyle)({ width: `${props.width}rpx`, height: `${props.semicircle ? props.width / 2 + 16 : props.width}rpx` })
            }, null, 12, ["id"]),
            (0, import_vue6.createElementVNode)("cover-view", {
              style: (0, import_vue6.normalizeStyle)([
              ...
              class: (0, import_vue6.normalizeClass)(["relative absolute l-0 t-0 flex flex-col", [!props.semicircle ? "flex-center" : ""]])
            }, [
              (0, import_vue6.renderSlot)(_ctx.$slots, "title", {}, () => [
                props.showBar ? ((0, import_vue6.openBlock)(), (0, import_vue6.createBlock)(tmText, {
                  key: 0,
                  color: props.color,
                  followTheme: props.followTheme,
                  dark: props.dark,
                  fontSize: props.fontSize,
                  label: props.percent + props.percentSuffix
                }, null, 8, ["color", "followTheme", "dark", "fontSize", "label"])) : (0, import_vue6.createCommentVNode)("v-if", true)
              ])
            ], 6)
          ], 4)) : (0, import_vue6.createCommentVNode)("v-if", true)
        ]);
  ...
  var tmProgress = /* @__PURE__ */ _export_sfc(_sfc_main$12, [["styles", [_style_03]], ["__file", "F:/CoinQT/CoinQT_app/tmui/components/tm-progress/tm-progress.vue"]]);
  var _sfc_main6 = /* @__PURE__ */ (0, import_vue6.defineComponent)({
    __name: "progress",
    setup(__props) {
      (0, import_vue6.getCurrentInstance)();
      const percent = (0, import_vue6.ref)(50);
      return (_ctx, _cache) => {
            ...
            default: (0, import_vue6.withCtx)(() => [
              (0, import_vue6.createVNode)(tmSheet, null, {
                default: (0, import_vue6.withCtx)(() => [
                  ...
                  (0, import_vue6.createVNode)(tmProgress, {
                    width: 636,
                    percent: percent.value,
                    "onUpdate:percent": _cache[0] || (_cache[0] = ($event) => percent.value = $event)
                  }, null, 8, ["percent"]),
                  (0, import_vue6.createElementVNode)("view", { class: "py-12" }),
                  (0, import_vue6.createVNode)(tmProgress, {
                    linear: "right",
                    width: 636,
                    color: "red",
              ...
              (0, import_vue6.createVNode)(tmSheet, null, {
                default: (0, import_vue6.withCtx)(() => [
                  ...
                  (0, import_vue6.createVNode)(tmDivider),
                  (0, import_vue6.createElementVNode)("view", { class: "flex flex-row" }, [
                    (0, import_vue6.createVNode)(tmProgress, {
                      model: "circle",
                      bgColor: "grey",
                      height: 24,
              ...
              (0, import_vue6.createVNode)(tmSheet, null, {
                default: (0, import_vue6.withCtx)(() => [
                  ...
                  (0, import_vue6.createVNode)(tmDivider),
                  (0, import_vue6.createElementVNode)("view", { class: "flex flex-row" }, [
                    (0, import_vue6.createVNode)(TmButton, {
                      onClick: _cache[7] || (_cache[7] = ($event) => percent.value = percent.value >= 100 ? 0 : percent.value + 10),
                      label: "\u589E\u52A0"
                    }),
                    (0, import_vue6.createElementVNode)("view", { class: "px-12" }),
                    (0, import_vue6.createVNode)(TmButton, {
                      color: "red",
  ...
  var progress = /* @__PURE__ */ _export_sfc(_sfc_main6, [["__file", "F:/CoinQT/CoinQT_app/pages/fankui/progress.nvue"]]);

  // <stdin>
  var webview = plus.webview.currentWebview();
  if (webview) {
    const __pageId = parseInt(webview.id);
    const __pagePath = "pages/fankui/progress";
    let __pageQuery = {};
    try {
