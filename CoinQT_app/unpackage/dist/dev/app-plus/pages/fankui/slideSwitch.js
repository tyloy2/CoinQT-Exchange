...
(() => {
  ...
  // F:/CoinQT/CoinQT_app/unpackage/dist/dev/.nvue/pages/fankui/slideSwitch.js
  ...
  // F:/CoinQT/CoinQT_app/unpackage/dist/dev/.nvue/tm-card.js
    ...
    setup(__props) {
      ...
      return (_ctx, _cache) => {
        return (0, import_vue8.openBlock)(), (0, import_vue8.createBlock)(tmSheet, {
          color: props.color,
          _class: [(0, import_vue8.unref)(customClass), "flex-col"],
          _style: [(0, import_vue8.unref)(customCSSStyle)],
          followTheme: props.followTheme,
          dark: props.dark,
          round: props.round,
          shadow: props.shadow,
          ...
          default: (0, import_vue8.withCtx)(() => [
            (0, import_vue8.createElementVNode)("view", { class: "flex-row flex flex-between pt-24" }, [
              ...
              (0, import_vue8.renderSlot)(_ctx.$slots, "status", {}, () => [
                (0, import_vue8.createVNode)(tmText, {
                  followTheme: false,
            ...
            (0, import_vue8.createElementVNode)("view", { class: "pb-24 flex" }, [
            ...
            (0, import_vue8.createElementVNode)("view", { class: "flex pb-24" }, [
              (0, import_vue8.renderSlot)(_ctx.$slots, "action")
            ])
          ]),
          _: 3
  ...
  var tmCard = /* @__PURE__ */ _export_sfc(_sfc_main8, [["__file", "F:/CoinQT/CoinQT_app/tmui/components/tm-card/tm-card.vue"]]);
  ...
  var _sfc_main$12 = /* @__PURE__ */ (0, import_vue10.defineComponent)({
    ...
    setup(__props, { emit: emits }) {
      ...
      const attr = (0, import_vue10.computed)(() => {
        return {
          width: props.width,
          height: props.height,
      ...
      const _disabled = (0, import_vue10.ref)(props.disabled);
      (0, import_vue10.watchEffect)(() => {
        _disabled.value = props.disabled;
      });
      const _cellwidth = (0, import_vue10.computed)(() => uni.upx2px(attr.value.width));
      (0, import_vue10.computed)(() => _cellwidth.value * 2);
      const list = (0, import_vue10.computed)(() => {
        let lp = props.action.map((el) => {
          var _a2, _b2, _c, _d;
          return __spreadValues10({
            text: (_a2 = el == null ? void 0 : el.text) != null ? _a2 : "",
            color: (_b2 = el == null ? void 0 : el.color) != null ? _b2 : "white",
      ...
      const maxWidth = (0, import_vue10.computed)(() => {
        let w = 0;
      ...
      const _x = (0, import_vue10.ref)(_cellwidth.value);
      const _old_x = (0, import_vue10.ref)(_cellwidth.value);
      const _mX = (0, import_vue10.ref)(_cellwidth.value);
      const _isDrag = (0, import_vue10.ref)(false);
      const isRend = (0, import_vue10.ref)(false);
      const _animation = (0, import_vue10.ref)(false);
      const _isCloseAni = (0, import_vue10.ref)(true);
      let ChaJuli = 0;
      let maxLen = _cellwidth.value - maxWidth.value;
      (0, import_vue10.watchEffect)(() => props.openStatus, () => oninit());
      (0, import_vue10.onMounted)(() => {
        (0, import_vue10.nextTick)(() => isRend.value = true);
      ...
      return (_ctx, _cache) => {
        const _component_movable_view = (0, import_vue10.resolveComponent)("movable-view");
        const _component_movable_area = (0, import_vue10.resolveComponent)("movable-area");
        return (0, import_vue10.openBlock)(), (0, import_vue10.createElementBlock)("view", {
          style: (0, import_vue10.normalizeStyle)(`width:${(0, import_vue10.unref)(attr).width}rpx;height:${(0, import_vue10.unref)(attr).height}rpx `),
          class: (0, import_vue10.normalizeClass)(["overflow", [(0, import_vue10.unref)(attr).disabled ? "opacity-7" : ""]]),
          renderWhole: true
        }, [
          (0, import_vue10.createVNode)(_component_movable_area, {
            style: (0, import_vue10.normalizeStyle)({
              width: (0, import_vue10.unref)(attr).width * 2 + "rpx",
              height: (0, import_vue10.unref)(attr).height + "rpx",
              transform: `translateX(-${(0, import_vue10.unref)(_cellwidth)}px)`
            })
          }, {
            default: (0, import_vue10.withCtx)(() => [
              (0, import_vue10.createVNode)(_component_movable_view, {
                animation: _animation.value,
                style: (0, import_vue10.normalizeStyle)({
                  width: (0, import_vue10.unref)(attr).width + "rpx",
                  height: (0, import_vue10.unref)(attr).height + "rpx"
                }),
                x: (0, import_vue10.unref)(_cellwidth),
                disabled: "",
                ...
                default: (0, import_vue10.withCtx)(() => [
                  ...
                  (0, import_vue10.createElementVNode)("view", { class: "flex flex-row flex-row-center-end" }, [
                    ((0, import_vue10.openBlock)(true), (0, import_vue10.createElementBlock)(import_vue10.Fragment, null, (0, import_vue10.renderList)((0, import_vue10.unref)(list), (item, index) => {
                      return (0, import_vue10.openBlock)(), (0, import_vue10.createBlock)(tmSheet, {
                        "no-level": "",
                        ...
                        key: index,
                        color: item.color,
                        height: (0, import_vue10.unref)(attr).height,
                        width: item.width,
                        _class: "flex-center flex-row"
                      }, {
                        default: (0, import_vue10.withCtx)(() => [
                          item.icon ? ((0, import_vue10.openBlock)(), (0, import_vue10.createBlock)(tmIcon, {
                            key: 0,
                            "font-size": 26,
                            _class: "pr-8",
                            userInteractionEnabled: false,
                            name: item.icon
                          }, null, 8, ["name"])) : (0, import_vue10.createCommentVNode)("v-if", true),
              ...
              (0, import_vue10.createVNode)(_component_movable_view, {
                ...
                default: (0, import_vue10.withCtx)(() => [
                  isRend.value ? ((0, import_vue10.openBlock)(), (0, import_vue10.createBlock)(tmSheet, {
                    key: 0,
                    shadow: 0,
                    outlined: props.outlined,
                    borderStyle: props.borderStyle,
                    ...
                    transprent: props.transprent,
                    width: (0, import_vue10.unref)(attr).width,
                    height: (0, import_vue10.unref)(attr).height,
                    margin: [0, 0],
                    padding: [0, 0]
                  }, {
                    ...
                    _: 3
                  }, 8, ["outlined", "borderStyle", "borderDirection", "linearDeep", "linear", "round", "color", "text", "transprent", "width", "height"])) : (0, import_vue10.createCommentVNode)("v-if", true)
                ]),
                _: 3
  ...
  var tmSlideSwitch = /* @__PURE__ */ _export_sfc(_sfc_main$12, [["__file", "F:/CoinQT/CoinQT_app/tmui/components/tm-slide-switch/tm-slide-switch.vue"]]);
  var _sfc_main10 = /* @__PURE__ */ (0, import_vue10.defineComponent)({
    __name: "slideSwitch",
    setup(__props) {
      const isopen = (0, import_vue10.ref)(true);
      const action = (0, import_vue10.ref)([
        { text: "\u64CD\u4F5C", color: "black" },
      ...
      return (_ctx, _cache) => {
        return (0, import_vue10.openBlock)(), (0, import_vue10.createElementBlock)("scroll-view", {
          scrollY: true,
          showScrollbar: true,
          ...
          (0, import_vue10.createVNode)(tmApp, null, {
            default: (0, import_vue10.withCtx)(() => [
              (0, import_vue10.createVNode)(tmSheet, null, {
                default: (0, import_vue10.withCtx)(() => [
                  (0, import_vue10.createVNode)(tmText, {
                    fontSize: 24,
              ...
              (0, import_vue10.createVNode)(tmSheet, { padding: [0, 0] }, {
                default: (0, import_vue10.withCtx)(() => [
                  (0, import_vue10.createVNode)(tmSlideSwitch, {
                    ...
                    default: (0, import_vue10.withCtx)(() => [
                      (0, import_vue10.createVNode)(tmCell, {
                        margin: [0, 0],
                        title: "\u5411\u5DE6\u6ED1\u52A8,\u5E76\u70B9\u51FB\u5E95\u90E8\u6309\u94AE"
                      })
                    ]),
                  ...
                  ((0, import_vue10.openBlock)(), (0, import_vue10.createElementBlock)(import_vue10.Fragment, null, (0, import_vue10.renderList)(4, (item) => {
                    return (0, import_vue10.createVNode)(tmSlideSwitch, {
                      key: item,
                      width: 686,
                      height: 84,
                      action: action.value
              ...
              (0, import_vue10.createElementVNode)("view", { class: "mx-32 round-2 overflow" }, [
                (0, import_vue10.createVNode)(tmSlideSwitch, {
                  ...
                  default: (0, import_vue10.withCtx)(() => [
                    (0, import_vue10.createVNode)(tmCard, {
                      margin: [0, 0],
                      shadow: 0,
                      status: "2022-5-2",
                      title: "\u5411\u5DE6\u6ED1\u52A8\u8BD5\u4E0B",
                      ...
                      action: (0, import_vue10.withCtx)(() => [
                        (0, import_vue10.createElementVNode)("view", { class: "flex flex-1 flex-row flex-row-center-end" }, [
  ...
  var slideSwitch = /* @__PURE__ */ _export_sfc(_sfc_main10, [["__file", "F:/CoinQT/CoinQT_app/pages/fankui/slideSwitch.nvue"]]);

  // <stdin>
  var webview = plus.webview.currentWebview();
  if (webview) {
    const __pageId = parseInt(webview.id);
    const __pagePath = "pages/fankui/slideSwitch";
    let __pageQuery = {};
    try {
      __pageQuery = JSON.parse(webview.__query__);
    } catch (e) {
    }
    slideSwitch.mpType = "page";
    const app = Vue.createPageApp(slideSwitch, { $store: getApp({ allowDefault: true }).$store, __pageId, __pagePath, __pageQuery });
    app.provide("__globalStyles", Vue.useCssStyles([...__uniConfig.styles, ...slideSwitch.styles || []]));
    app.mount("#root");
  }
})();
