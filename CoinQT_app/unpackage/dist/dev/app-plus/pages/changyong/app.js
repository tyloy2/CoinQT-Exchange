...
(() => {
  ...
  // F:/CoinQT/CoinQT_app/unpackage/dist/dev/.nvue/pages/changyong/app.js
  ...
  var app = /* @__PURE__ */ _export_sfc(_sfc_main3, [["__file", "F:/CoinQT/CoinQT_app/pages/changyong/app.nvue"]]);

  // <stdin>
  var webview = plus.webview.currentWebview();
  if (webview) {
    const __pageId = parseInt(webview.id);
    const __pagePath = "pages/changyong/app";
    let __pageQuery = {};
    try {
    ...
    app.mpType = "page";
    const app2 = Vue.createPageApp(app, { $store: getApp({ allowDefault: true }).$store, __pageId, __pagePath, __pageQuery });
    app2.provide("__globalStyles", Vue.useCssStyles([...__uniConfig.styles, ...app.styles || []]));
    app2.mount("#root");
  }
})();
