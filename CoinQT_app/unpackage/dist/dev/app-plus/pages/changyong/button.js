...
(() => {
  ...
  // F:/CoinQT/CoinQT_app/unpackage/dist/dev/.nvue/pages/changyong/button.js
            ...
            default: (0, import_vue6.withCtx)(() => [
              (0, import_vue6.createVNode)(tmSheet, null, {
                default: (0, import_vue6.withCtx)(() => [
                  ...
                  (0, import_vue6.createElementVNode)("view", { class: "flex flex-row flex-wrap" }, [
  ...
  var button = /* @__PURE__ */ _export_sfc(_sfc_main6, [["__file", "F:/CoinQT/CoinQT_app/pages/changyong/button.nvue"]]);

  // <stdin>
  var webview = plus.webview.currentWebview();
  if (webview) {
    const __pageId = parseInt(webview.id);
    const __pagePath = "pages/changyong/button";
    let __pageQuery = {};
    try {
