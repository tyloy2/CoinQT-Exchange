...
(() => {
  ...
  // F:/CoinQT/CoinQT_app/unpackage/dist/dev/.nvue/pages/changyong/text.js
  ...
  var _sfc_main2 = /* @__PURE__ */ (0, import_vue2.defineComponent)({
    ...
    setup(__props, { emit: emits }) {
      ...
      const tmcomputed = (0, import_vue2.computed)(() => {
        ...
        return computedTheme(__spreadProps2(__spreadValues2({}, props), { blur: _blur.value, text: text2 }), isDark.value, tmcfg.value);
      });
            ...
            default: (0, import_vue4.withCtx)(() => [
              (0, import_vue4.createVNode)(tmSheet, null, {
                default: (0, import_vue4.withCtx)(() => [
                  ...
                  (0, import_vue4.createVNode)(tmText, { label: "\u8FD9\u662F\u6587\u672C\u6807\u7B7E\uFF0C\u6587\u672C\u663E\u793A\u5FC5\u9700\u8981\u4F7F\u7528\u6B64\u6807\u7B7E" })
                ]),
                _: 1
              }),
              (0, import_vue4.createVNode)(tmSheet, null, {
  ...
  var text = /* @__PURE__ */ _export_sfc(_sfc_main4, [["__file", "F:/CoinQT/CoinQT_app/pages/changyong/text.nvue"]]);

  // <stdin>
  var webview = plus.webview.currentWebview();
  if (webview) {
    const __pageId = parseInt(webview.id);
    const __pagePath = "pages/changyong/text";
    let __pageQuery = {};
    try {
