...
(() => {
  ...
  // F:/CoinQT/CoinQT_app/unpackage/dist/dev/.nvue/pages/changyong/index.js
  ...
  var _sfc_main2 = /* @__PURE__ */ (0, import_vue2.defineComponent)({
    ...
    setup(__props) {
      ...
      const props = __props;
      const store = useTmpiniaStore();
      const borderDir = (0, import_vue2.computed)(() => props.vertical ? "left" : "bottom");
      ...
      const _realColor = (0, import_vue2.computed)(() => props.realColor);
      const isDark = (0, import_vue2.computed)(() => computedDark(__spreadProps2(__spreadValues2({}, props), { borderDirection: borderDir.value }), tmcfg.value));
      const tmcomputed = (0, import_vue2.computed)(() => computedTheme(__spreadProps2(__spreadValues2({}, props), { borderDirection: borderDir.value }), isDark.value, tmcfg.value));
      return (_ctx, _cache) => {
        return (0, import_vue2.openBlock)(), (0, import_vue2.createElementBlock)("view", { renderWhole: true }, [
          !(0, import_vue2.unref)(_label) && props.vertical ? ((0, import_vue2.openBlock)(), (0, import_vue2.createElementBlock)("view", {
            key: 0,
            style: (0, import_vue2.normalizeStyle)([{ backgroundColor: (0, import_vue2.unref)(_realColor) ? (0, import_vue2.unref)(tmcomputed).color : (0, import_vue2.unref)(tmcomputed).border }, props.vertical ? { width: props.border + "rpx", height: props.height + "rpx" } : ""]),
            class: (0, import_vue2.normalizeClass)([props.vertical ? `mx-${props.margin[0]}` : `my-${props.margin[1]}`])
          }, null, 6)) : (0, import_vue2.createCommentVNode)("v-if", true),
          (0, import_vue2.unref)(_label) && !props.vertical ? ((0, import_vue2.openBlock)(), (0, import_vue2.createElementBlock)("view", {
            key: 1,
            class: "flex flex-row flex-center"
          }, [
            (0, import_vue2.createElementVNode)("view", {
              style: (0, import_vue2.normalizeStyle)([(0, import_vue2.unref)(tmcomputed) ? { backgroundColor: (0, import_vue2.unref)(_realColor) ? (0, import_vue2.unref)(tmcomputed).color : (0, import_vue2.unref)(tmcomputed).border, height: props.border + "rpx" } : ""]),
              class: (0, import_vue2.normalizeClass)([`my-${props.margin[1]}`, __props.align == "left" ? "flex-2" : "", __props.align == "right" ? "flex-10" : "", __props.align == "center" ? "flex-1" : ""])
            }, null, 6),
            props.label ? ((0, import_vue2.openBlock)(), (0, import_vue2.createElementBlock)("view", {
              key: 0,
              class: (0, import_vue2.normalizeClass)([(0, import_vue2.unref)(isDark) ? "opacity-4" : ""])
            }, [
              (0, import_vue2.createVNode)(tmText, {
                fontSize: props.fontSize,
                dark: (0, import_vue2.unref)(isDark),
            ...
            (0, import_vue2.createElementVNode)("view", {
              style: (0, import_vue2.normalizeStyle)([(0, import_vue2.unref)(tmcomputed) ? { backgroundColor: (0, import_vue2.unref)(_realColor) ? (0, import_vue2.unref)(tmcomputed).color : (0, import_vue2.unref)(tmcomputed).border, height: props.border + "rpx" } : ""]),
              class: (0, import_vue2.normalizeClass)([`my-${props.margin[1]}`, __props.align == "left" ? "flex-10" : "", __props.align == "right" ? "flex-2" : "", __props.align == "center" ? "flex-1" : ""])
            }, null, 6)
          ...
          !(0, import_vue2.unref)(_label) && !props.vertical ? ((0, import_vue2.openBlock)(), (0, import_vue2.createElementBlock)("view", {
            ...
            (0, import_vue2.createElementVNode)("view", {
              class: (0, import_vue2.normalizeClass)(["flex-1", [`my-${props.margin[1]}`]]),
              style: (0, import_vue2.normalizeStyle)([(0, import_vue2.unref)(tmcomputed) ? { backgroundColor: (0, import_vue2.unref)(_realColor) ? (0, import_vue2.unref)(tmcomputed).color : (0, import_vue2.unref)(tmcomputed).border, height: props.border + "rpx" } : ""])
            }, null, 6)
          ])) : (0, import_vue2.createCommentVNode)("v-if", true)
        ]);
  ...
  var tmDivider = /* @__PURE__ */ _export_sfc(_sfc_main2, [["__file", "F:/CoinQT/CoinQT_app/tmui/components/tm-divider/tm-divider.vue"]]);
  ...
  var _sfc_main3 = /* @__PURE__ */ (0, import_vue3.defineComponent)({
    ...
    setup(__props, { emit: emits }) {
      ...
      const parenClass_p = (0, import_vue3.computed)(() => props.parenClass);
      const contStyle_p = (0, import_vue3.computed)(() => props.contStyle);
      const _transprent = (0, import_vue3.computed)(() => props.transprent);
      const tmcfg = (0, import_vue3.computed)(() => store.tmStore);
      const _blur = (0, import_vue3.computed)(() => {
      ...
      const tmcomputed = (0, import_vue3.computed)(() => {
        ...
        return computedTheme(__spreadProps3(__spreadValues3({}, props), { blur: _blur.value, text }), isDark.value, tmcfg.value);
      });
      const _isNvue = (0, import_vue3.ref)(false);
      _isNvue.value = true;
      const _margin = (0, import_vue3.computed)(() => props.margin);
      const _padding = (0, import_vue3.computed)(() => props.padding);
      const _width = (0, import_vue3.computed)(() => props.width);
      const _height = (0, import_vue3.computed)(() => props.height);
      const _noLevel = (0, import_vue3.computed)(() => props.noLevel);
      const _blue_sheet = (0, import_vue3.ref)(true);
      const _blurEffect = (0, import_vue3.computed)(() => {
        if (props.blur === true && isDark.value)
          return "dark";
        if (props.blur === true && !isDark.value)
          return "extralight";
      ...
      (0, import_vue3.watch)(() => isDark.value, () => {
        if (store.tmStore.os == "ios" && _blur.value === true) {
          _blue_sheet.value = false;
          (0, import_vue3.nextTick)(() => _blue_sheet.value = true);
        }
      });
      const _bgcolor = (0, import_vue3.computed)(() => {
        var _a22;
      ...
      const isLongPress = (0, import_vue3.ref)(false);
      ...
      let textColor = (0, import_vue3.computed)(() => {
        return tmcomputed.value.textColor;
      });
      (0, import_vue3.provide)("appTextColor", textColor);
      return (_ctx, _cache) => {
        return _blue_sheet.value ? ((0, import_vue3.openBlock)(), (0, import_vue3.createElementBlock)("view", {
          key: 0,
          renderWhole: true,
          blurEffect: (0, import_vue3.unref)(_blurEffect),
          onClick: _cache[0] || (_cache[0] = ($event) => emits("click", $event)),
          ...
          class: (0, import_vue3.normalizeClass)([
            ...
            (0, import_vue3.unref)(parenClass_p),
            `mx-${(0, import_vue3.unref)(_margin)[0]}`,
            `my-${(0, import_vue3.unref)(_margin)[1]}`,
            `px-${(0, import_vue3.unref)(_padding)[0]}`,
            `py-${(0, import_vue3.unref)(_padding)[1]}`,
          ...
          style: (0, import_vue3.normalizeStyle)([
            (0, import_vue3.unref)(_height) ? { height: (0, import_vue3.unref)(_height) + (0, import_vue3.unref)(_padding)[1] * 2 + props.unit } : "",
            (0, import_vue3.unref)(_width) ? { width: (0, import_vue3.unref)(_width) + (0, import_vue3.unref)(_padding)[0] * 2 + props.unit } : "",
            (0, import_vue3.unref)(tmcomputed).borderCss,
            (0, import_vue3.unref)(_blur) && (0, import_vue3.unref)(store).tmStore.os == "ios" && _isNvue.value === true ? "" : (0, import_vue3.unref)(_bgcolor),
            !(0, import_vue3.unref)(_transprent) && props.shadow > 0 ? (0, import_vue3.unref)(tmcomputed).shadowColor : "",
            !(0, import_vue3.unref)(_transprent) && (0, import_vue3.unref)(_blur) ? { backdropFilter: "blur(6px)" } : "",
            (0, import_vue3.unref)(customCSSStyle)
          ])
        }, [
          (0, import_vue3.createElementVNode)("view", {
            renderWhole: true,
            class: (0, import_vue3.normalizeClass)(["flex noNvueBorder flex-col flex-1", (0, import_vue3.unref)(customClass)]),
            style: (0, import_vue3.normalizeStyle)((0, import_vue3.unref)(contStyle_p))
          }, [
            (0, import_vue3.renderSlot)(_ctx.$slots, "default")
          ], 6)
        ], 46, ["blurEffect"])) : (0, import_vue3.createCommentVNode)("v-if", true);
      };
    }
  });
  var tmSheet = /* @__PURE__ */ _export_sfc(_sfc_main3, [["__file", "F:/CoinQT/CoinQT_app/tmui/components/tm-sheet/tm-sheet.vue"]]);
        ...
        return (0, import_vue8.openBlock)(), (0, import_vue8.createElementBlock)("scroll-view", {
          ...
          (0, import_vue8.createVNode)(tmApp, null, {
            default: (0, import_vue8.withCtx)(() => [
              (0, import_vue8.createElementVNode)("view", { class: "ma-32 round-3 overflow" }, [
                ((0, import_vue8.openBlock)(true), (0, import_vue8.createElementBlock)(import_vue8.Fragment, null, (0, import_vue8.renderList)(list.value, (item, index2) => {
                  return (0, import_vue8.openBlock)(), (0, import_vue8.createBlock)(tmCell, {
                    key: index2,
                    url: item.path,
                    margin: [0, 0],
                    titleFontSize: 30,
              ...
              (0, import_vue8.createElementVNode)("view", { class: "py-32 mx-32" }, [
                (0, import_vue8.createVNode)(tmDivider, {
                  color: "grey-2",
  ...
  var index = /* @__PURE__ */ _export_sfc(_sfc_main8, [["__file", "F:/CoinQT/CoinQT_app/pages/changyong/index.nvue"]]);

  // <stdin>
  var webview = plus.webview.currentWebview();
  if (webview) {
    const __pageId = parseInt(webview.id);
    const __pagePath = "pages/changyong/index";
    let __pageQuery = {};
    try {
